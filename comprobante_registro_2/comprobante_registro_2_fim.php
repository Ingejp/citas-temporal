...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____comprobante_registro_2"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____comprobante_registro_2"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['comprobante_registro_2']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['comprobante_registro_2']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['comprobante_registro_2']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['comprobante_registro_2']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['comprobante_registro_2']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>comprobante_registro_2</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['comprobante_registro_2']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['comprobante_registro_2']['embutida_filho'] as $ind => $sc_init)
          {
