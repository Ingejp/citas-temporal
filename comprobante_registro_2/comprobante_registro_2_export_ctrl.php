<?php
@session_start() ;
$_SESSION['scriptcase']['comprobante_registro_2']['sc_process_barr'] = true;
require_once('../comprobante_registro_2/index.php');
unset($_SESSION['scriptcase']['comprobante_registro_2']['sc_process_barr']);
$ExportCtrl = new comprobante_registro_2_export_control;
$ExportCtrl->Export_barr();

class comprobante_registro_2_export_control
{
