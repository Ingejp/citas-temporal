<?php
   include_once('Reporte_pdf_condicion_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class Reporte_pdf_condicion_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "Reporte_pdf_condicion"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20190805"; 
      $this->nm_hr_criacao   = "195151"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/Reporte_pdf_condicion';
      ...
      if (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['actual_lang']) || $_SESSION['scriptcase']['Reporte_pdf_condicion']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['Reporte_pdf_condicion']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("Reporte_pdf_condicion_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Reporte_pdf_condicion"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Reporte_pdf_condicion"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "Reporte_pdf_condicion_erro.class.php"); 
      $this->Erro = new Reporte_pdf_condicion_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('Reporte_pdf_condicion'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao']) && $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_perfil']) && $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['embutida_init']) 
      {
          if (!isset($_SESSION['ID_CONDICION'])) 
          {
              $this->nm_falta_var .= "ID_CONDICION; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Reporte_pdf_condicion']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class Reporte_pdf_condicion_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new Reporte_pdf_condicion_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_pdf_condicion']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_pdf_condicion']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Reporte_pdf_condicion']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Reporte_pdf_condicion'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Reporte_pdf_condicion']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Reporte_pdf_condicion']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Reporte_pdf_condicion') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Reporte_pdf_condicion']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_pdf_condicion']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Reporte_pdf_condicion']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['Reporte_pdf_condicion']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      include_once($this->Ini->path_aplicacao . 'fpdf.php');
      $this->nm_data = new nm_data("es");
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "Reporte_pdf_condicion_erro.class.php"); 
      $this->Erro      = new Reporte_pdf_condicion_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['Reporte_pdf_condicion']['contr_erro'] = 'on';
if (!isset($_SESSION['ID_CONDICION'])) {$_SESSION['ID_CONDICION'] = "";}
if (!isset($this->sc_temp_ID_CONDICION)) {$this->sc_temp_ID_CONDICION = (isset($_SESSION['ID_CONDICION'])) ? $_SESSION['ID_CONDICION'] : "";}
 $check_sql = "SELECT c.id_condicion,
	   c.fecha,
	   c.cable,
       c.medida,
       c.plug,
       ...
       dc.foto,
       v.viaje,
	   (Select t.transporte from transporte t where t.idTransporte=cab.idTransporte) as Transporte"

. " FROM condicion c
INNER JOIN naviera n ON c.idnaviera=n.idNaviera
INNER JOIN cabezal cab ON c.idcabezal=cab.idcabezal
INNER JOIN yarda y ON c.idyarda=y.idyarda
LEFT JOIN piloto p  ON c.idpiloto=p.idpiloto
INNER JOIN detalle_condicion dc  ON c.id_condicion=dc.idcondicion
INNER JOIN master_equipo me ON c.numero_contenedor=me.numero_contenedor
INNER JOIN tipomovimiento tm ON c.tipoMovimiento_idtipoMovimiento=tm.idtipoMovimiento 
left join viaje v ON c.idviaje=v.idviaje"
	
   . " WHERE c.id_condicion=dc.idcondicion AND LENGTH(dc.foto)>1 AND  c.id_condicion = '" . $this->sc_temp_ID_CONDICION . "'";
...
if (isset($this->rs[0][0]))     
{
	...
	$naviera  = $this->rs[0][5];
	$yarda  = $this->rs[0][6];
	$contenedor = $this->rs[0][7];
	$placa  = $this->rs[0][8];
	$nombre  = $this->rs[0][9];
	$observaciones  = $this->rs[0][10];
	$codigoqr  = $this->rs[0][11];
	$descripcion  = $this->rs[0][12];
	$foto = $this->rs[0][13];
	$transporte = $this->rs[0][15];
	
	
	$fpdf = new FPDF();
	$fpdf->AddPage();
	$fpdf->Image('https://puertobarrios.net/wp-content/uploads/2019/09/FORMATO-CONDICION-I.jpg',4,-5,210);
	
	
	$path="https://serviciosdat.puertobarrios.net/_lib/file/img";

	$fpdf->SetFont('Arial','B',12);
	

	$fpdf->Ln();
	$fpdf->Cell(20); $fpdf->Cell(20,58, $codigoqr);  $fpdf->Cell(105);
	$fpdf->Cell(90,58, $descripcion);
	
	$fpdf->Ln(1);
	$fpdf->Cell(10); $fpdf->Cell(30,85, $fecha);  $fpdf->Cell(40);
	$fpdf->Cell(50,85, $contenedor);$fpdf->Cell(15);
	$fpdf->Cell(50,85, $naviera);

	$fpdf->Ln(1);
	$fpdf->Cell(10); $fpdf->Cell(30,112, $placa); $fpdf->Cell(40);
	$fpdf->Cell(50,112, $transporte); $fpdf->Cell(16);
	$fpdf->Cell(20,112, $yarda);

	$fpdf->Ln(1);
	$fpdf->Cell(10); $fpdf->Cell(30,135, $cable);  $fpdf->Cell(40);
	$fpdf->Cell(50,135, $medida);  $fpdf->Cell(16);
	$fpdf->Cell(20,135, $plug);

	$fpdf->Ln(1);
	$fpdf->Cell(10);  $fpdf->Cell(30,160, $observaciones);
	
	

	$limite=sizeof($this->rs);
	$ejeY=115;
	$ejeX=15;
	$ejeXDerecho=110;		
	
	for($i = 0; $i < $limite ; $i++){
		$imagenes =$path.'/'.$this->rs[$i][13];		
		$caracteres_imagen=strlen($this->rs[$i][13]);		
			
			if($i==4){
				$fpdf->AddPage();
				$fpdf->Image('https://puertobarrios.net/wp-content/uploads/2019/09/FORMATO-CONDICION-II.jpg',4,-5,210);
				$ejeY=50; $ejeX=10; $ejeXDerecho=115;
			}
		
		if($caracteres_imagen>1){
			if((($i+1) % 2)!=0){	
				$fpdf->Image($imagenes,$ejeX,$ejeY,90,70);
			}
			else{
				$fpdf->Image($imagenes,$ejeXDerecho,$ejeY,90,70);
				$ejeY=$ejeY+90;
			}
...
{
		$this->nm_mens_alert[] = 'El registro que buscas no existe';$this->nm_params_alert[] = array();}
if (isset($this->sc_temp_ID_CONDICION)) {$_SESSION['ID_CONDICION'] = $this->sc_temp_ID_CONDICION;}
$_SESSION['scriptcase']['Reporte_pdf_condicion']['contr_erro'] = 'off'; 
$confirmButtonClass = '';
$cancelButtonClass  = '';
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<script type="text/javascript" src="../_lib/lib/js/frameControl.js"></script>

<script type="text/javascript" src="Reporte_pdf_condicion_message.js"></script>
<script type="text/javascript">
$(function() {
<?php
if (count($this->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_pdf_condicion']['ajax_nav'])
           { 
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_Reporte_pdf_condicion($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['Reporte_pdf_condicion']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "Reporte_pdf_condicion") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['Reporte_pdf_condicion']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   ...
   {
       $_SESSION["ID_CONDICION"] = $_POST["ID_CONDICION"];
       nm_limpa_str_Reporte_pdf_condicion($_SESSION["ID_CONDICION"]);
   }
   if (!isset($_POST["ID_CONDICION"]) && isset($_POST["id_condicion"])) 
   {
       $_SESSION["ID_CONDICION"] = $_POST["id_condicion"];
       nm_limpa_str_Reporte_pdf_condicion($_SESSION["ID_CONDICION"]);
   }
   ...
   {
       $_SESSION["ID_CONDICION"] = $_GET["ID_CONDICION"];
       nm_limpa_str_Reporte_pdf_condicion($_SESSION["ID_CONDICION"]);
   }
   if (!isset($_GET["ID_CONDICION"]) && isset($_GET["id_condicion"])) 
   {
       $_SESSION["ID_CONDICION"] = $_GET["id_condicion"];
       nm_limpa_str_Reporte_pdf_condicion($_SESSION["ID_CONDICION"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "Reporte_pdf_condicion";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'Reporte_pdf_condicion' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('Reporte_pdf_condicion' == $sReferer || 'Reporte_pdf_condicion_' == substr($sReferer, 0, 22))
       {
           $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'Reporte_pdf_condicion')
   {
       $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['Reporte_pdf_condicion']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/Reporte_pdf_condicion_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_Reporte_pdf_condicion($cadapar[1]);
       ...
       if (!isset($ID_CONDICION) && isset($id_condicion)) 
       {
           $_SESSION["ID_CONDICION"] = $id_condicion;
       }
       if (isset($ID_CONDICION)) 
       {
           $_SESSION['ID_CONDICION'] = $ID_CONDICION;
           nm_limpa_str_Reporte_pdf_condicion($_SESSION["ID_CONDICION"]);
       }
   ...
   $contr_Reporte_pdf_condicion = new Reporte_pdf_condicion_apl();
   $contr_Reporte_pdf_condicion->controle();
//
   function nm_limpa_str_Reporte_pdf_condicion(&$str)
   {
