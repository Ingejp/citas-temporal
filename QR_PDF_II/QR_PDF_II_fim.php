...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____QR_PDF_II"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____QR_PDF_II"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['QR_PDF_II']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['QR_PDF_II']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['QR_PDF_II']['embutida_filho'] as $ind => $sc_init)
          {
