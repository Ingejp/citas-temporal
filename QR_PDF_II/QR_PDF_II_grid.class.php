...
//
   ...
   $_SESSION['scriptcase']['QR_PDF_II']['default_font'] = $this->default_font;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
...
$_SESSION['scriptcase']['QR_PDF_II']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF_II']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF_II']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['QR_PDF_II']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF_II']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idcita'] = "Id Cita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['codigo_cita'] = "Codigo Cita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['codigo'] = "Codigo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['contenedorimport'] = "Contenedorimport";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['contenedorexport'] = "Contenedor Export";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['observaciones'] = "Observaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['fechainicio'] = "Fecha Inicio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['chasis'] = "Chasis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idnaviera'] = "Id Naviera";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idtipodecarga'] = "Idtipodecarga";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idestado'] = "Idestado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idpiloto'] = "Idpiloto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idcabezal'] = "Idcabezal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idselectivo'] = "Idselectivo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idyarda'] = "Idyarda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idtipomovimiento'] = "Idtipo Movimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['labels']['idviaje'] = "Idviaje";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF_II']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['QR_PDF_II']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['QR_PDF_II']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['qt_col_grid']) 
      {  
          ...
          $this->idviaje[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->idviaje[$this->nm_grid_colunas]);
            $cell_idCita = array('posx' => '15.793984583331342', 'posy' => '4.972526249999373', 'data' => $this->idcita[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '14', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            ...
            $cell_observaciones = array('posx' => '6.771692916665813', 'posy' => '11.826874999998509', 'data' => $this->observaciones[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_fechaInicio = array('posx' => '9.655227916665451', 'posy' => '5.00062499999937', 'data' => $this->fechainicio[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => '14', 'color_r'    => '255', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            ...
            $cell_codigo = array('posx' => '2.4325262499996936', 'posy' => '11.075696458331937', 'data' => $this->codigo[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
