<?php
@session_start() ;
$_SESSION['scriptcase']['QR_PDF_II']['sc_process_barr'] = true;
require_once('../QR_PDF_II/index.php');
unset($_SESSION['scriptcase']['QR_PDF_II']['sc_process_barr']);
$ExportCtrl = new QR_PDF_II_export_control;
$ExportCtrl->Export_barr();

class QR_PDF_II_export_control
{
