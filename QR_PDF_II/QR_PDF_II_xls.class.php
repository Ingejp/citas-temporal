...
class QR_PDF_II_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new QR_PDF_II_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_QR_PDF_II.zip";
          $this->Arquivo   .= "_QR_PDF_II" . $this->Xls_tp;
          $this->Tit_doc    = "QR_PDF_II" . $this->Xls_tp;
          $this->Tit_zip    = "QR_PDF_II.zip";
      ...
      require_once($this->Ini->path_aplicacao . "QR_PDF_II_total.class.php"); 
      $this->Tot = new QR_PDF_II_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['field_order'] as $Cada_cmp)
      {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->idtipomovimiento = $Busca_temp['idtipomovimiento']; 
          $tmp_pos = strpos($this->idtipomovimiento, "##@@");
          if ($tmp_pos !== false && !is_array($this->idtipomovimiento))
          {
              $this->idtipomovimiento = substr($this->idtipomovimiento, 0, $tmp_pos);
          }
      ...
      $_SESSION['scriptcase']['QR_PDF_II']['contr_erro'] = 'on';
...
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_dinamico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_dinamico'] != $this->nm_where_dinamico) {
    $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_dinamico'] = $this->nm_where_dinamico;
    unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['inicio']);
}
...
$_SESSION['scriptcase']['QR_PDF_II']['contr_erro'] = 'off'; 
      ...
      {   
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq'] .= $this->nm_where_dinamico;
      }   
      $this->arr_export = array('label' => array(), 'lines' => array());
      $this->arr_span   = array();

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   ...
   function NM_export_idtipodecarga()
   {
         ...
         if (is_numeric($this->look_idtipodecarga))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_idtipodecarga);
         $this->Xls_col++;
   }
   //----- idestado
   function NM_export_idestado()
   {
         ...
         if (is_numeric($this->look_idestado))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_idestado);
         $this->Xls_col++;
   }
   //----- idpiloto
   function NM_export_idpiloto()
   {
         ...
         if (is_numeric($this->look_idpiloto))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_idpiloto);
         $this->Xls_col++;
   }
   //----- idcabezal
   ...
   function NM_export_idselectivo()
   {
         ...
         if (is_numeric($this->look_idselectivo))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_idselectivo);
         $this->Xls_col++;
   }
   //----- idyarda
   function NM_export_idyarda()
   {
         ...
         if (is_numeric($this->idyarda))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idyarda);
         $this->Xls_col++;
   }
   //----- idtipomovimiento
   function NM_export_idtipomovimiento()
   {
         ...
         if (is_numeric($this->look_idtipomovimiento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_idtipomovimiento);
         $this->Xls_col++;
   }
   //----- idviaje
   ...
   //----- idtipodecarga
   function NM_sub_cons_idtipodecarga()
   {
         if (!NM_is_utf8($this->look_idtipodecarga))
         {
             $this->look_idtipodecarga = sc_convert_encoding($this->look_idtipodecarga, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_idtipodecarga;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- idestado
   function NM_sub_cons_idestado()
   {
         if (!NM_is_utf8($this->look_idestado))
         {
             $this->look_idestado = sc_convert_encoding($this->look_idestado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_idestado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- idselectivo
   function NM_sub_cons_idselectivo()
   {
         if (!NM_is_utf8($this->look_idselectivo))
         {
             $this->look_idselectivo = sc_convert_encoding($this->look_idselectivo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_idselectivo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- idyarda
   function NM_sub_cons_idyarda()
   {
         if (!NM_is_utf8($this->idyarda))
         {
             $this->idyarda = sc_convert_encoding($this->idyarda, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idyarda;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- idtipomovimiento
   function NM_sub_cons_idtipomovimiento()
   {
         if (!NM_is_utf8($this->look_idtipomovimiento))
         {
             $this->look_idtipomovimiento = sc_convert_encoding($this->look_idtipomovimiento, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_idtipomovimiento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> cita :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
