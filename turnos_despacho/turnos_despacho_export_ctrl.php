<?php
@session_start() ;
$_SESSION['scriptcase']['turnos_despacho']['sc_process_barr'] = true;
require_once('../turnos_despacho/index.php');
unset($_SESSION['scriptcase']['turnos_despacho']['sc_process_barr']);
$ExportCtrl = new turnos_despacho_export_control;
$ExportCtrl->Export_barr();

class turnos_despacho_export_control
{
