...
<?php
   ...
   $Ord_Cmp = new turnos_despacho_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class turnos_despacho_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["turno"] : "Turno";
   $tab_ger_campos['codigo_cita'] = "on";
   $tab_def_campos['codigo_cita'] = "codigo_cita";
   $tab_labels["codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["codigo_cita"] : "Codigo Cita";
   $tab_ger_campos['contenedorimport'] = "on";
   $tab_def_campos['contenedorimport'] = "contenedorimport";
   $tab_labels["contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["contenedorimport"] : "Contenedorimport";
   $tab_ger_campos['contenedorexport'] = "on";
   $tab_def_campos['contenedorexport'] = "contenedorExport";
   $tab_labels["contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["contenedorexport"] : "Contenedor Export";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['fechainicio'] = "on";
   $tab_def_campos['fechainicio'] = "fechaInicio";
   $tab_labels["fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['turnos_despacho']['labels']["fechainicio"] : "Fecha Inicio";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['turnos_despacho']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['turnos_despacho']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "turnos_despacho_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['turnos_despacho']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
