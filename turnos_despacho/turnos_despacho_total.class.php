...
class turnos_despacho_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['turnos_despacho']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['turnos_despacho']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_total($res_limit=false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['turnos_despacho']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['turnos_despacho']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['turnos_despacho']['contr_total_geral'] = "OK";
   } 
