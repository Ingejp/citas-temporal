  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_yarda" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_yarda_form();
	}

  // ---------- Validate idyarda_
  function do_ajax_form_yarda_validate_idyarda_(iNumLinha)
  {
    var nomeCampo_idyarda_ = "idyarda_" + iNumLinha;
    var var_idyarda_ = scAjaxGetFieldHidden(nomeCampo_idyarda_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_yarda_validate_idyarda_(var_idyarda_, iNumLinha, var_script_case_init, do_ajax_form_yarda_validate_idyarda__cb);
  } // do_ajax_form_yarda_validate_idyarda_

  function do_ajax_form_yarda_validate_idyarda__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idyarda_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idyarda_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idyarda_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idyarda_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_yarda_validate_idyarda__cb

  // ---------- Validate descripcion_yarda_
  function do_ajax_form_yarda_validate_descripcion_yarda_(iNumLinha)
  {
    var nomeCampo_descripcion_yarda_ = "descripcion_yarda_" + iNumLinha;
    var var_descripcion_yarda_ = scAjaxGetFieldText(nomeCampo_descripcion_yarda_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_yarda_validate_descripcion_yarda_(var_descripcion_yarda_, iNumLinha, var_script_case_init, do_ajax_form_yarda_validate_descripcion_yarda__cb);
  } // do_ajax_form_yarda_validate_descripcion_yarda_

  function do_ajax_form_yarda_validate_descripcion_yarda__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descripcion_yarda_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descripcion_yarda_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descripcion_yarda_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descripcion_yarda_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_yarda_validate_descripcion_yarda__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_yarda_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_yarda_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_yarda_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_yarda_add_new_line_cb);
  } // do_ajax_form_yarda_add_new_line

  function do_ajax_form_yarda_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_yarda_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_yarda_backup_line(iNumLinha)
  {
    var var_idyarda_ = scAjaxGetFieldHidden("idyarda_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_yarda_backup_line(var_idyarda_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_yarda_backup_line_cb);
  } // do_ajax_form_yarda_backup_line

  function do_ajax_form_yarda_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_yarda_backup_line_cb

  function do_ajax_form_yarda_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_yarda_cancel_insert

  function do_ajax_form_yarda_cancel_update(iSeqVert)
  {
    do_ajax_form_yarda_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_yarda_cancel_update

  function do_ajax_form_yarda_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_yarda_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_yarda_table_refresh()
  {
    var var_idyarda_ = document.F2.idyarda_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_yarda_table_refresh(var_idyarda_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_yarda_table_refresh_cb);
  } //  do_ajax_form_yarda_table_refresh

  function do_ajax_form_yarda_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idyarda_.value = scAjaxGetKeyValue("idyarda_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_yarda_table_refresh_cb_after_alert);
  } // do_ajax_form_yarda_table_refresh_cb
  function do_ajax_form_yarda_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_yarda_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_yarda_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_yarda_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idyarda_ = scAjaxGetFieldHidden("idyarda_" + iNumLinha);
    var var_descripcion_yarda_ = scAjaxGetFieldText("descripcion_yarda_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_yarda_submit_form(var_idyarda_, var_descripcion_yarda_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_yarda_submit_form_cb);
  } // do_ajax_form_yarda_submit_form

  function do_ajax_form_yarda_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idyarda_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_yarda_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_yarda_submit_form_cb_after_alert);
  } // do_ajax_form_yarda_submit_form_cb
  function do_ajax_form_yarda_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_yarda_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_yarda_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_yarda_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idyarda_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_yarda_" + iNavForm);
    }
    var var_idyarda_ = document.F2.idyarda_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_yarda_navigate_form(var_idyarda_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_yarda_navigate_form_cb);
  } // do_ajax_form_yarda_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_yarda']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_yarda_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idyarda_.value = scAjaxGetKeyValue("idyarda_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_yarda_navigate_form_cb_after_alert);
  } // do_ajax_form_yarda_navigate_form_cb
  function do_ajax_form_yarda_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_yarda_navigate_form_cb_after_alert
  function sc_hide_form_yarda_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idyarda_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_yarda_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idyarda_" + iNumLinha] = {"label": "Idyarda<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["descripcion_yarda_" + iNumLinha] = {"label": "Descripcion Yarda<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idyarda_"][iNumLinha] = "idyarda_" + iNumLinha;
    ajax_field_mult["descripcion_yarda_"][iNumLinha] = "descripcion_yarda_" + iNumLinha;
    ajax_field_id["idyarda_" + iNumLinha] = new Array("hidden_field_label_idyarda_", "hidden_field_data_idyarda_" + iNumLinha);
    ajax_field_id["descripcion_yarda_" + iNumLinha] = new Array("hidden_field_label_descripcion_yarda_", "hidden_field_data_descripcion_yarda_" + iNumLinha);
    ajax_error_count["idyarda_" + iNumLinha] = "off";
    ajax_error_count["descripcion_yarda_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idyarda_" + iNumLinha] = "on";
    ajax_read_only["descripcion_yarda_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idyarda_" + iNumLinha] = "on";
    ajax_read_only["descripcion_yarda_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idyarda_" + iNumLinha] = null;
    ajax_error_list["descripcion_yarda_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idyarda_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idyarda_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idyarda_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idyarda_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idyarda_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["descripcion_yarda_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descripcion_yarda_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descripcion_yarda_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descripcion_yarda_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descripcion_yarda_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idyarda_'])) ? $this->nmgp_cmp_readonly['idyarda_'] : 'on';
?>
    scAjaxFieldRead("idyarda_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descripcion_yarda_'])) ? $this->nmgp_cmp_readonly['descripcion_yarda_'] : 'off';
?>
    scAjaxFieldRead("descripcion_yarda_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idyarda_" + iSeq, "on");
    scAjaxFieldRead("descripcion_yarda_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idyarda_" + iRow] || "on" == ajax_error_count["descripcion_yarda_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idyarda_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_yarda_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idyarda_" + iRow] && "off" == ajax_error_count["descripcion_yarda_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idyarda_" + iRow] = "off";
        ajax_error_count["descripcion_yarda_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idyarda_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_yarda_" + iRow).removeClass("scFormErrorLine");
    }
  }
