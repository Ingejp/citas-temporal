...
$old_error_handler = set_error_handler("form_yarda_scriptcase_error_handler");

function form_yarda_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_yarda']['contr_erro']) && $_SESSION['scriptcase']['form_yarda']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_yarda->contr_form_yarda->Apl_com_erro = true;
            if ($inicial_form_yarda->contr_form_yarda->NM_ajax_flag)
            {
                $inicial_form_yarda->contr_form_yarda->NM_ajax_info['errList']['geral_form_yarda'][] = $msg;
                return;
            }
            form_yarda_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_yarda_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_yarda'])  && '' != $_SESSION['scriptcase']['error_icon']['form_yarda'])  ? $_SESSION['scriptcase']['error_icon']['form_yarda']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_yarda']) && '' != $_SESSION['scriptcase']['error_close']['form_yarda']) ? $_SESSION['scriptcase']['error_close']['form_yarda'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_yarda']) && '' != $_SESSION['scriptcase']['error_span_title']['form_yarda']) ? $_SESSION['scriptcase']['error_span_title']['form_yarda'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_yarda']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_yarda']) ? $_SESSION['scriptcase']['error_icon_title']['form_yarda'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_yarda']['error_buffer'] .= ob_get_flush();
}
