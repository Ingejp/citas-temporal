<?php
@session_start() ;
$_SESSION['scriptcase']['Turnos_Despachos_Contenedores']['sc_process_barr'] = true;
require_once('../Turnos_Despachos_Contenedores/index.php');
unset($_SESSION['scriptcase']['Turnos_Despachos_Contenedores']['sc_process_barr']);
$ExportCtrl = new Turnos_Despachos_Contenedores_export_control;
$ExportCtrl->Export_barr();

class Turnos_Despachos_Contenedores_export_control
{
