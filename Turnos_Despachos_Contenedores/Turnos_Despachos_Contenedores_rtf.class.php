...
class Turnos_Despachos_Contenedores_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "Turnos_Despachos_Contenedores.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['rtf_name']);
      }
...
$_SESSION['scriptcase']['Turnos_Despachos_Contenedores']['contr_erro'] = 'off'; 
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>TURNOS DE DESPACHO - CONTENEDORES :: RTF</TITLE>
