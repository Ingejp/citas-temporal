...
class Turnos_Despachos_Contenedores_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "Turnos_Despachos_Contenedores_res_xls.class.php");
              $this->Res_xls = new Turnos_Despachos_Contenedores_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_Turnos_Despachos_Contenedores.zip";
          $this->Arquivo   .= "_Turnos_Despachos_Contenedores" . $this->Xls_tp;
          $this->Tit_doc    = "Turnos_Despachos_Contenedores" . $this->Xls_tp;
          $this->Tit_zip    = "Turnos_Despachos_Contenedores.zip";
      ...
      require_once($this->Ini->path_aplicacao . "Turnos_Despachos_Contenedores_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['Turnos_Despachos_Contenedores']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>TURNOS DE DESPACHO - CONTENEDORES :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Turnos_Despachos_Contenedores']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
