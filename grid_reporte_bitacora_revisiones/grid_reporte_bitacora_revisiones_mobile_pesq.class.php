...
class grid_reporte_bitacora_revisiones_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_reporte_bitacora_revisiones_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_reporte_bitacora_revisiones_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_reporte_bitacora_revisiones_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idbitacora_revision')
      {
          $idbitacora_revision = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idbitacora_revision($idbitacora_revision);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   {
      $idbitacora_revision = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idbitacora_revision);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_datas[] = "Estadias_Horas";$Nm_datas[] = "Estadias_Horas";$Nm_numeric[] = "idbitacora_revision";$Nm_numeric[] = "turno";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_datas[] = "Estadias_Horas";$Nm_datas[] = "Estadias_Horas";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_reporte_bitacora_revisiones/grid_reporte_bitacora_revisiones_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_reporte_bitacora_revisiones_ajax_search.js"></script>
 <script type="text/javascript" src="grid_reporte_bitacora_revisiones_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_reporte_bitacora_revisiones_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_bitacora_revisiones']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_bitacora_revisiones']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idbitacora_revision_cond#NMF#' + search_get_sel_txt('SC_idbitacora_revision_cond') + '@NMF@';
  str_out += 'SC_idbitacora_revision#NMF#' + search_get_text('SC_idbitacora_revision') + '@NMF@';
  str_out += 'id_ac_idbitacora_revision#NMF#' + search_get_text('id_ac_idbitacora_revision') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_idbitacora_revision").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idbitacora_revision",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_idbitacora_revision").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idbitacora_revision").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $idbitacora_revision_cond, $idbitacora_revision, $idbitacora_revision_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idbitacora_revision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['idbitacora_revision']; 
          $idbitacora_revision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['idbitacora_revision_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_ano']; 
          $fecha_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_hor']; 
          $fecha_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_min']; 
          $fecha_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_seg']; 
          $fecha_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_hor']; 
          $fecha_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_min']; 
          $fecha_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_seg']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idbitacora_revision_cond) || empty($idbitacora_revision_cond))
      {
         $idbitacora_revision_cond = "gt";
      }
      ...
      $str_hide_idbitacora_revision = (in_array($idbitacora_revision_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fecha = (in_array($fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idbitacora_revision = ('bw' == $idbitacora_revision_cond) ? $display_aberto : $display_fechado;
      $str_display_fecha = ('bw' == $fecha_cond) ? $display_aberto : $display_fechado;

      if (!isset($idbitacora_revision) || $idbitacora_revision == "")
      {
          $idbitacora_revision = "";
      }
      if (isset($idbitacora_revision) && !empty($idbitacora_revision))
      {
         $tmp_pos = strpos($idbitacora_revision, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idbitacora_revision = substr($idbitacora_revision, 0, $tmp_pos);
         }
      }
...
?>
 ...
 $nmgp_tab_label .= "idbitacora_revision?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idbitacora_revision_cond" name="idbitacora_revision_cond" onChange="nm_campos_between(document.getElementById('id_vis_idbitacora_revision'), this, 'idbitacora_revision')">
       <OPTION value="gt" <?php if ("gt" == $idbitacora_revision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idbitacora_revision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idbitacora_revision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idbitacora_revision"  <?php echo $str_hide_idbitacora_revision?>><?php
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($idbitacora_revision, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idbitacora_revision;
      }
?>
<INPUT  type="text" id="SC_idbitacora_revision" name="idbitacora_revision" value="<?php echo NM_encode_input($idbitacora_revision) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idbitacora_revision" name="idbitacora_revision_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fecha_cond" name="fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha'), this, 'fecha')">
      ...
      <br><span id="id_hide_fecha"  <?php echo $str_hide_fecha?>>
<?php
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_hor" name="fecha_hor" value="<?php echo NM_encode_input($fecha_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_min" name="fecha_min" value="<?php echo NM_encode_input($fecha_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_seg" name="fecha_seg" value="<?php echo NM_encode_input($fecha_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fecha"  <?php echo $str_display_fecha; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_input_2_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_input_2_hor" name="fecha_input_2_hor" value="<?php echo NM_encode_input($fecha_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_input_2_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_input_2_min" name="fecha_input_2_min" value="<?php echo NM_encode_input($fecha_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_input_2_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fecha_input_2_seg" name="fecha_input_2_seg" value="<?php echo NM_encode_input($fecha_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_reporte_bitacora_revisiones_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_bitacora_revisiones']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_bitacora_revisiones']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idbitacora_revision_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idbitacora_revision'), document.F1.idbitacora_revision_cond, 'idbitacora_revision');
   document.F1.idbitacora_revision.value = "";
   document.F1.idbitacora_revision_autocomp.value = "";
   ...
   document.F1.fecha_hor.value = "";
   document.F1.fecha_min.value = "";
   document.F1.fecha_seg.value = "";
   document.F1.fecha_input_2_hor.value = "";
   document.F1.fecha_input_2_min.value = "";
   document.F1.fecha_input_2_seg.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_dia(this)});
    $('#SC_fecha_hor').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_hora(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_dia(this)});
    $('#SC_fecha_input_2_hor').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_hora(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_mes(this)});
    $('#SC_fecha_input_2_min').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_min(this)});
    $('#SC_fecha_input_2_seg').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_seg(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_mes(this)});
    $('#SC_fecha_min').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_min(this)});
    $('#SC_fecha_seg').bind('change', function() {sc_grid_reporte_bitacora_revisiones_valida_seg(this)});
 }
 function sc_grid_reporte_bitacora_revisiones_valida_dia(obj)
 {
 ...
 function sc_grid_reporte_bitacora_revisiones_valida_mes(obj)
 {
 ...
 function sc_grid_reporte_bitacora_revisiones_valida_hora(obj)
 {
 ...
 function sc_grid_reporte_bitacora_revisiones_valida_min(obj)
 {
 ...
 function sc_grid_reporte_bitacora_revisiones_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_reporte_bitacora_revisiones/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idbitacora_revision_cond'] = 'cond';
      $tp_fields['SC_idbitacora_revision'] = 'text_aut';
      $tp_fields['id_ac_idbitacora_revision'] = 'text_aut';
   ...
   {
      global $idbitacora_revision_cond, $idbitacora_revision, $idbitacora_revision_autocomp,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_hor, $fecha_min, $fecha_seg, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano, $fecha_input_2_min, $fecha_input_2_hor, $fecha_input_2_seg, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq'] = array();
      if (!empty($idbitacora_revision_autocomp) && empty($idbitacora_revision))
      {
          $idbitacora_revision = $idbitacora_revision_autocomp;
      }
      $idbitacora_revision_cond_salva = $idbitacora_revision_cond; 
      if (!isset($idbitacora_revision_input_2) || $idbitacora_revision_input_2 == "")
      {
          $idbitacora_revision_input_2 = $idbitacora_revision;
      }
      ...
      if (!isset($fecha_input_2_hor) || $fecha_input_2_hor == "")
      {
          $fecha_input_2_hor = $fecha_hor;
      }
      if (!isset($fecha_input_2_min) || $fecha_input_2_min == "")
      {
          $fecha_input_2_min = $fecha_min;
      }
      if (!isset($fecha_input_2_seg) || $fecha_input_2_seg == "")
      {
          $fecha_input_2_seg = $fecha_seg;
      }
      if ($idbitacora_revision_cond != "in")
      {
          nm_limpa_numero($idbitacora_revision, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $idbitacora_revision);
          ...
          $idbitacora_revision = implode(",", $Nm_sc_valores);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['idbitacora_revision'] = $idbitacora_revision; 
      if (is_array($idbitacora_revision) && !empty($idbitacora_revision))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0] = $idbitacora_revision;
      }
      elseif ($idbitacora_revision_cond_salva == "nu" || $idbitacora_revision_cond_salva == "nn" || $idbitacora_revision_cond_salva == "ep" || $idbitacora_revision_cond_salva == "ne" ||  !empty($idbitacora_revision))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0][0] = $idbitacora_revision;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['idbitacora_revision_cond'] = $idbitacora_revision_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['cmp'] = "idbitacora_revision"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['opc'] = $idbitacora_revision_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq']['idbitacora_revision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      if (!empty($fecha_dia) || !empty($fecha_mes) || !empty($fecha_ano) || $fecha_cond_salva == "nu" || $fecha_cond_salva == "nn" || $fecha_cond_salva == "ep" || $fecha_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_hor'] = $fecha_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_min'] = $fecha_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_seg'] = $fecha_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_hor'] = $fecha_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_min'] = $fecha_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2_seg'] = $fecha_input_2_seg; 
      if (!empty($fecha_hor) || !empty($fecha_min) || !empty($fecha_seg) || $fecha_cond_salva == "nu" || $fecha_cond_salva == "nn" || $fecha_cond_salva == "ep" || $fecha_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $fecha_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $fecha_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $fecha_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $fecha_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $fecha_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $fecha_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['cmp'] = "fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid]['opc'] = $fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq']['fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'] = $Temp_Busca;
      }
      if ($idbitacora_revision_cond != "in" && $idbitacora_revision_cond != "bw" && !empty($idbitacora_revision) && !is_numeric($idbitacora_revision))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idbitacora Revision";
      }
      if ($idbitacora_revision_cond == "bw" && ((!empty($idbitacora_revision) && !is_numeric($idbitacora_revision)) || (!empty($idbitacora_revision_input_2) && !is_numeric($idbitacora_revision_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idbitacora Revision";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idbitacora_revision'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idbitacora_revision'] = $cmp1;
      }
      else
      {
          $cmp1 = $idbitacora_revision;
      ...
      if (isset($idbitacora_revision) || $idbitacora_revision_cond == "nu" || $idbitacora_revision_cond == "nn" || $idbitacora_revision_cond == "ep" || $idbitacora_revision_cond == "ne")
      {
         $this->monta_condicao("idbitacora_revision", $idbitacora_revision_cond, $idbitacora_revision, "", "idbitacora_revision");
      }
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $val[1]['hor'] = $fecha_input_2_hor;
              $val[1]['min'] = $fecha_input_2_min;
              $val[1]['seg'] = $fecha_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $fecha_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fecha = $val[0];
          $this->cmp_formatado['fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fecha'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['fecha'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($fecha_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']['fecha_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fecha_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['fecha_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $fecha_cond == "NU" || $fecha_cond == "NN"|| $fecha_cond == "EP"|| $fecha_cond == "NE")
          {
              $this->monta_condicao("fecha", $fecha_cond, $fecha, $fecha_input_2, 'fecha', 'DATETIME');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq']['fecha']['label'] = $nmgp_tab_label['fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq']['fecha']['descr'] = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['grid_pesq']['fecha']['hint']  = $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_bitacora_revisiones']['cond_pesq'] .= $this->NM_operador;
