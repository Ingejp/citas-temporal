<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reporte_bitacora_revisiones']['sc_process_barr'] = true;
require_once('../grid_reporte_bitacora_revisiones/index.php');
unset($_SESSION['scriptcase']['grid_reporte_bitacora_revisiones']['sc_process_barr']);
$ExportCtrl = new grid_reporte_bitacora_revisiones_export_control;
$ExportCtrl->Export_barr();

class grid_reporte_bitacora_revisiones_export_control
{
