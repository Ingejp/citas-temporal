 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idbitacora_revision'])) ? $this->New_label['idbitacora_revision'] : "Idbitacora Revision"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idbitacora_revision_cond" name="idbitacora_revision_cond" onChange="nm_campos_between(document.getElementById('id_vis_idbitacora_revision'), this, 'idbitacora_revision')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idbitacora_revision" <?php echo $str_hide_idbitacora_revision?> valign="top">
