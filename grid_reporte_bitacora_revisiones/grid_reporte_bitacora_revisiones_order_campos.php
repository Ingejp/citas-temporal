...
<?php
   ...
   $Ord_Cmp = new grid_reporte_bitacora_revisiones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reporte_bitacora_revisiones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["turno"] : "Turno";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['estatus'] = "on";
   $tab_def_campos['estatus'] = "Estatus";
   $tab_labels["estatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["estatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["estatus"] : "Estatus";
   $tab_ger_campos['estadias_horas'] = "on";
   $tab_def_campos['estadias_horas'] = "Estadias_Horas";
   $tab_labels["estadias_horas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["estadias_horas"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["estadias_horas"] : "Estadias Horas";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reporte_bitacora_revisiones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reporte_bitacora_revisiones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
