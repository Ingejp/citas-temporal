<?php
@session_start() ;
$_SESSION['scriptcase']['grid_despachos']['sc_process_barr'] = true;
require_once('../grid_despachos/index.php');
unset($_SESSION['scriptcase']['grid_despachos']['sc_process_barr']);
$ExportCtrl = new grid_despachos_export_control;
$ExportCtrl->Export_barr();

class grid_despachos_export_control
{
