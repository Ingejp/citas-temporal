...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_despachos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_despachos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_despachos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_despachos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_despachos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_despachos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_despachos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_despachos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_despachos']['embutida_filho'] as $ind => $sc_init)
          {
