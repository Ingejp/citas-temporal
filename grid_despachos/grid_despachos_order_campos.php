<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_despachos']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_despachos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_despachos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["turno"] : "TURNO";
   $tab_ger_campos['placa'] = "on";
   $tab_def_campos['placa'] = "placa";
   $tab_labels["placa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["placa"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["placa"] : "PLACA";
   $tab_ger_campos['chasis'] = "on";
   $tab_def_campos['chasis'] = "chasis";
   $tab_labels["chasis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["chasis"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["chasis"] : "CHASIS";
   $tab_ger_campos['piloto'] = "on";
   $tab_def_campos['piloto'] = "PILOTO";
   $tab_labels["piloto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["piloto"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["piloto"] : "PILOTO";
   $tab_ger_campos['contenedorexport'] = "on";
   $tab_def_campos['contenedorexport'] = "contenedorExport";
   $tab_labels["contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["contenedorexport"] : "CONT_EXPORT";
   $tab_ger_campos['contenedorimport'] = "on";
   $tab_def_campos['contenedorimport'] = "contenedorimport";
   $tab_labels["contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["contenedorimport"] : "CONT_IMPORT";
   $tab_ger_campos['naviera'] = "on";
   $tab_def_campos['naviera'] = "naviera";
   $tab_labels["naviera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["naviera"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["naviera"] : "NAVIERA";
   $tab_ger_campos['viaje'] = "on";
   $tab_def_campos['viaje'] = "VIAJE";
   $tab_labels["viaje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["viaje"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["viaje"] : "VIAJE";
   $tab_ger_campos['tipo_carga'] = "on";
   $tab_def_campos['tipo_carga'] = "TIPO_CARGA";
   $tab_labels["tipo_carga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["tipo_carga"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["tipo_carga"] : "TIPO CARGA";
   $tab_ger_campos['codigo_cita'] = "on";
   $tab_def_campos['codigo_cita'] = "codigo_cita";
   $tab_labels["codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["codigo_cita"] : "Codigo Cita";
   $tab_ger_campos['fechainicio'] = "on";
   $tab_def_campos['fechainicio'] = "fechaInicio";
   $tab_labels["fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['labels']["fechainicio"] : "Fecha Inicio";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_despachos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_despachos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE>REPORTE DE TURNOS - PREPUERTO</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_despachos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_despachos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
