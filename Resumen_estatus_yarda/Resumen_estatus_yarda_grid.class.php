<?php
class Resumen_estatus_yarda_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['charts_html'] = '';
   ...
   { 
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Resumen_estatus_yarda'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
           $this->nmgp_embbed_placeholder_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] != 'print')
       { 
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("en_us");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "16px";
   $this->width_tabula_display = "''";
       $this->Tem_tab_vert = true;
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['emb_tree_no'])
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = "muda_qt_linhas";
   } 
       ob_start(); 
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "Resumen_estatus_yarda/Resumen_estatus_yarda_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "Resumen_estatus_yarda_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new Resumen_estatus_yarda_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] = 50;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] == "Resumen") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_select']['cit.idCita'] = 'ASC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] == "Resumen") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_quebra']['tipo_carga']["tipcar.descripcion"] = "asc"; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_quebra']['nav_naviera']["nav.naviera"] = "asc"; 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['prim_cons'] || !empty($nmgp_parms))  
   { 
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao']       = "igual" ; 
...
// 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   { 
       ...
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['pivot_charts']) : 0;
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-Resumen_estatus_yarda-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-4ca5b4bd\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
       ...
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Resumen_estatus_yarda_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Resumen_estatus_yarda_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_Resumen_estatus_yarda_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".Resumen_estatus_yarda_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
           $nm_saida->saida("  <body class=\"" . $this->css_scGridPage . "\" " . $str_iframe_body . " style=\"" . $remove_margin. $css_body . "\">\r\n");
       }
       $nm_saida->saida("  " . $this->Ini->Ajax_result_set . "\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida']) ? "Resumen_estatus_yarda_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_Resumen_estatus_yarda__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-Resumen_estatus_yarda-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq']) { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".Resumen_estatus_yarda_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_turno()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_cmp'] == $NM_cmp_class)
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ordem_label'] == "desc")
          {
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['turno'])) ? $this->New_label['turno'] : "Turno"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['turno'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_codigo_cita'])) ? $this->New_label['cit_codigo_cita'] : "Codigo Cita"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['cit_codigo_cita'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cab_placa'])) ? $this->New_label['cab_placa'] : "Placa"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['cab_placa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['piloto'])) ? $this->New_label['piloto'] : "PILOTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['piloto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_contenedorimport'])) ? $this->New_label['cit_contenedorimport'] : "Contenedorimport"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['cit_contenedorimport'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_contenedorexport'])) ? $this->New_label['cit_contenedorexport'] : "Contenedor Export"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['cit_contenedorexport'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_fechainicio'])) ? $this->New_label['cit_fechainicio'] : "Fecha Inicio"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['cit_fechainicio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nav_naviera'])) ? $this->New_label['nav_naviera'] : "Naviera"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['nav_naviera'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipo_carga'])) ? $this->New_label['tipo_carga'] : "TIPO CARGA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['tipo_carga'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['yarda'])) ? $this->New_label['yarda'] : "YARDA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['yarda'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['est_estado'])) ? $this->New_label['est_estado'] : "Estado"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['est_estado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_observaciones'])) ? $this->New_label['cit_observaciones'] : "Observaciones"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['labels']['cit_observaciones'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Resumen_estatus_yarda']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_Resumen_estatus_yarda#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['force_toolbar'] = true;
           } 
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_Resumen_estatus_yarda#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-4ca5b4bd\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Page_break_PDF'] = array();
       }
   }
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->arg_sum_tipo_carga = " = " . $this->Db->qstr($this->tipo_carga);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['rows_emb']++;
          if (($this->tipo_carga !== $this->tipo_carga_Old || $NM_prim_qb) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] == "Resumen") 
          {  
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby']]['tipo_carga'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Page_break_PDF']['tipo_carga'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->nav_naviera_Old = $this->nav_naviera ; 
          ...
          if ($this->nav_naviera !== $this->nav_naviera_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] == "Resumen") 
          {  
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby']]['nav_naviera'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['Page_break_PDF']['nav_naviera'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->nav_naviera_Old = $this->nav_naviera ; 
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['field_order'] as $Cada_col)
          { 
              $NM_func_grid = "NM_grid_" . $Cada_col;
              $this->$NM_func_grid();
          } 
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 { global
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_Resumen_estatus_yarda_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_Resumen_estatus_yarda_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_Resumen_estatus_yarda_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_Resumen_estatus_yarda, 'Resumen_estatus_yarda'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_Resumen_estatus_yarda_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_Resumen_estatus_yarda_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_Resumen_estatus_yarda_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_Resumen_estatus_yarda, 'Resumen_estatus_yarda'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['Resumen_estatus_yarda'][$this->NM_cont_body]['1'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_Resumen_estatus_yarda_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida_grid'] && $this->nm_prim_linha)
 ...
 { global
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['Resumen_estatus_yarda'][$this->NM_cont_body]['2'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_Resumen_estatus_yarda_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['Resumen_estatus_yarda'][$this->NM_cont_body]['2'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_Resumen_estatus_yarda_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_geral_Resumen_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
              $UseAlias =  "N";
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      $Tem_gb_pdf  = "s";
      $Tem_pdf_res = "n";
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=en_us&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=Resumen_estatus_yarda&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['SC_Gb_Free_cmp']))
          {
              $Tem_word_res = "n";
          }
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Resumen_estatus_yarda/Resumen_estatus_yarda_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          $Tem_xml_res = "s";
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          $Tem_csv_res = "s";
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
          ...
          if (is_file("Resumen_estatus_yarda_help.txt") && !$this->grid_emb_form)
          {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['dashboard_info']['under_dashboard']))
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['nav']))
          {
...
$nm_saida->saida("             }\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Resumen_estatus_yarda', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"Resumen_estatus_yarda\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"Resumen_estatus_yarda_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"Resumen_estatus_yarda_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda']['reg_start']))
   {
       $nm_saida->saida("      window.onload = function() {\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('Resumen_estatus_yarda')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Resumen_estatus_yarda', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
