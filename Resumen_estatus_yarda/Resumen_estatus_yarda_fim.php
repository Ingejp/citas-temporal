...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Resumen_estatus_yarda"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Resumen_estatus_yarda"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Resumen_estatus_yarda</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Resumen_estatus_yarda']['embutida_filho'] as $ind => $sc_init)
          {
