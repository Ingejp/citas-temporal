<?php
@session_start() ;
$_SESSION['scriptcase']['Resumen_estatus_yarda']['sc_process_barr'] = true;
require_once('../Resumen_estatus_yarda/index.php');
unset($_SESSION['scriptcase']['Resumen_estatus_yarda']['sc_process_barr']);
$ExportCtrl = new Resumen_estatus_yarda_export_control;
$ExportCtrl->Export_barr();

class Resumen_estatus_yarda_export_control
{
