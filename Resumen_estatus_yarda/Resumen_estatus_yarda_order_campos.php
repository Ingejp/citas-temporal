<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['Resumen_estatus_yarda']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new Resumen_estatus_yarda_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Resumen_estatus_yarda_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["turno"] : "Turno";
   ...
   $tab_labels["cit_codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_codigo_cita"] : "Codigo Cita";
   ...
   $tab_labels["cab_placa"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cab_placa"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cab_placa"] : "Placa";
   ...
   $tab_labels["piloto"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["piloto"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["piloto"] : "PILOTO";
   ...
   $tab_labels["cit_contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_contenedorimport"] : "Contenedorimport";
   ...
   $tab_labels["cit_contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_contenedorexport"] : "Contenedor Export";
   ...
   $tab_labels["cit_fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["cit_fechainicio"] : "Fecha Inicio";
   ...
   $tab_labels["nav_naviera"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["nav_naviera"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["nav_naviera"] : "Naviera";
   ...
   $tab_labels["tipo_carga"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["tipo_carga"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["tipo_carga"] : "TIPO CARGA";
   ...
   $tab_labels["yarda"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["yarda"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["yarda"] : "YARDA";
   ...
   $tab_labels["est_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["est_estado"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['labels']["est_estado"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Resumen_estatus_yarda_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
