...
$_SESSION['scriptcase']['sec_form_sec_groups_apps']['contr_erro'] = 'off';
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['opc_ant'];
      } 
   ...
   function ajax_return_values_all_vert()
   {
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("priv_access_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(sec_form_sec_groups_apps_pack_protect_string('Y') => sec_form_sec_groups_apps_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . ""));
