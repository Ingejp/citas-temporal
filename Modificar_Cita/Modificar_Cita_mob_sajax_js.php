  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Modificar_Cita_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_Modificar_Cita_mob_form();
	}

  // ---------- Validate turno
  function do_ajax_Modificar_Cita_mob_validate_turno()
  {
    var nomeCampo_turno = "turno";
    var var_turno = scAjaxGetFieldText(nomeCampo_turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Modificar_Cita_mob_validate_turno(var_turno, var_script_case_init, do_ajax_Modificar_Cita_mob_validate_turno_cb);
  } // do_ajax_Modificar_Cita_mob_validate_turno

  function do_ajax_Modificar_Cita_mob_validate_turno_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Modificar_Cita_mob_validate_turno_cb

  // ---------- Validate codigo_cita
  function do_ajax_Modificar_Cita_mob_validate_codigo_cita()
  {
    var nomeCampo_codigo_cita = "codigo_cita";
    var var_codigo_cita = scAjaxGetFieldText(nomeCampo_codigo_cita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Modificar_Cita_mob_validate_codigo_cita(var_codigo_cita, var_script_case_init, do_ajax_Modificar_Cita_mob_validate_codigo_cita_cb);
  } // do_ajax_Modificar_Cita_mob_validate_codigo_cita

  function do_ajax_Modificar_Cita_mob_validate_codigo_cita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Modificar_Cita_mob_validate_codigo_cita_cb

  // ---------- Validate placa
  function do_ajax_Modificar_Cita_mob_validate_placa()
  {
    var nomeCampo_placa = "placa";
    var var_placa = scAjaxGetFieldText(nomeCampo_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Modificar_Cita_mob_validate_placa(var_placa, var_script_case_init, do_ajax_Modificar_Cita_mob_validate_placa_cb);
  } // do_ajax_Modificar_Cita_mob_validate_placa

  function do_ajax_Modificar_Cita_mob_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Modificar_Cita_mob_validate_placa_cb

  // ---------- Validate coment
  function do_ajax_Modificar_Cita_mob_validate_coment()
  {
    var nomeCampo_coment = "coment";
    var var_coment = scAjaxGetFieldText(nomeCampo_coment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Modificar_Cita_mob_validate_coment(var_coment, var_script_case_init, do_ajax_Modificar_Cita_mob_validate_coment_cb);
  } // do_ajax_Modificar_Cita_mob_validate_coment

  function do_ajax_Modificar_Cita_mob_validate_coment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coment";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Modificar_Cita_mob_validate_coment_cb

  // ---------- Event onchange codigo_cita
  function do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_Modificar_Cita_mob_event_codigo_cita_onchange(var_codigo_cita, var_turno, var_placa, var_script_case_init, do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange_cb);
  } // do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange

  function do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_cita";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange_cb_after_alert);
  } // do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange_cb
  function do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Modificar_Cita_mob_event_codigo_cita_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_sc_btn_0
  function do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick()
  {
    var var_coment = scAjaxGetFieldText("coment");
    var var_turno = scAjaxGetFieldText("turno");
    var var_codigo_cita = scAjaxGetFieldText("codigo_cita");
    var var_placa = scAjaxGetFieldText("placa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick(var_coment, var_turno, var_codigo_cita, var_placa, var_script_case_init, do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick_cb);
  } // do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick

  function do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert);
  } // do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick_cb
  function do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Modificar_Cita_mob_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Modificar_Cita_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Modificar_Cita_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_turno = scAjaxGetFieldText("turno");
    ...
    scAjaxProcOn();
    x_ajax_Modificar_Cita_mob_submit_form(var_turno, var_codigo_cita, var_placa, var_coment, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Modificar_Cita_mob_submit_form_cb);
  } // do_ajax_Modificar_Cita_mob_submit_form

  function do_ajax_Modificar_Cita_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Modificar_Cita_mob_submit_form_cb_after_alert);
  } // do_ajax_Modificar_Cita_mob_submit_form_cb
  function do_ajax_Modificar_Cita_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Modificar_Cita_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Modificar_Cita_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Modificar_Cita_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Modificar_Cita_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Modificar_Cita_mob_navigate_form_cb_after_alert);
  } // do_ajax_Modificar_Cita_mob_navigate_form_cb
  function do_ajax_Modificar_Cita_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_Modificar_Cita_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Modificar_Cita_mob_navigate_form_cb_after_alert
  function sc_hide_Modificar_Cita_mob_form()
  {
  ...
  ajax_field_list[2] = "placa";
  ajax_field_list[3] = "coment";
  ...
  var ajax_error_list = {
    ...
    "codigo_cita": {"label": " CODIGO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "placa": {"label": "PLACA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coment": {"label": "COMENT", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["coment"][1] = "coment";
  ...
  var ajax_field_id = {
    ...
    "coment": new Array("hidden_field_label_coment", "hidden_field_data_coment")
  };
