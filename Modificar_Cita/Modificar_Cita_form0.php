...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("Modificar_Cita_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Modificar_Cita_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("Modificar_Cita_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['Modificar_Cita'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Modificar_Cita'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['empty_filter'] = true;
       }
  }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("Modificar_Cita");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("Modificar_Cita");
 parent.scAjaxDetailHeight("Modificar_Cita", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['Modificar_Cita']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
