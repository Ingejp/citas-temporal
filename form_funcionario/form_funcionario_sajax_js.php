  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_funcionario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_funcionario_form();
	}

  // ---------- Validate idfuncionario_
  function do_ajax_form_funcionario_validate_idfuncionario_(iNumLinha)
  {
    var nomeCampo_idfuncionario_ = "idfuncionario_" + iNumLinha;
    var var_idfuncionario_ = scAjaxGetFieldHidden(nomeCampo_idfuncionario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_idfuncionario_(var_idfuncionario_, iNumLinha, var_script_case_init, do_ajax_form_funcionario_validate_idfuncionario__cb);
  } // do_ajax_form_funcionario_validate_idfuncionario_

  function do_ajax_form_funcionario_validate_idfuncionario__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idfuncionario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idfuncionario_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idfuncionario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idfuncionario_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_idfuncionario__cb

  // ---------- Validate dpi_
  function do_ajax_form_funcionario_validate_dpi_(iNumLinha)
  {
    var nomeCampo_dpi_ = "dpi_" + iNumLinha;
    var var_dpi_ = scAjaxGetFieldText(nomeCampo_dpi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_dpi_(var_dpi_, iNumLinha, var_script_case_init, do_ajax_form_funcionario_validate_dpi__cb);
  } // do_ajax_form_funcionario_validate_dpi_

  function do_ajax_form_funcionario_validate_dpi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_dpi__cb

  // ---------- Validate nombre_
  function do_ajax_form_funcionario_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_funcionario_validate_nombre__cb);
  } // do_ajax_form_funcionario_validate_nombre_

  function do_ajax_form_funcionario_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_nombre__cb

  // ---------- Validate id_entidad_
  function do_ajax_form_funcionario_validate_id_entidad_(iNumLinha)
  {
    var nomeCampo_id_entidad_ = "id_entidad_" + iNumLinha;
    var var_id_entidad_ = scAjaxGetFieldText(nomeCampo_id_entidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_id_entidad_(var_id_entidad_, iNumLinha, var_script_case_init, do_ajax_form_funcionario_validate_id_entidad__cb);
  } // do_ajax_form_funcionario_validate_id_entidad_

  function do_ajax_form_funcionario_validate_id_entidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_entidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_entidad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_entidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_entidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_id_entidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_funcionario_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_funcionario_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_funcionario_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_funcionario_add_new_line_cb);
  } // do_ajax_form_funcionario_add_new_line

  function do_ajax_form_funcionario_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_funcionario_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_funcionario_backup_line(iNumLinha)
  {
    var var_idfuncionario_ = scAjaxGetFieldHidden("idfuncionario_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_backup_line(var_idfuncionario_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_funcionario_backup_line_cb);
  } // do_ajax_form_funcionario_backup_line

  function do_ajax_form_funcionario_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_funcionario_backup_line_cb

  function do_ajax_form_funcionario_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_funcionario_cancel_insert

  function do_ajax_form_funcionario_cancel_update(iSeqVert)
  {
    do_ajax_form_funcionario_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_funcionario_cancel_update

  function do_ajax_form_funcionario_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_funcionario_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_funcionario_table_refresh()
  {
    var var_idfuncionario_ = document.F2.idfuncionario_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_table_refresh(var_idfuncionario_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_table_refresh_cb);
  } //  do_ajax_form_funcionario_table_refresh

  function do_ajax_form_funcionario_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idfuncionario_.value = scAjaxGetKeyValue("idfuncionario_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_funcionario_table_refresh_cb_after_alert);
  } // do_ajax_form_funcionario_table_refresh_cb
  function do_ajax_form_funcionario_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_funcionario_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_funcionario_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_funcionario_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_id_entidad_ = scAjaxGetFieldText("id_entidad_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_funcionario_submit_form(var_idfuncionario_, var_dpi_, var_nombre_, var_id_entidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionario_submit_form_cb);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idfuncionario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dpi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_entidad_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_funcionario_submit_form_cb_after_alert);
  } // do_ajax_form_funcionario_submit_form_cb
  function do_ajax_form_funcionario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_funcionario_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_funcionario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_funcionario_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idfuncionario_" + iNavForm);
      scAjaxHideErrorDisplay("dpi_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("id_entidad_" + iNavForm);
    }
    var var_idfuncionario_ = document.F2.idfuncionario_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funcionario_navigate_form(var_idfuncionario_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_navigate_form_cb);
  } // do_ajax_form_funcionario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_funcionario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idfuncionario_.value = scAjaxGetKeyValue("idfuncionario_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_funcionario_navigate_form_cb_after_alert);
  } // do_ajax_form_funcionario_navigate_form_cb
  function do_ajax_form_funcionario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_funcionario_navigate_form_cb_after_alert
  function sc_hide_form_funcionario_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idfuncionario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dpi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_entidad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idfuncionario_" + iNumLinha] = {"label": "COD<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["id_entidad_" + iNumLinha] = {"label": "Id Entidad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idfuncionario_"][iNumLinha] = "idfuncionario_" + iNumLinha;
    ajax_field_mult["dpi_"][iNumLinha] = "dpi_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["id_entidad_"][iNumLinha] = "id_entidad_" + iNumLinha;
    ajax_field_id["idfuncionario_" + iNumLinha] = new Array("hidden_field_label_idfuncionario_", "hidden_field_data_idfuncionario_" + iNumLinha);
    ...
    ajax_field_id["id_entidad_" + iNumLinha] = new Array("hidden_field_label_id_entidad_", "hidden_field_data_id_entidad_" + iNumLinha);
    ajax_error_count["idfuncionario_" + iNumLinha] = "off";
    ajax_error_count["dpi_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["id_entidad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idfuncionario_" + iNumLinha] = "on";
    ajax_read_only["dpi_" + iNumLinha] = "off";
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["id_entidad_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["id_entidad_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idfuncionario_" + iNumLinha] = null;
    ajax_error_list["dpi_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["id_entidad_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idfuncionario_": new Array(),
    "dpi_": new Array(),
    "nombre_": new Array(),
    "id_entidad_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idfuncionario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idfuncionario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idfuncionario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idfuncionario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idfuncionario_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["id_entidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_entidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_entidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_entidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_entidad_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idfuncionario_'])) ? $this->nmgp_cmp_readonly['idfuncionario_'] : 'on';
?>
    scAjaxFieldRead("idfuncionario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_entidad_'])) ? $this->nmgp_cmp_readonly['id_entidad_'] : 'off';
?>
    scAjaxFieldRead("id_entidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idfuncionario_" + iSeq, "on");
    scAjaxFieldRead("dpi_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("id_entidad_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idfuncionario_" + iRow] || "on" == ajax_error_count["dpi_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["id_entidad_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idfuncionario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dpi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_entidad_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idfuncionario_" + iRow] && "off" == ajax_error_count["dpi_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["id_entidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idfuncionario_" + iRow] = "off";
        ajax_error_count["dpi_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["id_entidad_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idfuncionario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dpi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_entidad_" + iRow).removeClass("scFormErrorLine");
    }
  }
