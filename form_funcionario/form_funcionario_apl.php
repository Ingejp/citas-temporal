...
class form_funcionario_apl
{
   ...
   var $form_vert_form_funcionario = array();
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['id_entidad_']))
          {
              $this->id_entidad_ = $this->NM_ajax_info['param']['id_entidad_'];
          }
          if (isset($this->NM_ajax_info['param']['idfuncionario_']))
          {
              $this->idfuncionario_ = $this->NM_ajax_info['param']['idfuncionario_'];
          }
      ...
      $this->sc_conv_var['idfuncionario'] = "idfuncionario_";
      $this->sc_conv_var['dpi'] = "dpi_";
      $this->sc_conv_var['nombre'] = "nombre_";
      $this->sc_conv_var['id_entidad'] = "id_entidad_";
      if (!empty($_FILES))
      {
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 if ($cadapar[0] == "idfuncionario_")
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= "idfuncionario = " . $this->idfuncionario_;
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']['label'] = "REGISTRO DE FUNCIONARIOS";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_max_reg']) == "all")
      {
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['opcao'] = "inicio";
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['opc_ant'];
      } 
...
//
   ...
   function loadFieldConfig()
   {
      ...
      //-- idfuncionario_
      $this->field_config['idfuncionario_']               = array();
      $this->field_config['idfuncionario_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idfuncionario_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idfuncionario_']['symbol_dec'] = '';
      $this->field_config['idfuncionario_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idfuncionario_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- id_entidad_
      $this->field_config['id_entidad_']               = array();
      $this->field_config['id_entidad_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['id_entidad_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['id_entidad_']['symbol_dec'] = '';
      $this->field_config['id_entidad_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['id_entidad_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      {
         if (isset($this->idfuncionario_)) { $this->nm_limpa_alfa($this->idfuncionario_); }
         if (isset($this->dpi_)) { $this->nm_limpa_alfa($this->dpi_); }
         if (isset($this->nombre_)) { $this->nm_limpa_alfa($this->nombre_); }
         if (isset($this->id_entidad_)) { $this->nm_limpa_alfa($this->id_entidad_); }
         if (isset($this->Sc_num_lin_alt) && $this->Sc_num_lin_alt > 0) 
         {
             $sc_seq_vert = $this->Sc_num_lin_alt;
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form'][$sc_seq_vert];
         }
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_funcionario']) || !is_array($this->NM_ajax_info['errList']['geral_form_funcionario']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_funcionario'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_funcionario'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_funcionario'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_funcionario'][] = $this->Campos_Mens_erro;
                  }
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Falta = array();
         $Campos_Erros = array();
          if ('validate_idfuncionario_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idfuncionario_');
          }
          ...
          if ('validate_id_entidad_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'id_entidad_');
          }
          form_funcionario_pack_ajax_response();
          exit;
      }
      ...
      { 
         ...
         $Campos_Falta = array();
         $Campos_Erros = array();
         $this->idfuncionario_ = $GLOBALS["idfuncionario_" . $sc_seq_vert]; 
         $this->dpi_ = $GLOBALS["dpi_" . $sc_seq_vert]; 
         $this->nombre_ = $GLOBALS["nombre_" . $sc_seq_vert]; 
         $this->id_entidad_ = $GLOBALS["id_entidad_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form'][$sc_seq_vert];
         }
         ...
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_funcionario[$sc_seq_vert]['idfuncionario_'] =  $this->idfuncionario_; 
             $this->form_vert_form_funcionario[$sc_seq_vert]['dpi_'] =  $this->dpi_; 
             $this->form_vert_form_funcionario[$sc_seq_vert]['nombre_'] =  $this->nombre_; 
             $this->form_vert_form_funcionario[$sc_seq_vert]['id_entidad_'] =  $this->id_entidad_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_funcionario);
          $this->NM_ajax_info['fldList']['idfuncionario_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['idfuncionario_']);
          $this->NM_close_db();
          form_funcionario_pack_ajax_response();
          exit;
      }
...
<HEAD>
 <TITLE><?php echo strip_tags("REGISTRO DE FUNCIONARIOS") ?></TITLE>
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_funcionario'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'idfuncionario_' == $filtro)
        $this->ValidateField_idfuncionario_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'id_entidad_' == $filtro)
        $this->ValidateField_id_entidad_($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_idfuncionario_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idfuncionario_ === "" || is_null($this->idfuncionario_))  
      { 
          $this->idfuncionario_ = 0;
      } 
      nm_limpa_numero($this->idfuncionario_, $this->field_config['idfuncionario_']['symbol_grp']) ; 
      if ($this->nmgp_opcao == "incluir")
      { 
          if ($this->idfuncionario_ != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->idfuncionario_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "COD: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idfuncionario_']))
                  {
                      $Campos_Erros['idfuncionario_'] = array();
                  }
                  $Campos_Erros['idfuncionario_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['idfuncionario_']) || !is_array($this->NM_ajax_info['errList']['idfuncionario_']))
                  {
                      $this->NM_ajax_info['errList']['idfuncionario_'] = array();
                  }
                  $this->NM_ajax_info['errList']['idfuncionario_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idfuncionario_, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "COD; " ; 
                  if (!isset($Campos_Erros['idfuncionario_']))
                  ...
                  $Campos_Erros['idfuncionario_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['idfuncionario_']) || !is_array($this->NM_ajax_info['errList']['idfuncionario_']))
                  {
                      $this->NM_ajax_info['errList']['idfuncionario_'] = array();
                  }
                  $this->NM_ajax_info['errList']['idfuncionario_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'idfuncionario_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_idfuncionario_
    ...
    function ValidateField_id_entidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->id_entidad_ === "" || is_null($this->id_entidad_))  
      { 
          $this->id_entidad_ = 0;
          $this->sc_force_zero[] = 'id_entidad_';
      } 
      nm_limpa_numero($this->id_entidad_, $this->field_config['id_entidad_']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->id_entidad_ != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->id_entidad_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Id Entidad: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['id_entidad_']))
                  {
                      $Campos_Erros['id_entidad_'] = array();
                  }
                  $Campos_Erros['id_entidad_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['id_entidad_']) || !is_array($this->NM_ajax_info['errList']['id_entidad_']))
                  {
                      $this->NM_ajax_info['errList']['id_entidad_'] = array();
                  }
                  $this->NM_ajax_info['errList']['id_entidad_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->id_entidad_, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Id Entidad; " ; 
                  if (!isset($Campos_Erros['id_entidad_']))
                  {
                      $Campos_Erros['id_entidad_'] = array();
                  }
                  $Campos_Erros['id_entidad_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['id_entidad_']) || !is_array($this->NM_ajax_info['errList']['id_entidad_']))
                  {
                      $this->NM_ajax_info['errList']['id_entidad_'] = array();
                  }
                  $this->NM_ajax_info['errList']['id_entidad_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'id_entidad_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_id_entidad_
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['idfuncionario_'] = $this->idfuncionario_;
    $this->nmgp_dados_form['dpi_'] = $this->dpi_;
    $this->nmgp_dados_form['nombre_'] = $this->nombre_;
    $this->nmgp_dados_form['id_entidad_'] = $this->id_entidad_;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['idfuncionario_'] = $this->idfuncionario_;
      nm_limpa_numero($this->idfuncionario_, $this->field_config['idfuncionario_']['symbol_grp']) ; 
      $this->Before_unformat['id_entidad_'] = $this->id_entidad_;
      nm_limpa_numero($this->id_entidad_, $this->field_config['id_entidad_']['symbol_grp']) ; 
   }
   ...
   {
      if ($Nome_Campo == "idfuncionario_")
      {
          nm_limpa_numero($this->idfuncionario_, $this->field_config['idfuncionario_']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "id_entidad_")
      {
          nm_limpa_numero($this->id_entidad_, $this->field_config['id_entidad_']['symbol_grp']) ; 
      }
   }
   ...
   {
      global $nm_form_submit;
      if ('' !== $this->idfuncionario_ || (!empty($format_fields) && isset($format_fields['idfuncionario_'])))
      {
          nmgp_Form_Num_Val($this->idfuncionario_, $this->field_config['idfuncionario_']['symbol_grp'], $this->field_config['idfuncionario_']['symbol_dec'], "0", "S", $this->field_config['idfuncionario_']['format_neg'], "", "", "-", $this->field_config['idfuncionario_']['symbol_fmt']) ; 
      }
      if ('' !== $this->id_entidad_ || (!empty($format_fields) && isset($format_fields['id_entidad_'])))
      {
          nmgp_Form_Num_Val($this->id_entidad_, $this->field_config['id_entidad_']['symbol_grp'], $this->field_config['id_entidad_']['symbol_dec'], "0", "S", $this->field_config['id_entidad_']['format_neg'], "", "", "-", $this->field_config['id_entidad_']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['idfuncionario_']['keyVal'] = form_funcionario_pack_protect_string($this->nmgp_dados_form['idfuncionario_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_funcionario[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  if (isset($this->NM_ajax_changed['idfuncionario_']) && $this->NM_ajax_changed['idfuncionario_'])
                  {
                      $this->form_vert_form_funcionario[$this->nmgp_refresh_row]['idfuncionario_'] = $this->idfuncionario_;
                  }
                  if (isset($this->NM_ajax_changed['dpi_']) && $this->NM_ajax_changed['dpi_'])
                  {
                      $this->form_vert_form_funcionario[$this->nmgp_refresh_row]['dpi_'] = $this->dpi_;
                  }
                  if (isset($this->NM_ajax_changed['nombre_']) && $this->NM_ajax_changed['nombre_'])
                  {
                      $this->form_vert_form_funcionario[$this->nmgp_refresh_row]['nombre_'] = $this->nombre_;
                  }
                  if (isset($this->NM_ajax_changed['id_entidad_']) && $this->NM_ajax_changed['id_entidad_'])
                  {
                      $this->form_vert_form_funcionario[$this->nmgp_refresh_row]['id_entidad_'] = $this->id_entidad_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_funcionario as $sc_seq_vert => $aRecData)
          {
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idfuncionario_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['idfuncionario_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['idfuncionario_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'label',
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("id_entidad_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['id_entidad_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['id_entidad_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
...
{
    $original_idfuncionario_ = $this->idfuncionario_;
}
             /* revision */
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM revision WHERE idfuncionario = " . $this->idfuncionario_ ;
      }
      else
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM revision WHERE idfuncionario = " . $this->idfuncionario_ ;
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_funcionario' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_idfuncionario_ != $this->idfuncionario_ || (isset($bFlagRead_idfuncionario_) && $bFlagRead_idfuncionario_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['idfuncionario_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['idfuncionario_' . $this->nmgp_refresh_row]['valList'] = array($this->idfuncionario_);
        $this->NM_ajax_changed['idfuncionario_'] = true;
    }
}
$_SESSION['scriptcase']['form_funcionario']['contr_erro'] = 'off'; 
    }
      ...
      {
          $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select'][$sc_seq_vert];
          if ($this->nmgp_dados_select['idfuncionario_'] == $this->idfuncionario_ &&
              $this->nmgp_dados_select['dpi_'] == $this->dpi_ &&
              $this->nmgp_dados_select['nombre_'] == $this->nombre_ &&
              $this->nmgp_dados_select['id_entidad_'] == $this->id_entidad_)
          { }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select'][$sc_seq_vert]['idfuncionario_'] = $this->idfuncionario_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select'][$sc_seq_vert]['dpi_'] = $this->dpi_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select'][$sc_seq_vert]['nombre_'] = $this->nombre_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select'][$sc_seq_vert]['id_entidad_'] = $this->id_entidad_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      $NM_val_form['idfuncionario_'] = $this->idfuncionario_;
      $NM_val_form['dpi_'] = $this->dpi_;
      $NM_val_form['nombre_'] = $this->nombre_;
      $NM_val_form['id_entidad_'] = $this->id_entidad_;
      if ($this->idfuncionario_ === "" || is_null($this->idfuncionario_))  
      { 
          $this->idfuncionario_ = 0;
      } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where idfuncionario = $this->idfuncionario_ ";
              $rs1 = $this->Db->Execute("select count(*) AS countTest from " . $this->Ini->nm_tabela . " where idfuncionario = $this->idfuncionario_ "); 
          }  
          else  
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) AS countTest from " . $this->Ini->nm_tabela . " where idfuncionario = $this->idfuncionario_ ";
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "dpi = '$this->dpi_', nombre = '$this->nombre_', id_entidad = $this->id_entidad_"; 
              } 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $comando .= " WHERE idfuncionario = $this->idfuncionario_ ";  
              }  
              else  
              {
                  $comando .= " WHERE idfuncionario = $this->idfuncionario_ ";  
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['idfuncionario_'])) { $this->idfuncionario_ = $NM_val_form['idfuncionario_']; }
              elseif (isset($this->idfuncionario_)) { $this->nm_limpa_alfa($this->idfuncionario_); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['id_entidad_'])) { $this->id_entidad_ = $NM_val_form['id_entidad_']; }
              elseif (isset($this->id_entidad_)) { $this->nm_limpa_alfa($this->id_entidad_); }
              $this->nm_proc_onload_record($this->nmgp_refresh_row);

              $this->nm_formatar_campos();

              $aOldRefresh               = $this->nmgp_refresh_fields;
              $this->nmgp_refresh_fields = array_diff(array('idfuncionario_', 'dpi_', 'nombre_', 'id_entidad_'), $aDoNotUpdate);
              $this->ajax_return_values();
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['idfuncionario_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['dpi_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['nombre_' . $this->nmgp_refresh_row] = 'on';

                  $this->NM_ajax_info['readOnly']['id_entidad_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (dpi, nombre, id_entidad) VALUES ('$this->dpi_', '$this->nombre_', $this->id_entidad_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "dpi, nombre, id_entidad) VALUES (" . $NM_seq_auto . "'$this->dpi_', '$this->nombre_', $this->id_entidad_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "dpi, nombre, id_entidad) VALUES (" . $NM_seq_auto . "'$this->dpi_', '$this->nombre_', $this->id_entidad_)"; 
              ...
              { 
                  ...
                  $this->idfuncionario_ =  $rsy->fields[0];
                 $rsy->Close(); 
              } 
              ...
              $this->dpi_ = $this->dpi__before_qstr;
              $this->nombre_ = $this->nombre__before_qstr;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_I_E']++; 
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total'] + 1; 
              $this->NM_gera_nav_page(); 
              $this->NM_ajax_info['navPage'] = $this->SC_nav_page; 
              ...
              if (isset($this->Embutida_form) && $this->Embutida_form)
              {
                  ...
                  $this->NM_ajax_info['fldList']['idfuncionario_' . $this->nmgp_refresh_row]['type']    = 'label';
                  $this->NM_ajax_info['fldList']['idfuncionario_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->idfuncionario_)));
                  $this->NM_ajax_info['fldList']['idfuncionario_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_idfuncionario_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['idfuncionario_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['idfuncionario_' . $this->nmgp_refresh_row] = "on";
                      }
                  }
                  ...
                  $this->NM_ajax_info['fldList']['id_entidad_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['id_entidad_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->id_entidad_)));
                  $this->NM_ajax_info['fldList']['id_entidad_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_id_entidad_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['id_entidad_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['id_entidad_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
      ...
      if ($this->nmgp_opcao == "excluir") 
      { 
          $this->idfuncionario_ = substr($this->Db->qstr($this->idfuncionario_), 1, -1); 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where idfuncionario = $this->idfuncionario_ "; 
                  $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where idfuncionario = $this->idfuncionario_ "); 
              }  
              else  
              {
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where idfuncionario = $this->idfuncionario_ "; 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['parms'] = "idfuncionario_?#?$this->idfuncionario_?@?"; 
      }
      if ($this->sc_evento != "insert" && $this->sc_evento != "update" && $this->sc_evento != "delete")
      { 
          $this->idfuncionario_ = null === $this->idfuncionario_ ? null : substr($this->Db->qstr($this->idfuncionario_), 1, -1); 
      } 
   }
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_funcionario']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_funcionario']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_funcionario']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_funcionario']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_funcionario']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_funcionario']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_funcionario = array();
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = 0;
      }
      ...
      {
          $aNewWhereCond = array();
          if (null != $this->idfuncionario_)
          {
              $aNewWhereCond[] = "idfuncionario = " . $this->idfuncionario_;
          }
          if (!$this->NM_ajax_flag)
          {
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total']))
          {
      ...
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_I_E'] = 0; 
          if (!$this->sc_teve_excl && !$this->sc_teve_incl) 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = 0; 
          } 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idfuncionario_))
          {
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $Key_Where = "idfuncionario < $this->idfuncionario_ "; 
              }  
              else  
              {
                  $Key_Where = "idfuncionario < $this->idfuncionario_ "; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_funcionario = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_funcionario) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] > $qt_geral_reg_form_funcionario)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = $qt_geral_reg_form_funcionario - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = ($qt_geral_reg_form_funcionario + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT idfuncionario, dpi, nombre, id_entidad from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      else 
      { 
          $nmgp_select = "SELECT idfuncionario, dpi, nombre, id_entidad from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start']) ; 
              } 
              else  
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          if ($rs->EOF && !$this->proc_fast_search && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['empty_filter']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['empty_filter'])) 
          { 
              $this->nm_flag_saida_novo = "S"; 
              $this->nmgp_opcao = "novo"; 
              $this->sc_evento  = "novo"; 
          ...
          { 
              ...
              $this->idfuncionario_ = $rs->fields[0] ; 
              $this->nmgp_dados_select['idfuncionario_'] = $this->idfuncionario_;
              $this->dpi_ = $rs->fields[1] ; 
              $this->nmgp_dados_select['dpi_'] = $this->dpi_;
              $this->nombre_ = $rs->fields[2] ; 
              $this->nmgp_dados_select['nombre_'] = $this->nombre_;
              $this->id_entidad_ = $rs->fields[3] ; 
              $this->nmgp_dados_select['id_entidad_'] = $this->id_entidad_;
              $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->idfuncionario_ = (string)$this->idfuncionario_; 
              $this->id_entidad_ = (string)$this->id_entidad_; 
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['parms'] = "idfuncionario_?#?$this->idfuncionario_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_funcionario[$sc_seq_vert]['idfuncionario_'] =  $this->idfuncionario_; 
             $this->form_vert_form_funcionario[$sc_seq_vert]['dpi_'] =  $this->dpi_; 
          ...
          ksort ($this->form_vert_form_funcionario); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] < (($qt_geral_reg_form_funcionario + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_multi']) 
          { 
          } 
          else 
          { 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['reg_start'] + $this->sc_max_reg;
...
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idfuncionario";$nm_numeric[] = "id_entidad";
