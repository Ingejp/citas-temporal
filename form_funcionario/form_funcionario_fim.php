...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____form_funcionario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____form_funcionario"]);
   }
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_redir_insert']);
      unset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_max_reg']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['form_funcionario']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   if ((isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_funcionario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_funcionario']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_funcionario']['db_changed'])
           {
...
?>
   ...
   { 
       parent.del_aba_td('form_funcionario');
   } 
   else 
   { 
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['form_funcionario']['embutida_filho'] as $ind => $sc_init)
          {
