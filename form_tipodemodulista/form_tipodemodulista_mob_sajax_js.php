  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipodemodulista_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipodemodulista_mob_form();
	}

  // ---------- Validate idtipodemodulista
  function do_ajax_form_tipodemodulista_mob_validate_idtipodemodulista()
  {
    var nomeCampo_idtipodemodulista = "idtipodemodulista";
    var var_idtipodemodulista = scAjaxGetFieldHidden(nomeCampo_idtipodemodulista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipodemodulista_mob_validate_idtipodemodulista(var_idtipodemodulista, var_script_case_init, do_ajax_form_tipodemodulista_mob_validate_idtipodemodulista_cb);
  } // do_ajax_form_tipodemodulista_mob_validate_idtipodemodulista

  function do_ajax_form_tipodemodulista_mob_validate_idtipodemodulista_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipodemodulista_mob_validate_idtipodemodulista_cb

  // ---------- Validate tipomodulista
  function do_ajax_form_tipodemodulista_mob_validate_tipomodulista()
  {
    var nomeCampo_tipomodulista = "tipomodulista";
    var var_tipomodulista = scAjaxGetFieldText(nomeCampo_tipomodulista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipodemodulista_mob_validate_tipomodulista(var_tipomodulista, var_script_case_init, do_ajax_form_tipodemodulista_mob_validate_tipomodulista_cb);
  } // do_ajax_form_tipodemodulista_mob_validate_tipomodulista

  function do_ajax_form_tipodemodulista_mob_validate_tipomodulista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipomodulista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipodemodulista_mob_validate_tipomodulista_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tipodemodulista_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipodemodulista_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idtipodemodulista = scAjaxGetFieldHidden("idtipodemodulista");
    var var_tipomodulista = scAjaxGetFieldText("tipomodulista");
    ...
    scAjaxProcOn();
    x_ajax_form_tipodemodulista_mob_submit_form(var_idtipodemodulista, var_tipomodulista, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipodemodulista_mob_submit_form_cb);
  } // do_ajax_form_tipodemodulista_mob_submit_form

  function do_ajax_form_tipodemodulista_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tipomodulista");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tipodemodulista_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tipodemodulista_mob_submit_form_cb
  function do_ajax_form_tipodemodulista_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipodemodulista_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipodemodulista_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idtipodemodulista");
    scAjaxHideErrorDisplay("tipomodulista");
    var var_idtipodemodulista = document.F2.idtipodemodulista.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipodemodulista_mob_navigate_form(var_idtipodemodulista, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipodemodulista_mob_navigate_form_cb);
  } // do_ajax_form_tipodemodulista_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipodemodulista_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipodemodulista_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtipodemodulista.value = scAjaxGetKeyValue("idtipodemodulista");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipodemodulista_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tipodemodulista_mob_navigate_form_cb
  function do_ajax_form_tipodemodulista_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tipodemodulista_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tipodemodulista_mob_navigate_form_cb_after_alert
  function sc_hide_form_tipodemodulista_mob_form()
  {
  ...
  ajax_field_list[1] = "tipomodulista";
  ...
  var ajax_error_list = {
    ...
    "tipomodulista": {"label": "Tipo de Modulista", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "tipomodulista": new Array()
  };
  ajax_field_mult["idtipodemodulista"][1] = "idtipodemodulista";
  ajax_field_mult["tipomodulista"][1] = "tipomodulista";

  var ajax_field_id = {
    "idtipodemodulista": new Array("hidden_field_label_idtipodemodulista", "hidden_field_data_idtipodemodulista"),
    "tipomodulista": new Array("hidden_field_label_tipomodulista", "hidden_field_data_tipomodulista")
  };

  var ajax_read_only = {
    "idtipodemodulista": "on",
    "tipomodulista": "off"
  };
