<?php
@session_start() ;
$_SESSION['scriptcase']['grid_asignacionmodulista_1']['sc_process_barr'] = true;
require_once('../grid_asignacionmodulista_1/index.php');
unset($_SESSION['scriptcase']['grid_asignacionmodulista_1']['sc_process_barr']);
$ExportCtrl = new grid_asignacionmodulista_1_export_control;
$ExportCtrl->Export_barr();

class grid_asignacionmodulista_1_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - asignacionmodulista :: Excel</TITLE>
