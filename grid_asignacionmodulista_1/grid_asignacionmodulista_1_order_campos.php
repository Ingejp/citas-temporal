...
<?php
   ...
   $Ord_Cmp = new grid_asignacionmodulista_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_asignacionmodulista_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["citas_disponibles"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["citas_disponibles"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["citas_disponibles"] : "Citas Disponibles";
   $tab_ger_campos['rangoinicial'] = "on";
   $tab_def_campos['rangoinicial'] = "rangoInicial";
   $tab_labels["rangoinicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["rangoinicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["rangoinicial"] : "Rango Inicial";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "horaInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["horainicio"] : "Hora Inicio";
   $tab_ger_campos['disponible'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['disponible'] = "DISPONIBLE";
   }
   else
   {
       $tab_def_campos['disponible'] = "";
   }
   $tab_labels["disponible"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["disponible"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['labels']["disponible"] : "DISPONIBLE";
   $tab_ger_campos['disponible'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_asignacionmodulista_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
