  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cita_1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cita_1_mob_form();
	}

  // ---------- Validate lectura
  function do_ajax_form_cita_1_mob_validate_lectura()
  {
    var nomeCampo_lectura = "lectura";
    var var_lectura = scAjaxGetFieldText(nomeCampo_lectura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_1_mob_validate_lectura(var_lectura, var_script_case_init, do_ajax_form_cita_1_mob_validate_lectura_cb);
  } // do_ajax_form_cita_1_mob_validate_lectura

  function do_ajax_form_cita_1_mob_validate_lectura_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_1_mob_validate_lectura_cb

  // ---------- Validate descripcion
  function do_ajax_form_cita_1_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_1_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_cita_1_mob_validate_descripcion_cb);
  } // do_ajax_form_cita_1_mob_validate_descripcion

  function do_ajax_form_cita_1_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_1_mob_validate_descripcion_cb

  // ---------- Validate idestado
  function do_ajax_form_cita_1_mob_validate_idestado()
  {
    var nomeCampo_idestado = "idestado";
    var var_idestado = scAjaxGetFieldText(nomeCampo_idestado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_1_mob_validate_idestado(var_idestado, var_script_case_init, do_ajax_form_cita_1_mob_validate_idestado_cb);
  } // do_ajax_form_cita_1_mob_validate_idestado

  function do_ajax_form_cita_1_mob_validate_idestado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_1_mob_validate_idestado_cb

  // ---------- Validate fechainicio
  function do_ajax_form_cita_1_mob_validate_fechainicio()
  {
    ...
    setTimeout(function() {
      var var_fechainicio = scAjaxGetFieldText(nomeCampo_fechainicio);
      x_ajax_form_cita_1_mob_validate_fechainicio(var_fechainicio, var_script_case_init, do_ajax_form_cita_1_mob_validate_fechainicio_cb);
    }, 200);
  } // do_ajax_form_cita_1_mob_validate_fechainicio

  function do_ajax_form_cita_1_mob_validate_fechainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_1_mob_validate_fechainicio_cb

  // ---------- Validate horainicio
  function do_ajax_form_cita_1_mob_validate_horainicio()
  {
    var nomeCampo_horainicio = "horainicio";
    var var_horainicio = scAjaxGetFieldText(nomeCampo_horainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_1_mob_validate_horainicio(var_horainicio, var_script_case_init, do_ajax_form_cita_1_mob_validate_horainicio_cb);
  } // do_ajax_form_cita_1_mob_validate_horainicio

  function do_ajax_form_cita_1_mob_validate_horainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_1_mob_validate_horainicio_cb

  // ---------- Validate idcontenedor
  function do_ajax_form_cita_1_mob_validate_idcontenedor()
  {
    var nomeCampo_idcontenedor = "idcontenedor";
    var var_idcontenedor = scAjaxGetFieldText(nomeCampo_idcontenedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_1_mob_validate_idcontenedor(var_idcontenedor, var_script_case_init, do_ajax_form_cita_1_mob_validate_idcontenedor_cb);
  } // do_ajax_form_cita_1_mob_validate_idcontenedor

  function do_ajax_form_cita_1_mob_validate_idcontenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_1_mob_validate_idcontenedor_cb

  // ---------- Validate idtipocita
  function do_ajax_form_cita_1_mob_validate_idtipocita()
  {
    var nomeCampo_idtipocita = "idtipocita";
    var var_idtipocita = scAjaxGetFieldText(nomeCampo_idtipocita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_1_mob_validate_idtipocita(var_idtipocita, var_script_case_init, do_ajax_form_cita_1_mob_validate_idtipocita_cb);
  } // do_ajax_form_cita_1_mob_validate_idtipocita

  function do_ajax_form_cita_1_mob_validate_idtipocita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipocita";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_1_mob_validate_idtipocita_cb

  // ---------- Event onchange lectura
  function do_ajax_form_cita_1_mob_event_lectura_onchange()
  {
    var var_lectura = scAjaxGetFieldText("lectura");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_idestado = scAjaxGetFieldText("idestado");
    ...
    var var_idtipocita = scAjaxGetFieldText("idtipocita");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cita_1_mob_event_lectura_onchange(var_lectura, var_descripcion, var_idestado, var_fechainicio, var_horainicio, var_idcontenedor, var_idtipocita, var_script_case_init, do_ajax_form_cita_1_mob_event_lectura_onchange_cb);
  } // do_ajax_form_cita_1_mob_event_lectura_onchange

  function do_ajax_form_cita_1_mob_event_lectura_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lectura";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cita_1_mob_event_lectura_onchange_cb_after_alert);
  } // do_ajax_form_cita_1_mob_event_lectura_onchange_cb
  function do_ajax_form_cita_1_mob_event_lectura_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cita_1_mob_event_lectura_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cita_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cita_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_lectura = scAjaxGetFieldText("lectura");
    ...
    scAjaxProcOn();
    x_ajax_form_cita_1_mob_submit_form(var_lectura, var_descripcion, var_idestado, var_fechainicio, var_horainicio, var_idcontenedor, var_idtipocita, var_idcita, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cita_1_mob_submit_form_cb);
  } // do_ajax_form_cita_1_mob_submit_form

  function do_ajax_form_cita_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("lectura");
      ...
      scAjaxHideErrorDisplay("idtipocita");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cita_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cita_1_mob_submit_form_cb
  function do_ajax_form_cita_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cita_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cita_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cita_1_mob_navigate_form(var_idcita, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cita_1_mob_navigate_form_cb);
  } // do_ajax_form_cita_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cita_1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cita_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cita_1_mob_navigate_form_cb
  function do_ajax_form_cita_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_cita_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cita_1_mob_navigate_form_cb_after_alert
  function sc_hide_form_cita_1_mob_form()
  {
  ...
  ajax_field_list[0] = "lectura";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "idestado";
  ajax_field_list[3] = "fechainicio";
  ajax_field_list[4] = "horainicio";
  ajax_field_list[5] = "idcontenedor";
  ajax_field_list[6] = "idtipocita";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "lectura": {"label": "lectura", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idtipocita": {"label": "Tipo Cita", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "idtipocita": new Array()
  };
  ajax_field_mult["lectura"][1] = "lectura";
  ...
  ajax_field_mult["idtipocita"][1] = "idtipocita";

  var ajax_field_id = {
    "lectura": new Array("hidden_field_label_lectura", "hidden_field_data_lectura"),
    ...
    "idtipocita": new Array("hidden_field_label_idtipocita", "hidden_field_data_idtipocita")
  };
