<?php
@session_start() ;
$_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['sc_process_barr'] = true;
require_once('../Boleta_Pesaje_Por_Embarque/index.php');
unset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['sc_process_barr']);
$ExportCtrl = new Boleta_Pesaje_Por_Embarque_export_control;
$ExportCtrl->Export_barr();

class Boleta_Pesaje_Por_Embarque_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> weighings :: Excel</TITLE>
