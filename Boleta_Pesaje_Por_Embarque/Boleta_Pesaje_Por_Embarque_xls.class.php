...
class Boleta_Pesaje_Por_Embarque_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new Boleta_Pesaje_Por_Embarque_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_Boleta_Pesaje_Por_Embarque.zip";
          $this->Arquivo   .= "_Boleta_Pesaje_Por_Embarque" . $this->Xls_tp;
          $this->Tit_doc    = "Boleta_Pesaje_Por_Embarque" . $this->Xls_tp;
          $this->Tit_zip    = "Boleta_Pesaje_Por_Embarque.zip";
      ...
      require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_total.class.php"); 
      $this->Tot = new Boleta_Pesaje_Por_Embarque_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['field_order'] as $Cada_cmp)
      {
      ...
      { 
          ...
          $this->out = $Busca_temp['out']; 
          $tmp_pos = strpos($this->out, "##@@");
          if ($tmp_pos !== false && !is_array($this->out))
          {
              $this->out = substr($this->out, 0, $tmp_pos);
          }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->codigo = $rs->fields[16] ;  
         $this->codigo = (string)$this->codigo;
         $this->exitticket = $rs->fields[17] ;  
         $this->inticket = $rs->fields[18] ;  
         $this->licenseplate = $rs->fields[19] ;  
         $this->driverslicense = $rs->fields[20] ;  
         $this->driverslicense = (string)$this->driverslicense;
         $this->pilotname = $rs->fields[21] ;  
         $this->transportname = $rs->fields[22] ;  
         $this->chasis = $rs->fields[23] ;  
         $this->machine = $rs->fields[24] ;  
         $this->machine = (string)$this->machine;
         $this->bl = $rs->fields[25] ;  
         $this->out = $rs->fields[26] ;  
         $this->in = $rs->fields[27] ;  
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   ...
   function NM_export_idweighing()
   {
         ...
         if (is_numeric($this->idweighing))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idweighing);
         $this->Xls_col++;
   }
   //----- container
   function NM_export_container()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->container, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->container, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vessel
   function NM_export_vessel()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vessel, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->vessel, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- shippingcompany
   function NM_export_shippingcompany()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->shippingcompany, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->shippingcompany, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- voyage
   function NM_export_voyage()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->voyage, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->voyage, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- date
   function NM_export_date()
   {
      ...
      if (!empty($this->date))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->date, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->date, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- commodity
   function NM_export_commodity()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->commodity, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->commodity, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tarechassis
   function NM_export_tarechassis()
   {
         ...
         if (is_numeric($this->tarechassis))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tarechassis);
         $this->Xls_col++;
   }
   //----- tarecontainer
   function NM_export_tarecontainer()
   {
         ...
         if (is_numeric($this->tarecontainer))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tarecontainer);
         $this->Xls_col++;
   }
   //----- grossweight
   function NM_export_grossweight()
   {
         ...
         if (is_numeric($this->grossweight))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->grossweight);
         $this->Xls_col++;
   }
   //----- netweight
   function NM_export_netweight()
   {
         ...
         if (is_numeric($this->netweight))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->netweight);
         $this->Xls_col++;
   }
   //----- packages
   function NM_export_packages()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->packages);
         $this->Xls_col++;
   }
   //----- country
   function NM_export_country()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->country, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->country, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- typeoperation
   function NM_export_typeoperation()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->typeoperation, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->typeoperation, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vgm
   function NM_export_vgm()
   {
         ...
         if (is_numeric($this->vgm))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->vgm);
         $this->Xls_col++;
   }
   //----- qr
   ...
   function NM_export_exitticket()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->exitticket, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->exitticket, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- inticket
   function NM_export_inticket()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->inticket, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->inticket, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- licenseplate
   function NM_export_licenseplate()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->licenseplate, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->licenseplate, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- driverslicense
   function NM_export_driverslicense()
   {
         ...
         if (is_numeric($this->driverslicense))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->driverslicense);
         $this->Xls_col++;
   }
   //----- pilotname
   function NM_export_pilotname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pilotname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pilotname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- transportname
   function NM_export_transportname()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->transportname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->transportname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- chasis
   function NM_export_chasis()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->chasis, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->chasis, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- machine
   function NM_export_machine()
   {
         ...
         if (is_numeric($this->machine))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->machine);
         $this->Xls_col++;
   }
   //----- bl
   function NM_export_bl()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->bl, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->bl, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- out
   function NM_export_out()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->out, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->out, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- in
   function NM_export_in()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->in, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->in, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- idweighing
   function NM_sub_cons_idweighing()
   {
         if (!NM_is_utf8($this->idweighing))
         {
             $this->idweighing = sc_convert_encoding($this->idweighing, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idweighing;
   ...
   //----- container
   function NM_sub_cons_container()
   {
         $this->container = html_entity_decode($this->container, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->container = strip_tags($this->container);
         if (!NM_is_utf8($this->container))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->container;
   ...
   function NM_sub_cons_vessel()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vessel;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- shippingcompany
   function NM_sub_cons_shippingcompany()
   {
         $this->shippingcompany = html_entity_decode($this->shippingcompany, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->shippingcompany = strip_tags($this->shippingcompany);
         if (!NM_is_utf8($this->shippingcompany))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->shippingcompany;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_voyage()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->voyage;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_date()
   {
      if (!empty($this->date))
      {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->date;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- commodity
   function NM_sub_cons_commodity()
   {
         $this->commodity = html_entity_decode($this->commodity, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->commodity = strip_tags($this->commodity);
         if (!NM_is_utf8($this->commodity))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->commodity;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tarechassis
   function NM_sub_cons_tarechassis()
   {
         if (!NM_is_utf8($this->tarechassis))
         {
             $this->tarechassis = sc_convert_encoding($this->tarechassis, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tarechassis;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- tarecontainer
   function NM_sub_cons_tarecontainer()
   {
         if (!NM_is_utf8($this->tarecontainer))
         {
             $this->tarecontainer = sc_convert_encoding($this->tarecontainer, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tarecontainer;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- grossweight
   function NM_sub_cons_grossweight()
   {
         if (!NM_is_utf8($this->grossweight))
         {
             $this->grossweight = sc_convert_encoding($this->grossweight, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->grossweight;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- netweight
   function NM_sub_cons_netweight()
   {
         if (!NM_is_utf8($this->netweight))
         {
             $this->netweight = sc_convert_encoding($this->netweight, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->netweight;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- packages
   function NM_sub_cons_packages()
   {
         if (!NM_is_utf8($this->packages))
         {
             $this->packages = sc_convert_encoding($this->packages, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->packages;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   function NM_sub_cons_country()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->country;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- typeoperation
   function NM_sub_cons_typeoperation()
   {
         $this->typeoperation = html_entity_decode($this->typeoperation, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->typeoperation = strip_tags($this->typeoperation);
         if (!NM_is_utf8($this->typeoperation))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->typeoperation;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- vgm
   function NM_sub_cons_vgm()
   {
         if (!NM_is_utf8($this->vgm))
         {
             $this->vgm = sc_convert_encoding($this->vgm, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vgm;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- exitticket
   function NM_sub_cons_exitticket()
   {
         $this->exitticket = html_entity_decode($this->exitticket, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->exitticket = strip_tags($this->exitticket);
         if (!NM_is_utf8($this->exitticket))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->exitticket;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_inticket()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->inticket;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- licenseplate
   function NM_sub_cons_licenseplate()
   {
         $this->licenseplate = html_entity_decode($this->licenseplate, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->licenseplate = strip_tags($this->licenseplate);
         if (!NM_is_utf8($this->licenseplate))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->licenseplate;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- driverslicense
   function NM_sub_cons_driverslicense()
   {
         if (!NM_is_utf8($this->driverslicense))
         {
             $this->driverslicense = sc_convert_encoding($this->driverslicense, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->driverslicense;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- pilotname
   function NM_sub_cons_pilotname()
   {
         $this->pilotname = html_entity_decode($this->pilotname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pilotname = strip_tags($this->pilotname);
         if (!NM_is_utf8($this->pilotname))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pilotname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- transportname
   function NM_sub_cons_transportname()
   {
         $this->transportname = html_entity_decode($this->transportname, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->transportname = strip_tags($this->transportname);
         if (!NM_is_utf8($this->transportname))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->transportname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_chasis()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->chasis;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- machine
   function NM_sub_cons_machine()
   {
         if (!NM_is_utf8($this->machine))
         {
             $this->machine = sc_convert_encoding($this->machine, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->machine;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   function NM_sub_cons_bl()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->bl;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_out()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->out;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_in()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->in;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> weighings :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
