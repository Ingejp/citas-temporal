<?php
   include_once('Boleta_Pesaje_Por_Embarque_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class Boleta_Pesaje_Por_Embarque_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "Boleta_Pesaje_Por_Embarque"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20190306"; 
      $this->nm_hr_criacao   = "212215"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20200303"; 
      $this->nm_hr_ult_alt   = "153011"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/Boleta_Pesaje_Por_Embarque';
      ...
      if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['actual_lang']) || $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("Boleta_Pesaje_Por_Embarque_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Boleta_Pesaje_Por_Embarque"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Boleta_Pesaje_Por_Embarque"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir']))
      {
      ...
      $this->nm_path_pdf     = $this->path_imag_temp . "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_Boleta_Pesaje_Por_Embarque" . ".pdf";
      $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "Boleta_Pesaje_Por_Embarque_erro.class.php"); 
      $this->Erro = new Boleta_Pesaje_Por_Embarque_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('Boleta_Pesaje_Por_Embarque'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao']) && $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_perfil']) && $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida_init']) 
      {
          if (!isset($_SESSION['VIAJE'])) 
          {
              $this->nm_falta_var .= "VIAJE; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Boleta_Pesaje_Por_Embarque']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class Boleta_Pesaje_Por_Embarque_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['Boleta_Pesaje_Por_Embarque']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['Boleta_Pesaje_Por_Embarque'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class Boleta_Pesaje_Por_Embarque_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_ibase'])) 
      { 
          $this->Ini = new Boleta_Pesaje_Por_Embarque_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Boleta_Pesaje_Por_Embarque']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Boleta_Pesaje_Por_Embarque'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Boleta_Pesaje_Por_Embarque']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Boleta_Pesaje_Por_Embarque']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Boleta_Pesaje_Por_Embarque') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Boleta_Pesaje_Por_Embarque']['label'] = "" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " weighings";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "Boleta_Pesaje_Por_Embarque")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      include_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_erro.class.php"); 
      $this->Erro      = new Boleta_Pesaje_Por_Embarque_erro();
      $this->Erro->Ini = $this->Ini;
      require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_lookup.class.php"); 
      $this->Lookup       = new Boleta_Pesaje_Por_Embarque_lookup();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje_Por_Embarque']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje_Por_Embarque']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje_Por_Embarque']['exit'];
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida'])
      { 
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje_Por_Embarque']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje_Por_Embarque']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] = "grid" ;  
      }   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['prim_cons'] = true;  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['where_pesq_ant'];  
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_Boleta_Pesaje_Por_Embarque_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_xls.class.php"); 
          } 
          $this->xls  = new Boleta_Pesaje_Por_Embarque_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_res_xls.class.php"); 
          } 
          $this->xls  = new Boleta_Pesaje_Por_Embarque_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_xml.class.php"); 
          } 
          $this->xml  = new Boleta_Pesaje_Por_Embarque_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_res_xml.class.php"); 
          } 
          $this->xml  = new Boleta_Pesaje_Por_Embarque_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_csv.class.php"); 
          } 
          $this->csv  = new Boleta_Pesaje_Por_Embarque_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_res_csv.class.php"); 
          } 
          $this->csv  = new Boleta_Pesaje_Por_Embarque_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_rtf.class.php"); 
          } 
          $this->rtf  = new Boleta_Pesaje_Por_Embarque_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Boleta_Pesaje_Por_Embarque/Boleta_Pesaje_Por_Embarque_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_res_rtf.class.php"); 
          } 
          $this->rtf  = new Boleta_Pesaje_Por_Embarque_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new Boleta_Pesaje_Por_Embarque_pesq();
      ...
      { 
           require_once($this->Ini->path_aplicacao . "Boleta_Pesaje_Por_Embarque_grid.class.php"); 
           $this->grid  = new Boleta_Pesaje_Por_Embarque_grid();
...
<?php
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp'] . "/");
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> weighings :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
<?php
if ($_SESSION['scriptcase']['proc_mobile'])
{
...
<form name="Fdown" method="get" action="Boleta_Pesaje_Por_Embarque_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="Boleta_Pesaje_Por_Embarque"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje_Por_Embarque'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_Boleta_Pesaje_Por_Embarque($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_Boleta_Pesaje_Por_Embarque($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "Boleta_Pesaje_Por_Embarque") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['Boleta_Pesaje_Por_Embarque']['master_pai']) && $_SESSION['sc_session'][$init_filho]['Boleta_Pesaje_Por_Embarque']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           foreach ($todo as $param)
           {
                ...
                if (1 < sizeof($cadapar))
                {
                    ...
                    nm_limpa_str_Boleta_Pesaje_Por_Embarque($cadapar[1]);
                    nm_protect_num_Boleta_Pesaje_Por_Embarque($cadapar[0], $cadapar[1]);
                    if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                    $Tmp_par   = $cadapar[0];
                    $$Tmp_par = $cadapar[1];
                }
           }
           if (!isset($VIAJE) && isset($viaje)) 
           {
               $_SESSION["VIAJE"] = $viaje;
           }
           if (isset($VIAJE)) 
           {
               $_SESSION['VIAJE'] = $VIAJE;
               nm_limpa_str_Boleta_Pesaje_Por_Embarque($_SESSION["VIAJE"]);
           }
           $NMSC_conf_apl = array();
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']);
               $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida']) && $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['Boleta_Pesaje_Por_Embarque']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['Boleta_Pesaje_Por_Embarque']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['Boleta_Pesaje_Por_Embarque']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['protect_modal']) && !empty($_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['Boleta_Pesaje_Por_Embarque']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "Boleta_Pesaje_Por_Embarque";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'Boleta_Pesaje_Por_Embarque' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/Boleta_Pesaje_Por_Embarque/'))
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'Boleta_Pesaje_Por_Embarque')
   {
       $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/Boleta_Pesaje_Por_Embarque_erro.php");
   }
   ...
   if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Boleta_Pesaje_Por_Embarque']))
   { 
       return;
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       if (!isset($_POST["VIAJE"]) && isset($_POST["viaje"])) 
       {
           $_SESSION["VIAJE"] = $_POST["viaje"];
           nm_limpa_str_Boleta_Pesaje_Por_Embarque($_SESSION["VIAJE"]);
       }
       if (isset($_GET["VIAJE"])) 
       {
           $_SESSION["VIAJE"] = $_GET["VIAJE"];
           nm_limpa_str_Boleta_Pesaje_Por_Embarque($_SESSION["VIAJE"]);
       }
       if (!isset($_GET["VIAJE"]) && isset($_GET["viaje"])) 
       {
           $_SESSION["VIAJE"] = $_GET["viaje"];
           nm_limpa_str_Boleta_Pesaje_Por_Embarque($_SESSION["VIAJE"]);
       }
       ...
       {
          $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['volta_redirect_tp'] = "";
           $nm_url_saida = "Boleta_Pesaje_Por_Embarque_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['sc_modal'] = true;
               }
               $nm_url_saida = "Boleta_Pesaje_Por_Embarque_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['mostra_edit'] = "N";   
           } 
       ...
       $contr_Boleta_Pesaje_Por_Embarque = new Boleta_Pesaje_Por_Embarque_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] = "busca";
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_flag = true;
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] = "busca";
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_flag = true;
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] = "busca";
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_flag = true;
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['opcao'] = "busca";
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_flag = true;
          $contr_Boleta_Pesaje_Por_Embarque->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_Boleta_Pesaje_Por_Embarque->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['Boleta_Pesaje_Por_Embarque']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_Boleta_Pesaje_Por_Embarque(&$str)
   {
   ...
   function nm_protect_num_Boleta_Pesaje_Por_Embarque($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function Boleta_Pesaje_Por_Embarque_pack_protect_string($sString)
   {
