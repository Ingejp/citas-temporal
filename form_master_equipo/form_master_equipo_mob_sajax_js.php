  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_master_equipo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_master_equipo_mob_form();
	}

  // ---------- Validate numero_contenedor
  function do_ajax_form_master_equipo_mob_validate_numero_contenedor()
  {
    var nomeCampo_numero_contenedor = "numero_contenedor";
    var var_numero_contenedor = scAjaxGetFieldText(nomeCampo_numero_contenedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_master_equipo_mob_validate_numero_contenedor(var_numero_contenedor, var_script_case_init, do_ajax_form_master_equipo_mob_validate_numero_contenedor_cb);
  } // do_ajax_form_master_equipo_mob_validate_numero_contenedor

  function do_ajax_form_master_equipo_mob_validate_numero_contenedor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_master_equipo_mob_validate_numero_contenedor_cb

  // ---------- Validate idtipo_equipo
  function do_ajax_form_master_equipo_mob_validate_idtipo_equipo()
  {
    var nomeCampo_idtipo_equipo = "idtipo_equipo";
    var var_idtipo_equipo = scAjaxGetFieldSelect(nomeCampo_idtipo_equipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_master_equipo_mob_validate_idtipo_equipo(var_idtipo_equipo, var_script_case_init, do_ajax_form_master_equipo_mob_validate_idtipo_equipo_cb);
  } // do_ajax_form_master_equipo_mob_validate_idtipo_equipo

  function do_ajax_form_master_equipo_mob_validate_idtipo_equipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipo_equipo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_master_equipo_mob_validate_idtipo_equipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_master_equipo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_master_equipo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numero_contenedor = scAjaxGetFieldText("numero_contenedor");
    var var_idtipo_equipo = scAjaxGetFieldSelect("idtipo_equipo");
    ...
    scAjaxProcOn();
    x_ajax_form_master_equipo_mob_submit_form(var_numero_contenedor, var_idtipo_equipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_master_equipo_mob_submit_form_cb);
  } // do_ajax_form_master_equipo_mob_submit_form

  function do_ajax_form_master_equipo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idtipo_equipo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_master_equipo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_master_equipo_mob_submit_form_cb
  function do_ajax_form_master_equipo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_master_equipo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_master_equipo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("numero_contenedor");
    scAjaxHideErrorDisplay("idtipo_equipo");
    var var_numero_contenedor = document.F2.numero_contenedor.value;
    ...
    scAjaxProcOn();
    x_ajax_form_master_equipo_mob_navigate_form(var_numero_contenedor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_master_equipo_mob_navigate_form_cb);
  } // do_ajax_form_master_equipo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_equipo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_master_equipo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.numero_contenedor.value = scAjaxGetKeyValue("numero_contenedor");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_master_equipo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_master_equipo_mob_navigate_form_cb
  function do_ajax_form_master_equipo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_master_equipo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_master_equipo_mob_navigate_form_cb_after_alert
  function sc_hide_form_master_equipo_mob_form()
  {
  ...
  ajax_field_list[0] = "numero_contenedor";
  ajax_field_list[1] = "idtipo_equipo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "numero_contenedor": {"label": "CONTENEDOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idtipo_equipo": {"label": "TIPO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "idtipo_equipo": new Array()
  };
  ajax_field_mult["numero_contenedor"][1] = "numero_contenedor";
  ajax_field_mult["idtipo_equipo"][1] = "idtipo_equipo";

  var ajax_field_id = {
    "numero_contenedor": new Array("hidden_field_label_numero_contenedor", "hidden_field_data_numero_contenedor"),
    "idtipo_equipo": new Array("hidden_field_label_idtipo_equipo", "hidden_field_data_idtipo_equipo")
  };

  var ajax_read_only = {
    "numero_contenedor": "on",
    "idtipo_equipo": "off"
  };
