...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_sync_apps_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_sync_apps_submit_form(var_sync, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_sync_apps_submit_form_cb);
