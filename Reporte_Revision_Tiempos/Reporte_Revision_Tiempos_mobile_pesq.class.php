...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "rev.fecha_solicitud";$Nm_datas[] = "rev_fecha_solicitud";$Nm_numeric[] = "rev_codigo_revision";$Nm_numeric[] = "rev_porcentaje_intrusion";$Nm_numeric[] = "rev_cantidad_por_bl";$Nm_numeric[] = "rev_turno";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_horas_cond" name="horas_cond" onChange="nm_campos_between(document.getElementById('id_vis_horas'), this, 'horas')">
      ...
      <br><span id="id_hide_horas"  <?php echo $str_hide_horas?>><INPUT  type="text" id="SC_horas" name="horas" value="<?php echo NM_encode_input($horas) ?>"  size=50 alt="{datatype: 'text', maxLength: 102, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rev_ubicacion_cond" name="rev_ubicacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_rev_ubicacion'), this, 'rev_ubicacion')">
      ...
      <br><span id="id_hide_rev_ubicacion"  <?php echo $str_hide_rev_ubicacion?>><?php
      if ($rev_ubicacion != "")
      {
      $rev_ubicacion_look = substr($this->Db->qstr($rev_ubicacion), 1, -1); 
      $nmgp_def_dados = array(); 
