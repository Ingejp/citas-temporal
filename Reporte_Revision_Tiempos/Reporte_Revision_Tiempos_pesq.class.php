...
class Reporte_Revision_Tiempos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . Reporte_Revision_Tiempos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . Reporte_Revision_Tiempos_pack_protect_string($Tipo_filter[0]) . "\">.." . Reporte_Revision_Tiempos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rev_ubicacion')
      {
          $rev_ubicacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rev_ubicacion($rev_ubicacion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>Reporte_Revision_Tiempos/Reporte_Revision_Tiempos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="Reporte_Revision_Tiempos_ajax_search.js"></script>
 <script type="text/javascript" src="Reporte_Revision_Tiempos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="Reporte_Revision_Tiempos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Reporte_Revision_Tiempos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Reporte_Revision_Tiempos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_horas_cond#NMF#' + search_get_sel_txt('SC_horas_cond') + '@NMF@';
  str_out += 'SC_horas#NMF#' + search_get_text('SC_horas') + '@NMF@';
  str_out += 'SC_rev_ubicacion_cond#NMF#' + search_get_sel_txt('SC_rev_ubicacion_cond') + '@NMF@';
  str_out += 'SC_rev_ubicacion#NMF#' + search_get_text('SC_rev_ubicacion') + '@NMF@';
  str_out += 'id_ac_rev_ubicacion#NMF#' + search_get_text('id_ac_rev_ubicacion') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_rev_ubicacion").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_rev_ubicacion",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_rev_ubicacion").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Reporte de Revisiones </div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $horas_cond, $horas,
             $rev_ubicacion_cond, $rev_ubicacion, $rev_ubicacion_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $rev_codigo_revision = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_codigo_revision']; 
          $rev_codigo_revision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_codigo_revision_cond']; 
          $buq_buque = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['buq_buque']; 
          $buq_buque_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['buq_buque_cond']; 
          $horas = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['horas']; 
          $horas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['horas_cond']; 
          $rev_ubicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_ubicacion']; 
          $rev_ubicacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_ubicacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($horas_cond) || empty($horas_cond))
      {
         $horas_cond = "qp";
      }
      if (!isset($rev_ubicacion_cond) || empty($rev_ubicacion_cond))
      {
         $rev_ubicacion_cond = "qp";
      }
      ...
      $str_hide_horas = (in_array($horas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rev_ubicacion = (in_array($rev_ubicacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($horas, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $horas = substr($horas, 0, $tmp_pos);
         }
      }
      if (!isset($rev_ubicacion) || $rev_ubicacion == "")
      {
          $rev_ubicacion = "";
      }
      if (isset($rev_ubicacion) && !empty($rev_ubicacion))
      {
         $tmp_pos = strpos($rev_ubicacion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rev_ubicacion = substr($rev_ubicacion, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['rev_codigo_revision'])) ? $this->New_label['rev_codigo_revision'] : "TURNO"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_buq_buque" name="buq_buque_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 135, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['horas'])) ? $this->New_label['horas'] : "Horas"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_horas_cond" name="horas_cond" onChange="nm_campos_between(document.getElementById('id_vis_horas'), this, 'horas')">
       <OPTION value="qp" <?php if ("qp" == $horas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $horas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $horas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $horas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_horas" <?php echo $str_hide_horas?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['horas'])) ? $this->New_label['horas'] : "Horas";
 $nmgp_tab_label .= "horas?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_horas" name="horas" value="<?php echo NM_encode_input($horas) ?>"  size=50 alt="{datatype: 'text', maxLength: 102, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['rev_ubicacion'])) ? $this->New_label['rev_ubicacion'] : "Ubicacion"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_rev_ubicacion_cond" name="rev_ubicacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_rev_ubicacion'), this, 'rev_ubicacion')">
       <OPTION value="qp" <?php if ("qp" == $rev_ubicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rev_ubicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rev_ubicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rev_ubicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rev_ubicacion" <?php echo $str_hide_rev_ubicacion?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['rev_ubicacion'])) ? $this->New_label['rev_ubicacion'] : "Ubicacion";
 $nmgp_tab_label .= "rev_ubicacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $rev_ubicacion;
      }
?>
<INPUT  type="text" id="SC_rev_ubicacion" name="rev_ubicacion" value="<?php echo NM_encode_input($rev_ubicacion) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_rev_ubicacion" name="rev_ubicacion_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("Reporte_Revision_Tiempos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Revision_Tiempos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Reporte_Revision_Tiempos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.horas_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_horas'), document.F1.horas_cond, 'horas');
   document.F1.horas.value = "";
   document.F1.rev_ubicacion_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rev_ubicacion'), document.F1.rev_ubicacion_cond, 'rev_ubicacion');
   document.F1.rev_ubicacion.value = "";
   document.F1.rev_ubicacion_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "Reporte_Revision_Tiempos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_horas_cond'] = 'cond';
      $tp_fields['SC_horas'] = 'text';
      $tp_fields['SC_rev_ubicacion_cond'] = 'cond';
      $tp_fields['SC_rev_ubicacion'] = 'text_aut';
      $tp_fields['id_ac_rev_ubicacion'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $rev_codigo_revision_cond, $rev_codigo_revision, $rev_codigo_revision_autocomp,
             $buq_buque_cond, $buq_buque, $buq_buque_autocomp,
             $horas_cond, $horas,
             $rev_ubicacion_cond, $rev_ubicacion, $rev_ubicacion_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq'] = array();
      ...
      if (!empty($rev_ubicacion_autocomp) && empty($rev_ubicacion))
      {
          $rev_ubicacion = $rev_ubicacion_autocomp;
      }
      ...
      $horas_cond_salva = $horas_cond; 
      if (!isset($horas_input_2) || $horas_input_2 == "")
      {
          $horas_input_2 = $horas;
      }
      $rev_ubicacion_cond_salva = $rev_ubicacion_cond; 
      if (!isset($rev_ubicacion_input_2) || $rev_ubicacion_input_2 == "")
      {
          $rev_ubicacion_input_2 = $rev_ubicacion;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_codigo_revision'] = $rev_codigo_revision; 
      if (is_array($rev_codigo_revision) && !empty($rev_codigo_revision))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0] = $rev_codigo_revision;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $rev_codigo_revision;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_codigo_revision_cond'] = $rev_codigo_revision_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['cmp'] = "rev_codigo_revision"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['opc'] = $rev_codigo_revision_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq']['rev_codigo_revision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['buq_buque'] = $buq_buque; 
      if (is_array($buq_buque) && !empty($buq_buque))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0] = $buq_buque;
      }
      elseif ($buq_buque_cond_salva == "nu" || $buq_buque_cond_salva == "nn" || $buq_buque_cond_salva == "ep" || $buq_buque_cond_salva == "ne" ||  !empty($buq_buque))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $buq_buque;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['buq_buque_cond'] = $buq_buque_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['cmp'] = "buq_buque"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['opc'] = $buq_buque_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq']['buq_buque'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['horas'] = $horas; 
      if (is_array($horas) && !empty($horas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0] = $horas;
      }
      elseif ($horas_cond_salva == "nu" || $horas_cond_salva == "nn" || $horas_cond_salva == "ep" || $horas_cond_salva == "ne" ||  !empty($horas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $horas;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['horas_cond'] = $horas_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['cmp'] = "horas"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['opc'] = $horas_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq']['horas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_ubicacion'] = $rev_ubicacion; 
      if (is_array($rev_ubicacion) && !empty($rev_ubicacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0] = $rev_ubicacion;
      }
      elseif ($rev_ubicacion_cond_salva == "nu" || $rev_ubicacion_cond_salva == "nn" || $rev_ubicacion_cond_salva == "ep" || $rev_ubicacion_cond_salva == "ne" ||  !empty($rev_ubicacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $rev_ubicacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['rev_ubicacion_cond'] = $rev_ubicacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['cmp'] = "rev_ubicacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid]['opc'] = $rev_ubicacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['grid_pesq']['rev_ubicacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      $Conteudo = $horas;
      $this->cmp_formatado['horas'] = $Conteudo;
      $rev_ubicacion_look = substr($this->Db->qstr($rev_ubicacion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct rev.ubicacion from " . $this->Ini->nm_tabela . " where via.idBuque=buq.idBuque AND f.id_entidad=ede.identidad_de_estado AND idestado <3 and rev.ubicacion = '$rev_ubicacion_look' order by rev.ubicacion"; 
      unset($cmp1,$cmp2);
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rev_ubicacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['rev_ubicacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rev_ubicacion'] = $rev_ubicacion;
      }
      ...
      //----- $horas
      $this->Date_part = false;
      if (isset($horas) || $horas_cond == "nu" || $horas_cond == "nn" || $horas_cond == "ep" || $horas_cond == "ne")
      {
         $this->monta_condicao("concat(rev.fecha_solicitud,rev.ubicacion)", $horas_cond, $horas, "", "horas");
      }

      //----- $rev_ubicacion
      $this->Date_part = false;
      if (isset($rev_ubicacion) || $rev_ubicacion_cond == "nu" || $rev_ubicacion_cond == "nn" || $rev_ubicacion_cond == "ep" || $rev_ubicacion_cond == "ne")
      {
         $this->monta_condicao("rev.ubicacion", $rev_ubicacion_cond, $rev_ubicacion, "", "rev_ubicacion");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Revision_Tiempos']['cond_pesq'] .= $this->NM_operador;
