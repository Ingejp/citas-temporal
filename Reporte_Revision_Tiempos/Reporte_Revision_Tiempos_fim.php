...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Reporte_Revision_Tiempos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Reporte_Revision_Tiempos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Reporte_Revision_Tiempos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Reporte_Revision_Tiempos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Reporte_Revision_Tiempos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Reporte_Revision_Tiempos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Reporte_Revision_Tiempos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Reporte_Revision_Tiempos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Reporte_Revision_Tiempos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Reporte_Revision_Tiempos']['embutida_filho'] as $ind => $sc_init)
          {
