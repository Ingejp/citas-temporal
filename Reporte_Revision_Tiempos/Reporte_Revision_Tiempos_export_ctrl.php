<?php
@session_start() ;
$_SESSION['scriptcase']['Reporte_Revision_Tiempos']['sc_process_barr'] = true;
require_once('../Reporte_Revision_Tiempos/index.php');
unset($_SESSION['scriptcase']['Reporte_Revision_Tiempos']['sc_process_barr']);
$ExportCtrl = new Reporte_Revision_Tiempos_export_control;
$ExportCtrl->Export_barr();

class Reporte_Revision_Tiempos_export_control
{
