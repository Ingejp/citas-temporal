...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_placa' + iSeqRow).bind('blur', function() { sc_Busqueda_Placa_placa_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_Busqueda_Placa_placa_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_Busqueda_Placa_placa_onblur(oThis, iSeqRow) {
  do_ajax_Busqueda_Placa_mob_validate_placa();
  scCssBlur(oThis);
}

function sc_Busqueda_Placa_placa_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_Busqueda_Placa_mob_form" + pageNo).hide();
}
