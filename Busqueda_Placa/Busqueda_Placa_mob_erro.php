...
$old_error_handler = set_error_handler("Busqueda_Placa_mob_scriptcase_error_handler");

function Busqueda_Placa_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Busqueda_Placa_mob']['contr_erro']) && $_SESSION['scriptcase']['Busqueda_Placa_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Busqueda_Placa_mob->contr_Busqueda_Placa_mob->Apl_com_erro = true;
            if ($inicial_Busqueda_Placa_mob->contr_Busqueda_Placa_mob->NM_ajax_flag)
            {
                $inicial_Busqueda_Placa_mob->contr_Busqueda_Placa_mob->NM_ajax_info['errList']['geral_Busqueda_Placa_mob'][] = $msg;
                return;
            }
            Busqueda_Placa_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Busqueda_Placa_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Busqueda_Placa_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['Busqueda_Placa_mob'])  ? $_SESSION['scriptcase']['error_icon']['Busqueda_Placa_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Busqueda_Placa_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['Busqueda_Placa_mob']) ? $_SESSION['scriptcase']['error_span_title']['Busqueda_Placa_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Busqueda_Placa_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['Busqueda_Placa_mob']) ? $_SESSION['scriptcase']['error_icon_title']['Busqueda_Placa_mob'] : '';
?>
