  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cabezal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cabezal_form();
	}

  // ---------- Validate idcabezal
  function do_ajax_form_cabezal_validate_idcabezal()
  {
    var nomeCampo_idcabezal = "idcabezal";
    var var_idcabezal = scAjaxGetFieldHidden(nomeCampo_idcabezal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cabezal_validate_idcabezal(var_idcabezal, var_script_case_init, do_ajax_form_cabezal_validate_idcabezal_cb);
  } // do_ajax_form_cabezal_validate_idcabezal

  function do_ajax_form_cabezal_validate_idcabezal_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cabezal_validate_idcabezal_cb

  // ---------- Validate placa
  function do_ajax_form_cabezal_validate_placa()
  {
    var nomeCampo_placa = "placa";
    var var_placa = scAjaxGetFieldText(nomeCampo_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cabezal_validate_placa(var_placa, var_script_case_init, do_ajax_form_cabezal_validate_placa_cb);
  } // do_ajax_form_cabezal_validate_placa

  function do_ajax_form_cabezal_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cabezal_validate_placa_cb

  // ---------- Validate descripcion
  function do_ajax_form_cabezal_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cabezal_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_cabezal_validate_descripcion_cb);
  } // do_ajax_form_cabezal_validate_descripcion

  function do_ajax_form_cabezal_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cabezal_validate_descripcion_cb

  // ---------- Validate idtransporte
  function do_ajax_form_cabezal_validate_idtransporte()
  {
  } // do_ajax_form_cabezal_validate_idtransporte

  function do_ajax_form_cabezal_validate_idtransporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cabezal_validate_idtransporte_cb

  // ---------- Event onchange placa
  function do_ajax_form_cabezal_event_placa_onchange()
  {
    var var_placa = scAjaxGetFieldText("placa");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cabezal_event_placa_onchange(var_placa, var_descripcion, var_script_case_init, do_ajax_form_cabezal_event_placa_onchange_cb);
  } // do_ajax_form_cabezal_event_placa_onchange

  function do_ajax_form_cabezal_event_placa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "placa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cabezal_event_placa_onchange_cb_after_alert);
  } // do_ajax_form_cabezal_event_placa_onchange_cb
  function do_ajax_form_cabezal_event_placa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cabezal_event_placa_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cabezal_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cabezal_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cabezal_submit_form(var_idcabezal, var_placa, var_descripcion, var_idtransporte, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cabezal_submit_form_cb);
  } // do_ajax_form_cabezal_submit_form

  function do_ajax_form_cabezal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cabezal_submit_form_cb_after_alert);
  } // do_ajax_form_cabezal_submit_form_cb
  function do_ajax_form_cabezal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cabezal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cabezal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cabezal_navigate_form(var_idcabezal, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cabezal_navigate_form_cb);
  } // do_ajax_form_cabezal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cabezal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cabezal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cabezal_navigate_form_cb_after_alert);
  } // do_ajax_form_cabezal_navigate_form_cb
  function do_ajax_form_cabezal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_cabezal_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cabezal_navigate_form_cb_after_alert
  function sc_hide_form_cabezal_form()
  {
