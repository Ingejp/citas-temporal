  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_viaje" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_viaje_form();
	}

  // ---------- Validate idviaje
  function do_ajax_form_viaje_validate_idviaje()
  {
    var nomeCampo_idviaje = "idviaje";
    var var_idviaje = scAjaxGetFieldHidden(nomeCampo_idviaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_validate_idviaje(var_idviaje, var_script_case_init, do_ajax_form_viaje_validate_idviaje_cb);
  } // do_ajax_form_viaje_validate_idviaje

  function do_ajax_form_viaje_validate_idviaje_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_validate_idviaje_cb

  // ---------- Validate idestado
  function do_ajax_form_viaje_validate_idestado()
  {
    var nomeCampo_idestado = "idestado";
    var var_idestado = scAjaxGetFieldSelect(nomeCampo_idestado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_validate_idestado(var_idestado, var_script_case_init, do_ajax_form_viaje_validate_idestado_cb);
  } // do_ajax_form_viaje_validate_idestado

  function do_ajax_form_viaje_validate_idestado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_validate_idestado_cb

  // ---------- Validate viaje
  function do_ajax_form_viaje_validate_viaje()
  {
    var nomeCampo_viaje = "viaje";
    var var_viaje = scAjaxGetFieldText(nomeCampo_viaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_validate_viaje(var_viaje, var_script_case_init, do_ajax_form_viaje_validate_viaje_cb);
  } // do_ajax_form_viaje_validate_viaje

  function do_ajax_form_viaje_validate_viaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "viaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_validate_viaje_cb

  // ---------- Validate fechaatraque
  function do_ajax_form_viaje_validate_fechaatraque()
  {
    ...
    setTimeout(function() {
      var var_fechaatraque = scAjaxGetFieldText(nomeCampo_fechaatraque);
      x_ajax_form_viaje_validate_fechaatraque(var_fechaatraque, var_script_case_init, do_ajax_form_viaje_validate_fechaatraque_cb);
    }, 200);
  } // do_ajax_form_viaje_validate_fechaatraque

  function do_ajax_form_viaje_validate_fechaatraque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_validate_fechaatraque_cb

  // ---------- Validate fechazarpe
  function do_ajax_form_viaje_validate_fechazarpe()
  {
    ...
    setTimeout(function() {
      var var_fechazarpe = scAjaxGetFieldText(nomeCampo_fechazarpe);
      x_ajax_form_viaje_validate_fechazarpe(var_fechazarpe, var_script_case_init, do_ajax_form_viaje_validate_fechazarpe_cb);
    }, 200);
  } // do_ajax_form_viaje_validate_fechazarpe

  function do_ajax_form_viaje_validate_fechazarpe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_validate_fechazarpe_cb

  // ---------- Validate idbuque
  function do_ajax_form_viaje_validate_idbuque()
  {
  } // do_ajax_form_viaje_validate_idbuque

  function do_ajax_form_viaje_validate_idbuque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbuque";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_validate_idbuque_cb

  // ---------- Validate idnaviera
  function do_ajax_form_viaje_validate_idnaviera()
  {
    var nomeCampo_idnaviera = "idnaviera";
    var var_idnaviera = scAjaxGetFieldSelect(nomeCampo_idnaviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_validate_idnaviera(var_idnaviera, var_script_case_init, do_ajax_form_viaje_validate_idnaviera_cb);
  } // do_ajax_form_viaje_validate_idnaviera

  function do_ajax_form_viaje_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_validate_idnaviera_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_viaje_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_viaje_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_viaje_submit_form(var_idviaje, var_idestado, var_viaje, var_fechaatraque, var_fechazarpe, var_idbuque, var_idnaviera, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_viaje_submit_form_cb);
  } // do_ajax_form_viaje_submit_form

  function do_ajax_form_viaje_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_viaje_submit_form_cb_after_alert);
  } // do_ajax_form_viaje_submit_form_cb
  function do_ajax_form_viaje_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_viaje_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_viaje_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_viaje_navigate_form(var_idviaje, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_viaje_navigate_form_cb);
  } // do_ajax_form_viaje_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_viaje']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_viaje_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_viaje_navigate_form_cb_after_alert);
  } // do_ajax_form_viaje_navigate_form_cb
  function do_ajax_form_viaje_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_viaje_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_viaje_navigate_form_cb_after_alert
  function sc_hide_form_viaje_form()
  {
