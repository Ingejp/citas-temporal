  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_viaje_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_viaje_mob_form();
	}

  // ---------- Validate idviaje
  function do_ajax_form_viaje_mob_validate_idviaje()
  {
    var nomeCampo_idviaje = "idviaje";
    var var_idviaje = scAjaxGetFieldHidden(nomeCampo_idviaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_mob_validate_idviaje(var_idviaje, var_script_case_init, do_ajax_form_viaje_mob_validate_idviaje_cb);
  } // do_ajax_form_viaje_mob_validate_idviaje

  function do_ajax_form_viaje_mob_validate_idviaje_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_mob_validate_idviaje_cb

  // ---------- Validate idestado
  function do_ajax_form_viaje_mob_validate_idestado()
  {
    var nomeCampo_idestado = "idestado";
    var var_idestado = scAjaxGetFieldSelect(nomeCampo_idestado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_mob_validate_idestado(var_idestado, var_script_case_init, do_ajax_form_viaje_mob_validate_idestado_cb);
  } // do_ajax_form_viaje_mob_validate_idestado

  function do_ajax_form_viaje_mob_validate_idestado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_mob_validate_idestado_cb

  // ---------- Validate viaje
  function do_ajax_form_viaje_mob_validate_viaje()
  {
    var nomeCampo_viaje = "viaje";
    var var_viaje = scAjaxGetFieldText(nomeCampo_viaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_mob_validate_viaje(var_viaje, var_script_case_init, do_ajax_form_viaje_mob_validate_viaje_cb);
  } // do_ajax_form_viaje_mob_validate_viaje

  function do_ajax_form_viaje_mob_validate_viaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "viaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_mob_validate_viaje_cb

  // ---------- Validate fechaatraque
  function do_ajax_form_viaje_mob_validate_fechaatraque()
  {
    var nomeCampo_fechaatraque = "fechaatraque";
    var var_fechaatraque = scAjaxGetFieldText(nomeCampo_fechaatraque);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fechaatraque = scAjaxGetFieldText(nomeCampo_fechaatraque);
      x_ajax_form_viaje_mob_validate_fechaatraque(var_fechaatraque, var_script_case_init, do_ajax_form_viaje_mob_validate_fechaatraque_cb);
    }, 200);
  } // do_ajax_form_viaje_mob_validate_fechaatraque

  function do_ajax_form_viaje_mob_validate_fechaatraque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechaatraque";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_mob_validate_fechaatraque_cb

  // ---------- Validate fechazarpe
  function do_ajax_form_viaje_mob_validate_fechazarpe()
  {
    var nomeCampo_fechazarpe = "fechazarpe";
    var var_fechazarpe = scAjaxGetFieldText(nomeCampo_fechazarpe);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fechazarpe = scAjaxGetFieldText(nomeCampo_fechazarpe);
      x_ajax_form_viaje_mob_validate_fechazarpe(var_fechazarpe, var_script_case_init, do_ajax_form_viaje_mob_validate_fechazarpe_cb);
    }, 200);
  } // do_ajax_form_viaje_mob_validate_fechazarpe

  function do_ajax_form_viaje_mob_validate_fechazarpe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechazarpe";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_mob_validate_fechazarpe_cb

  // ---------- Validate idbuque
  function do_ajax_form_viaje_mob_validate_idbuque()
  {
  } // do_ajax_form_viaje_mob_validate_idbuque

  function do_ajax_form_viaje_mob_validate_idbuque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbuque";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_mob_validate_idbuque_cb

  // ---------- Validate idnaviera
  function do_ajax_form_viaje_mob_validate_idnaviera()
  {
    var nomeCampo_idnaviera = "idnaviera";
    var var_idnaviera = scAjaxGetFieldSelect(nomeCampo_idnaviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_mob_validate_idnaviera(var_idnaviera, var_script_case_init, do_ajax_form_viaje_mob_validate_idnaviera_cb);
  } // do_ajax_form_viaje_mob_validate_idnaviera

  function do_ajax_form_viaje_mob_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_mob_validate_idnaviera_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_viaje_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_viaje_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idviaje = scAjaxGetFieldHidden("idviaje");
    var var_idestado = scAjaxGetFieldSelect("idestado");
    var var_viaje = scAjaxGetFieldText("viaje");
    var var_fechaatraque = scAjaxGetFieldText("fechaatraque");
    var var_fechazarpe = scAjaxGetFieldText("fechazarpe");
    var var_idbuque = scAjaxGetFieldText("idbuque");
    ...
    scAjaxProcOn();
    x_ajax_form_viaje_mob_submit_form(var_idviaje, var_idestado, var_viaje, var_fechaatraque, var_fechazarpe, var_idbuque, var_idnaviera, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_viaje_mob_submit_form_cb);
  } // do_ajax_form_viaje_mob_submit_form

  function do_ajax_form_viaje_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("viaje");
      scAjaxHideErrorDisplay("fechaatraque");
      scAjaxHideErrorDisplay("fechazarpe");
      scAjaxHideErrorDisplay("idbuque");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_viaje_mob_submit_form_cb_after_alert);
  } // do_ajax_form_viaje_mob_submit_form_cb
  function do_ajax_form_viaje_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_viaje_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_viaje_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idbuque");
    scAjaxHideErrorDisplay("idnaviera");
    var var_idviaje = document.F2.idviaje.value;
    ...
    scAjaxProcOn();
    x_ajax_form_viaje_mob_navigate_form(var_idviaje, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_viaje_mob_navigate_form_cb);
  } // do_ajax_form_viaje_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_viaje_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_viaje_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idviaje.value = scAjaxGetKeyValue("idviaje");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_viaje_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_viaje_mob_navigate_form_cb
  function do_ajax_form_viaje_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_viaje_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_viaje_mob_navigate_form_cb_after_alert
  function sc_hide_form_viaje_mob_form()
  {
  ...
  ajax_field_list[0] = "idviaje";
  ajax_field_list[1] = "idestado";
  ajax_field_list[2] = "viaje";
  ajax_field_list[3] = "fechaatraque";
  ajax_field_list[4] = "fechazarpe";
  ajax_field_list[5] = "idbuque";
  ...
  var ajax_error_list = {
    ...
    "viaje": {"label": "Viaje", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechaatraque": {"label": "Fecha Atraque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechazarpe": {"label": "Fecha Zarpe", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idbuque": {"label": "Buque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "idestado": new Array(),
    "viaje": new Array(),
    "fechaatraque": new Array(),
    "fechazarpe": new Array(),
    "idbuque": new Array(),
    "idnaviera": new Array()
  };
  ...
  ajax_field_mult["fechaatraque"][1] = "fechaatraque";
  ajax_field_mult["fechazarpe"][1] = "fechazarpe";
  ajax_field_mult["idbuque"][1] = "idbuque";
  ...
  var ajax_field_id = {
    ...
    "fechaatraque": new Array("hidden_field_label_fechaatraque", "hidden_field_data_fechaatraque"),
    "fechazarpe": new Array("hidden_field_label_fechazarpe", "hidden_field_data_fechazarpe"),
    "idbuque": new Array("hidden_field_label_idbuque", "hidden_field_data_idbuque"),
