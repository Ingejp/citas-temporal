...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("Finalizar_Turno_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Finalizar_Turno_mob_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-placa", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_Finalizar_Turno_mob_event_placa_onchange) { do_ajax_Finalizar_Turno_mob_event_placa_onchange(sRow); }
    }
   }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['Finalizar_Turno']['error_buffer']) && '' != $_SESSION['scriptcase']['Finalizar_Turno']['error_buffer'])
{
    echo $_SESSION['scriptcase']['Finalizar_Turno']['error_buffer'];
}
...
<?php
 include_once("Finalizar_Turno_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="Finalizar_Turno_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['Finalizar_Turno_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Finalizar_Turno_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_carga_line" id="hidden_field_data_tipo_carga" style="<?php echo $sStyleHidden_tipo_carga; ?>"> <span class="scFormLabelOddFormat css_tipo_carga_label"><span id="id_label_tipo_carga"><?php echo $this->nm_new_label['tipo_carga']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_cita_line" id="hidden_field_data_id_cita" style="<?php echo $sStyleHidden_id_cita; ?>"> <span class="scFormLabelOddFormat css_id_cita_label"><span id="id_label_id_cita"><?php echo $this->nm_new_label['id_cita']; ?></span></span><br>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("Finalizar_Turno_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("Finalizar_Turno_mob");
 parent.scAjaxDetailHeight("Finalizar_Turno_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
