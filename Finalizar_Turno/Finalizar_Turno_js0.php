...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="Finalizar_Turno"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_CONCLUIR()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_CONCLUIR(); }, 500);
      return;
    }
    sc_btn_CONCLUIR_ok();
}
function sc_btn_CONCLUIR_cancel()
{
}
function sc_btn_CONCLUIR_ok()
{
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno']['where_detal']))
  {
?>  
...
{ 
   ...
   document.F4.action               = "Finalizar_Turno_fim.php";
   document.F4.submit(); 
} 
