  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Finalizar_Turno_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_Finalizar_Turno_mob_form();
	}

  // ---------- Validate placa
  function do_ajax_Finalizar_Turno_mob_validate_placa()
  {
  } // do_ajax_Finalizar_Turno_mob_validate_placa

  function do_ajax_Finalizar_Turno_mob_validate_placa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_placa_cb

  // ---------- Validate codigo_cita
  function do_ajax_Finalizar_Turno_mob_validate_codigo_cita()
  {
    var nomeCampo_codigo_cita = "codigo_cita";
    var var_codigo_cita = scAjaxGetFieldText(nomeCampo_codigo_cita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Finalizar_Turno_mob_validate_codigo_cita(var_codigo_cita, var_script_case_init, do_ajax_Finalizar_Turno_mob_validate_codigo_cita_cb);
  } // do_ajax_Finalizar_Turno_mob_validate_codigo_cita

  function do_ajax_Finalizar_Turno_mob_validate_codigo_cita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_codigo_cita_cb

  // ---------- Validate chasis
  function do_ajax_Finalizar_Turno_mob_validate_chasis()
  {
    var nomeCampo_chasis = "chasis";
    var var_chasis = scAjaxGetFieldText(nomeCampo_chasis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Finalizar_Turno_mob_validate_chasis(var_chasis, var_script_case_init, do_ajax_Finalizar_Turno_mob_validate_chasis_cb);
  } // do_ajax_Finalizar_Turno_mob_validate_chasis

  function do_ajax_Finalizar_Turno_mob_validate_chasis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "chasis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_chasis_cb

  // ---------- Validate piloto
  function do_ajax_Finalizar_Turno_mob_validate_piloto()
  {
    var nomeCampo_piloto = "piloto";
    var var_piloto = scAjaxGetFieldText(nomeCampo_piloto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Finalizar_Turno_mob_validate_piloto(var_piloto, var_script_case_init, do_ajax_Finalizar_Turno_mob_validate_piloto_cb);
  } // do_ajax_Finalizar_Turno_mob_validate_piloto

  function do_ajax_Finalizar_Turno_mob_validate_piloto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "piloto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_piloto_cb

  // ---------- Validate contenedor_exp
  function do_ajax_Finalizar_Turno_mob_validate_contenedor_exp()
  {
    var nomeCampo_contenedor_exp = "contenedor_exp";
    var var_contenedor_exp = scAjaxGetFieldText(nomeCampo_contenedor_exp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Finalizar_Turno_mob_validate_contenedor_exp(var_contenedor_exp, var_script_case_init, do_ajax_Finalizar_Turno_mob_validate_contenedor_exp_cb);
  } // do_ajax_Finalizar_Turno_mob_validate_contenedor_exp

  function do_ajax_Finalizar_Turno_mob_validate_contenedor_exp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_contenedor_exp_cb

  // ---------- Validate contenedor_imp
  function do_ajax_Finalizar_Turno_mob_validate_contenedor_imp()
  {
    var nomeCampo_contenedor_imp = "contenedor_imp";
    var var_contenedor_imp = scAjaxGetFieldText(nomeCampo_contenedor_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Finalizar_Turno_mob_validate_contenedor_imp(var_contenedor_imp, var_script_case_init, do_ajax_Finalizar_Turno_mob_validate_contenedor_imp_cb);
  } // do_ajax_Finalizar_Turno_mob_validate_contenedor_imp

  function do_ajax_Finalizar_Turno_mob_validate_contenedor_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_contenedor_imp_cb

  // ---------- Validate tipo_carga
  function do_ajax_Finalizar_Turno_mob_validate_tipo_carga()
  {
    var nomeCampo_tipo_carga = "tipo_carga";
    var var_tipo_carga = scAjaxGetFieldText(nomeCampo_tipo_carga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Finalizar_Turno_mob_validate_tipo_carga(var_tipo_carga, var_script_case_init, do_ajax_Finalizar_Turno_mob_validate_tipo_carga_cb);
  } // do_ajax_Finalizar_Turno_mob_validate_tipo_carga

  function do_ajax_Finalizar_Turno_mob_validate_tipo_carga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_tipo_carga_cb

  // ---------- Validate id_cita
  function do_ajax_Finalizar_Turno_mob_validate_id_cita()
  {
    var nomeCampo_id_cita = "id_cita";
    var var_id_cita = scAjaxGetFieldText(nomeCampo_id_cita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Finalizar_Turno_mob_validate_id_cita(var_id_cita, var_script_case_init, do_ajax_Finalizar_Turno_mob_validate_id_cita_cb);
  } // do_ajax_Finalizar_Turno_mob_validate_id_cita

  function do_ajax_Finalizar_Turno_mob_validate_id_cita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_cita";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Finalizar_Turno_mob_validate_id_cita_cb

  // ---------- Event onchange codigo_cita
  function do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange(var_codigo_cita, var_placa, var_id_cita, var_chasis, var_piloto, var_contenedor_exp, var_contenedor_imp, var_tipo_carga, var_script_case_init, do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange_cb);
  } // do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange

  function do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_cita";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange_cb_after_alert);
  } // do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange_cb
  function do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Finalizar_Turno_mob_event_codigo_cita_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_concluir
  function do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick()
  {
    var var_id_cita = scAjaxGetFieldText("id_cita");
    var var_placa = scAjaxGetFieldText("placa");
    var var_codigo_cita = scAjaxGetFieldText("codigo_cita");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick(var_id_cita, var_placa, var_codigo_cita, var_chasis, var_piloto, var_contenedor_exp, var_contenedor_imp, var_tipo_carga, var_script_case_init, do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick_cb);
  } // do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick

  function do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick_cb_after_alert);
  } // do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick_cb
  function do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Finalizar_Turno_mob_event_scajaxbutton_concluir_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Finalizar_Turno_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Finalizar_Turno_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_placa = scAjaxGetFieldText("placa");
    ...
    scAjaxProcOn();
    x_ajax_Finalizar_Turno_mob_submit_form(var_placa, var_codigo_cita, var_chasis, var_piloto, var_contenedor_exp, var_contenedor_imp, var_tipo_carga, var_id_cita, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Finalizar_Turno_mob_submit_form_cb);
  } // do_ajax_Finalizar_Turno_mob_submit_form

  function do_ajax_Finalizar_Turno_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Finalizar_Turno_mob_submit_form_cb_after_alert);
  } // do_ajax_Finalizar_Turno_mob_submit_form_cb
  function do_ajax_Finalizar_Turno_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Finalizar_Turno_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Finalizar_Turno_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Finalizar_Turno_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Finalizar_Turno_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Finalizar_Turno_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Finalizar_Turno_mob_navigate_form_cb_after_alert);
  } // do_ajax_Finalizar_Turno_mob_navigate_form_cb
  function do_ajax_Finalizar_Turno_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_Finalizar_Turno_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Finalizar_Turno_mob_navigate_form_cb_after_alert
  function sc_hide_Finalizar_Turno_mob_form()
  {
