  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_gestor_aduanal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_gestor_aduanal_form();
	}

  // ---------- Validate idgestor_aduanal_
  function do_ajax_form_gestor_aduanal_validate_idgestor_aduanal_(iNumLinha)
  {
    var nomeCampo_idgestor_aduanal_ = "idgestor_aduanal_" + iNumLinha;
    var var_idgestor_aduanal_ = scAjaxGetFieldHidden(nomeCampo_idgestor_aduanal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_aduanal_validate_idgestor_aduanal_(var_idgestor_aduanal_, iNumLinha, var_script_case_init, do_ajax_form_gestor_aduanal_validate_idgestor_aduanal__cb);
  } // do_ajax_form_gestor_aduanal_validate_idgestor_aduanal_

  function do_ajax_form_gestor_aduanal_validate_idgestor_aduanal__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idgestor_aduanal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idgestor_aduanal_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idgestor_aduanal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idgestor_aduanal_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_aduanal_validate_idgestor_aduanal__cb

  // ---------- Validate dpi_
  function do_ajax_form_gestor_aduanal_validate_dpi_(iNumLinha)
  {
    var nomeCampo_dpi_ = "dpi_" + iNumLinha;
    var var_dpi_ = scAjaxGetFieldText(nomeCampo_dpi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_aduanal_validate_dpi_(var_dpi_, iNumLinha, var_script_case_init, do_ajax_form_gestor_aduanal_validate_dpi__cb);
  } // do_ajax_form_gestor_aduanal_validate_dpi_

  function do_ajax_form_gestor_aduanal_validate_dpi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dpi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dpi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_aduanal_validate_dpi__cb

  // ---------- Validate nombre_
  function do_ajax_form_gestor_aduanal_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_aduanal_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_gestor_aduanal_validate_nombre__cb);
  } // do_ajax_form_gestor_aduanal_validate_nombre_

  function do_ajax_form_gestor_aduanal_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_aduanal_validate_nombre__cb

  // ---------- Validate telefono1_
  function do_ajax_form_gestor_aduanal_validate_telefono1_(iNumLinha)
  {
    var nomeCampo_telefono1_ = "telefono1_" + iNumLinha;
    var var_telefono1_ = scAjaxGetFieldText(nomeCampo_telefono1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_aduanal_validate_telefono1_(var_telefono1_, iNumLinha, var_script_case_init, do_ajax_form_gestor_aduanal_validate_telefono1__cb);
  } // do_ajax_form_gestor_aduanal_validate_telefono1_

  function do_ajax_form_gestor_aduanal_validate_telefono1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "telefono1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "telefono1_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "telefono1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "telefono1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_aduanal_validate_telefono1__cb

  // ---------- Validate telefono2_
  function do_ajax_form_gestor_aduanal_validate_telefono2_(iNumLinha)
  {
    var nomeCampo_telefono2_ = "telefono2_" + iNumLinha;
    var var_telefono2_ = scAjaxGetFieldText(nomeCampo_telefono2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_aduanal_validate_telefono2_(var_telefono2_, iNumLinha, var_script_case_init, do_ajax_form_gestor_aduanal_validate_telefono2__cb);
  } // do_ajax_form_gestor_aduanal_validate_telefono2_

  function do_ajax_form_gestor_aduanal_validate_telefono2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "telefono2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "telefono2_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "telefono2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "telefono2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_gestor_aduanal_validate_telefono2__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_gestor_aduanal_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_gestor_aduanal_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_gestor_aduanal_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_gestor_aduanal_add_new_line_cb);
  } // do_ajax_form_gestor_aduanal_add_new_line

  function do_ajax_form_gestor_aduanal_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_gestor_aduanal_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_gestor_aduanal_backup_line(iNumLinha)
  {
    var var_idgestor_aduanal_ = scAjaxGetFieldHidden("idgestor_aduanal_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_gestor_aduanal_backup_line(var_idgestor_aduanal_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_gestor_aduanal_backup_line_cb);
  } // do_ajax_form_gestor_aduanal_backup_line

  function do_ajax_form_gestor_aduanal_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_gestor_aduanal_backup_line_cb

  function do_ajax_form_gestor_aduanal_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_gestor_aduanal_cancel_insert

  function do_ajax_form_gestor_aduanal_cancel_update(iSeqVert)
  {
    do_ajax_form_gestor_aduanal_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_gestor_aduanal_cancel_update

  function do_ajax_form_gestor_aduanal_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_gestor_aduanal_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_gestor_aduanal_table_refresh()
  {
    var var_idgestor_aduanal_ = document.F2.idgestor_aduanal_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_gestor_aduanal_table_refresh(var_idgestor_aduanal_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_gestor_aduanal_table_refresh_cb);
  } //  do_ajax_form_gestor_aduanal_table_refresh

  function do_ajax_form_gestor_aduanal_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idgestor_aduanal_.value = scAjaxGetKeyValue("idgestor_aduanal_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_gestor_aduanal_table_refresh_cb_after_alert);
  } // do_ajax_form_gestor_aduanal_table_refresh_cb
  function do_ajax_form_gestor_aduanal_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_gestor_aduanal_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_gestor_aduanal_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_gestor_aduanal_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idgestor_aduanal_ = scAjaxGetFieldHidden("idgestor_aduanal_" + iNumLinha);
    var var_dpi_ = scAjaxGetFieldText("dpi_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_telefono1_ = scAjaxGetFieldText("telefono1_" + iNumLinha);
    var var_telefono2_ = scAjaxGetFieldText("telefono2_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_gestor_aduanal_submit_form(var_idgestor_aduanal_, var_dpi_, var_nombre_, var_telefono1_, var_telefono2_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_gestor_aduanal_submit_form_cb);
  } // do_ajax_form_gestor_aduanal_submit_form

  function do_ajax_form_gestor_aduanal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idgestor_aduanal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dpi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("telefono1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("telefono2_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_gestor_aduanal_submit_form_cb_after_alert);
  } // do_ajax_form_gestor_aduanal_submit_form_cb
  function do_ajax_form_gestor_aduanal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_gestor_aduanal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_gestor_aduanal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_gestor_aduanal_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idgestor_aduanal_" + iNavForm);
      scAjaxHideErrorDisplay("dpi_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("telefono1_" + iNavForm);
      scAjaxHideErrorDisplay("telefono2_" + iNavForm);
    }
    var var_idgestor_aduanal_ = document.F2.idgestor_aduanal_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_gestor_aduanal_navigate_form(var_idgestor_aduanal_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_gestor_aduanal_navigate_form_cb);
  } // do_ajax_form_gestor_aduanal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_gestor_aduanal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_gestor_aduanal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idgestor_aduanal_.value = scAjaxGetKeyValue("idgestor_aduanal_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_gestor_aduanal_navigate_form_cb_after_alert);
  } // do_ajax_form_gestor_aduanal_navigate_form_cb
  function do_ajax_form_gestor_aduanal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_gestor_aduanal_navigate_form_cb_after_alert
  function sc_hide_form_gestor_aduanal_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idgestor_aduanal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dpi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "telefono1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "telefono2_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idgestor_aduanal_" + iNumLinha] = {"label": "COD<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dpi_" + iNumLinha] = {"label": "DPI<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["telefono1_" + iNumLinha] = {"label": "TELEFONO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["telefono2_" + iNumLinha] = {"label": "TELEFONO 2<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idgestor_aduanal_"][iNumLinha] = "idgestor_aduanal_" + iNumLinha;
    ajax_field_mult["dpi_"][iNumLinha] = "dpi_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["telefono1_"][iNumLinha] = "telefono1_" + iNumLinha;
    ajax_field_mult["telefono2_"][iNumLinha] = "telefono2_" + iNumLinha;
    ajax_field_id["idgestor_aduanal_" + iNumLinha] = new Array("hidden_field_label_idgestor_aduanal_", "hidden_field_data_idgestor_aduanal_" + iNumLinha);
    ajax_field_id["dpi_" + iNumLinha] = new Array("hidden_field_label_dpi_", "hidden_field_data_dpi_" + iNumLinha);
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_field_id["telefono1_" + iNumLinha] = new Array("hidden_field_label_telefono1_", "hidden_field_data_telefono1_" + iNumLinha);
    ajax_field_id["telefono2_" + iNumLinha] = new Array("hidden_field_label_telefono2_", "hidden_field_data_telefono2_" + iNumLinha);
    ajax_error_count["idgestor_aduanal_" + iNumLinha] = "off";
    ajax_error_count["dpi_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["telefono1_" + iNumLinha] = "off";
    ajax_error_count["telefono2_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idgestor_aduanal_" + iNumLinha] = "on";
    ajax_read_only["dpi_" + iNumLinha] = "off";
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["telefono1_" + iNumLinha] = "off";
    ajax_read_only["telefono2_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idgestor_aduanal_" + iNumLinha] = "on";
    ajax_read_only["dpi_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["telefono1_" + iNumLinha] = "on";
    ajax_read_only["telefono2_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idgestor_aduanal_" + iNumLinha] = null;
    ajax_error_list["dpi_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["telefono1_" + iNumLinha] = null;
    ajax_error_list["telefono2_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idgestor_aduanal_": new Array(),
    "dpi_": new Array(),
    "nombre_": new Array(),
    "telefono1_": new Array(),
    "telefono2_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idgestor_aduanal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idgestor_aduanal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idgestor_aduanal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idgestor_aduanal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idgestor_aduanal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dpi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dpi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dpi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dpi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dpi_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["telefono1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["telefono1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["telefono1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["telefono1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["telefono1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["telefono2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["telefono2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["telefono2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["telefono2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["telefono2_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idgestor_aduanal_'])) ? $this->nmgp_cmp_readonly['idgestor_aduanal_'] : 'on';
?>
    scAjaxFieldRead("idgestor_aduanal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dpi_'])) ? $this->nmgp_cmp_readonly['dpi_'] : 'off';
?>
    scAjaxFieldRead("dpi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['telefono1_'])) ? $this->nmgp_cmp_readonly['telefono1_'] : 'off';
?>
    scAjaxFieldRead("telefono1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['telefono2_'])) ? $this->nmgp_cmp_readonly['telefono2_'] : 'off';
?>
    scAjaxFieldRead("telefono2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idgestor_aduanal_" + iSeq, "on");
    scAjaxFieldRead("dpi_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("telefono1_" + iSeq, "on");
    scAjaxFieldRead("telefono2_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idgestor_aduanal_" + iRow] || "on" == ajax_error_count["dpi_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["telefono1_" + iRow] || "on" == ajax_error_count["telefono2_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idgestor_aduanal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dpi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_telefono1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_telefono2_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idgestor_aduanal_" + iRow] && "off" == ajax_error_count["dpi_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["telefono1_" + iRow] && "off" == ajax_error_count["telefono2_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idgestor_aduanal_" + iRow] = "off";
        ajax_error_count["dpi_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["telefono1_" + iRow] = "off";
        ajax_error_count["telefono2_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idgestor_aduanal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dpi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_telefono1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_telefono2_" + iRow).removeClass("scFormErrorLine");
    }
  }
