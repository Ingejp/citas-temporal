...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_cita' + iSeqRow).bind('blur', function() { sc_form_cita_2_codigo_cita_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cita_2_codigo_cita_onfocus(this, iSeqRow) });
  $('#id_sc_field_contenedorimport' + iSeqRow).bind('blur', function() { sc_form_cita_2_contenedorimport_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_cita_2_contenedorimport_onfocus(this, iSeqRow) });
  $('#id_sc_field_contenedorexport' + iSeqRow).bind('blur', function() { sc_form_cita_2_contenedorexport_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_cita_2_contenedorexport_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechainicio' + iSeqRow).bind('blur', function() { sc_form_cita_2_fechainicio_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cita_2_fechainicio_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechainicio_hora' + iSeqRow).bind('blur', function() { sc_form_cita_2_fechainicio_hora_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_cita_2_fechainicio_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_chasis' + iSeqRow).bind('blur', function() { sc_form_cita_2_chasis_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_cita_2_chasis_onfocus(this, iSeqRow) });
  $('#id_sc_field_idnaviera' + iSeqRow).bind('blur', function() { sc_form_cita_2_idnaviera_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_cita_2_idnaviera_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_cita_2_idnaviera_onfocus(this, iSeqRow) });
  $('#id_sc_field_idtipodecarga' + iSeqRow).bind('blur', function() { sc_form_cita_2_idtipodecarga_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_cita_2_idtipodecarga_onfocus(this, iSeqRow) });
  $('#id_sc_field_idestado' + iSeqRow).bind('blur', function() { sc_form_cita_2_idestado_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_cita_2_idestado_onfocus(this, iSeqRow) });
  $('#id_sc_field_idpiloto' + iSeqRow).bind('blur', function() { sc_form_cita_2_idpiloto_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_cita_2_idpiloto_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_cita_2_idpiloto_onfocus(this, iSeqRow) });
  $('#id_sc_field_idcabezal' + iSeqRow).bind('blur', function() { sc_form_cita_2_idcabezal_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_cita_2_idcabezal_onfocus(this, iSeqRow) });
  $('#id_sc_field_idselectivo' + iSeqRow).bind('blur', function() { sc_form_cita_2_idselectivo_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cita_2_idselectivo_onfocus(this, iSeqRow) });
  $('#id_sc_field_idyarda' + iSeqRow).bind('blur', function() { sc_form_cita_2_idyarda_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_cita_2_idyarda_onfocus(this, iSeqRow) });
  $('#id_sc_field_idtipomovimiento' + iSeqRow).bind('blur', function() { sc_form_cita_2_idtipomovimiento_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_cita_2_idtipomovimiento_onfocus(this, iSeqRow) });
  $('#id_sc_field_idviaje' + iSeqRow).bind('blur', function() { sc_form_cita_2_idviaje_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_cita_2_idviaje_onfocus(this, iSeqRow) });
  $('#id_sc_field_atc_ingreso' + iSeqRow).bind('blur', function() { sc_form_cita_2_atc_ingreso_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cita_2_atc_ingreso_onfocus(this, iSeqRow) });
  $('#id_sc_field_marchamo_ingreso' + iSeqRow).bind('blur', function() { sc_form_cita_2_marchamo_ingreso_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_cita_2_marchamo_ingreso_onfocus(this, iSeqRow) });
  $('#id_sc_field_atc_despacho' + iSeqRow).bind('blur', function() { sc_form_cita_2_atc_despacho_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_cita_2_atc_despacho_onfocus(this, iSeqRow) });
  $('#id_sc_field_marchamo_despacho' + iSeqRow).bind('blur', function() { sc_form_cita_2_marchamo_despacho_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_cita_2_marchamo_despacho_onfocus(this, iSeqRow) });
  $('#id_sc_field_sec_users_login' + iSeqRow).bind('blur', function() { sc_form_cita_2_sec_users_login_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_cita_2_sec_users_login_onfocus(this, iSeqRow) });
  $('#id_sc_field_turno' + iSeqRow).bind('blur', function() { sc_form_cita_2_turno_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_cita_2_turno_onfocus(this, iSeqRow) });
  $('#id_sc_field_piloto' + iSeqRow).bind('blur', function() { sc_form_cita_2_piloto_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_cita_2_piloto_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_qr' + iSeqRow).bind('blur', function() { sc_form_cita_2_tipo_qr_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_cita_2_tipo_qr_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_cita_2_tipo_qr_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_cita_2_codigo_cita_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_codigo_cita();
  scCssBlur(oThis);
}

function sc_form_cita_2_codigo_cita_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_contenedorimport_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_contenedorimport();
  scCssBlur(oThis);
}

function sc_form_cita_2_contenedorimport_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_contenedorexport_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_contenedorexport();
  scCssBlur(oThis);
}

function sc_form_cita_2_contenedorexport_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_fechainicio_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_fechainicio();
  scCssBlur(oThis);
}

function sc_form_cita_2_fechainicio_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_fechainicio();
  scCssBlur(oThis);
}

function sc_form_cita_2_fechainicio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_fechainicio_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_chasis_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_chasis();
  scCssBlur(oThis);
}

function sc_form_cita_2_chasis_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_idnaviera_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idnaviera();
  scCssBlur(oThis);
}

function sc_form_cita_2_idnaviera_onchange(oThis, iSeqRow) {
  do_ajax_form_cita_2_event_idnaviera_onchange();
}

function sc_form_cita_2_idnaviera_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_idtipodecarga_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idtipodecarga();
  scCssBlur(oThis);
}

function sc_form_cita_2_idtipodecarga_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_idestado_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idestado();
  scCssBlur(oThis);
}

function sc_form_cita_2_idestado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_idpiloto_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idpiloto();
  scCssBlur(oThis);
}

function sc_form_cita_2_idpiloto_onchange(oThis, iSeqRow) {
  do_ajax_form_cita_2_event_idpiloto_onchange();
}

function sc_form_cita_2_idpiloto_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_cita_2_idcabezal_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idcabezal();
  scCssBlur(oThis);
}

function sc_form_cita_2_idcabezal_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_cita_2_idselectivo_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idselectivo();
  scCssBlur(oThis);
}

function sc_form_cita_2_idselectivo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_idyarda_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idyarda();
  scCssBlur(oThis);
}

function sc_form_cita_2_idyarda_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_idtipomovimiento_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idtipomovimiento();
  scCssBlur(oThis);
}

function sc_form_cita_2_idtipomovimiento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_idviaje_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_idviaje();
  scCssBlur(oThis);
}

function sc_form_cita_2_idviaje_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_cita_2_atc_ingreso_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_atc_ingreso();
  scCssBlur(oThis);
}

function sc_form_cita_2_atc_ingreso_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_marchamo_ingreso_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_marchamo_ingreso();
  scCssBlur(oThis);
}

function sc_form_cita_2_marchamo_ingreso_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_atc_despacho_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_atc_despacho();
  scCssBlur(oThis);
}

function sc_form_cita_2_atc_despacho_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_marchamo_despacho_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_marchamo_despacho();
  scCssBlur(oThis);
}

function sc_form_cita_2_marchamo_despacho_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_sec_users_login_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_sec_users_login();
  scCssBlur(oThis);
}

function sc_form_cita_2_sec_users_login_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_turno_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_turno();
  scCssBlur(oThis);
}

function sc_form_cita_2_turno_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_piloto_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_piloto();
  scCssBlur(oThis);
}

function sc_form_cita_2_piloto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cita_2_tipo_qr_onblur(oThis, iSeqRow) {
  do_ajax_form_cita_2_validate_tipo_qr();
  scCssBlur(oThis);
}

function sc_form_cita_2_tipo_qr_onchange(oThis, iSeqRow) {
  do_ajax_form_cita_2_event_tipo_qr_onchange();
}

function sc_form_cita_2_tipo_qr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_cita_2_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechainicio" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cita_2_validate_fechainicio(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
