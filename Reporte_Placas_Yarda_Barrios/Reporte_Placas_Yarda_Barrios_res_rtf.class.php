...
class Reporte_Placas_Yarda_Barrios_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['arr_export']['data'];
