<?php
@session_start() ;
$_SESSION['scriptcase']['Reporte_Placas_Yarda_Barrios']['sc_process_barr'] = true;
require_once('../Reporte_Placas_Yarda_Barrios/index.php');
unset($_SESSION['scriptcase']['Reporte_Placas_Yarda_Barrios']['sc_process_barr']);
$ExportCtrl = new Reporte_Placas_Yarda_Barrios_export_control;
$ExportCtrl->Export_barr();

class Reporte_Placas_Yarda_Barrios_export_control
{
