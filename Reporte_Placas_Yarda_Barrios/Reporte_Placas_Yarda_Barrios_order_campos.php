...
<?php
   ...
   $Ord_Cmp = new Reporte_Placas_Yarda_Barrios_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Reporte_Placas_Yarda_Barrios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['fechamayor'] = "FechaMayor";
   $tab_labels["fechamayor"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["fechamayor"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["fechamayor"] : "INGRESO AL PUERTO";
   $tab_ger_campos['total_horas'] = "on";
   $tab_def_campos['total_horas'] = "Total_Horas";
   $tab_labels["total_horas"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["total_horas"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["total_horas"] : "TOTAL HORAS";
   $tab_ger_campos['placa'] = "on";
   $tab_def_campos['placa'] = "placa";
   $tab_labels["placa"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["placa"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["placa"] : "PLACA";
   $tab_ger_campos['idtransporte'] = "on";
   $tab_def_campos['idtransporte'] = "idTransporte";
   $tab_labels["idtransporte"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["idtransporte"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["idtransporte"] : "TRANSPORTE";
   $tab_ger_campos['contenedorimport'] = "on";
   $tab_def_campos['contenedorimport'] = "contenedorimport";
   $tab_labels["contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["contenedorimport"] : "CONT. IMP";
   $tab_ger_campos['contenedorexport'] = "on";
   $tab_def_campos['contenedorexport'] = "contenedorExport";
   $tab_labels["contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["contenedorexport"] : "CONT. EXP";
   $tab_ger_campos['naviera'] = "on";
   $tab_def_campos['naviera'] = "naviera";
   $tab_labels["naviera"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["naviera"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["naviera"] : "NAVIERA";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["observaciones"] : "OBSERVACIONES";
   $tab_ger_campos['codigo_cita'] = "on";
   $tab_def_campos['codigo_cita'] = "codigo_cita";
   $tab_labels["codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['labels']["codigo_cita"] : "CODIGO CITA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Reporte_Placas_Yarda_Barrios_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Reporte_Placas_Yarda_Barrios']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
