...
class Reporte_Placas_Yarda_Barrios_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          { 
              ...
              $this->Res_xls = new Reporte_Placas_Yarda_Barrios_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_Reporte_Placas_Yarda_Barrios.zip";
          $this->Arquivo   .= "_Reporte_Placas_Yarda_Barrios" . $this->Xls_tp;
          $this->Tit_doc    = "Reporte_Placas_Yarda_Barrios" . $this->Xls_tp;
          $this->Tit_zip    = "Reporte_Placas_Yarda_Barrios.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_fechamayor()
   {
      ...
      if (!empty($this->fechamayor))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fechamayor, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fechamayor, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- total_horas
   function NM_export_total_horas()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->total_horas, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->total_horas, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- placa
   ...
   function NM_export_idtransporte()
   {
      ...
      if (!empty($this->idtransporte))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_idtransporte, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_idtransporte, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- contenedorimport
   ...
   //----- fechamayor
   function NM_sub_cons_fechamayor()
   {
      if (!empty($this->fechamayor))
      {
         if (substr($this->fechamayor, 10, 1) == "-") 
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fechamayor;
   ...
   //----- total_horas
   function NM_sub_cons_total_horas()
   {
         $this->total_horas = html_entity_decode($this->total_horas, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->total_horas = strip_tags($this->total_horas);
         if (!NM_is_utf8($this->total_horas))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->total_horas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>PLACAS EN YARDA BARRIOS :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Placas_Yarda_Barrios']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
