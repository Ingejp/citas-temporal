  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_naviera" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_naviera_form();
	}

  // ---------- Validate idnaviera_
  function do_ajax_form_naviera_validate_idnaviera_(iNumLinha)
  {
    var nomeCampo_idnaviera_ = "idnaviera_" + iNumLinha;
    var var_idnaviera_ = scAjaxGetFieldHidden(nomeCampo_idnaviera_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_naviera_validate_idnaviera_(var_idnaviera_, iNumLinha, var_script_case_init, do_ajax_form_naviera_validate_idnaviera__cb);
  } // do_ajax_form_naviera_validate_idnaviera_

  function do_ajax_form_naviera_validate_idnaviera__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idnaviera_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idnaviera_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idnaviera_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idnaviera_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_naviera_validate_idnaviera__cb

  // ---------- Validate naviera_
  function do_ajax_form_naviera_validate_naviera_(iNumLinha)
  {
    var nomeCampo_naviera_ = "naviera_" + iNumLinha;
    var var_naviera_ = scAjaxGetFieldText(nomeCampo_naviera_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_naviera_validate_naviera_(var_naviera_, iNumLinha, var_script_case_init, do_ajax_form_naviera_validate_naviera__cb);
  } // do_ajax_form_naviera_validate_naviera_

  function do_ajax_form_naviera_validate_naviera__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "naviera_" + iLineNumber;
    }
    else
    {
      sFieldValid = "naviera_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "naviera_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "naviera_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_naviera_validate_naviera__cb

  // ---------- Validate descripcion_larga_
  function do_ajax_form_naviera_validate_descripcion_larga_(iNumLinha)
  {
    var nomeCampo_descripcion_larga_ = "descripcion_larga_" + iNumLinha;
    var var_descripcion_larga_ = scAjaxGetFieldText(nomeCampo_descripcion_larga_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_naviera_validate_descripcion_larga_(var_descripcion_larga_, iNumLinha, var_script_case_init, do_ajax_form_naviera_validate_descripcion_larga__cb);
  } // do_ajax_form_naviera_validate_descripcion_larga_

  function do_ajax_form_naviera_validate_descripcion_larga__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descripcion_larga_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descripcion_larga_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descripcion_larga_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descripcion_larga_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_naviera_validate_descripcion_larga__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_naviera_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_naviera_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_naviera_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_naviera_add_new_line_cb);
  } // do_ajax_form_naviera_add_new_line

  function do_ajax_form_naviera_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_naviera_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_naviera_backup_line(iNumLinha)
  {
    var var_idnaviera_ = scAjaxGetFieldHidden("idnaviera_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_naviera_backup_line(var_idnaviera_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_naviera_backup_line_cb);
  } // do_ajax_form_naviera_backup_line

  function do_ajax_form_naviera_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_naviera_backup_line_cb

  function do_ajax_form_naviera_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_naviera_cancel_insert

  function do_ajax_form_naviera_cancel_update(iSeqVert)
  {
    do_ajax_form_naviera_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_naviera_cancel_update

  function do_ajax_form_naviera_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_naviera_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_naviera_table_refresh()
  {
    var var_idnaviera_ = document.F2.idnaviera_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_naviera_table_refresh(var_idnaviera_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_naviera_table_refresh_cb);
  } //  do_ajax_form_naviera_table_refresh

  function do_ajax_form_naviera_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idnaviera_.value = scAjaxGetKeyValue("idnaviera_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_naviera_table_refresh_cb_after_alert);
  } // do_ajax_form_naviera_table_refresh_cb
  function do_ajax_form_naviera_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_naviera_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_naviera_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_naviera_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idnaviera_ = scAjaxGetFieldHidden("idnaviera_" + iNumLinha);
    var var_naviera_ = scAjaxGetFieldText("naviera_" + iNumLinha);
    var var_descripcion_larga_ = scAjaxGetFieldText("descripcion_larga_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_naviera_submit_form(var_idnaviera_, var_naviera_, var_descripcion_larga_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_naviera_submit_form_cb);
  } // do_ajax_form_naviera_submit_form

  function do_ajax_form_naviera_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idnaviera_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("naviera_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_larga_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_naviera_submit_form_cb_after_alert);
  } // do_ajax_form_naviera_submit_form_cb
  function do_ajax_form_naviera_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_naviera_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_naviera_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_naviera_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idnaviera_" + iNavForm);
      scAjaxHideErrorDisplay("naviera_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_larga_" + iNavForm);
    }
    var var_idnaviera_ = document.F2.idnaviera_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_naviera_navigate_form(var_idnaviera_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_naviera_navigate_form_cb);
  } // do_ajax_form_naviera_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_naviera']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_naviera_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idnaviera_.value = scAjaxGetKeyValue("idnaviera_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_naviera_navigate_form_cb_after_alert);
  } // do_ajax_form_naviera_navigate_form_cb
  function do_ajax_form_naviera_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_naviera_navigate_form_cb_after_alert
  function sc_hide_form_naviera_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idnaviera_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "naviera_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_larga_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idnaviera_" + iNumLinha] = {"label": "Id Naviera<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["naviera_" + iNumLinha] = {"label": "Naviera<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["descripcion_larga_" + iNumLinha] = {"label": "Descripcion Larga<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idnaviera_"][iNumLinha] = "idnaviera_" + iNumLinha;
    ajax_field_mult["naviera_"][iNumLinha] = "naviera_" + iNumLinha;
    ajax_field_mult["descripcion_larga_"][iNumLinha] = "descripcion_larga_" + iNumLinha;
    ajax_field_id["idnaviera_" + iNumLinha] = new Array("hidden_field_label_idnaviera_", "hidden_field_data_idnaviera_" + iNumLinha);
    ajax_field_id["naviera_" + iNumLinha] = new Array("hidden_field_label_naviera_", "hidden_field_data_naviera_" + iNumLinha);
    ajax_field_id["descripcion_larga_" + iNumLinha] = new Array("hidden_field_label_descripcion_larga_", "hidden_field_data_descripcion_larga_" + iNumLinha);
    ajax_error_count["idnaviera_" + iNumLinha] = "off";
    ajax_error_count["naviera_" + iNumLinha] = "off";
    ajax_error_count["descripcion_larga_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idnaviera_" + iNumLinha] = "on";
    ajax_read_only["naviera_" + iNumLinha] = "off";
    ajax_read_only["descripcion_larga_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idnaviera_" + iNumLinha] = "on";
    ajax_read_only["naviera_" + iNumLinha] = "on";
    ajax_read_only["descripcion_larga_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idnaviera_" + iNumLinha] = null;
    ajax_error_list["naviera_" + iNumLinha] = null;
    ajax_error_list["descripcion_larga_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idnaviera_": new Array(),
    "naviera_": new Array(),
    "descripcion_larga_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idnaviera_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idnaviera_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idnaviera_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idnaviera_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idnaviera_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["naviera_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["naviera_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["naviera_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["naviera_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["naviera_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["descripcion_larga_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descripcion_larga_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descripcion_larga_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descripcion_larga_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descripcion_larga_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idnaviera_'])) ? $this->nmgp_cmp_readonly['idnaviera_'] : 'on';
?>
    scAjaxFieldRead("idnaviera_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['naviera_'])) ? $this->nmgp_cmp_readonly['naviera_'] : 'off';
?>
    scAjaxFieldRead("naviera_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descripcion_larga_'])) ? $this->nmgp_cmp_readonly['descripcion_larga_'] : 'off';
?>
    scAjaxFieldRead("descripcion_larga_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idnaviera_" + iSeq, "on");
    scAjaxFieldRead("naviera_" + iSeq, "on");
    scAjaxFieldRead("descripcion_larga_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idnaviera_" + iRow] || "on" == ajax_error_count["naviera_" + iRow] || "on" == ajax_error_count["descripcion_larga_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idnaviera_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_naviera_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_larga_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idnaviera_" + iRow] && "off" == ajax_error_count["naviera_" + iRow] && "off" == ajax_error_count["descripcion_larga_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idnaviera_" + iRow] = "off";
        ajax_error_count["naviera_" + iRow] = "off";
        ajax_error_count["descripcion_larga_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idnaviera_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_naviera_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_larga_" + iRow).removeClass("scFormErrorLine");
    }
  }
