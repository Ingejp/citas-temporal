<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_path_doc']        = "";
...
<?php
      ...
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/sec_form_sec_groups_apps_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/sec_form_sec_groups_apps_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/sec_form_sec_groups_apps_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/sec_form_sec_groups_apps_ini.txt");
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_search_sec_groups']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_search_sec_groups']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_search_sec_groups']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_search_sec_groups']['label'] = "" . $this->Ini->Nm_lang['lang_othr_srch_titl'] . " - sec_groups";
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'CITASPB'); 
      } 
      else 
      { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sec_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['sec_search_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   if (isset($group)) 
