...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecha_solicitud_hora' + iSeqRow).bind('blur', function() { sc_form_revision_fecha_solicitud_hora_onblur(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_revision_fecha_solicitud_hora_onfocus(this, iSeqRow) });
...
function sc_form_revision_fecha_solicitud_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_revision_validate_fecha_solicitud();
  scCssBlur(oThis);
}
...
function sc_form_revision_fecha_solicitud_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_revision_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_solicitud" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_revision_validate_fecha_solicitud(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
