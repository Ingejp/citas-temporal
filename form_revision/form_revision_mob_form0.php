...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_revision_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_revision_mob_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idcabezal", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_revision_mob_event_idcabezal_onchange) { do_ajax_form_revision_mob_event_idcabezal_onchange(sRow); }
    }
   }
  ...
  $(".sc-ui-autocomp-idgestor_aduanal", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_revision_mob_event_idgestor_aduanal_onchange) { do_ajax_form_revision_mob_event_idgestor_aduanal_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-idconsignatario", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_revision_mob_event_idconsignatario_onchange) { do_ajax_form_revision_mob_event_idconsignatario_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-idcontenido", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_revision_mob_event_idcontenido_onchange) { do_ajax_form_revision_mob_event_idcontenido_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-idfuncionario", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_revision_mob_event_idfuncionario_onchange) { do_ajax_form_revision_mob_event_idfuncionario_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-idviaje_importacion", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_revision_mob_event_idviaje_importacion_onchange) { do_ajax_form_revision_mob_event_idviaje_importacion_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_revision']['error_buffer']) && '' != $_SESSION['scriptcase']['form_revision']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_revision']['error_buffer'];
}
...
<?php
 include_once("form_revision_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_revision_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_revision_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_revision_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnFn_sys_format_cnl()", "scBtnFn_sys_format_cnl()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-10", "", "group_2");?>
  </div>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-18", "", "");?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_solicitud_line" id="hidden_field_data_fecha_solicitud" style="<?php echo $sStyleHidden_fecha_solicitud; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_solicitud_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_solicitud_label"><span id="id_label_fecha_solicitud"><?php echo $this->nm_new_label['fecha_solicitud']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['fecha_solicitud']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['fecha_solicitud'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="fecha_solicitud" value="<?php echo $this->form_encode_input($fecha_solicitud); ?>"><span id="id_ajax_label_fecha_solicitud"><?php echo nl2br($fecha_solicitud); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idregimen_aduanero_line" id="hidden_field_data_idregimen_aduanero" style="<?php echo $sStyleHidden_idregimen_aduanero; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idregimen_aduanero_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idregimen_aduanero_label"><span id="id_label_idregimen_aduanero"><?php echo $this->nm_new_label['idregimen_aduanero']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idregimen_aduanero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idregimen_aduanero'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['Lookup_maga'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['Lookup_sgaia'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['Lookup_sat'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['Lookup_dipafront'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['Lookup_ucc'][] = '1'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idnaviera_line" id="hidden_field_data_idnaviera" style="<?php echo $sStyleHidden_idnaviera; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idnaviera_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idnaviera_label"><span id="id_label_idnaviera"><?php echo $this->nm_new_label['idnaviera']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idnaviera']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idnaviera'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idselectivo_line" id="hidden_field_data_idselectivo" style="<?php echo $sStyleHidden_idselectivo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idselectivo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idselectivo_label"><span id="id_label_idselectivo"><?php echo $this->nm_new_label['idselectivo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idselectivo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idselectivo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idtipodecarga_line" id="hidden_field_data_idtipodecarga" style="<?php echo $sStyleHidden_idtipodecarga; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtipodecarga_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idtipodecarga_label"><span id="id_label_idtipodecarga"><?php echo $this->nm_new_label['idtipodecarga']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idtipodecarga']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idtipodecarga'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bl_line" id="hidden_field_data_bl" style="<?php echo $sStyleHidden_bl; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bl_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bl_label"><span id="id_label_bl"><?php echo $this->nm_new_label['bl']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['bl']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['bl'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantidad_por_bl_line" id="hidden_field_data_cantidad_por_bl" style="<?php echo $sStyleHidden_cantidad_por_bl; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cantidad_por_bl_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cantidad_por_bl_label"><span id="id_label_cantidad_por_bl"><?php echo $this->nm_new_label['cantidad_por_bl']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['cantidad_por_bl']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['cantidad_por_bl'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idviaje_importacion_line" id="hidden_field_data_idviaje_importacion" style="<?php echo $sStyleHidden_idviaje_importacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idviaje_importacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idviaje_importacion_label"><span id="id_label_idviaje_importacion"><?php echo $this->nm_new_label['idviaje_importacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idviaje_importacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idviaje_importacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_iddestino_line" id="hidden_field_data_iddestino" style="<?php echo $sStyleHidden_iddestino; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_iddestino_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_iddestino_label"><span id="id_label_iddestino"><?php echo $this->nm_new_label['iddestino']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['iddestino']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['iddestino'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idgestor_aduanal_line" id="hidden_field_data_idgestor_aduanal" style="<?php echo $sStyleHidden_idgestor_aduanal; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idgestor_aduanal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idgestor_aduanal_label"><span id="id_label_idgestor_aduanal"><?php echo $this->nm_new_label['idgestor_aduanal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idgestor_aduanal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['php_cmp_required']['idgestor_aduanal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_codigo_revision_line" id="hidden_field_data_codigo_revision" style="<?php echo $sStyleHidden_codigo_revision; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_revision_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_revision_label"><span id="id_label_codigo_revision"><?php echo $this->nm_new_label['codigo_revision']; ?></span></span><br><span id="id_read_on_codigo_revision" class="css_codigo_revision_line" style="<?php echo $sStyleReadLab_codigo_revision; ?>"><?php echo $this->form_encode_input($this->codigo_revision); ?></span><span id="id_read_off_codigo_revision" class="css_read_off_codigo_revision" style="<?php echo $sStyleReadInp_codigo_revision; ?>"><input type="hidden" name="codigo_revision" value="<?php echo $this->form_encode_input($codigo_revision) . "\">"?><span id="id_ajax_label_codigo_revision"><?php echo nl2br($codigo_revision); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_codigo_revision_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_codigo_revision_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "binicio", "scBtnFn_sys_format_ini()", "scBtnFn_sys_format_ini()", "sc_b_ini_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-19", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-20", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-21", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-22", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_revision_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_revision_mob");
 parent.scAjaxDetailHeight("form_revision_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_revision_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
