<?php
@session_start() ;
$_SESSION['scriptcase']['grid_master_equipo']['sc_process_barr'] = true;
require_once('../grid_master_equipo/index.php');
unset($_SESSION['scriptcase']['grid_master_equipo']['sc_process_barr']);
$ExportCtrl = new grid_master_equipo_export_control;
$ExportCtrl->Export_barr();

class grid_master_equipo_export_control
{
