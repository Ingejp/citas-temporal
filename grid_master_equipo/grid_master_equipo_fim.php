...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_master_equipo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_master_equipo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_master_equipo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_master_equipo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_master_equipo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_master_equipo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_master_equipo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_master_equipo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_master_equipo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_master_equipo']['embutida_filho'] as $ind => $sc_init)
          {
