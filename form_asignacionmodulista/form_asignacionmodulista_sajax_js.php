  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_asignacionmodulista" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_asignacionmodulista_form();
	}

  // ---------- Validate idasignacionmodulista
  function do_ajax_form_asignacionmodulista_validate_idasignacionmodulista()
  {
    ...
    x_ajax_form_asignacionmodulista_validate_idasignacionmodulista(var_idasignacionmodulista, var_script_case_init, do_ajax_form_asignacionmodulista_validate_idasignacionmodulista_cb);
  } // do_ajax_form_asignacionmodulista_validate_idasignacionmodulista

  function do_ajax_form_asignacionmodulista_validate_idasignacionmodulista_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_idasignacionmodulista_cb

  // ---------- Validate cantidadmodulistas
  function do_ajax_form_asignacionmodulista_validate_cantidadmodulistas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_cantidadmodulistas(var_cantidadmodulistas, var_script_case_init, do_ajax_form_asignacionmodulista_validate_cantidadmodulistas_cb);
  } // do_ajax_form_asignacionmodulista_validate_cantidadmodulistas

  function do_ajax_form_asignacionmodulista_validate_cantidadmodulistas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_cantidadmodulistas_cb

  // ---------- Validate rangoinicial
  function do_ajax_form_asignacionmodulista_validate_rangoinicial()
  {
    var nomeCampo_rangoinicial = "rangoinicial";
    var var_rangoinicial = scAjaxGetFieldText(nomeCampo_rangoinicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_rangoinicial(var_rangoinicial, var_script_case_init, do_ajax_form_asignacionmodulista_validate_rangoinicial_cb);
  } // do_ajax_form_asignacionmodulista_validate_rangoinicial

  function do_ajax_form_asignacionmodulista_validate_rangoinicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_rangoinicial_cb

  // ---------- Validate rangofinal
  function do_ajax_form_asignacionmodulista_validate_rangofinal()
  {
    var nomeCampo_rangofinal = "rangofinal";
    var var_rangofinal = scAjaxGetFieldText(nomeCampo_rangofinal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_rangofinal(var_rangofinal, var_script_case_init, do_ajax_form_asignacionmodulista_validate_rangofinal_cb);
  } // do_ajax_form_asignacionmodulista_validate_rangofinal

  function do_ajax_form_asignacionmodulista_validate_rangofinal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_rangofinal_cb

  // ---------- Validate fechamodificacion
  function do_ajax_form_asignacionmodulista_validate_fechamodificacion()
  {
    ...
    setTimeout(function() {
      var var_fechamodificacion = scAjaxGetFieldText(nomeCampo_fechamodificacion);
      x_ajax_form_asignacionmodulista_validate_fechamodificacion(var_fechamodificacion, var_script_case_init, do_ajax_form_asignacionmodulista_validate_fechamodificacion_cb);
    }, 200);
  } // do_ajax_form_asignacionmodulista_validate_fechamodificacion

  function do_ajax_form_asignacionmodulista_validate_fechamodificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_fechamodificacion_cb

  // ---------- Validate idtipodemodulista
  function do_ajax_form_asignacionmodulista_validate_idtipodemodulista()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_idtipodemodulista(var_idtipodemodulista, var_script_case_init, do_ajax_form_asignacionmodulista_validate_idtipodemodulista_cb);
  } // do_ajax_form_asignacionmodulista_validate_idtipodemodulista

  function do_ajax_form_asignacionmodulista_validate_idtipodemodulista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_idtipodemodulista_cb

  // ---------- Validate inicio
  function do_ajax_form_asignacionmodulista_validate_inicio()
  {
    var nomeCampo_inicio = "inicio";
    var var_inicio = scAjaxGetFieldText(nomeCampo_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_inicio(var_inicio, var_script_case_init, do_ajax_form_asignacionmodulista_validate_inicio_cb);
  } // do_ajax_form_asignacionmodulista_validate_inicio

  function do_ajax_form_asignacionmodulista_validate_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inicio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_inicio_cb

  // ---------- Validate fin
  function do_ajax_form_asignacionmodulista_validate_fin()
  {
    var nomeCampo_fin = "fin";
    var var_fin = scAjaxGetFieldText(nomeCampo_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_fin(var_fin, var_script_case_init, do_ajax_form_asignacionmodulista_validate_fin_cb);
  } // do_ajax_form_asignacionmodulista_validate_fin

  function do_ajax_form_asignacionmodulista_validate_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_fin_cb

  // ---------- Validate horainicio
  function do_ajax_form_asignacionmodulista_validate_horainicio()
  {
    var nomeCampo_horainicio = "horainicio";
    var var_horainicio = scAjaxGetFieldText(nomeCampo_horainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_horainicio(var_horainicio, var_script_case_init, do_ajax_form_asignacionmodulista_validate_horainicio_cb);
  } // do_ajax_form_asignacionmodulista_validate_horainicio

  function do_ajax_form_asignacionmodulista_validate_horainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_horainicio_cb

  // ---------- Validate horafin
  function do_ajax_form_asignacionmodulista_validate_horafin()
  {
    var nomeCampo_horafin = "horafin";
    var var_horafin = scAjaxGetFieldText(nomeCampo_horafin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignacionmodulista_validate_horafin(var_horafin, var_script_case_init, do_ajax_form_asignacionmodulista_validate_horafin_cb);
  } // do_ajax_form_asignacionmodulista_validate_horafin

  function do_ajax_form_asignacionmodulista_validate_horafin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horafin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignacionmodulista_validate_horafin_cb

  // ---------- Event onblur inicio
  function do_ajax_form_asignacionmodulista_event_inicio_onblur()
  {
    var var_rangoinicial = scAjaxGetFieldText("rangoinicial");
    var var_horainicio = scAjaxGetFieldText("horainicio");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_asignacionmodulista_event_inicio_onblur(var_rangoinicial, var_horainicio, var_script_case_init, do_ajax_form_asignacionmodulista_event_inicio_onblur_cb);
  } // do_ajax_form_asignacionmodulista_event_inicio_onblur

  function do_ajax_form_asignacionmodulista_event_inicio_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "inicio";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_asignacionmodulista_event_inicio_onblur_cb_after_alert);
  } // do_ajax_form_asignacionmodulista_event_inicio_onblur_cb
  function do_ajax_form_asignacionmodulista_event_inicio_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_asignacionmodulista_event_inicio_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_asignacionmodulista_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_asignacionmodulista_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_asignacionmodulista_submit_form(var_idasignacionmodulista, var_cantidadmodulistas, var_rangoinicial, var_rangofinal, var_fechamodificacion, var_idtipodemodulista, var_inicio, var_fin, var_horainicio, var_horafin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_asignacionmodulista_submit_form_cb);
  } // do_ajax_form_asignacionmodulista_submit_form

  function do_ajax_form_asignacionmodulista_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_asignacionmodulista_submit_form_cb_after_alert);
  } // do_ajax_form_asignacionmodulista_submit_form_cb
  function do_ajax_form_asignacionmodulista_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_asignacionmodulista_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_asignacionmodulista_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_asignacionmodulista_navigate_form(var_idasignacionmodulista, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_asignacionmodulista_navigate_form_cb);
  } // do_ajax_form_asignacionmodulista_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_asignacionmodulista']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_asignacionmodulista_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_asignacionmodulista_navigate_form_cb_after_alert);
  } // do_ajax_form_asignacionmodulista_navigate_form_cb
  function do_ajax_form_asignacionmodulista_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_asignacionmodulista_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_asignacionmodulista_navigate_form_cb_after_alert
  function sc_hide_form_asignacionmodulista_form()
  {
