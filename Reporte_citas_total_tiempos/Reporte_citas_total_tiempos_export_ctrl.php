<?php
@session_start() ;
$_SESSION['scriptcase']['Reporte_citas_total_tiempos']['sc_process_barr'] = true;
require_once('../Reporte_citas_total_tiempos/index.php');
unset($_SESSION['scriptcase']['Reporte_citas_total_tiempos']['sc_process_barr']);
$ExportCtrl = new Reporte_citas_total_tiempos_export_control;
$ExportCtrl->Export_barr();

class Reporte_citas_total_tiempos_export_control
{
