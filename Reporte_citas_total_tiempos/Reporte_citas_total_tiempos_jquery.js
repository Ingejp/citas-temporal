...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_Reporte_citas_total_tiempos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_Reporte_citas_total_tiempos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_Reporte_citas_total_tiempos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_Reporte_citas_total_tiempos').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_Reporte_citas_total_tiempos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_Reporte_citas_total_tiempos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_Reporte_citas_total_tiempos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_Reporte_citas_total_tiempos').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_Reporte_citas_total_tiempos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_Reporte_citas_total_tiempos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_Reporte_citas_total_tiempos').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_Reporte_citas_total_tiempos').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
