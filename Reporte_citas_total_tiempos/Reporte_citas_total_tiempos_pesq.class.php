...
class Reporte_citas_total_tiempos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . Reporte_citas_total_tiempos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . Reporte_citas_total_tiempos_pack_protect_string($Tipo_filter[0]) . "\">.." . Reporte_citas_total_tiempos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>Reporte_citas_total_tiempos/Reporte_citas_total_tiempos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="Reporte_citas_total_tiempos_ajax_search.js"></script>
 <script type="text/javascript" src="Reporte_citas_total_tiempos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="Reporte_citas_total_tiempos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Reporte_citas_total_tiempos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Reporte_citas_total_tiempos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idcita = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['idcita']; 
          $idcita_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['idcita_cond']; 
          $codigo_cita = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['codigo_cita']; 
          $codigo_cita_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['codigo_cita_cond']; 
          $contenedorimport = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorimport']; 
          $contenedorimport_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorimport_cond']; 
          $contenedorexport = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorexport']; 
          $contenedorexport_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorexport_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcita'])) ? $this->New_label['idcita'] : "idCita"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idcita" name="idcita_autocomp" size="11"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['codigo_cita'])) ? $this->New_label['codigo_cita'] : "CODIGO"; ?></TD>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("Reporte_citas_total_tiempos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_citas_total_tiempos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Reporte_citas_total_tiempos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "Reporte_citas_total_tiempos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq'] = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['idcita'] = $idcita; 
      if (is_array($idcita) && !empty($idcita))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0] = $idcita;
      }
      elseif ($idcita_cond_salva == "nu" || $idcita_cond_salva == "nn" || $idcita_cond_salva == "ep" || $idcita_cond_salva == "ne" ||  !empty($idcita))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $idcita;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['idcita_cond'] = $idcita_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['cmp'] = "idcita"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['opc'] = $idcita_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq']['idcita'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['codigo_cita'] = $codigo_cita; 
      if (is_array($codigo_cita) && !empty($codigo_cita))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0] = $codigo_cita;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $codigo_cita;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['codigo_cita_cond'] = $codigo_cita_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['cmp'] = "codigo_cita"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['opc'] = $codigo_cita_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq']['codigo_cita'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorimport'] = $contenedorimport; 
      if (is_array($contenedorimport) && !empty($contenedorimport))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0] = $contenedorimport;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $contenedorimport;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorimport_cond'] = $contenedorimport_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['cmp'] = "contenedorimport"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['opc'] = $contenedorimport_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq']['contenedorimport'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorexport'] = $contenedorexport; 
      if (is_array($contenedorexport) && !empty($contenedorexport))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0] = $contenedorexport;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['val'][0][0] = $contenedorexport;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['contenedorexport_cond'] = $contenedorexport_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['cmp'] = "contenedorexport"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid]['opc'] = $contenedorexport_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['grid_pesq']['contenedorexport'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'] = $Temp_Busca;
      }
      if ($idcita_cond != "in" && $idcita_cond != "bw" && !empty($idcita) && !is_numeric($idcita))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : idCita";
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['cond_pesq'] .= $this->NM_operador;
