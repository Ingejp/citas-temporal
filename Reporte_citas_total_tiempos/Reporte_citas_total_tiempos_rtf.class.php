...
class Reporte_citas_total_tiempos_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "Reporte_citas_total_tiempos.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['rtf_name']);
      }
...
$_SESSION['scriptcase']['Reporte_citas_total_tiempos']['contr_erro'] = 'off'; 
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
