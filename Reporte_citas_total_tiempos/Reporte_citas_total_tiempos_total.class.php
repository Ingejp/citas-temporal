...
class Reporte_citas_total_tiempos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['Reporte_citas_total_tiempos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['Reporte_citas_total_tiempos']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_total($res_limit=false)
   {
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['interativ_search'] = array();
              $this->quebra_geral_sc_free_total();
          }
          
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos']['contr_total_geral'] = "OK";
   } 
