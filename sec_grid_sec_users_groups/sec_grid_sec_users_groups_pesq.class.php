...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CITASPB/sec_grid_sec_users_groups";
