...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____agregar_usuarios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____agregar_usuarios"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['agregar_usuarios']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['agregar_usuarios']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['agregar_usuarios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['agregar_usuarios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['agregar_usuarios']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['agregar_usuarios']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['agregar_usuarios']['embutida_filho'] as $ind => $sc_init)
          {
