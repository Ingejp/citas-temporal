<?php
@session_start() ;
$_SESSION['scriptcase']['agregar_usuarios']['sc_process_barr'] = true;
require_once('../agregar_usuarios/index.php');
unset($_SESSION['scriptcase']['agregar_usuarios']['sc_process_barr']);
$ExportCtrl = new agregar_usuarios_export_control;
$ExportCtrl->Export_barr();

class agregar_usuarios_export_control
{
