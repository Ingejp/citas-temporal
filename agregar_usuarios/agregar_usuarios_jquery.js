...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_agregar_usuarios').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_agregar_usuarios').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_agregar_usuarios').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_agregar_usuarios').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_agregar_usuarios').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_agregar_usuarios').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_agregar_usuarios').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_agregar_usuarios').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_agregar_usuarios').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_agregar_usuarios').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_agregar_usuarios').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_agregar_usuarios').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
