<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_path_doc']        = "";
...
<?php
      ...
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/sec_form_sec_groups_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/sec_form_sec_groups_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/sec_form_sec_groups_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/sec_form_sec_groups_ini.txt");
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_grid_sec_groups']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_grid_sec_groups']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_list_groups'] . "";
...
//
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_sec_grid_sec_groups.pdf";
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['ajax_nav'])
         {
             ...
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_groups']['fast_search'][0] = $field;
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sec_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['sec_grid_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['sec_grid_sec_groups']['orig_pesq'] = $nmgp_orig_pesq;
   }
