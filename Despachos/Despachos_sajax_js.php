...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_Despachos_form();
	}

  // ---------- Validate codigo_cita
  function do_ajax_Despachos_validate_codigo_cita()
  {
    var nomeCampo_codigo_cita = "codigo_cita";
    var var_codigo_cita = scAjaxGetFieldText(nomeCampo_codigo_cita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_codigo_cita(var_codigo_cita, var_script_case_init, do_ajax_Despachos_validate_codigo_cita_cb);
  } // do_ajax_Despachos_validate_codigo_cita

  function do_ajax_Despachos_validate_codigo_cita_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_codigo_cita_cb

  // ---------- Validate atc
  function do_ajax_Despachos_validate_atc()
  {
    var nomeCampo_atc = "atc";
    var var_atc = scAjaxGetFieldText(nomeCampo_atc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_atc(var_atc, var_script_case_init, do_ajax_Despachos_validate_atc_cb);
  } // do_ajax_Despachos_validate_atc

  function do_ajax_Despachos_validate_atc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "atc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_atc_cb

  // ---------- Validate sc_field_0
  function do_ajax_Despachos_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_Despachos_validate_sc_field_0_cb);
  } // do_ajax_Despachos_validate_sc_field_0

  function do_ajax_Despachos_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_sc_field_0_cb

  // ---------- Validate destino
  function do_ajax_Despachos_validate_destino()
  {
    var nomeCampo_destino = "destino";
    var var_destino = scAjaxGetFieldSelect(nomeCampo_destino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_destino(var_destino, var_script_case_init, do_ajax_Despachos_validate_destino_cb);
  } // do_ajax_Despachos_validate_destino

  function do_ajax_Despachos_validate_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "destino";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_destino_cb

  // ---------- Validate placa
  function do_ajax_Despachos_validate_placa()
  {
    var nomeCampo_placa = "placa";
    var var_placa = scAjaxGetFieldText(nomeCampo_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_placa(var_placa, var_script_case_init, do_ajax_Despachos_validate_placa_cb);
  } // do_ajax_Despachos_validate_placa

  function do_ajax_Despachos_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_placa_cb

  // ---------- Validate chasis
  function do_ajax_Despachos_validate_chasis()
  {
    var nomeCampo_chasis = "chasis";
    var var_chasis = scAjaxGetFieldText(nomeCampo_chasis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_chasis(var_chasis, var_script_case_init, do_ajax_Despachos_validate_chasis_cb);
  } // do_ajax_Despachos_validate_chasis

  function do_ajax_Despachos_validate_chasis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "chasis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_chasis_cb

  // ---------- Validate naviera
  function do_ajax_Despachos_validate_naviera()
  {
    var nomeCampo_naviera = "naviera";
    var var_naviera = scAjaxGetFieldText(nomeCampo_naviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_naviera(var_naviera, var_script_case_init, do_ajax_Despachos_validate_naviera_cb);
  } // do_ajax_Despachos_validate_naviera

  function do_ajax_Despachos_validate_naviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "naviera";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_naviera_cb

  // ---------- Validate contenedor_exp
  function do_ajax_Despachos_validate_contenedor_exp()
  {
    var nomeCampo_contenedor_exp = "contenedor_exp";
    var var_contenedor_exp = scAjaxGetFieldText(nomeCampo_contenedor_exp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_contenedor_exp(var_contenedor_exp, var_script_case_init, do_ajax_Despachos_validate_contenedor_exp_cb);
  } // do_ajax_Despachos_validate_contenedor_exp

  function do_ajax_Despachos_validate_contenedor_exp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_contenedor_exp_cb

  // ---------- Validate contenedor_imp
  function do_ajax_Despachos_validate_contenedor_imp()
  {
    var nomeCampo_contenedor_imp = "contenedor_imp";
    var var_contenedor_imp = scAjaxGetFieldText(nomeCampo_contenedor_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_contenedor_imp(var_contenedor_imp, var_script_case_init, do_ajax_Despachos_validate_contenedor_imp_cb);
  } // do_ajax_Despachos_validate_contenedor_imp

  function do_ajax_Despachos_validate_contenedor_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_contenedor_imp_cb

  // ---------- Validate idcita
  function do_ajax_Despachos_validate_idcita()
  {
    var nomeCampo_idcita = "idcita";
    var var_idcita = scAjaxGetFieldText(nomeCampo_idcita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_idcita(var_idcita, var_script_case_init, do_ajax_Despachos_validate_idcita_cb);
  } // do_ajax_Despachos_validate_idcita

  function do_ajax_Despachos_validate_idcita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcita";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_idcita_cb

  // ---------- Validate piloto
  function do_ajax_Despachos_validate_piloto()
  {
    var nomeCampo_piloto = "piloto";
    var var_piloto = scAjaxGetFieldText(nomeCampo_piloto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_piloto(var_piloto, var_script_case_init, do_ajax_Despachos_validate_piloto_cb);
  } // do_ajax_Despachos_validate_piloto

  function do_ajax_Despachos_validate_piloto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "piloto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_piloto_cb

  // ---------- Validate viaje
  function do_ajax_Despachos_validate_viaje()
  {
    var nomeCampo_viaje = "viaje";
    var var_viaje = scAjaxGetFieldText(nomeCampo_viaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Despachos_validate_viaje(var_viaje, var_script_case_init, do_ajax_Despachos_validate_viaje_cb);
  } // do_ajax_Despachos_validate_viaje

  function do_ajax_Despachos_validate_viaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "viaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Despachos_validate_viaje_cb

  // ---------- Event onchange codigo_cita
  function do_ajax_Despachos_event_codigo_cita_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_Despachos_event_codigo_cita_onchange(var_codigo_cita, var_placa, var_chasis, var_naviera, var_contenedor_exp, var_contenedor_imp, var_idcita, var_piloto, var_viaje, var_script_case_init, do_ajax_Despachos_event_codigo_cita_onchange_cb);
  } // do_ajax_Despachos_event_codigo_cita_onchange

  function do_ajax_Despachos_event_codigo_cita_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_cita";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Despachos_event_codigo_cita_onchange_cb_after_alert);
  } // do_ajax_Despachos_event_codigo_cita_onchange_cb
  function do_ajax_Despachos_event_codigo_cita_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Despachos_event_codigo_cita_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_sc_btn_0
  function do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick(var_atc, var_sc_field_0, var_destino, var_codigo_cita, var_placa, var_chasis, var_naviera, var_contenedor_exp, var_contenedor_imp, var_piloto, var_viaje, var_idcita, var_script_case_init, do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick_cb);
  } // do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick

  function do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert);
  } // do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick_cb
  function do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Despachos_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Despachos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Despachos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigo_cita = scAjaxGetFieldText("codigo_cita");
    ...
    scAjaxProcOn();
    x_ajax_Despachos_submit_form(var_codigo_cita, var_atc, var_sc_field_0, var_destino, var_placa, var_chasis, var_naviera, var_contenedor_exp, var_contenedor_imp, var_idcita, var_piloto, var_viaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Despachos_submit_form_cb);
  } // do_ajax_Despachos_submit_form

  function do_ajax_Despachos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Despachos_submit_form_cb_after_alert);
  } // do_ajax_Despachos_submit_form_cb
  function do_ajax_Despachos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Despachos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Despachos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Despachos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Despachos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Despachos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Despachos_navigate_form_cb_after_alert);
  } // do_ajax_Despachos_navigate_form_cb
  function do_ajax_Despachos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_Despachos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Despachos_navigate_form_cb_after_alert
  function sc_hide_Despachos_form()
  {
