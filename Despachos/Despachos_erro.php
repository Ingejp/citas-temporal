...
$old_error_handler = set_error_handler("Despachos_scriptcase_error_handler");

function Despachos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Despachos']['contr_erro']) && $_SESSION['scriptcase']['Despachos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Despachos->contr_Despachos->Apl_com_erro = true;
            if ($inicial_Despachos->contr_Despachos->NM_ajax_flag)
            {
                $inicial_Despachos->contr_Despachos->NM_ajax_info['errList']['geral_Despachos'][] = $msg;
                return;
            }
            Despachos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Despachos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Despachos'])  && '' != $_SESSION['scriptcase']['error_icon']['Despachos'])  ? $_SESSION['scriptcase']['error_icon']['Despachos']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Despachos']) && '' != $_SESSION['scriptcase']['error_close']['Despachos']) ? $_SESSION['scriptcase']['error_close']['Despachos'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Despachos']) && '' != $_SESSION['scriptcase']['error_span_title']['Despachos']) ? $_SESSION['scriptcase']['error_span_title']['Despachos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Despachos']) && '' != $_SESSION['scriptcase']['error_icon_title']['Despachos']) ? $_SESSION['scriptcase']['error_icon_title']['Despachos'] : '';
?>
