<?php
@session_start() ;
$_SESSION['scriptcase']['grid_entidad_de_estado']['sc_process_barr'] = true;
require_once('../grid_entidad_de_estado/index.php');
unset($_SESSION['scriptcase']['grid_entidad_de_estado']['sc_process_barr']);
$ExportCtrl = new grid_entidad_de_estado_export_control;
$ExportCtrl->Export_barr();

class grid_entidad_de_estado_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> entidad_de_estado :: Excel</TITLE>
