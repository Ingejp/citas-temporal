...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_entidad_de_estado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_entidad_de_estado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_entidad_de_estado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_entidad_de_estado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_entidad_de_estado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_entidad_de_estado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_entidad_de_estado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_entidad_de_estado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_entidad_de_estado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_entidad_de_estado']['embutida_filho'] as $ind => $sc_init)
          {
