...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "identidad_de_estado";$Nm_numeric[] = "identidad_de_estado";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_identidad_de_estado_cond" name="identidad_de_estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_identidad_de_estado'), this, 'identidad_de_estado')">
      ...
      <br><span id="id_hide_identidad_de_estado"  <?php echo $str_hide_identidad_de_estado?>><?php
