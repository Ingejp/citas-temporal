<?php
@session_start() ;
$_SESSION['scriptcase']['grid_buque']['sc_process_barr'] = true;
require_once('../grid_buque/index.php');
unset($_SESSION['scriptcase']['grid_buque']['sc_process_barr']);
$ExportCtrl = new grid_buque_export_control;
$ExportCtrl->Export_barr();

class grid_buque_export_control
{
