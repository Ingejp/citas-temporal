  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_buque_1_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_buque_1_mob_form();
	}

  // ---------- Validate idbuque
  function do_ajax_form_buque_1_mob_validate_idbuque()
  {
    var nomeCampo_idbuque = "idbuque";
    var var_idbuque = scAjaxGetFieldHidden(nomeCampo_idbuque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buque_1_mob_validate_idbuque(var_idbuque, var_script_case_init, do_ajax_form_buque_1_mob_validate_idbuque_cb);
  } // do_ajax_form_buque_1_mob_validate_idbuque

  function do_ajax_form_buque_1_mob_validate_idbuque_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buque_1_mob_validate_idbuque_cb

  // ---------- Validate buque
  function do_ajax_form_buque_1_mob_validate_buque()
  {
    var nomeCampo_buque = "buque";
    var var_buque = scAjaxGetFieldText(nomeCampo_buque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_buque_1_mob_validate_buque(var_buque, var_script_case_init, do_ajax_form_buque_1_mob_validate_buque_cb);
  } // do_ajax_form_buque_1_mob_validate_buque

  function do_ajax_form_buque_1_mob_validate_buque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "buque";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_buque_1_mob_validate_buque_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_buque_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_buque_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idbuque = scAjaxGetFieldHidden("idbuque");
    var var_buque = scAjaxGetFieldText("buque");
    ...
    scAjaxProcOn();
    x_ajax_form_buque_1_mob_submit_form(var_idbuque, var_buque, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_buque_1_mob_submit_form_cb);
  } // do_ajax_form_buque_1_mob_submit_form

  function do_ajax_form_buque_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_buque_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_buque_1_mob_submit_form_cb
  function do_ajax_form_buque_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_buque_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_buque_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idbuque");
    scAjaxHideErrorDisplay("buque");
    var var_idbuque = document.F2.idbuque.value;
    ...
    scAjaxProcOn();
    x_ajax_form_buque_1_mob_navigate_form(var_idbuque, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_buque_1_mob_navigate_form_cb);
  } // do_ajax_form_buque_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_buque_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_buque_1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idbuque.value = scAjaxGetKeyValue("idbuque");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_buque_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_buque_1_mob_navigate_form_cb
  function do_ajax_form_buque_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_buque_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_buque_1_mob_navigate_form_cb_after_alert
  function sc_hide_form_buque_1_mob_form()
  {
  ...
  ajax_field_list[0] = "idbuque";
  ajax_field_list[1] = "buque";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idbuque": {"label": "Id Buque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "buque": {"label": "Buque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["buque"][1] = "buque";

  var ajax_field_id = {
    "idbuque": new Array("hidden_field_label_idbuque", "hidden_field_data_idbuque"),
    "buque": new Array("hidden_field_label_buque", "hidden_field_data_buque")
  };
