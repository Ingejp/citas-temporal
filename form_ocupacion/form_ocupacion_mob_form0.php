...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_ocupacion_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_ocupacion_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_ocupacion']['error_buffer']) && '' != $_SESSION['scriptcase']['form_ocupacion']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_ocupacion']['error_buffer'];
}
...
<?php
 include_once("form_ocupacion_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_ocupacion_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ocupacion_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ocupacion_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ocupaciondry_line" id="hidden_field_data_ocupaciondry" style="<?php echo $sStyleHidden_ocupaciondry; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ocupaciondry_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ocupaciondry_label"><span id="id_label_ocupaciondry"><?php echo $this->nm_new_label['ocupaciondry']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ocupacionreefer_line" id="hidden_field_data_ocupacionreefer" style="<?php echo $sStyleHidden_ocupacionreefer; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ocupacionreefer_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ocupacionreefer_label"><span id="id_label_ocupacionreefer"><?php echo $this->nm_new_label['ocupacionreefer']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ocupacionteu_line" id="hidden_field_data_ocupacionteu" style="<?php echo $sStyleHidden_ocupacionteu; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ocupacionteu_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ocupacionteu_label"><span id="id_label_ocupacionteu"><?php echo $this->nm_new_label['ocupacionteu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_totalocupacion_line" id="hidden_field_data_totalocupacion" style="<?php echo $sStyleHidden_totalocupacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totalocupacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_totalocupacion_label"><span id="id_label_totalocupacion"><?php echo $this->nm_new_label['totalocupacion']; ?></span></span><br>
...
<?php $sStyleHidden_totalocupacion_dumb = ('' == $sStyleHidden_totalocupacion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_totalocupacion_dumb" style="<?php echo $sStyleHidden_totalocupacion_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importdry_line" id="hidden_field_data_importdry" style="<?php echo $sStyleHidden_importdry; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importdry_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_importdry_label"><span id="id_label_importdry"><?php echo $this->nm_new_label['importdry']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importreefer_line" id="hidden_field_data_importreefer" style="<?php echo $sStyleHidden_importreefer; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importreefer_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_importreefer_label"><span id="id_label_importreefer"><?php echo $this->nm_new_label['importreefer']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_importteu_line" id="hidden_field_data_importteu" style="<?php echo $sStyleHidden_importteu; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importteu_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_importteu_label"><span id="id_label_importteu"><?php echo $this->nm_new_label['importteu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_totalimport_line" id="hidden_field_data_totalimport" style="<?php echo $sStyleHidden_totalimport; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totalimport_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_totalimport_label"><span id="id_label_totalimport"><?php echo $this->nm_new_label['totalimport']; ?></span></span><br>
...
<?php $sStyleHidden_totalimport_dumb = ('' == $sStyleHidden_totalimport) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_totalimport_dumb" style="<?php echo $sStyleHidden_totalimport_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_disponibledry_line" id="hidden_field_data_disponibledry" style="<?php echo $sStyleHidden_disponibledry; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_disponibledry_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_disponibledry_label"><span id="id_label_disponibledry"><?php echo $this->nm_new_label['disponibledry']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_disponiblereefer_line" id="hidden_field_data_disponiblereefer" style="<?php echo $sStyleHidden_disponiblereefer; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_disponiblereefer_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_disponiblereefer_label"><span id="id_label_disponiblereefer"><?php echo $this->nm_new_label['disponiblereefer']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_disponibleteu_line" id="hidden_field_data_disponibleteu" style="<?php echo $sStyleHidden_disponibleteu; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_disponibleteu_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_disponibleteu_label"><span id="id_label_disponibleteu"><?php echo $this->nm_new_label['disponibleteu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_totaldisponible_line" id="hidden_field_data_totaldisponible" style="<?php echo $sStyleHidden_totaldisponible; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totaldisponible_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_totaldisponible_label"><span id="id_label_totaldisponible"><?php echo $this->nm_new_label['totaldisponible']; ?></span></span><br>
...
<?php $sStyleHidden_totaldisponible_dumb = ('' == $sStyleHidden_totaldisponible) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_totaldisponible_dumb" style="<?php echo $sStyleHidden_totaldisponible_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_exportdry_line" id="hidden_field_data_exportdry" style="<?php echo $sStyleHidden_exportdry; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_exportdry_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_exportdry_label"><span id="id_label_exportdry"><?php echo $this->nm_new_label['exportdry']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_exportreefer_line" id="hidden_field_data_exportreefer" style="<?php echo $sStyleHidden_exportreefer; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_exportreefer_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_exportreefer_label"><span id="id_label_exportreefer"><?php echo $this->nm_new_label['exportreefer']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_exportteu_line" id="hidden_field_data_exportteu" style="<?php echo $sStyleHidden_exportteu; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_exportteu_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_exportteu_label"><span id="id_label_exportteu"><?php echo $this->nm_new_label['exportteu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_totalexport_line" id="hidden_field_data_totalexport" style="<?php echo $sStyleHidden_totalexport; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totalexport_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_totalexport_label"><span id="id_label_totalexport"><?php echo $this->nm_new_label['totalexport']; ?></span></span><br>
...
<?php $sStyleHidden_totalexport_dumb = ('' == $sStyleHidden_totalexport) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_totalexport_dumb" style="<?php echo $sStyleHidden_totalexport_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_despachodry_line" id="hidden_field_data_despachodry" style="<?php echo $sStyleHidden_despachodry; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_despachodry_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_despachodry_label"><span id="id_label_despachodry"><?php echo $this->nm_new_label['despachodry']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_despachoreefer_line" id="hidden_field_data_despachoreefer" style="<?php echo $sStyleHidden_despachoreefer; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_despachoreefer_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_despachoreefer_label"><span id="id_label_despachoreefer"><?php echo $this->nm_new_label['despachoreefer']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_despachoteu_line" id="hidden_field_data_despachoteu" style="<?php echo $sStyleHidden_despachoteu; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_despachoteu_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_despachoteu_label"><span id="id_label_despachoteu"><?php echo $this->nm_new_label['despachoteu']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_totaldespacho_line" id="hidden_field_data_totaldespacho" style="<?php echo $sStyleHidden_totaldespacho; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totaldespacho_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_totaldespacho_label"><span id="id_label_totaldespacho"><?php echo $this->nm_new_label['totaldespacho']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ocupacion_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ocupacion_mob");
 parent.scAjaxDetailHeight("form_ocupacion_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ocupacion_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
