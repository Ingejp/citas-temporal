<?php
   include_once('PruebaPHPInfo_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class PruebaPHPInfo_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "PruebaPHPInfo"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20190117"; 
      $this->nm_hr_criacao   = "093512"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/PruebaPHPInfo';
      ...
      if (isset($_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['PruebaPHPInfo']['actual_lang']) || $_SESSION['scriptcase']['PruebaPHPInfo']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['PruebaPHPInfo']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("PruebaPHPInfo_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["PruebaPHPInfo"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["PruebaPHPInfo"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "PruebaPHPInfo_erro.class.php"); 
      $this->Erro = new PruebaPHPInfo_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('PruebaPHPInfo'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao']) && $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_perfil']) && $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['PruebaPHPInfo']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['PruebaPHPInfo']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new PruebaPHPInfo_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['PruebaPHPInfo']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['PruebaPHPInfo']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['PruebaPHPInfo']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['PruebaPHPInfo'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['PruebaPHPInfo']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['PruebaPHPInfo']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('PruebaPHPInfo') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['PruebaPHPInfo']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['PruebaPHPInfo']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['PruebaPHPInfo']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['PruebaPHPInfo']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "PruebaPHPInfo_erro.class.php"); 
      $this->Erro      = new PruebaPHPInfo_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['PruebaPHPInfo']['contr_erro'] = 'on';
 phpinfo();
$_SESSION['scriptcase']['PruebaPHPInfo']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_PruebaPHPInfo($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['PruebaPHPInfo']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "PruebaPHPInfo") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['PruebaPHPInfo']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "PruebaPHPInfo";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'PruebaPHPInfo' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('PruebaPHPInfo' == $sReferer || 'PruebaPHPInfo_' == substr($sReferer, 0, 14))
       {
           $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'PruebaPHPInfo')
   {
       $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['PruebaPHPInfo']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/PruebaPHPInfo_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_PruebaPHPInfo($cadapar[1]);
   ...
   $contr_PruebaPHPInfo = new PruebaPHPInfo_apl();
   $contr_PruebaPHPInfo->controle();
//
   function nm_limpa_str_PruebaPHPInfo(&$str)
   {
