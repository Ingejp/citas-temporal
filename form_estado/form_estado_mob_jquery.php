...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idestado' + iSeqRow).bind('blur', function() { sc_form_estado_idestado_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_estado_idestado_onfocus(this, iSeqRow) });
  $('#id_sc_field_estado' + iSeqRow).bind('blur', function() { sc_form_estado_estado_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_estado_estado_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_estado_idestado_onblur(oThis, iSeqRow) {
  do_ajax_form_estado_mob_validate_idestado();
  scCssBlur(oThis);
}

function sc_form_estado_idestado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_estado_estado_onblur(oThis, iSeqRow) {
  do_ajax_form_estado_mob_validate_estado();
  scCssBlur(oThis);
}

function sc_form_estado_estado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_estado_mob_form" + pageNo).hide();
}
