  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estado_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_estado_mob_form();
	}

  // ---------- Validate idestado
  function do_ajax_form_estado_mob_validate_idestado()
  {
    var nomeCampo_idestado = "idestado";
    var var_idestado = scAjaxGetFieldHidden(nomeCampo_idestado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estado_mob_validate_idestado(var_idestado, var_script_case_init, do_ajax_form_estado_mob_validate_idestado_cb);
  } // do_ajax_form_estado_mob_validate_idestado

  function do_ajax_form_estado_mob_validate_idestado_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estado_mob_validate_idestado_cb

  // ---------- Validate estado
  function do_ajax_form_estado_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estado_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_estado_mob_validate_estado_cb);
  } // do_ajax_form_estado_mob_validate_estado

  function do_ajax_form_estado_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estado_mob_validate_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_estado_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estado_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_estado_mob_submit_form(var_idestado, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_estado_mob_submit_form_cb);
  } // do_ajax_form_estado_mob_submit_form

  function do_ajax_form_estado_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_estado_mob_submit_form_cb_after_alert);
  } // do_ajax_form_estado_mob_submit_form_cb
  function do_ajax_form_estado_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_estado_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_estado_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idestado");
    scAjaxHideErrorDisplay("estado");
    var var_idestado = document.F2.idestado.value;
    ...
    scAjaxProcOn();
    x_ajax_form_estado_mob_navigate_form(var_idestado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estado_mob_navigate_form_cb);
  } // do_ajax_form_estado_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estado_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estado_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idestado.value = scAjaxGetKeyValue("idestado");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_estado_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_estado_mob_navigate_form_cb
  function do_ajax_form_estado_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_estado_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_estado_mob_navigate_form_cb_after_alert
  function sc_hide_form_estado_mob_form()
  {
  ...
  ajax_field_list[0] = "idestado";
  ajax_field_list[1] = "estado";
