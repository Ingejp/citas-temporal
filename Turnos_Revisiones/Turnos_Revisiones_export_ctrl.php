<?php
@session_start() ;
$_SESSION['scriptcase']['Turnos_Revisiones']['sc_process_barr'] = true;
require_once('../Turnos_Revisiones/index.php');
unset($_SESSION['scriptcase']['Turnos_Revisiones']['sc_process_barr']);
$ExportCtrl = new Turnos_Revisiones_export_control;
$ExportCtrl->Export_barr();

class Turnos_Revisiones_export_control
{
