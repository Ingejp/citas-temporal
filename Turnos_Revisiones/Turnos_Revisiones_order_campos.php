...
<?php
   ...
   $Ord_Cmp = new Turnos_Revisiones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Turnos_Revisiones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["rev_codigo_revision"]   = (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["rev_codigo_revision"])) ? $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["rev_codigo_revision"] : "Turno Revision";
   ...
   $tab_labels["buq_buque"]   = (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["buq_buque"])) ? $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["buq_buque"] : "Buque";
   ...
   $tab_labels["cab_placa"]   = (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["cab_placa"])) ? $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["cab_placa"] : "Placa";
   ...
   $tab_labels["consig_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["consig_nombre"])) ? $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["consig_nombre"] : "Nombre";
   ...
   $tab_labels["cont_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["cont_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["cont_descripcion"] : "Descripcion";
   ...
   $tab_labels["est_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["est_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['labels']["est_descripcion"] : "Descripcion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Turnos_Revisiones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Turnos_Revisiones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
