...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Turnos_Revisiones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Turnos_Revisiones"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Turnos_Revisiones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Turnos_Revisiones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Turnos_Revisiones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Turnos_Revisiones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Turnos_Revisiones']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Turnos_Revisiones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Turnos_Revisiones']['embutida_filho'] as $ind => $sc_init)
          {
