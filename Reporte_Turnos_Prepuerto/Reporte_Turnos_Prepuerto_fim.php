...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Reporte_Turnos_Prepuerto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Reporte_Turnos_Prepuerto"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Reporte_Turnos_Prepuerto</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['embutida_filho'] as $ind => $sc_init)
          {
