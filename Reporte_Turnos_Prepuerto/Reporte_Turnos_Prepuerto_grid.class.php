<?php
class Reporte_Turnos_Prepuerto_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['charts_html'] = '';
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "Reporte_Turnos_Prepuerto/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new Reporte_Turnos_Prepuerto_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
      }
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] != 'print')
       { 
           $this->html_interativ_search();
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'])
           { 
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchMolduraResult\" valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Reporte_Turnos_Prepuerto'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
           $this->nmgp_embbed_placeholder_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['save_grid']))
       {
           $this->refresh_interativ_search();
       }
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new Reporte_Turnos_Prepuerto_grafico();
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("en_us");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pesq_tab_label'] .= "turno?#?" . "Turno" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pesq_tab_label'] .= "cit_codigo_cita?#?" . "Codigo Cita" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pesq_tab_label'] .= "cit_contenedorimport?#?" . "Contenedorimport" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pesq_tab_label'] .= "cit_contenedorexport?#?" . "Contenedor Export" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dyn_search_aut_comp']))
   {
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dyn_search_aut_comp']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("Reporte_Turnos_Prepuerto", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "muda_qt_linhas";
   } 
       ob_start(); 
...
$_SESSION['scriptcase']['Reporte_Turnos_Prepuerto']['contr_erro'] = 'off'; 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Reporte_Turnos_Prepuerto'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Reporte_Turnos_Prepuerto'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "Reporte_Turnos_Prepuerto_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] = 50;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_select']['cit.idCita'] = 'ASC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq_filtro'] = "";
   }   
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] == "all") 
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->tipo_carga = $this->rs_grid->fields[6] ;  
       $this->nav_naviera = $this->rs_grid->fields[7] ;  
       $this->cit_fechainicio = $this->rs_grid->fields[8] ;  
       $this->cit_observaciones = $this->rs_grid->fields[9] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>TURNOS DE DESPACHO :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['pivot_charts']) : 0;
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>TURNOS DE DESPACHO</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"Reporte_Turnos_Prepuerto_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"Reporte_Turnos_Prepuerto_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"Reporte_Turnos_Prepuerto_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-Reporte_Turnos_Prepuerto-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-69359cd7\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"Reporte_Turnos_Prepuerto_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Reporte_Turnos_Prepuerto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Reporte_Turnos_Prepuerto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_Reporte_Turnos_Prepuerto_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".Reporte_Turnos_Prepuerto_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
           $nm_saida->saida("  <body class=\"" . $this->css_scGridPage . "\" " . $str_iframe_body . " style=\"" . $remove_margin. $css_body . "\">\r\n");
       }
       $nm_saida->saida("  " . $this->Ini->Ajax_result_set . "\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Reporte_Turnos_Prepuerto']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Reporte_Turnos_Prepuerto']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Reporte_Turnos_Prepuerto']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Reporte_Turnos_Prepuerto']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida']) ? "Reporte_Turnos_Prepuerto_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf")
   { 
       $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
   } 
   else 
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">TURNOS DE DESPACHO</div>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_Reporte_Turnos_Prepuerto__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-Reporte_Turnos_Prepuerto-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq']) { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".Reporte_Turnos_Prepuerto_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_turno()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_cmp'] == $NM_cmp_class)
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ordem_label'] == "desc")
          {
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['turno'])) ? $this->New_label['turno'] : "Turno"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['turno'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_codigo_cita'])) ? $this->New_label['cit_codigo_cita'] : "Codigo Cita"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['cit_codigo_cita'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cab_placa'])) ? $this->New_label['cab_placa'] : "Placa"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['cab_placa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['piloto'])) ? $this->New_label['piloto'] : "PILOTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['piloto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_contenedorimport'])) ? $this->New_label['cit_contenedorimport'] : "Contenedorimport"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['cit_contenedorimport'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_contenedorexport'])) ? $this->New_label['cit_contenedorexport'] : "Contenedor Export"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['cit_contenedorexport'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipo_carga'])) ? $this->New_label['tipo_carga'] : "TIPO CARGA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['tipo_carga'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nav_naviera'])) ? $this->New_label['nav_naviera'] : "Naviera"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['nav_naviera'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_fechainicio'])) ? $this->New_label['cit_fechainicio'] : "Fecha Inicio"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['cit_fechainicio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_observaciones'])) ? $this->New_label['cit_observaciones'] : "Observaciones"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['labels']['cit_observaciones'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Reporte_Turnos_Prepuerto']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_Reporte_Turnos_Prepuerto#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_Reporte_Turnos_Prepuerto#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-69359cd7\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Page_break_PDF'] = array();
       }
   }
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
         {
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf")
          {
              $this->Res->nm_acum_res_unit($this->rs_grid);
          }
         }
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['rows_emb']++;
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'])
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['fast_search'][2] : "";
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if (is_file("Reporte_Turnos_Prepuerto_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("Reporte_Turnos_Prepuerto_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['dashboard_info']['under_dashboard']))
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_modal'])
        {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
          {
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
          {
          ...
          if ($Tem_csv_res == "n")
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "nm_gp_csv_conf('1','1','1','N','$Csv_mod_export','');", "nm_gp_csv_conf('1','1','1','N','$Csv_mod_export','');", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
          $nm_saida->saida("         </td> \r\n");
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao_print'] != "print") 
      {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['nav']))
          {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Gb_Free_cmp']))
      {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=en_us&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=Reporte_Turnos_Prepuerto&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
          {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['SC_Ind_Groupby'] != "sc_free_total")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq'] as $cmp => $def)
           {
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = Reporte_Turnos_Prepuerto_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CITASPB/Reporte_Turnos_Prepuerto";
...
$nm_saida->saida("             }\r\n");
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['yarda'] = (isset($this->New_label['yarda'])) ? $this->New_label['yarda'] : 'YARDA';
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_sql']['yarda']   = "yard.descripcion_yarda";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['est_estado'] = (isset($this->New_label['est_estado'])) ? $this->New_label['est_estado'] : 'Estado';
       $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_sql']['est_estado']   = "est.estado";
       ...
       $nm_saida->saida("" . $lin_obj . "\r\n");
       $lin_obj = $this->interativ_search_est_estado();
       $nm_saida->saida("" . $lin_obj . "\r\n");
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']["yarda"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']["yarda"])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['yarda'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       $lin_obj .= "     </td></tr>";
       $Cmps_where = "";
       $nm_comando = "select yard.descripcion_yarda, COUNT(*) AS countTest from " . $this->Ini->nm_tabela;
       $tmp_where = "";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq'];
       }
       $nm_comando .= " " . $tmp_where;
       $nm_comando .= " GROUP BY yard.descripcion_yarda". $Cmps_where;
       $nm_comando .= " order by yard.descripcion_yarda ASC";
       $result = array();
       $range_max = false;
       $range_min = false;
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']['yarda'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']['yarda']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['yarda']) . "','yarda','id_int_search_yarda','yarda', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['yarda']) . "','yarda','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'yarda', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['yarda']) . "','yarda','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'yarda', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['yarda']) . "','yarda','id_int_search_yarda','yarda', '');", "nm_proc_int_search('chbx', 'tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['yarda']) . "','yarda','id_int_search_yarda','yarda', '');", "app_int_search_yarda", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   function interativ_search_est_estado()
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']["est_estado"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']["est_estado"])) ? "none" : "";
       $lin_obj  = "    <div id=\"div_int_est_estado\">";
       $lin_obj .= "    <table width='100%' cellspacing=0 cellpadding=0>";
       $lin_obj .= "     <tr>";
       $lin_obj .= "      <td nowrap class='scGridRefinedSearchLabel'>";
       $lin_obj .= "        <table width='100%' cellspacing=0 cellpadding=0>";
       $lin_obj .= "         <tr>";
       $lin_obj .= "          <td nowrap>";
       $lin_obj .= "              <span id=\"id_expand_est_estado\" style=\"display: " .  $exp_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer; padding:0px 2px 0px 0px;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_show . "\" BORDER=\"0\" onclick=\"nm_toggle_int_search('est_estado')\"/>   </span>";
       $lin_obj .= "              <span id=\"id_retract_est_estado\" style=\"display: none;\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_hide . "\" BORDER=\"0\" onclick=\"nm_toggle_int_search('est_estado')\"/>   </span>";
       $lin_obj .= "              <INPUT class='" . $this->css_scAppDivToolbarInput . "' style=\"display: none;\" type=\"checkbox\" id=\"id_int_search_est_estado_ck\" name=\"int_search_est_estado_ck[]\" value=\"\" checked onclick=\"nm_change_mult_int_search('est_estado');\">";
       $lin_obj .= "              <span style=\"cursor: pointer;\" onclick=\"nm_toggle_int_search('est_estado')\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['est_estado'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       $lin_obj .= "              <span id=\"id_clear_est_estado\" style=\"display: " .  $cle_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_close . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear','','','est_estado', '', 'est_estado', '')\"/>   </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "         </tr>";
       $lin_obj .= "        </table>";
       $lin_obj .= "     </td></tr>";
       $Cmps_where = "";
       $nm_comando = "select est.estado, COUNT(*) AS countTest from " . $this->Ini->nm_tabela;
       $tmp_where = "";
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['where_pesq'];
       ...
       $nm_comando .= " " . $tmp_where;
       $nm_comando .= " GROUP BY est.estado". $Cmps_where;
       $nm_comando .= " order by est.estado ASC";
       $result = array();
       $range_max = false;
       $range_min = false;
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']['est_estado'])) ? "" : "none";
       $lin_obj  .= "   <tr><td><div class='scGridRefinedSearchMolduraResult' id=\"id_tab_est_estado_link\" style=\"display: " . $disp_link . ";\">";
       $qtd_see_more  = 0;
       $qtd_result_see_more  = 0;
       $bol_open_see_more  = false;
       foreach ($result as $dados => $qtd_result)
       {
           ...
           if($qtd_see_more > 0 && $qtd_result_see_more >= $qtd_see_more && !$bol_open_see_more)
           {
               $lin_obj  .= "   <div id='id_see_more_est_estado' class='scGridRefinedSearchVejaMais'>";
               $lin_obj  .= "    <a href=\"javascript:toggleSeeMore('est_estado');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
               $lin_obj  .= "   </div>";
               $lin_obj  .= "   <div id='id_see_more_list_est_estado' style='display:none'>";
               $bol_open_see_more  = true;
           }
           $on_mouse_over= "";
           $on_mouse_out = "";
           ...
           $lin_obj  .= "  <table cellspacing=0 cellpadding=0>";
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['interativ_search']['est_estado']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['est_estado']) . "','est_estado','id_int_search_est_estado','est_estado', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['est_estado']) . "','est_estado','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'est_estado', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['est_estado']) . "','est_estado','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'est_estado', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
           $lin_obj  .= "   </div>";
           $lin_mult .= "   <div><label class='scGridRefinedSearchCampo' style='display: block;'>";
           $lin_mult .= "    <INPUT class='" . $this->css_scAppDivToolbarInput . "' type=\"checkbox\" id=\"id_int_search_est_estado\" name=\"int_search_est_estado[]\" value=\"" . NM_encode_input($dados . "##@@" . $formatado) . "\" checked><span class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</span>";
           if(!empty($veja_mais_link))
           {
               $lin_mult .= "    <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           }
           ...
           {
               $lin_obj  .= "   </div>";
               $lin_obj  .= "   <div id='id_see_less_est_estado' class='scGridRefinedSearchVejaMais' style='display:none'>";
               $lin_obj  .= "    <a href=\"javascript:toggleSeeMore('est_estado');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_less'] ."</a>";
               $lin_obj  .= "   </div>";
           }
      $lin_obj  .= "<SCRIPT>
";
      $lin_obj  .= "$( document ).ready(function() {";
      $lin_obj  .= "nm_expand_int_search('est_estado');";
      $lin_obj  .= "    adjustMobile();";
      $lin_obj  .= "});";
      $lin_obj  .= "</SCRIPT>";
       $lin_obj  .= "   </div></td></tr>";
       ...
       {
           $disp_chk = "none";
           $lin_obj  .= "   <tr><td><div class='scGridRefinedSearchMolduraResult' id=\"id_tab_est_estado_chk\" style=\"display: " . $disp_chk . ";\">";
           $lin_obj  .= $lin_mult;
           $lin_obj  .= "   </div></td></tr>";
       }
       if (count($result) > 1)
       {
           $lin_obj .= "    <tr>";
           $lin_obj .= "    <td style='display:'>";
           $lin_obj .= "    <div class='scGridRefinedSearchToolbar' id=\"id_toolbar_est_estado\" style='display:none'>";
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bmultiselect", "nm_mult_int_search('est_estado');", "nm_mult_int_search('est_estado');", "mult_int_search_est_estado", "", "", "display: $disp_link", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "multiselect", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['est_estado']) . "','est_estado','id_int_search_est_estado','est_estado', '');", "nm_proc_int_search('chbx', 'tx','" . str_replace('"', '__asp__', $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['int_search_label']['est_estado']) . "','est_estado','id_int_search_est_estado','est_estado', '');", "app_int_search_est_estado", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_cancel", "nm_single_int_search('est_estado');", "nm_single_int_search('est_estado');", "single_int_search_est_estado", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $lin_obj .= "    </div>";
       }
       $lin_obj .= "    </td>";
   ...
   function JS_interativ_search()
   {
       ...
       $nm_saida->saida("     $('#app_int_search_est.estado').click();\r\n");
       $nm_saida->saida("     }\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Reporte_Turnos_Prepuerto', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"Reporte_Turnos_Prepuerto\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"Reporte_Turnos_Prepuerto_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"Reporte_Turnos_Prepuerto_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "Reporte_Turnos_Prepuerto/Reporte_Turnos_Prepuerto_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"Reporte_Turnos_Prepuerto_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Reporte_Turnos_Prepuerto_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@Reporte_Turnos_Prepuerto@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"Reporte_Turnos_Prepuerto_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"Reporte_Turnos_Prepuerto_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['Reporte_Turnos_Prepuerto']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"Reporte_Turnos_Prepuerto_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_Turnos_Prepuerto']['reg_start']))
   {
       $nm_saida->saida("      window.onload = function() {\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('Reporte_Turnos_Prepuerto')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Reporte_Turnos_Prepuerto', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
