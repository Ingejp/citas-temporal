<?php
@session_start() ;
$_SESSION['scriptcase']['Reporte_Turnos_Prepuerto']['sc_process_barr'] = true;
require_once('../Reporte_Turnos_Prepuerto/index.php');
unset($_SESSION['scriptcase']['Reporte_Turnos_Prepuerto']['sc_process_barr']);
$ExportCtrl = new Reporte_Turnos_Prepuerto_export_control;
$ExportCtrl->Export_barr();

class Reporte_Turnos_Prepuerto_export_control
{
