<?php
@session_start() ;
$_SESSION['scriptcase']['Tunos_Despachos_Chasis']['sc_process_barr'] = true;
require_once('../Tunos_Despachos_Chasis/index.php');
unset($_SESSION['scriptcase']['Tunos_Despachos_Chasis']['sc_process_barr']);
$ExportCtrl = new Tunos_Despachos_Chasis_export_control;
$ExportCtrl->Export_barr();

class Tunos_Despachos_Chasis_export_control
{
