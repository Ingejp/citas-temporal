...
<?php
   ...
   $Ord_Cmp = new Tunos_Despachos_Chasis_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Tunos_Despachos_Chasis_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["turno"] : "TURNO";
   $tab_ger_campos['placa'] = "on";
   $tab_def_campos['placa'] = "placa";
   $tab_labels["placa"]   = (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["placa"])) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["placa"] : "PLACA";
   $tab_ger_campos['chasis'] = "on";
   $tab_def_campos['chasis'] = "chasis";
   $tab_labels["chasis"]   = (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["chasis"])) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["chasis"] : "CHASIS";
   $tab_ger_campos['piloto'] = "on";
   $tab_def_campos['piloto'] = "PILOTO";
   $tab_labels["piloto"]   = (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["piloto"])) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["piloto"] : "PILOTO";
   $tab_ger_campos['contenedorexport'] = "on";
   $tab_def_campos['contenedorexport'] = "contenedorExport";
   $tab_labels["contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["contenedorexport"] : "CONT_EXPORT";
   $tab_ger_campos['contenedorimport'] = "on";
   $tab_def_campos['contenedorimport'] = "contenedorimport";
   $tab_labels["contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["contenedorimport"] : "CONT_IMPORT";
   $tab_ger_campos['viaje'] = "on";
   $tab_def_campos['viaje'] = "VIAJE";
   $tab_labels["viaje"]   = (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["viaje"])) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['labels']["viaje"] : "VIAJE";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Tunos_Despachos_Chasis_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Tunos_Despachos_Chasis']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
