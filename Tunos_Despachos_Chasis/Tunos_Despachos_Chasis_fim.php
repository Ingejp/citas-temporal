...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Tunos_Despachos_Chasis"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Tunos_Despachos_Chasis"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Tunos_Despachos_Chasis']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Tunos_Despachos_Chasis']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Tunos_Despachos_Chasis']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Tunos_Despachos_Chasis']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Tunos_Despachos_Chasis']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Tunos_Despachos_Chasis</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Tunos_Despachos_Chasis']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Tunos_Despachos_Chasis']['embutida_filho'] as $ind => $sc_init)
          {
