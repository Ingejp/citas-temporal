<?php
@session_start() ;
$_SESSION['scriptcase']['Boleta_Pesaje']['sc_process_barr'] = true;
require_once('../Boleta_Pesaje/index.php');
unset($_SESSION['scriptcase']['Boleta_Pesaje']['sc_process_barr']);
$ExportCtrl = new Boleta_Pesaje_export_control;
$ExportCtrl->Export_barr();

class Boleta_Pesaje_export_control
{
