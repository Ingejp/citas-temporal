...
//
   ...
   $_SESSION['scriptcase']['Boleta_Pesaje']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("Boleta_Pesaje", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['idweighing'] = "Idweighing";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['container'] = "Container";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['vessel'] = "Vessel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['shippingcompany'] = "Shipping Company";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['voyage'] = "Voyage";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['date'] = "Date";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['commodity'] = "Commodity";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['tarechassis'] = "Tare Chassis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['tarecontainer'] = "Tare Container";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['grossweight'] = "Gross Weight";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['netweight'] = "Net Weight";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['packages'] = "Packages";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['country'] = "Country";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['typeoperation'] = "Type Operation";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['vgm'] = "VGM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['qr'] = "QR";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['codigo'] = "CODIGO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['exitticket'] = "Exit Ticket";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['inticket'] = "In Ticket";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['licenseplate'] = "License Plate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['driverslicense'] = "Drivers License";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['pilotname'] = "Pilot Name";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['transportname'] = "Transport Name";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['chasis'] = "Chasis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['machine'] = "Machine";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['bl'] = "Bl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['out'] = "Out";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['labels']['in'] = "In";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Boleta_Pesaje']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['Boleta_Pesaje']['qt_col_grid']) 
      {  
