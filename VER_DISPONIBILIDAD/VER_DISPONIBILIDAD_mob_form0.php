...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("VER_DISPONIBILIDAD_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('VER_DISPONIBILIDAD_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['VER_DISPONIBILIDAD']['error_buffer']) && '' != $_SESSION['scriptcase']['VER_DISPONIBILIDAD']['error_buffer'])
{
    echo $_SESSION['scriptcase']['VER_DISPONIBILIDAD']['error_buffer'];
}
...
<?php
 include_once("VER_DISPONIBILIDAD_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="VER_DISPONIBILIDAD_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['VER_DISPONIBILIDAD_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['VER_DISPONIBILIDAD_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechamodificacion_line" id="hidden_field_data_fechamodificacion" style="<?php echo $sStyleHidden_fechamodificacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechamodificacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechamodificacion_label"><span id="id_label_fechamodificacion"><?php echo $this->nm_new_label['fechamodificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fechamodificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_citas_disponibles_line" id="hidden_field_data_citas_disponibles" style="<?php echo $sStyleHidden_citas_disponibles; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_citas_disponibles_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_citas_disponibles_label"><span id="id_label_citas_disponibles"><?php echo $this->nm_new_label['citas_disponibles']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['citas_disponibles']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['citas_disponibles'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_horafin_line" id="hidden_field_data_horafin" style="<?php echo $sStyleHidden_horafin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_horafin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_horafin_label"><span id="id_label_horafin"><?php echo $this->nm_new_label['horafin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['horafin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup___calend_all_day__'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'D'; ?>
 <option  value="W" <?php  if ($this->periodo == "W") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_weekly']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'W'; ?>
 <option  value="M" <?php  if ($this->periodo == "M") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_monthly']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'M'; ?>
 <option  value="A" <?php  if ($this->periodo == "A") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_recu_annual']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'A'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_reaparicion'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_reaparicion'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("VER_DISPONIBILIDAD_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("VER_DISPONIBILIDAD_mob");
 parent.scAjaxDetailHeight("VER_DISPONIBILIDAD_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
