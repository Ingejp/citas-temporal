...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_rangoinicial_hora' + iSeqRow).bind('blur', function() { sc_VER_DISPONIBILIDAD_rangoinicial_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_VER_DISPONIBILIDAD_rangoinicial_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_rangofinal_hora' + iSeqRow).bind('blur', function() { sc_VER_DISPONIBILIDAD_rangofinal_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_VER_DISPONIBILIDAD_rangofinal_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fecharegistro_hora' + iSeqRow).bind('blur', function() { sc_VER_DISPONIBILIDAD_fecharegistro_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_VER_DISPONIBILIDAD_fecharegistro_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fechamodificacion_hora' + iSeqRow).bind('blur', function() { sc_VER_DISPONIBILIDAD_fechamodificacion_onblur(this, iSeqRow) })
                                                    .bind('focus', function() { sc_VER_DISPONIBILIDAD_fechamodificacion_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_VER_DISPONIBILIDAD_mob_form" + pageNo).hide();
}
...
function scEventControl_onCalculator_recur_info() {
  if (!_scCalculatorControl["id_sc_field_recur_info"]) {
    ...
    do_ajax_VER_DISPONIBILIDAD_mob_event_recur_info_onblur();
  }
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_rangofinal" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_VER_DISPONIBILIDAD_mob_validate_rangofinal(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecharegistro" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_VER_DISPONIBILIDAD_mob_validate_fecharegistro(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechamodificacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_VER_DISPONIBILIDAD_mob_validate_fechamodificacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_rangoinicial" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_VER_DISPONIBILIDAD_mob_validate_rangoinicial(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
