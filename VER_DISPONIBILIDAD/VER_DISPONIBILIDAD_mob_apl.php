<?php
//
class VER_DISPONIBILIDAD_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_VER_DISPONIBILIDAD_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new VER_DISPONIBILIDAD_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['VER_DISPONIBILIDAD_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['VER_DISPONIBILIDAD_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['VER_DISPONIBILIDAD_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['VER_DISPONIBILIDAD_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['VER_DISPONIBILIDAD_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('VER_DISPONIBILIDAD_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['VER_DISPONIBILIDAD_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - asignacionmodulista";
      ...
      $_SESSION['scriptcase']['error_icon']['VER_DISPONIBILIDAD_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['VER_DISPONIBILIDAD_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['VER_DISPONIBILIDAD_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['VER_DISPONIBILIDAD_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['VER_DISPONIBILIDAD_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("VER_DISPONIBILIDAD_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'VER_DISPONIBILIDAD/VER_DISPONIBILIDAD_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'VER_DISPONIBILIDAD_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'VER_DISPONIBILIDAD_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'VER_DISPONIBILIDAD_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'VER_DISPONIBILIDAD/VER_DISPONIBILIDAD_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "VER_DISPONIBILIDAD_mob_erro.class.php"); 
      }
      $this->Erro      = new VER_DISPONIBILIDAD_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['VER_DISPONIBILIDAD_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          VER_DISPONIBILIDAD_mob_pack_ajax_response();
          exit;
      }
      if (isset($this->sc_inline_call) && 'Y' == $this->sc_inline_call)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['VER_DISPONIBILIDAD_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "VER_DISPONIBILIDAD_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="VER_DISPONIBILIDAD_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="VER_DISPONIBILIDAD_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="VER_DISPONIBILIDAD_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_VER_DISPONIBILIDAD_mob']) || !is_array($this->NM_ajax_info['errList']['geral_VER_DISPONIBILIDAD_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_VER_DISPONIBILIDAD_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_VER_DISPONIBILIDAD_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['bypass_required_time']['horainicio'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['bypass_required_time']['horainicio'] = false;
...
//---
    ...
    function ValidateField_rangofinal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangofinal'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangofinal_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangofinal_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Rango Final" ; 
              if (!isset($Campos_Erros['rangofinal_hora']))
    ...
    function ValidateField_fecharegistro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fecharegistro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fecharegistro'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fecharegistro_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fecharegistro_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Registro" ; 
              if (!isset($Campos_Erros['fecharegistro_hora']))
    ...
    function ValidateField_fechamodificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fechamodificacion'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fechamodificacion_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['fechamodificacion_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Modificacion" ; 
              if (!isset($Campos_Erros['fechamodificacion_hora']))
    ...
    function ValidateField_idtipodemodulista(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipodemodulista) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_idtipodemodulista']) && !in_array($this->idtipodemodulista, $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_idtipodemodulista']))
               {
                   $hasError = true;
    ...
    function ValidateField_citas_disponibles(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['citas_disponibles']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['citas_disponibles'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Citas Disponibles" ; 
              if (!isset($Campos_Erros['citas_disponibles']))
              {
                  $Campos_Erros['citas_disponibles'] = array();
              }
              $Campos_Erros['citas_disponibles'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['citas_disponibles']) || !is_array($this->NM_ajax_info['errList']['citas_disponibles']))
                  {
                      $this->NM_ajax_info['errList']['citas_disponibles'] = array();
                  }
                  $this->NM_ajax_info['errList']['citas_disponibles'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_rangoinicial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangoinicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangoinicial'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangoinicial_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['rangoinicial_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Rango Inicial" ; 
              if (!isset($Campos_Erros['rangoinicial_hora']))
    ...
    function ValidateField_horafin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['horafin'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_horainicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['php_cmp_required']['horainicio'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['bypass_required_time']['horainicio']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['bypass_required_time']['horainicio'])
              {
              $hasError = true;
    ...
    function ValidateField_periodo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->periodo == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_reaparicion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->reaparicion == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idasignacionmodulista']['keyVal'] = VER_DISPONIBILIDAD_mob_pack_protect_string($this->nmgp_dados_form['idasignacionmodulista']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_idtipodemodulista']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_idtipodemodulista'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_idtipodemodulista']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_idtipodemodulista'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', VER_DISPONIBILIDAD_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_idtipodemodulista'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodemodulista']['valList'][$i] = VER_DISPONIBILIDAD_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('1') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_category_personal'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('2') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_category_work'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('3') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_category_family'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('4') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_category_friends'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('5') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_category_others'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_category'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_category'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_category'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_category'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_category'][] = '5';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"category\"";
          if (isset($this->NM_ajax_info['select_html']['category']) && !empty($this->NM_ajax_info['select_html']['category']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['category'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          {
              $this->NM_ajax_info['fldList']['category']['valList'][$i] = VER_DISPONIBILIDAD_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('Y') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_per_allday'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup___calend_all_day__'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['__calend_all_day__']['valList'][$i] = VER_DISPONIBILIDAD_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('D') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_daily'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('W') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_weekly'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('M') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_monthly'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('A') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_annual'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'D';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'W';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_periodo'][] = 'A';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"periodo\"";
          if (isset($this->NM_ajax_info['select_html']['periodo']) && !empty($this->NM_ajax_info['select_html']['periodo']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['periodo'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          {
              $this->NM_ajax_info['fldList']['periodo']['valList'][$i] = VER_DISPONIBILIDAD_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_reaparicion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("reaparicion", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_reaparicion = $this->reaparicion;

$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('Y') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_yes'] . ""));
$aLookup[] = array(VER_DISPONIBILIDAD_mob_pack_protect_string('N') => VER_DISPONIBILIDAD_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_no'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_reaparicion'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['Lookup_reaparicion'][] = 'N';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"reaparicion\"";
          if (isset($this->NM_ajax_info['select_html']['reaparicion']) && !empty($this->NM_ajax_info['select_html']['reaparicion']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['reaparicion'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->reaparicion == $sValue)
                  {
                      $this->_tmp_lookup_reaparicion = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['reaparicion']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['reaparicion']['valList'][$i] = VER_DISPONIBILIDAD_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['reaparicion']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['reaparicion']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['reaparicion']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_recur_info($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idasignacionmodulista)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opcao'] = '';
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['VER_DISPONIBILIDAD_mob']['contr_erro'] = 'on';
             /* detalle_asaignacion */
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_VER_DISPONIBILIDAD_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['VER_DISPONIBILIDAD_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('idasignacionmodulista', 'descripcion', 'cantidadmodulistas', 'rangofinal', 'fecharegistro', 'fechamodificacion', 'id_api', 'event_color', 'idtipodemodulista', 'category', 'citas_disponibles', 'citas_reservadas', 'rangoinicial', 'horafin', 'horainicio', '__calend_all_day__', 'periodo', 'reaparicion', 'recur_info'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['parms'] = "idasignacionmodulista?#?$this->idasignacionmodulista?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dados_select'] = $this->nmgp_dados_select;
      ...
      { 
          ...
          if (isset($this->sc_cal_click_date) && isset($this->sc_cal_click_time))
          {
              ...
              $this->horafin      = date('Y-m-d' . $sTimeFormat2, $iTimestampEnd);
              $this->horafin_hora = date('Y-m-d' . $sTimeFormat2, $iTimestampEnd);
          }
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    if (('' == $this->horainicio || '00:00:00' == $this->horainicio) && ('' == $this->horafin_hora || '00:00:00' == $this->horafin_hora))
    {
        $this->__calend_all_day__ = 'Y';
    }

    include_once("VER_DISPONIBILIDAD_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_outra_jan'] != 'VER_DISPONIBILIDAD_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
@media (max-width: 853px) {
 ...
 <script type="text/javascript">
  ...
  function calendar_print() {
      $.ajax({
          url: 'VER_DISPONIBILIDAD_mob.php',
          type: 'GET',
          dataType: 'json',
          data: {
...
?>
      events: 'VER_DISPONIBILIDAD_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'VER_DISPONIBILIDAD_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'VER_DISPONIBILIDAD_mob.php?nmgp_opcao=igual_calendar&idasignacionmodulista=' + calEvent.id + '&__orig_idasignacionmodulista=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'VER_DISPONIBILIDAD_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'VER_DISPONIBILIDAD_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<div class='scCalendarBorder'>
    <?php
if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard']) {
?>
<style type="text/css">
...
<div style="width: 260px; display: inline-block;">
     ...
     <div class='scCalendarCategory'>
      <div class='scCalendarCategoryTitle'><?php echo html_entity_decode($this->Ini->Nm_lang["lang_calendar_categories"], ENT_COMPAT, $_SESSION["scriptcase"]["charset"]); ?></div>
       ...
       <div class='scCalendarCategoryItemsMoldura'>
        <div class='scCalendarCategoryItem scCalendarCategoryItemActive' onclick="filterCategory('1')" id='id_calendar_category_1'>
        ...
        <div class='scCalendarCategoryItem scCalendarCategoryItemActive' onclick="filterCategory('2')" id='id_calendar_category_2'>
        ...
        <div class='scCalendarCategoryItem scCalendarCategoryItemActive' onclick="filterCategory('3')" id='id_calendar_category_3'>
        ...
        <div class='scCalendarCategoryItem scCalendarCategoryItemActive' onclick="filterCategory('4')" id='id_calendar_category_4'>
        ...
        <div class='scCalendarCategoryItem scCalendarCategoryItemActive' onclick="filterCategory('5')" id='id_calendar_category_5'>
...
<?php
   ...
   function calendarFetchSelect($googleInfo = false)
   {
       ...
       $aSelect['title'] = "citas_disponibles";

       $aSelect['description'] = "horaInicio";
       ...
       if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
       {
           $aSelect['end'] = "convert(char(8),horaFin,108)";
       }
       elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
       {
           $aSelect['end'] = "str_replace(convert(char(10),horaFin,102), '.', '-') + ' ' + convert(char(8),horaFin,20)";
       }
       else
       {
           $aSelect['end'] = "horaFin";
   ...
   function calendarWhere($sId, $bRecur, $bPrintCalendar = false, $filter = null)
   {
       ...
       if (null === $filter) {
           ...
           if ('' != $sStart && '' != $sEnd)
           {
               ...
               if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
               {
                   $aWhere[] = "convert(char(8),horaFin,108) >= '" . $s_Fin_StartFormat . "' AND convert(char(8),horaFin,108) <= '" . $s_Fin_EndFormat . "'";
                   $aWhere[] = "convert(char(23),rangoInicial,121) <= '" . $s_Ini_StartFormat . "' AND convert(char(8),horaFin,108) >= '" . $s_Fin_EndFormat . "'";
               }
               elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
               {
                   $aWhere[] = "str_replace(convert(char(10),horaFin,102), '.', '-') + ' ' + convert(char(8),horaFin,20) >= '" . $s_Fin_StartFormat . "' AND str_replace(convert(char(10),horaFin,102), '.', '-') + ' ' + convert(char(8),horaFin,20) <= '" . $s_Fin_EndFormat . "'";
                   $aWhere[] = "str_replace(convert(char(10),rangoInicial,102), '.', '-') + ' ' + convert(char(8),rangoInicial,20) <= '" . $s_Ini_StartFormat . "' AND str_replace(convert(char(10),horaFin,102), '.', '-') + ' ' + convert(char(8),horaFin,20) >= '" . $s_Fin_EndFormat . "'";
               }
               elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
               {
                   $aWhere[] = "horaFin >= #" . $s_Fin_StartFormat . "# AND horaFin <= #" . $s_Fin_EndFormat . "#";
                   $aWhere[] = "rangoInicial <= #" . $s_Ini_StartFormat . "# AND horaFin >= #" . $s_Fin_EndFormat . "#";
               }
               else
               {
                   $aWhere[] = "horaFin >= '" . $s_Fin_StartFormat . "' AND horaFin <= '" . $s_Fin_EndFormat . "'";
   ...
   function calendarUpdateEvent($sOp, $sId, $iDays, $iMinutes, $bAllDay, $fullcalendarStart, $fullcalendarEnd)
   {
       ...
       if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
       {
           $sSql = 'UPDATE ' . $this->Ini->nm_tabela . " SET rangoInicial = #" . $aEvent['start'] . "#, horaInicio = #" . $aEvent['start_time'] . "#, horaFin = #" . $aEvent['end'] . "#" . $this->calendarWhere($sId);
       }
       elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
       {
           $sSql = 'UPDATE ' . $this->Ini->nm_tabela . " SET rangoInicial = EXTEND(rangoInicial, YEAR TO FRACTION)" . $this->calendarWhere($sId);
       }
       else
       {
           $sSql = 'UPDATE ' . $this->Ini->nm_tabela . " SET rangoInicial = '" . $aEvent['start'] . "', horaInicio = '" . $aEvent['start_time'] . "', horaFin = '" . $aEvent['end'] . "'" . $this->calendarWhere($sId);
   ...
   function calendarEndToTimestamp($aEvent)
   {
       ...
       $iHour   = (integer) substr($aEvent['end'], 11, 2);
       $iMinute = (integer) substr($aEvent['end'], 14, 2);
       $iSecond = (integer) substr($aEvent['end'], 17, 2);
   ...
   function calendarTimestampToEnd(&$aEvent, $iTimestamp, $bAllDay)
   {
       ...
       $aEvent['end'] = date('Y-m-d H:i:s', $iTimestamp);
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_reaparicion()
   {
       $nmgp_def_dados  = "";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_VER_DISPONIBILIDAD_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['total'] = $qt_geral_reg_VER_DISPONIBILIDAD_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          VER_DISPONIBILIDAD_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "VER_DISPONIBILIDAD_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "VER_DISPONIBILIDAD_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
