  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_VER_DISPONIBILIDAD" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_VER_DISPONIBILIDAD_form();
	}

  // ---------- Validate idasignacionmodulista
  function do_ajax_VER_DISPONIBILIDAD_validate_idasignacionmodulista()
  {
    ...
    x_ajax_VER_DISPONIBILIDAD_validate_idasignacionmodulista(var_idasignacionmodulista, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_idasignacionmodulista_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_idasignacionmodulista

  function do_ajax_VER_DISPONIBILIDAD_validate_idasignacionmodulista_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_idasignacionmodulista_cb

  // ---------- Validate descripcion
  function do_ajax_VER_DISPONIBILIDAD_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_descripcion_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_descripcion

  function do_ajax_VER_DISPONIBILIDAD_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_descripcion_cb

  // ---------- Validate cantidadmodulistas
  function do_ajax_VER_DISPONIBILIDAD_validate_cantidadmodulistas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_cantidadmodulistas(var_cantidadmodulistas, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_cantidadmodulistas_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_cantidadmodulistas

  function do_ajax_VER_DISPONIBILIDAD_validate_cantidadmodulistas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_cantidadmodulistas_cb

  // ---------- Validate rangofinal
  function do_ajax_VER_DISPONIBILIDAD_validate_rangofinal()
  {
    var nomeCampo_rangofinal = "rangofinal";
    var var_rangofinal = scAjaxGetFieldText(nomeCampo_rangofinal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_rangofinal(var_rangofinal, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_rangofinal_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_rangofinal

  function do_ajax_VER_DISPONIBILIDAD_validate_rangofinal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_rangofinal_cb

  // ---------- Validate fecharegistro
  function do_ajax_VER_DISPONIBILIDAD_validate_fecharegistro()
  {
    var nomeCampo_fecharegistro = "fecharegistro";
    var var_fecharegistro = scAjaxGetFieldText(nomeCampo_fecharegistro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_fecharegistro(var_fecharegistro, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_fecharegistro_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_fecharegistro

  function do_ajax_VER_DISPONIBILIDAD_validate_fecharegistro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_fecharegistro_cb

  // ---------- Validate fechamodificacion
  function do_ajax_VER_DISPONIBILIDAD_validate_fechamodificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_fechamodificacion(var_fechamodificacion, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_fechamodificacion_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_fechamodificacion

  function do_ajax_VER_DISPONIBILIDAD_validate_fechamodificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_fechamodificacion_cb

  // ---------- Validate id_api
  function do_ajax_VER_DISPONIBILIDAD_validate_id_api()
  {
    var nomeCampo_id_api = "id_api";
    var var_id_api = scAjaxGetFieldText(nomeCampo_id_api);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_id_api(var_id_api, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_id_api_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_id_api

  function do_ajax_VER_DISPONIBILIDAD_validate_id_api_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_api";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_id_api_cb

  // ---------- Validate event_color
  function do_ajax_VER_DISPONIBILIDAD_validate_event_color()
  {
    var nomeCampo_event_color = "event_color";
    var var_event_color = scAjaxGetFieldText(nomeCampo_event_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_event_color(var_event_color, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_event_color_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_event_color

  function do_ajax_VER_DISPONIBILIDAD_validate_event_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_event_color_cb

  // ---------- Validate idtipodemodulista
  function do_ajax_VER_DISPONIBILIDAD_validate_idtipodemodulista()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_idtipodemodulista(var_idtipodemodulista, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_idtipodemodulista_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_idtipodemodulista

  function do_ajax_VER_DISPONIBILIDAD_validate_idtipodemodulista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_idtipodemodulista_cb

  // ---------- Validate category
  function do_ajax_VER_DISPONIBILIDAD_validate_category()
  {
    var nomeCampo_category = "category";
    var var_category = scAjaxGetFieldSelect(nomeCampo_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_category(var_category, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_category_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_category

  function do_ajax_VER_DISPONIBILIDAD_validate_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_category_cb

  // ---------- Validate citas_disponibles
  function do_ajax_VER_DISPONIBILIDAD_validate_citas_disponibles()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_citas_disponibles(var_citas_disponibles, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_citas_disponibles_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_citas_disponibles

  function do_ajax_VER_DISPONIBILIDAD_validate_citas_disponibles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_citas_disponibles_cb

  // ---------- Validate citas_reservadas
  function do_ajax_VER_DISPONIBILIDAD_validate_citas_reservadas()
  {
    var nomeCampo_citas_reservadas = "citas_reservadas";
    var var_citas_reservadas = scAjaxGetFieldText(nomeCampo_citas_reservadas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_citas_reservadas(var_citas_reservadas, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_citas_reservadas_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_citas_reservadas

  function do_ajax_VER_DISPONIBILIDAD_validate_citas_reservadas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_citas_reservadas_cb

  // ---------- Validate rangoinicial
  function do_ajax_VER_DISPONIBILIDAD_validate_rangoinicial()
  {
    var nomeCampo_rangoinicial = "rangoinicial";
    var var_rangoinicial = scAjaxGetFieldText(nomeCampo_rangoinicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_rangoinicial(var_rangoinicial, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_rangoinicial_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_rangoinicial

  function do_ajax_VER_DISPONIBILIDAD_validate_rangoinicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_rangoinicial_cb

  // ---------- Validate horafin
  function do_ajax_VER_DISPONIBILIDAD_validate_horafin()
  {
    var nomeCampo_horafin = "horafin";
    var var_horafin = scAjaxGetFieldText(nomeCampo_horafin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_horafin(var_horafin, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_horafin_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_horafin

  function do_ajax_VER_DISPONIBILIDAD_validate_horafin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horafin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_horafin_cb

  // ---------- Validate horainicio
  function do_ajax_VER_DISPONIBILIDAD_validate_horainicio()
  {
    var nomeCampo_horainicio = "horainicio";
    var var_horainicio = scAjaxGetFieldText(nomeCampo_horainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_horainicio(var_horainicio, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_horainicio_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_horainicio

  function do_ajax_VER_DISPONIBILIDAD_validate_horainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_horainicio_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_VER_DISPONIBILIDAD_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate___calend_all_day___cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate___calend_all_day__

  function do_ajax_VER_DISPONIBILIDAD_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate___calend_all_day___cb

  // ---------- Validate periodo
  function do_ajax_VER_DISPONIBILIDAD_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldSelect(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_periodo(var_periodo, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_periodo_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_periodo

  function do_ajax_VER_DISPONIBILIDAD_validate_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_periodo_cb

  // ---------- Validate reaparicion
  function do_ajax_VER_DISPONIBILIDAD_validate_reaparicion()
  {
    var nomeCampo_reaparicion = "reaparicion";
    var var_reaparicion = scAjaxGetFieldSelect(nomeCampo_reaparicion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_reaparicion(var_reaparicion, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_reaparicion_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_reaparicion

  function do_ajax_VER_DISPONIBILIDAD_validate_reaparicion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_reaparicion_cb

  // ---------- Validate recur_info
  function do_ajax_VER_DISPONIBILIDAD_validate_recur_info()
  {
    var nomeCampo_recur_info = "recur_info";
    var var_recur_info = scAjaxGetFieldRecurInfo(nomeCampo_recur_info);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_VER_DISPONIBILIDAD_validate_recur_info(var_recur_info, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_validate_recur_info_cb);
  } // do_ajax_VER_DISPONIBILIDAD_validate_recur_info

  function do_ajax_VER_DISPONIBILIDAD_validate_recur_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_VER_DISPONIBILIDAD_validate_recur_info_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_VER_DISPONIBILIDAD_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_VER_DISPONIBILIDAD_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_VER_DISPONIBILIDAD_submit_form(var_idasignacionmodulista, var_descripcion, var_cantidadmodulistas, var_rangofinal, var_fecharegistro, var_fechamodificacion, var_id_api, var_event_color, var_idtipodemodulista, var_category, var_citas_disponibles, var_citas_reservadas, var_rangoinicial, var_horafin, var_horainicio, var___calend_all_day__, var_periodo, var_reaparicion, var_recur_info, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_VER_DISPONIBILIDAD_submit_form_cb);
  } // do_ajax_VER_DISPONIBILIDAD_submit_form

  function do_ajax_VER_DISPONIBILIDAD_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_VER_DISPONIBILIDAD_submit_form_cb_after_alert);
  } // do_ajax_VER_DISPONIBILIDAD_submit_form_cb
  function do_ajax_VER_DISPONIBILIDAD_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_VER_DISPONIBILIDAD_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_VER_DISPONIBILIDAD_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_VER_DISPONIBILIDAD_navigate_form(var_idasignacionmodulista, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_VER_DISPONIBILIDAD_navigate_form_cb);
  } // do_ajax_VER_DISPONIBILIDAD_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['VER_DISPONIBILIDAD']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_VER_DISPONIBILIDAD_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_VER_DISPONIBILIDAD_navigate_form_cb_after_alert);
  } // do_ajax_VER_DISPONIBILIDAD_navigate_form_cb
  function do_ajax_VER_DISPONIBILIDAD_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_VER_DISPONIBILIDAD_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_VER_DISPONIBILIDAD_navigate_form_cb_after_alert
  function sc_hide_VER_DISPONIBILIDAD_form()
  {
