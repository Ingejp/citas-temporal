...
$old_error_handler = set_error_handler("form_entidad_de_estado_scriptcase_error_handler");

function form_entidad_de_estado_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_entidad_de_estado']['contr_erro']) && $_SESSION['scriptcase']['form_entidad_de_estado']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_entidad_de_estado->contr_form_entidad_de_estado->Apl_com_erro = true;
            if ($inicial_form_entidad_de_estado->contr_form_entidad_de_estado->NM_ajax_flag)
            {
                $inicial_form_entidad_de_estado->contr_form_entidad_de_estado->NM_ajax_info['errList']['geral_form_entidad_de_estado'][] = $msg;
                return;
            }
            form_entidad_de_estado_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_entidad_de_estado_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_entidad_de_estado'])  && '' != $_SESSION['scriptcase']['error_icon']['form_entidad_de_estado'])  ? $_SESSION['scriptcase']['error_icon']['form_entidad_de_estado']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_entidad_de_estado']) && '' != $_SESSION['scriptcase']['error_span_title']['form_entidad_de_estado']) ? $_SESSION['scriptcase']['error_span_title']['form_entidad_de_estado'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_entidad_de_estado']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_entidad_de_estado']) ? $_SESSION['scriptcase']['error_icon_title']['form_entidad_de_estado'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_entidad_de_estado']['error_buffer'] .= ob_get_flush();
}
