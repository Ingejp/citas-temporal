...
//
   function init()
   {
      ...
      $this->nm_dt_ult_alt   = "20200410"; 
      $this->nm_hr_ult_alt   = "111241"; 
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
                $_SESSION['scriptcase']['sec_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
            }
        }
    }
...
//
    ...
    function ajax_sec_Login_submit_form($login, $pswd, $links, $links_sc_target_name, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_sec_Login;
        //register_shutdown_function("sec_Login_pack_ajax_response");
        $inicial_sec_Login->contr_sec_Login->NM_ajax_flag          = true;
