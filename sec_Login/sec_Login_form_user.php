...
?>
        ...
        <link rel="stylesheet" href="../_lib/libraries/scriptcase/samples/login/css/login04.css">
        <link rel="stylesheet" type="text/css" href="../_lib/libraries/scriptcase/samples/libs/bootstrap/css/bootstrap.min.css" />   
		...
		<div class="page">
			<div class="container">
              <div class="card card-container">
                  ...
                  <img id="profile-img" class="profile-img-card" src="../_lib/libraries/scriptcase/samples/login/img/avatar.png" />
...
<input type="hidden" name="csrf_token" value="<?php echo $this->scCsrfGetToken() ?>" />
                      ...
                      <input type="password" id="inputPassword" class="form-control  sc-js-input "  name="pswd" id="id_sc_field_pswd" value="<?php echo $this->form_encode_input($pswd) ?>"  alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"  placeholder="Password" required>
						* <?php echo $this->Ini->Nm_lang['lang_othr_reqr']; ?>
						<!--SC_CAPTCHA-->
                      <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit"  onclick="nm_atualiza('alterar');" >Sign in</button>
