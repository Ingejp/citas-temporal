...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->login; ?></span><span id="id_read_off_login" class="css_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=10 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</TD>
   <?php }?>
...
<input type="hidden" name="links_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_links('#', '_self')"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<br>

 <a href="javascript:nm_menu_link_links('#', '_self')"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
