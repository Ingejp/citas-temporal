...
$old_error_handler = set_error_handler("sec_Login_scriptcase_error_handler");

function sec_Login_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['sec_Login']['contr_erro']) && $_SESSION['scriptcase']['sec_Login']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_sec_Login->contr_sec_Login->Apl_com_erro = true;
            if ($inicial_sec_Login->contr_sec_Login->NM_ajax_flag)
            {
                $inicial_sec_Login->contr_sec_Login->NM_ajax_info['errList']['geral_sec_Login'][] = $msg;
                return;
            }
            sec_Login_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function sec_Login_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['sec_Login'])  && '' != $_SESSION['scriptcase']['error_icon']['sec_Login'])  ? $_SESSION['scriptcase']['error_icon']['sec_Login']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['sec_Login']) && '' != $_SESSION['scriptcase']['error_close']['sec_Login']) ? $_SESSION['scriptcase']['error_close']['sec_Login'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['sec_Login']) && '' != $_SESSION['scriptcase']['error_span_title']['sec_Login']) ? $_SESSION['scriptcase']['error_span_title']['sec_Login'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['sec_Login']) && '' != $_SESSION['scriptcase']['error_icon_title']['sec_Login']) ? $_SESSION['scriptcase']['error_icon_title']['sec_Login'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['sec_Login']['error_buffer'] .= ob_get_flush();
}
