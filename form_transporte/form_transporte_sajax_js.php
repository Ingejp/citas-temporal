  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_transporte" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_transporte_form();
	}

  // ---------- Validate idtransporte
  function do_ajax_form_transporte_validate_idtransporte()
  {
    var nomeCampo_idtransporte = "idtransporte";
    var var_idtransporte = scAjaxGetFieldHidden(nomeCampo_idtransporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transporte_validate_idtransporte(var_idtransporte, var_script_case_init, do_ajax_form_transporte_validate_idtransporte_cb);
  } // do_ajax_form_transporte_validate_idtransporte

  function do_ajax_form_transporte_validate_idtransporte_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transporte_validate_idtransporte_cb

  // ---------- Validate transporte
  function do_ajax_form_transporte_validate_transporte()
  {
    var nomeCampo_transporte = "transporte";
    var var_transporte = scAjaxGetFieldText(nomeCampo_transporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transporte_validate_transporte(var_transporte, var_script_case_init, do_ajax_form_transporte_validate_transporte_cb);
  } // do_ajax_form_transporte_validate_transporte

  function do_ajax_form_transporte_validate_transporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transporte_validate_transporte_cb

  // ---------- Validate telefono
  function do_ajax_form_transporte_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transporte_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_transporte_validate_telefono_cb);
  } // do_ajax_form_transporte_validate_telefono

  function do_ajax_form_transporte_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transporte_validate_telefono_cb

  // ---------- Validate correo
  function do_ajax_form_transporte_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transporte_validate_correo(var_correo, var_script_case_init, do_ajax_form_transporte_validate_correo_cb);
  } // do_ajax_form_transporte_validate_correo

  function do_ajax_form_transporte_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transporte_validate_correo_cb

  // ---------- Event onchange transporte
  function do_ajax_form_transporte_event_transporte_onchange()
  {
    var var_transporte = scAjaxGetFieldText("transporte");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_transporte_event_transporte_onchange(var_transporte, var_script_case_init, do_ajax_form_transporte_event_transporte_onchange_cb);
  } // do_ajax_form_transporte_event_transporte_onchange

  function do_ajax_form_transporte_event_transporte_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "transporte";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_transporte_event_transporte_onchange_cb_after_alert);
  } // do_ajax_form_transporte_event_transporte_onchange_cb
  function do_ajax_form_transporte_event_transporte_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_transporte_event_transporte_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_transporte_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_transporte_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_transporte_submit_form(var_idtransporte, var_transporte, var_telefono, var_correo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_transporte_submit_form_cb);
  } // do_ajax_form_transporte_submit_form

  function do_ajax_form_transporte_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_transporte_submit_form_cb_after_alert);
  } // do_ajax_form_transporte_submit_form_cb
  function do_ajax_form_transporte_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_transporte_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_transporte_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_transporte_navigate_form(var_idtransporte, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_transporte_navigate_form_cb);
  } // do_ajax_form_transporte_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_transporte']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_transporte_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_transporte_navigate_form_cb_after_alert);
  } // do_ajax_form_transporte_navigate_form_cb
  function do_ajax_form_transporte_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_transporte_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_transporte_navigate_form_cb_after_alert
  function sc_hide_form_transporte_form()
  {
