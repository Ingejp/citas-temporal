...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['registro_turnos']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['registro_turnos']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['registro_turnos']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['registro_turnos']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['registro_turnos']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['registro_turnos']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->VIGENTE) && isset($this->vigente)) 
          {
              $this->VIGENTE = $this->vigente;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['registro_turnos']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['registro_turnos']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['registro_turnos']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['registro_turnos']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['registro_turnos']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['registro_turnos']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['registro_turnos']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['registro_turnos']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['registro_turnos']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new registro_turnos_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['initialize'])
          {
              $_SESSION['scriptcase']['registro_turnos']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['registro_turnos']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['registro_turnos']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['registro_turnos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['registro_turnos'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['registro_turnos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['registro_turnos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('registro_turnos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['registro_turnos']['label'] = "registro_turnos";
      ...
      $_SESSION['scriptcase']['error_icon']['registro_turnos']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['registro_turnos'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['registro_turnos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['registro_turnos'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'registro_turnos/registro_turnos_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'registro_turnos_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'registro_turnos_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'registro_turnos_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'registro_turnos/registro_turnos_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "registro_turnos_erro.class.php"); 
      }
      $this->Erro      = new registro_turnos_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao']))
         { 
             if ($this->idcita != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idpiloto']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idpiloto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idpiloto']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idpiloto'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(registro_turnos_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', registro_turnos_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idpiloto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idcabezal']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idcabezal'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idcabezal']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idcabezal'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idcabezal'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idviaje']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idviaje'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idviaje']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idviaje'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idviaje'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "registro_turnos.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="registro_turnos_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="registro_turnos"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_registro_turnos']) || !is_array($this->NM_ajax_info['errList']['geral_registro_turnos']))
              {
                  $this->NM_ajax_info['errList']['geral_registro_turnos'] = array();
              }
              $this->NM_ajax_info['errList']['geral_registro_turnos'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_codigo_cita(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['codigo_cita']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['codigo_cita'] == "on")) 
      { 
          if ($this->codigo_cita == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_idtipomovimiento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipomovimiento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipomovimiento']) && !in_array($this->idtipomovimiento, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipomovimiento']))
               {
                   $hasError = true;
    ...
    function ValidateField_idestado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idestado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idestado']) && !in_array($this->idestado, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idestado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idpiloto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idpiloto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idpiloto'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_idcabezal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idcabezal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idcabezal'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "PLACA" ; 
              if (!isset($Campos_Erros['idcabezal']))
    ...
    function ValidateField_chasis(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['chasis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['chasis'] == "on")) 
      { 
          if ($this->chasis == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_idselectivo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idselectivo == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idselectivo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idselectivo'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idselectivo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo']) && !in_array($this->idselectivo, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idselectivo']))
    ...
    function ValidateField_idnaviera(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idnaviera == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idnaviera']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idnaviera'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idnaviera) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera']) && !in_array($this->idnaviera, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idnaviera']))
...
;
    ...
    function ValidateField_idtipodecarga(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idtipodecarga == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idtipodecarga']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['php_cmp_required']['idtipodecarga'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idtipodecarga) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga']) && !in_array($this->idtipodecarga, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idtipodecarga']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcita']['keyVal'] = registro_turnos_pack_protect_string($this->nmgp_dados_form['idcita']);
          }
   } // ajax_return_values
...
$aLookup[] = array(registro_turnos_pack_protect_string('1') => registro_turnos_pack_protect_string("QR AUTOMATICO"));
$aLookup[] = array(registro_turnos_pack_protect_string('2') => registro_turnos_pack_protect_string("QR MANUAL"));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_tipo_qr'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_tipo_qr'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_qr']['valList'][$i] = registro_turnos_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipomovimiento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipomovimiento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipomovimiento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipomovimiento'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipomovimiento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipomovimiento']['valList'][$i] = registro_turnos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idestado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idestado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idestado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idestado'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idestado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idestado']['valList'][$i] = registro_turnos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][registro_turnos_pack_protect_string(NM_charset_to_utf8($unformatted_value_idpiloto))]) ? $aLookup[0][registro_turnos_pack_protect_string(NM_charset_to_utf8($unformatted_value_idpiloto))] : "";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][registro_turnos_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcabezal))]) ? $aLookup[0][registro_turnos_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcabezal))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo'] = array(); 
}
$aLookup[] = array(registro_turnos_pack_protect_string('') => registro_turnos_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idselectivo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idselectivo']['valList'][$i] = registro_turnos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera'] = array(); 
}
$aLookup[] = array(registro_turnos_pack_protect_string('') => registro_turnos_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idnaviera'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idnaviera']['valList'][$i] = registro_turnos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga'] = array(); 
}
$aLookup[] = array(registro_turnos_pack_protect_string('') => registro_turnos_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['Lookup_idtipodecarga'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodecarga']['valList'][$i] = registro_turnos_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][registro_turnos_pack_protect_string(NM_charset_to_utf8($this->idviaje))]) ? $aLookup[0][registro_turnos_pack_protect_string(NM_charset_to_utf8($this->idviaje))] : "";
   ...
   function ajax_return_values_turno($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcita)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] = '';
...
$_SESSION['scriptcase']['registro_turnos']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['registro_turnos']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['parms'] = "idcita?#?$this->idcita?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("registro_turnos_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_registro_turnos = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['total'] = $qt_geral_reg_registro_turnos;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          registro_turnos_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "registro_turnos_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['nm_run_menu'] = 2;
       $nmgp_saida_form = "registro_turnos_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['retorno_edit'] = "";
   }
