...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->VIGENTE) && isset($this->vigente)) 
          {
              $this->VIGENTE = $this->vigente;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new registro_turnos_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['initialize'])
          {
              $_SESSION['scriptcase']['registro_turnos_mob']['contr_erro'] = 'on';
  $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['start'] = 'new';
$_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['insert'] = 'on';
$_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']['add'] = 'on';
$_SESSION['scriptcase']['registro_turnos_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['registro_turnos_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['registro_turnos_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['registro_turnos_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['registro_turnos_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['registro_turnos_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('registro_turnos_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['registro_turnos_mob']['label'] = "registro_turnos_mob";
      ...
      $_SESSION['scriptcase']['error_icon']['registro_turnos_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['registro_turnos_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['registro_turnos_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['registro_turnos_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['registro_turnos_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'registro_turnos/registro_turnos_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'registro_turnos_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'registro_turnos_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'registro_turnos_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'registro_turnos/registro_turnos_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "registro_turnos_mob_erro.class.php"); 
      }
      $this->Erro      = new registro_turnos_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao']))
         { 
             if ($this->idcita != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['registro_turnos_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idpiloto']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idpiloto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idpiloto']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idpiloto'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idpiloto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idcabezal']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idcabezal'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idcabezal']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idcabezal'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idcabezal'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idviaje']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idviaje'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idviaje']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idviaje'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idviaje'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "registro_turnos_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="registro_turnos_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="registro_turnos_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="registro_turnos_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_registro_turnos_mob']) || !is_array($this->NM_ajax_info['errList']['geral_registro_turnos_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_registro_turnos_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_registro_turnos_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_codigo_cita(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['codigo_cita']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['codigo_cita'] == "on")) 
      { 
          if ($this->codigo_cita == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_idtipomovimiento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipomovimiento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipomovimiento']) && !in_array($this->idtipomovimiento, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipomovimiento']))
               {
                   $hasError = true;
    ...
    function ValidateField_idestado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idestado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idestado']) && !in_array($this->idestado, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idestado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idpiloto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->idpiloto, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idpiloto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idpiloto'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_idcabezal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->idcabezal, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "PLACA; " ; 
                  if (!isset($Campos_Erros['idcabezal']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idcabezal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idcabezal'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "PLACA" ; 
              if (!isset($Campos_Erros['idcabezal']))
    ...
    function ValidateField_chasis(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['chasis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['chasis'] == "on")) 
      { 
          if ($this->chasis == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_idselectivo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idselectivo == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idselectivo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idselectivo'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idselectivo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo']) && !in_array($this->idselectivo, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idselectivo']))
    ...
    function ValidateField_idnaviera(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idnaviera == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idnaviera']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idnaviera'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idnaviera) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera']) && !in_array($this->idnaviera, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idnaviera']))
    ...
    function ValidateField_contenedorexport(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      $this->contenedorexport = sc_strtoupper($this->contenedorexport); 
      if ($this->nmgp_opcao != "excluir") 
      { 
...
;
      $Teste_trab = $Teste_trab . chr(10) . chr(13) ; 
      $Teste_compara = $this->contenedorexport ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->contenedorexport, $_SESSION['scriptcase']['charset']); $x++) 
          { 
               for ($y = 0; $y < mb_strlen($Teste_trab, $_SESSION['scriptcase']['charset']); $y++) 
               { 
                    if (sc_substr($Teste_compara, $x, 1) == sc_substr($Teste_trab, $y, 1) ) 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "CONTENEDOR EXPORT " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['contenedorexport']))
              {
                  $Campos_Erros['contenedorexport'] = array();
              }
              $Campos_Erros['contenedorexport'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['contenedorexport']) || !is_array($this->NM_ajax_info['errList']['contenedorexport']))
              {
                  $this->NM_ajax_info['errList']['contenedorexport'] = array();
              }
              $this->NM_ajax_info['errList']['contenedorexport'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
...
;
      $Teste_trab = $Teste_trab . chr(10) . chr(13) ; 
      $Teste_compara = $this->contenedorimport ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->contenedorimport, $_SESSION['scriptcase']['charset']); $x++) 
          { 
               for ($y = 0; $y < mb_strlen($Teste_trab, $_SESSION['scriptcase']['charset']); $y++) 
               { 
                    if (sc_substr($Teste_compara, $x, 1) == sc_substr($Teste_trab, $y, 1) ) 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "CONTENEDOR IMPORT " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['contenedorimport']))
              {
                  $Campos_Erros['contenedorimport'] = array();
              }
              $Campos_Erros['contenedorimport'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['contenedorimport']) || !is_array($this->NM_ajax_info['errList']['contenedorimport']))
              {
                  $this->NM_ajax_info['errList']['contenedorimport'] = array();
              }
              $this->NM_ajax_info['errList']['contenedorimport'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_idtipodecarga(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idtipodecarga == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idtipodecarga']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idtipodecarga'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idtipodecarga) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga']) && !in_array($this->idtipodecarga, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idtipodecarga']))
    ...
    function ValidateField_idyarda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->idyarda, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Yarda; " ; 
                  if (!isset($Campos_Erros['idyarda']))
    ...
    function ValidateField_turno(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->turno, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Turno; " ; 
                  if (!isset($Campos_Erros['turno']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcita']['keyVal'] = registro_turnos_mob_pack_protect_string($this->nmgp_dados_form['idcita']);
          }
   } // ajax_return_values
...
$aLookup[] = array(registro_turnos_mob_pack_protect_string('1') => registro_turnos_mob_pack_protect_string("QR AUTOMATICO"));
$aLookup[] = array(registro_turnos_mob_pack_protect_string('2') => registro_turnos_mob_pack_protect_string("QR MANUAL"));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_tipo_qr'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_tipo_qr'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_qr']['valList'][$i] = registro_turnos_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipomovimiento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipomovimiento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipomovimiento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipomovimiento'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipomovimiento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipomovimiento']['valList'][$i] = registro_turnos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idestado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idestado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idestado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idestado'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idestado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idestado']['valList'][$i] = registro_turnos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_idpiloto))]) ? $aLookup[0][registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_idpiloto))] : "";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcabezal))]) ? $aLookup[0][registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($unformatted_value_idcabezal))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo'] = array(); 
}
$aLookup[] = array(registro_turnos_mob_pack_protect_string('') => registro_turnos_mob_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idselectivo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idselectivo']['valList'][$i] = registro_turnos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera'] = array(); 
}
$aLookup[] = array(registro_turnos_mob_pack_protect_string('') => registro_turnos_mob_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idnaviera'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idnaviera']['valList'][$i] = registro_turnos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga'] = array(); 
}
$aLookup[] = array(registro_turnos_mob_pack_protect_string('') => registro_turnos_mob_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_idtipodecarga'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodecarga']['valList'][$i] = registro_turnos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($this->idviaje))]) ? $aLookup[0][registro_turnos_mob_pack_protect_string(NM_charset_to_utf8($this->idviaje))] : "";
   ...
   function ajax_return_values_idcita($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcita)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] = '';
...
$_SESSION['scriptcase']['registro_turnos_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "codigo_cita = '$this->codigo_cita', contenedorimport = '$this->contenedorimport', contenedorExport = '$this->contenedorexport', observaciones = '$this->observaciones', fechaInicio = #$this->fechainicio#, chasis = '$this->chasis', idNaviera = $this->idnaviera, idtipodecarga = $this->idtipodecarga, idestado = $this->idestado, idpiloto = $this->idpiloto, idcabezal = $this->idcabezal, idselectivo = $this->idselectivo, idyarda = $this->idyarda, idtipoMovimiento = $this->idtipomovimiento, idviaje = $this->idviaje, atc_ingreso = '$this->atc_ingreso', marchamo_ingreso = '$this->marchamo_ingreso', atc_despacho = '$this->atc_despacho', marchamo_despacho = '$this->marchamo_despacho', sec_users_login = '$this->sec_users_login', turno = $this->turno"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "codigo_cita = '$this->codigo_cita', contenedorimport = '$this->contenedorimport', contenedorExport = '$this->contenedorexport', observaciones = '$this->observaciones', fechaInicio = " . $this->Ini->date_delim . $this->fechainicio . $this->Ini->date_delim1 . ", chasis = '$this->chasis', idNaviera = $this->idnaviera, idtipodecarga = $this->idtipodecarga, idestado = $this->idestado, idpiloto = $this->idpiloto, idcabezal = $this->idcabezal, idselectivo = $this->idselectivo, idyarda = $this->idyarda, idtipoMovimiento = $this->idtipomovimiento, idviaje = $this->idviaje, atc_ingreso = '$this->atc_ingreso', marchamo_ingreso = '$this->marchamo_ingreso', atc_despacho = '$this->atc_despacho', marchamo_despacho = '$this->marchamo_despacho', sec_users_login = '$this->sec_users_login', turno = $this->turno"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$insert_sql = 'INSERT INTO ' . $insert_table
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('QR_PDF_III') . "/", $this->nm_location, "codigo?#?" . NM_encode_input($this->codigo_cita ) . "?@?", "_blank", "ret_self", 440, 630);
 };
if (isset($this->sc_temp_idyarda)) { $_SESSION['idyarda'] = $this->sc_temp_idyarda;}
if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
...
$_SESSION['scriptcase']['registro_turnos_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['parms'] = "idcita?#?$this->idcita?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$_SESSION['scriptcase']['registro_turnos_mob']['contr_erro'] = 'on';
	...
	$hora=date("H");
	$minuto=date("i");
	$this->codigo_cita ='TFPB'.$semana.$dia.$hora.$minuto. $this->idcabezal .$this->idnaviera ;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("registro_turnos_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_registro_turnos_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['total'] = $qt_geral_reg_registro_turnos_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          registro_turnos_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "registro_turnos_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "registro_turnos_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['retorno_edit'] = "";
   }
