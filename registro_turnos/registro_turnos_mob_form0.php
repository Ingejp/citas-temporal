...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("registro_turnos_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('registro_turnos_mob_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idpiloto", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_registro_turnos_mob_event_idpiloto_onchange) { do_ajax_registro_turnos_mob_event_idpiloto_onchange(sRow); }
    }
   }
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'idpiloto' != sId ? sId.substr(8) : '';
    if ("" == $(this).val()) {
     do_ajax_registro_turnos_mob_event_idpiloto_onchange(sRow);
    }
   },
  ...
  $(".sc-ui-autocomp-idcabezal", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_registro_turnos_mob_event_idcabezal_onchange) { do_ajax_registro_turnos_mob_event_idcabezal_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-idviaje", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_registro_turnos_mob_event_idviaje_onchange) { do_ajax_registro_turnos_mob_event_idviaje_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['registro_turnos']['error_buffer']) && '' != $_SESSION['scriptcase']['registro_turnos']['error_buffer'])
{
    echo $_SESSION['scriptcase']['registro_turnos']['error_buffer'];
}
...
<?php
 include_once("registro_turnos_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="registro_turnos_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['registro_turnos_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['registro_turnos_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['run_iframe'] != "R")
{
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigo_cita_line" id="hidden_field_data_codigo_cita" style="<?php echo $sStyleHidden_codigo_cita; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_cita_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_cita_label"><span id="id_label_codigo_cita"><?php echo $this->nm_new_label['codigo_cita']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['codigo_cita']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['codigo_cita'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_tipo_qr'][] = '1'; ?>
 <option  value="2" <?php  if ($this->tipo_qr == "2") { echo " selected" ;} ?>>QR MANUAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['Lookup_tipo_qr'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idpiloto_line" id="hidden_field_data_idpiloto" style="<?php echo $sStyleHidden_idpiloto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idpiloto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idpiloto_label"><span id="id_label_idpiloto"><?php echo $this->nm_new_label['idpiloto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idpiloto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idpiloto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idcabezal_line" id="hidden_field_data_idcabezal" style="<?php echo $sStyleHidden_idcabezal; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcabezal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcabezal_label"><span id="id_label_idcabezal"><?php echo $this->nm_new_label['idcabezal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idcabezal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idcabezal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_chasis_line" id="hidden_field_data_chasis" style="<?php echo $sStyleHidden_chasis; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_chasis_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_chasis_label"><span id="id_label_chasis"><?php echo $this->nm_new_label['chasis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['chasis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['chasis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idselectivo_line" id="hidden_field_data_idselectivo" style="<?php echo $sStyleHidden_idselectivo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idselectivo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idselectivo_label"><span id="id_label_idselectivo"><?php echo $this->nm_new_label['idselectivo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idselectivo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idselectivo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idnaviera_line" id="hidden_field_data_idnaviera" style="<?php echo $sStyleHidden_idnaviera; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idnaviera_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idnaviera_label"><span id="id_label_idnaviera"><?php echo $this->nm_new_label['idnaviera']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idnaviera']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idnaviera'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idtipodecarga_line" id="hidden_field_data_idtipodecarga" style="<?php echo $sStyleHidden_idtipodecarga; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtipodecarga_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idtipodecarga_label"><span id="id_label_idtipodecarga"><?php echo $this->nm_new_label['idtipodecarga']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idtipodecarga']) || $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['php_cmp_required']['idtipodecarga'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("registro_turnos_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("registro_turnos_mob");
 parent.scAjaxDetailHeight("registro_turnos_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['registro_turnos_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
