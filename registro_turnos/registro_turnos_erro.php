...
$old_error_handler = set_error_handler("registro_turnos_scriptcase_error_handler");

function registro_turnos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['registro_turnos']['contr_erro']) && $_SESSION['scriptcase']['registro_turnos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_registro_turnos->contr_registro_turnos->Apl_com_erro = true;
            if ($inicial_registro_turnos->contr_registro_turnos->NM_ajax_flag)
            {
                $inicial_registro_turnos->contr_registro_turnos->NM_ajax_info['errList']['geral_registro_turnos'][] = $msg;
                return;
            }
            registro_turnos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function registro_turnos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['registro_turnos'])  && '' != $_SESSION['scriptcase']['error_icon']['registro_turnos'])  ? $_SESSION['scriptcase']['error_icon']['registro_turnos']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['registro_turnos']) && '' != $_SESSION['scriptcase']['error_span_title']['registro_turnos']) ? $_SESSION['scriptcase']['error_span_title']['registro_turnos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['registro_turnos']) && '' != $_SESSION['scriptcase']['error_icon_title']['registro_turnos']) ? $_SESSION['scriptcase']['error_icon_title']['registro_turnos'] : '';
?>
