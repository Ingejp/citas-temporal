...
class Estatus_PrePuerto_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pivot_tabular'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_file'] = $this->Csv_f;
      }
