...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Estatus_PrePuerto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Estatus_PrePuerto"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_filho'] as $ind => $sc_init)
          {
