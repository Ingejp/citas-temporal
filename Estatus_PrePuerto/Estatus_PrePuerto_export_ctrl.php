<?php
@session_start() ;
$_SESSION['scriptcase']['Estatus_PrePuerto']['sc_process_barr'] = true;
require_once('../Estatus_PrePuerto/index.php');
unset($_SESSION['scriptcase']['Estatus_PrePuerto']['sc_process_barr']);
$ExportCtrl = new Estatus_PrePuerto_export_control;
$ExportCtrl->Export_barr();

class Estatus_PrePuerto_export_control
{
