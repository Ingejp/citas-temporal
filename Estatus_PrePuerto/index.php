<?php
   include_once('Estatus_PrePuerto_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class Estatus_PrePuerto_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "Estatus_PrePuerto"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20200313"; 
      $this->nm_hr_criacao   = "150953"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/Estatus_PrePuerto';
      ...
      if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['Estatus_PrePuerto']['actual_lang']) || $_SESSION['scriptcase']['Estatus_PrePuerto']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['Estatus_PrePuerto']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("Estatus_PrePuerto_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_Link_View'] = true;
          }
      }
    if (!$_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['opcao'] = $_GET['origem'];
          $nmgp_opcao = $_GET['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Estatus_PrePuerto"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Estatus_PrePuerto"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "Estatus_PrePuerto_erro.class.php"); 
      $this->Erro = new Estatus_PrePuerto_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('Estatus_PrePuerto'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao']) && $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_perfil']) && $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Estatus_PrePuerto']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class Estatus_PrePuerto_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['Estatus_PrePuerto']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['Estatus_PrePuerto'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class Estatus_PrePuerto_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Estatus_PrePuerto']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Estatus_PrePuerto'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_Estatus_PrePuerto($cadapar[1]);
                       nm_protect_num_Estatus_PrePuerto($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          if (isset($idtipo_usuario)) 
          {
              ...
              nm_limpa_str_Estatus_PrePuerto($_SESSION["idtipo_usuario"]);
          }
          ...
          if (isset($USUARIO_YARDA)) 
          {
              ...
              nm_limpa_str_Estatus_PrePuerto($_SESSION["USUARIO_YARDA"]);
          }
          ...
          if (isset($USUARIO_MASTER)) 
          {
              ...
              nm_limpa_str_Estatus_PrePuerto($_SESSION["USUARIO_MASTER"]);
          }
          ...
          if (isset($INGRESO)) 
          {
              ...
              nm_limpa_str_Estatus_PrePuerto($_SESSION["INGRESO"]);
          }
          if (isset($idyarda)) 
          {
              $_SESSION['idyarda'] = $idyarda;
              nm_limpa_str_Estatus_PrePuerto($_SESSION["idyarda"]);
          }
          ...
          if (isset($VIGENTE)) 
          {
              ...
              nm_limpa_str_Estatus_PrePuerto($_SESSION["VIGENTE"]);
          }
          ...
          if (isset($idNaviera)) 
          {
              ...
              nm_limpa_str_Estatus_PrePuerto($_SESSION["idNaviera"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_ibase'])) 
      { 
          $this->Ini = new Estatus_PrePuerto_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Estatus_PrePuerto']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Estatus_PrePuerto'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Estatus_PrePuerto']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Estatus_PrePuerto']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Estatus_PrePuerto') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Estatus_PrePuerto']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " ";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_erro.class.php"); 
      } 
      $this->Erro      = new Estatus_PrePuerto_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_lookup.class.php"); 
      } 
      $this->Lookup       = new Estatus_PrePuerto_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_Estatus_PrePuerto_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['save_grid'] = true;
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "Estatus_PrePuerto_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "Estatus_PrePuerto_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_Estatus_PrePuerto_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_Estatus_PrePuerto_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf_det')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf']      = (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf_res")) ? true : false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "turno";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "cit_codigo_cita";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "cab_placa";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "piloto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "cit_contenedorimport";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "cit_contenedorexport";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "cit_fechainicio";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "nav_naviera";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "tipo_carga";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "yarda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "est_estado";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'][] = "cit_observaciones";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['usr_cmp_sel']['cit_observaciones'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['exit'];
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_Estatus_PrePuerto_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['contr_array_resumo'] = "NAO";
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['contr_total_geral']  = "NAO";
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral']);
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq'] = 'grid';
          } 
      } 
      $this->Ini->grid_search_change_fil = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new Estatus_PrePuerto_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_ant']   = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cond_pesq'] = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_fast'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_ant'];  
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_Estatus_PrePuerto_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_Estatus_PrePuerto.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_Estatus_PrePuerto_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_Estatus_PrePuerto_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_Estatus_PrePuerto_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_xls.class.php"); 
          } 
          $this->xls  = new Estatus_PrePuerto_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_res_xls.class.php"); 
          } 
          $this->xls  = new Estatus_PrePuerto_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_xml.class.php"); 
          } 
          $this->xml  = new Estatus_PrePuerto_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_res_xml.class.php"); 
          } 
          $this->xml  = new Estatus_PrePuerto_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_csv.class.php"); 
          } 
          $this->csv  = new Estatus_PrePuerto_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_res_csv.class.php"); 
          } 
          $this->csv  = new Estatus_PrePuerto_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_rtf.class.php"); 
          } 
          $this->rtf  = new Estatus_PrePuerto_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_res_rtf.class.php"); 
          } 
          $this->rtf  = new Estatus_PrePuerto_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . Estatus_PrePuerto . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new Estatus_PrePuerto_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_pesq.class.php"); 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "Estatus_PrePuerto/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new Estatus_PrePuerto_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_Estatus_PrePuerto_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
              $this->Ini->nm_limite_lin_prt = 0;
              $GLOBALS['nmgp_tipo_pdf'] = "CO";
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_det.class.php"); 
              } 
              $this->det  = new Estatus_PrePuerto_det();
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_grid.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_grid.class.php"); 
              } 
              $this->grid  = new Estatus_PrePuerto_grid();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_res'])
            { 
                $str_pd4ml .= " --outline-depth 0";
            }
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_det'])
{
    if ($this->pdf_zip == "S")
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_filtro'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search']);
          return;
      }
      $comando = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      $Nm_datas['cit.fechaInicio'] = "datetime";$Nm_datas['via.fechaAtraque'] = "date";$Nm_datas['via.fechaZarpe'] = "date";
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_sep_date']))
      {
          $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_sep_date'];
          $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_sep_date1'];
      }
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imag_temp'] . "/");
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][1] = "Estatus_PrePuerto_det.pdf";
?>
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_Estatus_PrePuerto($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_Estatus_PrePuerto($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['Estatus_PrePuerto']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "Estatus_PrePuerto") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['Estatus_PrePuerto']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['Estatus_PrePuerto']['master_pai']) && $_SESSION['sc_session'][$init_filho]['Estatus_PrePuerto']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['Estatus_PrePuerto']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']);
               $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida']) && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['Estatus_PrePuerto']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['Estatus_PrePuerto']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['Estatus_PrePuerto']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['Estatus_PrePuerto']['protect_modal']) && !empty($_SESSION['scriptcase']['Estatus_PrePuerto']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['Estatus_PrePuerto']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "Estatus_PrePuerto";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'Estatus_PrePuerto' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/Estatus_PrePuerto/'))
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'Estatus_PrePuerto')
   {
       $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/Estatus_PrePuerto_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] = $nmgp_opcao ;  
       }   
       if ($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['Sc_seq_det'] = $Sc_seq_det;
       } 
       ...
       {
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['volta_redirect_tp'] = "";
           $nm_url_saida = "Estatus_PrePuerto_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['sc_modal'] = true;
               }
               $nm_url_saida = "Estatus_PrePuerto_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['mostra_edit'] = "N";   
           } 
       ...
       $contr_Estatus_PrePuerto = new Estatus_PrePuerto_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] = "busca";
          $contr_Estatus_PrePuerto->NM_ajax_flag = true;
          $contr_Estatus_PrePuerto->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] = "busca";
          $contr_Estatus_PrePuerto->NM_ajax_flag = true;
          $contr_Estatus_PrePuerto->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] = "busca";
          $contr_Estatus_PrePuerto->NM_ajax_flag = true;
          $contr_Estatus_PrePuerto->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['opcao'] = "busca";
          $contr_Estatus_PrePuerto->NM_ajax_flag = true;
          $contr_Estatus_PrePuerto->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_Estatus_PrePuerto->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_Estatus_PrePuerto(&$str)
   {
   ...
   function nm_protect_num_Estatus_PrePuerto($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function Estatus_PrePuerto_pack_protect_string($sString)
   {
