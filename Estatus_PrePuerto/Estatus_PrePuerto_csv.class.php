...
class Estatus_PrePuerto_csv
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo  .= "_Estatus_PrePuerto";
      $this->Arquivo  .= ".csv";
      $this->Tit_doc   = "Estatus_PrePuerto.csv";
      ...
      if (!$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_return']);
          if ($this->Tem_csv_res) {
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_name']);
      }
...
$_SESSION['scriptcase']['Estatus_PrePuerto']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          $this->Res = new Estatus_PrePuerto_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_res_file']);
          }
          unlink($Arq_input);
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['csv_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
