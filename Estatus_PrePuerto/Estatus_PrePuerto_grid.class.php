...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['charts_html'] = '';
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "Estatus_PrePuerto/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new Estatus_PrePuerto_resumo();
       $this->Res->Db     = $this->Db;
       ...
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Estatus_PrePuerto'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
           $this->nmgp_embbed_placeholder_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_pdf']['all_label'] : "S";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pesq_tab_label'] .= "turno?#?" . "Turno" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pesq_tab_label'] .= "cit_codigo_cita?#?" . "CODIGO CITA" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pesq_tab_label'] .= "cit_contenedorimport?#?" . "CONT. IMPORT" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pesq_tab_label'] .= "cit_contenedorexport?#?" . "CONT. EXPORT" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dyn_search_aut_comp']))
   {
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dyn_search_aut_comp']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'];
   }
   ...
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("Estatus_PrePuerto", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "muda_qt_linhas";
   } 
       ob_start(); 
...
$_SESSION['scriptcase']['Estatus_PrePuerto']['contr_erro'] = 'off'; 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Estatus_PrePuerto'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Estatus_PrePuerto'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "Estatus_PrePuerto/Estatus_PrePuerto_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "Estatus_PrePuerto_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_select']['cit.idCita'] = 'ASC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['prim_cons'] || !empty($nmgp_parms))  
   { 
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']       = "igual" ; 
...
// 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] == "all") 
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['contr_array_resumo']))  
       { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['pivot_charts']) : 0;
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-Estatus_PrePuerto-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-796de618\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"Estatus_PrePuerto_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Estatus_PrePuerto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Estatus_PrePuerto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_Estatus_PrePuerto_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".Estatus_PrePuerto_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
           $nm_saida->saida("  <body class=\"" . $this->css_scGridPage . "\" " . $str_iframe_body . " style=\"" . $remove_margin. $css_body . "\">\r\n");
       }
       $nm_saida->saida("  " . $this->Ini->Ajax_result_set . "\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Estatus_PrePuerto']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Estatus_PrePuerto']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Estatus_PrePuerto']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Estatus_PrePuerto']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida']) ? "Estatus_PrePuerto_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_Estatus_PrePuerto__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-Estatus_PrePuerto-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq']) { 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cit_observaciones_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".Estatus_PrePuerto_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_turno()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_cmp'] == $NM_cmp_class)
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ordem_label'] == "desc")
          {
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['turno'])) ? $this->New_label['turno'] : "Turno"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['turno'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_codigo_cita'])) ? $this->New_label['cit_codigo_cita'] : "CODIGO CITA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['cit_codigo_cita'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cab_placa'])) ? $this->New_label['cab_placa'] : "PLACA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['cab_placa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['piloto'])) ? $this->New_label['piloto'] : "PILOTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['piloto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_contenedorimport'])) ? $this->New_label['cit_contenedorimport'] : "CONT. IMPORT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['cit_contenedorimport'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_contenedorexport'])) ? $this->New_label['cit_contenedorexport'] : "CONT. EXPORT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['cit_contenedorexport'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_fechainicio'])) ? $this->New_label['cit_fechainicio'] : "FECHA INICIO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['cit_fechainicio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nav_naviera'])) ? $this->New_label['nav_naviera'] : "NAVIERA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['nav_naviera'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipo_carga'])) ? $this->New_label['tipo_carga'] : "TIPO CARGA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['tipo_carga'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['yarda'])) ? $this->New_label['yarda'] : "YARDA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['yarda'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['est_estado'])) ? $this->New_label['est_estado'] : "ESTADO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['est_estado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cit_observaciones'])) ? $this->New_label['cit_observaciones'] : "Observaciones"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['labels']['cit_observaciones'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Estatus_PrePuerto']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_Estatus_PrePuerto#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['force_toolbar'] = true;
           } 
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_Estatus_PrePuerto#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-796de618\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Page_break_PDF'] = array();
       }
   }
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->cit_observaciones = $this->rs_grid->fields[11] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['rows_emb']++;
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['mostra_edit'] != "N"){ 
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->turno . "*PDet*" . $this->cit_codigo_cita . "*PDet*" . $this->cab_placa . "*PDet*" . $this->piloto . "*PDet*" . $this->cit_contenedorimport . "*PDet*" . $this->cit_contenedorexport . "*PDet*" . $this->cit_fechainicio . "*PDet*" . $this->nav_naviera . "*PDet*" . $this->tipo_carga . "*PDet*" . $this->yarda . "*PDet*" . $this->est_estado . "*PDet*" . $this->cit_observaciones . "?@?Sc_seq_det?#?" . $this->SC_seq_register . "?#?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@Estatus_PrePuerto@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['mostra_edit'] == "N"){ 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][1] . ")";
   ...
   {
    if ($Cada_cmp == "turno" && (!isset($this->NM_cmp_hidden['turno']) || $this->NM_cmp_hidden['turno'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "cit_codigo_cita" && (!isset($this->NM_cmp_hidden['cit_codigo_cita']) || $this->NM_cmp_hidden['cit_codigo_cita'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "cab_placa" && (!isset($this->NM_cmp_hidden['cab_placa']) || $this->NM_cmp_hidden['cab_placa'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "piloto" && (!isset($this->NM_cmp_hidden['piloto']) || $this->NM_cmp_hidden['piloto'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "cit_contenedorimport" && (!isset($this->NM_cmp_hidden['cit_contenedorimport']) || $this->NM_cmp_hidden['cit_contenedorimport'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "cit_contenedorexport" && (!isset($this->NM_cmp_hidden['cit_contenedorexport']) || $this->NM_cmp_hidden['cit_contenedorexport'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "cit_fechainicio" && (!isset($this->NM_cmp_hidden['cit_fechainicio']) || $this->NM_cmp_hidden['cit_fechainicio'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "nav_naviera" && (!isset($this->NM_cmp_hidden['nav_naviera']) || $this->NM_cmp_hidden['nav_naviera'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['tot_geral'][2] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_nav_naviera_tot_ger\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "tipo_carga" && (!isset($this->NM_cmp_hidden['tipo_carga']) || $this->NM_cmp_hidden['tipo_carga'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "yarda" && (!isset($this->NM_cmp_hidden['yarda']) || $this->NM_cmp_hidden['yarda'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "est_estado" && (!isset($this->NM_cmp_hidden['est_estado']) || $this->NM_cmp_hidden['est_estado'] != "off"))
    {
       $colspan++;
    }
    if ($Cada_cmp == "cit_observaciones" && (!isset($this->NM_cmp_hidden['cit_observaciones']) || $this->NM_cmp_hidden['cit_observaciones'] != "off"))
    {
       $colspan++;
    }
   }
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
              $UseAlias =  "N";
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=Estatus_PrePuerto&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
          {
          ...
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Estatus_PrePuerto/Estatus_PrePuerto_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['SC_Ind_Groupby'] != "sc_free_total")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
          ...
          if (is_file("Estatus_PrePuerto_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("Estatus_PrePuerto_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['dashboard_info']['under_dashboard']))
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['nav']))
          {
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = Estatus_PrePuerto_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CITASPB/Estatus_PrePuerto";
...
$nm_saida->saida("             }\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Estatus_PrePuerto', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"Estatus_PrePuerto\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"Estatus_PrePuerto_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"Estatus_PrePuerto_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Estatus_PrePuerto_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@Estatus_PrePuerto@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"Estatus_PrePuerto_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"Estatus_PrePuerto_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['Estatus_PrePuerto']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"Estatus_PrePuerto_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Estatus_PrePuerto']['reg_start']))
   {
       $nm_saida->saida("      window.onload = function() {\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('Estatus_PrePuerto')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Estatus_PrePuerto', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
   }
