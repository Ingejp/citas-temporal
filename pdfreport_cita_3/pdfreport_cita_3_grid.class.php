...
//
   ...
   $_SESSION['scriptcase']['pdfreport_cita_3']['default_font'] = $this->default_font;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
...
$_SESSION['scriptcase']['pdfreport_cita_3']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_cita_3']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_cita_3']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_cita_3']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_cita_3']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idcita'] = "Id Cita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['codigo_cita'] = "Codigo Cita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['contenedorimport'] = "Contenedorimport";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['contenedorexport'] = "Contenedor Export";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['observaciones'] = "Observaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['fechainicio'] = "Fecha Inicio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['chasis'] = "Chasis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idnaviera'] = "Id Naviera";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idtipodecarga'] = "Idtipodecarga";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idestado'] = "Idestado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idpiloto'] = "Idpiloto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idcabezal'] = "Idcabezal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idselectivo'] = "Idselectivo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idyarda'] = "Idyarda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idtipomovimiento'] = "Idtipo Movimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['labels']['idviaje'] = "Idviaje";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_cita_3']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_cita_3']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_cita_3']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_cita_3']['qt_col_grid']) 
      {  
          ...
          $this->idviaje[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->idviaje[$this->nm_grid_colunas]);
            $cell_codigo_cita = array('posx' => '2.4325262499996936', 'posy' => '6.849824374999137', 'data' => $this->codigo_cita[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_idNaviera = array('posx' => '10.475859583332014', 'posy' => '8.78416666666556', 'data' => $this->idnaviera[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '18', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_idpiloto = array('posx' => '6.454192916665853', 'posy' => '7.3554166666657395', 'data' => $this->idpiloto[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '18', 'color_r'    => '255', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_idcabezal = array('posx' => '14.127109583331553', 'posy' => '8.75770833333223', 'data' => $this->idcabezal[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '18', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
