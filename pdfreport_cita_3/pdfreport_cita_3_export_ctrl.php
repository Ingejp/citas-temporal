<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_cita_3']['sc_process_barr'] = true;
require_once('../pdfreport_cita_3/index.php');
unset($_SESSION['scriptcase']['pdfreport_cita_3']['sc_process_barr']);
$ExportCtrl = new pdfreport_cita_3_export_control;
$ExportCtrl->Export_barr();

class pdfreport_cita_3_export_control
{
