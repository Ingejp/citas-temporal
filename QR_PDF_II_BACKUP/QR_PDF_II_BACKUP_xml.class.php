...
class QR_PDF_II_BACKUP_xml
{
   ...
   function monta_xml()
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['SC_Gb_Free_cmp']))
      {
          $this->Tem_xml_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_label'];
          $this->New_Format    = true;
      }
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      require_once($this->Ini->path_aplicacao . "QR_PDF_II_BACKUP_total.class.php"); 
      $this->Tot      = new QR_PDF_II_BACKUP_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['SC_Ind_Groupby'];
      if (method_exists($this->Tot,$Gb_geral))
      {
          $this->Tot->$Gb_geral();
          $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['tot_geral'][1];
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_return']);
          if ($this->Tem_xml_res) {
      ...
      $this->Arq_zip      = $this->Arquivo . "_QR_PDF_II_BACKUP.zip";
      $this->Arquivo     .= "_QR_PDF_II_BACKUP";
      $this->Arquivo_view = $this->Arquivo . "_view.xml";
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "QR_PDF_II_BACKUP.xml";
      $this->Tit_zip      = "QR_PDF_II_BACKUP.zip";
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_name']);
      }
      if (!$this->Grava_view)
      {
...
$_SESSION['scriptcase']['QR_PDF_II_BACKUP']['contr_erro'] = 'off'; 
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<QR_PDF_II_BACKUP>\r\n";
         }
         else
         {
             $this->xml_registro = "<QR_PDF_II_BACKUP";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['field_order'] as $Cada_col)
         { 
      ...
      { 
          ...
          { 
              ...
              $this->Res = new QR_PDF_II_BACKUP_res_xml();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_res_grid'] = true;
              $this->Res->monta_xml();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_res_file']['xml'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_res_file']['xml']);
              }
              if ($this->Grava_view)
              {
                  $str_zip    = "";
                  ...
                  { 
                      $str_zip   = "";
                      $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_res_file']['view'];
                      $Arq_input = (FALSE !== strpos($Arq_res, ' ')) ? " \"" . $Arq_res . "\"" :  $Arq_res;
                      if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                      {
                          $str_zip = "zip.exe " . strtoupper($Parm_pass) . " -j -u " . $this->Xml_password . " " . $Zip_f . " " . $Arq_input;
                      ...
                      unlink($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_res_file']['view']);
                  }
              } 
              else 
              {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_res_grid']);
          } 
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   //----- idcita
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
