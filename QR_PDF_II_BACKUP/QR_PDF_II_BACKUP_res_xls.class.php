...
class QR_PDF_II_BACKUP_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Tit_doc    = "QR_PDF_II_BACKUP" . $this->Xls_tp;
      $this->Tit_zip    = "QR_PDF_II_BACKUP.zip";
      if (isset($_POST['nmgp_tp_xls']) && !empty($_POST['nmgp_tp_xls']))
      {
          $this->Xls_tp = "." . $_POST['nmgp_tp_xls'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_name']);
      }
      ...
      $this->Res       = new QR_PDF_II_BACKUP_resumo("out");
      $this->prep_modulos("Res");
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_return']);
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['pivot_tabular'];
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_sheet'] = $this->Xls_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
