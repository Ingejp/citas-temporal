<?php
@session_start() ;
$_SESSION['scriptcase']['QR_PDF_II_BACKUP']['sc_process_barr'] = true;
require_once('../QR_PDF_II_BACKUP/index.php');
unset($_SESSION['scriptcase']['QR_PDF_II_BACKUP']['sc_process_barr']);
$ExportCtrl = new QR_PDF_II_BACKUP_export_control;
$ExportCtrl->Export_barr();

class QR_PDF_II_BACKUP_export_control
{
