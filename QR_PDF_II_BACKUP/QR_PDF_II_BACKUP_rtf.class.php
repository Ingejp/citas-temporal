...
class QR_PDF_II_BACKUP_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "QR_PDF_II_BACKUP.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['rtf_name']);
      }
...
$_SESSION['scriptcase']['QR_PDF_II_BACKUP']['contr_erro'] = 'off'; 
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
