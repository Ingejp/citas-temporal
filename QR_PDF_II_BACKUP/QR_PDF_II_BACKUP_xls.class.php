...
class QR_PDF_II_BACKUP_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          { 
              ...
              $this->Res_xls = new QR_PDF_II_BACKUP_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_QR_PDF_II_BACKUP.zip";
          $this->Arquivo   .= "_QR_PDF_II_BACKUP" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['QR_PDF_II_BACKUP']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF_II_BACKUP']['nolabel'])
       {
