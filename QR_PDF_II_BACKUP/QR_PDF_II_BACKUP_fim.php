...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____QR_PDF_II_BACKUP"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____QR_PDF_II_BACKUP"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II_BACKUP']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['QR_PDF_II_BACKUP']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II_BACKUP']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['QR_PDF_II_BACKUP']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II_BACKUP']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['QR_PDF_II_BACKUP']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['QR_PDF_II_BACKUP']['embutida_filho'] as $ind => $sc_init)
          {
