<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipodemodulista']['sc_process_barr'] = true;
require_once('../grid_tipodemodulista/index.php');
unset($_SESSION['scriptcase']['grid_tipodemodulista']['sc_process_barr']);
$ExportCtrl = new grid_tipodemodulista_export_control;
$ExportCtrl->Export_barr();

class grid_tipodemodulista_export_control
{
