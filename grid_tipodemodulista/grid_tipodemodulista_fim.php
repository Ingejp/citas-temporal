...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_tipodemodulista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_tipodemodulista"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tipodemodulista'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipodemodulista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tipodemodulista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipodemodulista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tipodemodulista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tipodemodulista']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tipodemodulista</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tipodemodulista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tipodemodulista']['embutida_filho'] as $ind => $sc_init)
          {
