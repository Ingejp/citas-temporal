  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipodecarga" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipodecarga_form();
	}

  // ---------- Validate idtipodecarga
  function do_ajax_form_tipodecarga_validate_idtipodecarga()
  {
    var nomeCampo_idtipodecarga = "idtipodecarga";
    var var_idtipodecarga = scAjaxGetFieldHidden(nomeCampo_idtipodecarga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipodecarga_validate_idtipodecarga(var_idtipodecarga, var_script_case_init, do_ajax_form_tipodecarga_validate_idtipodecarga_cb);
  } // do_ajax_form_tipodecarga_validate_idtipodecarga

  function do_ajax_form_tipodecarga_validate_idtipodecarga_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipodecarga_validate_idtipodecarga_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipodecarga_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipodecarga_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipodecarga_validate_descripcion_cb);
  } // do_ajax_form_tipodecarga_validate_descripcion

  function do_ajax_form_tipodecarga_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipodecarga_validate_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tipodecarga_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipodecarga_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tipodecarga_submit_form(var_idtipodecarga, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipodecarga_submit_form_cb);
  } // do_ajax_form_tipodecarga_submit_form

  function do_ajax_form_tipodecarga_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tipodecarga_submit_form_cb_after_alert);
  } // do_ajax_form_tipodecarga_submit_form_cb
  function do_ajax_form_tipodecarga_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipodecarga_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipodecarga_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tipodecarga_navigate_form(var_idtipodecarga, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipodecarga_navigate_form_cb);
  } // do_ajax_form_tipodecarga_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipodecarga']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipodecarga_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipodecarga_navigate_form_cb_after_alert);
  } // do_ajax_form_tipodecarga_navigate_form_cb
  function do_ajax_form_tipodecarga_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tipodecarga_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipodecarga_navigate_form_cb_after_alert
  function sc_hide_form_tipodecarga_form()
  {
