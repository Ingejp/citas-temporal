...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("fondo_menu") . "/fondo_menu_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['fondo_menu']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['fondo_menu'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("registro_turnos") . "/registro_turnos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Reimpresion_QR") . "/Reimpresion_QR_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reimpresion_QR']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Despachos") . "/Despachos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Despachos']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("ingresobar") . "/ingresobar_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ingresobar']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['ingresobar'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Busqueda_Placa") . "/Busqueda_Placa_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Busqueda_Placa']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Busqueda_Placa'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Reporte_citas_total_tiempos") . "/Reporte_citas_total_tiempos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Resumen_estatus_yarda") . "/Resumen_estatus_yarda_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Resumen_estatus_yarda']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Resumen_estatus_yarda'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Reporte_citas_total_tiempos_general") . "/Reporte_citas_total_tiempos_general_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos_general']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos_general'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_despachos") . "/grid_despachos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_despachos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_despachos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Reporte_Placas_Yarda_Barrios") . "/Reporte_Placas_Yarda_Barrios_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Placas_Yarda_Barrios']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Reporte_Placas_Yarda_Barrios'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_cabezal") . "/form_cabezal_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_cabezal']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_cabezal'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_cabezal") . "/grid_cabezal_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cabezal']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_piloto") . "/form_piloto_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_piloto']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_piloto'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_piloto") . "/grid_piloto_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_piloto']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_piloto'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_master_equipo") . "/form_master_equipo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_master_equipo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_master_equipo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_master_equipo") . "/grid_master_equipo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_master_equipo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_master_equipo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_estado") . "/form_estado_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_estado']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_estado'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_estado") . "/grid_estado_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estado']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_estado'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_naviera") . "/form_naviera_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_naviera']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_naviera'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_naviera") . "/grid_naviera_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_naviera']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_naviera'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tipodecarga") . "/form_tipodecarga_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipodecarga']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_tipodecarga'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tipodecarga") . "/grid_tipodecarga_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipodecarga']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_viaje") . "/grid_viaje_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_viaje']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_viaje'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_buque_1") . "/form_buque_1_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_buque_1']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_buque_1'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tipo_equipo") . "/form_tipo_equipo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_equipo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_tipo_equipo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tipoequipo") . "/grid_tipoequipo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipoequipo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_tipoequipo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_transporte") . "/form_transporte_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_transporte']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_transporte'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_transporte") . "/grid_transporte_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transporte']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_yarda") . "/form_yarda_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_yarda']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_yarda'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_funcionario") . "/form_funcionario_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_funcionario']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_funcionario'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_contenido") . "/form_contenido_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_contenido']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_contenido'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_gestor_aduanal") . "/form_gestor_aduanal_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_gestor_aduanal']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_gestor_aduanal'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_consignatario") . "/form_consignatario_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_consignatario']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_consignatario'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_viaje_importacion") . "/form_viaje_importacion_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_viaje_importacion']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_viaje_importacion'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_revision") . "/form_revision_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_revision']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Cambio_estatus_Rev") . "/Cambio_estatus_Rev_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Cambio_estatus_Rev']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Reporte_Revision_Tiempos") . "/Reporte_Revision_Tiempos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Revision_Tiempos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Reporte_Revision_Tiempos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_weighings") . "/grid_weighings_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_weighings']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_weighings'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_reporte_de_pesaje_completo") . "/grid_reporte_de_pesaje_completo_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_de_pesaje_completo']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_de_pesaje_completo'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_pesaje_por_embarque") . "/grid_pesaje_por_embarque_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pesaje_por_embarque']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_pesaje_por_embarque'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_EIR") . "/form_EIR_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_EIR']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_EIR'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_condicion") . "/grid_condicion_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_condicion'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Modificar_Cita") . "/Modificar_Cita_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Modificar_Cita']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Modificar_Cita'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Finalizar_Turno") . "/Finalizar_Turno_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Finalizar_Turno']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Finalizar_Turno'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("sec_form_edit_users") . "/sec_form_edit_users_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_form_edit_users']))
    {
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[0]))
{
 ...
 $nm_var_lab[1] = "SOLICITUD DE TURNO";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "TURNOS SOLICITADOS - REPORTE";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "DESPACHO DE PREDIO";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "INGRESO AL PREDIO";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[6]))
{
 ...
 $nm_var_lab[7] = "REPORTE INGRESOS POR NAVIERA";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[10]))
{
 ...
 $nm_var_lab[11] = "PLACAS EN BARRIOS";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[11]))
{
 ...
 $nm_var_lab[12] = "Bienvenido {$usr_name}";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[14]))
{
 ...
 $nm_var_lab[15] = "REGISTRAR DE UNIDADES";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[15]))
{
 ...
 $nm_var_lab[16] = "VER UNIDADES REGISTRADAS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[17]))
{
 ...
 $nm_var_lab[18] = "REGISTRAR PILOTOS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[19]))
{
 ...
 $nm_var_lab[20] = "REGISTRO DE EQUIPOS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[21]))
{
 ...
 $nm_var_lab[22] = "VER EQUIPOS REGISTRADOS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[23]))
{
 ...
 $nm_var_lab[24] = "REGISTRAR ESTADO";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[26]))
{
 ...
 $nm_var_lab[27] = "REGISTRAR NAVIERA";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[29]))
{
 ...
 $nm_var_lab[30] = "REGISTRAR TIPO DE CARGA";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[30]))
{
 ...
 $nm_var_lab[31] = "VER TIPO DE CARGA";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[35]))
{
 ...
 $nm_var_lab[36] = "REGISTRAR TIPO DE EQUIPO";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[36]))
{
 ...
 $nm_var_lab[37] = "VER TIPO DE EQUIPO";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[38]))
{
 ...
 $nm_var_lab[39] = "REGISTRAR TRANSPORTES";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[42]))
{
 ...
 $nm_var_lab[43] = "CATALOGOS DE REVISIONES";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[47]))
{
 ...
 $nm_var_lab[48] = "VIAJES DE IMPORTACION";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[48]))
{
 ...
 $nm_var_lab[49] = "INGRESAR REVISIONES";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[49]))
{
 ...
 $nm_var_lab[50] = "ACTUALIZAR ESTATUS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[51]))
{
 ...
 $nm_var_lab[52] = "REPORTE DE REVISIONES";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[54]))
{
 ...
 $nm_var_lab[55] = "REPORTE GENERAL VGM";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[55]))
{
 ...
 $nm_var_lab[56] = "REPORTE VGM POR EMBARQUE";
...
$menu_menuData['data'] .= "item_8|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "|grp__NM__ico__NM__calendario-mural.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) == "on")
{
    $menu_menuData['data'] .= "item_9|..|" . $nm_var_lab[1] . "|menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=registro_turnos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Reimpresion_QR']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reimpresion_QR']) == "on")
{
    $menu_menuData['data'] .= "item_10|..|" . $nm_var_lab[2] . "|menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=Reimpresion_QR&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Despachos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Despachos']) == "on")
{
    $menu_menuData['data'] .= "item_41|..|" . $nm_var_lab[3] . "|menu_form_php.php?sc_item_menu=item_41&sc_apl_menu=Despachos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['ingresobar']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['ingresobar']) == "on")
{
    $menu_menuData['data'] .= "item_40|..|" . $nm_var_lab[4] . "|menu_form_php.php?sc_item_menu=item_40&sc_apl_menu=ingresobar&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Busqueda_Placa']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Busqueda_Placa']) == "on")
{
    $menu_menuData['data'] .= "item_134|..|" . $nm_var_lab[5] . "|menu_form_php.php?sc_item_menu=item_134&sc_apl_menu=Busqueda_Placa&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_47|..|" . $nm_var_lab[6] . "||" . $nm_var_hint[6] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos']) == "on")
{
    $menu_menuData['data'] .= "item_45|...|" . $nm_var_lab[7] . "|menu_form_php.php?sc_item_menu=item_45&sc_apl_menu=Reporte_citas_total_tiempos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Resumen_estatus_yarda']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Resumen_estatus_yarda']) == "on")
{
    $menu_menuData['data'] .= "item_116|...|" . $nm_var_lab[8] . "|menu_form_php.php?sc_item_menu=item_116&sc_apl_menu=Resumen_estatus_yarda&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos_general']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos_general']) == "on")
{
    $menu_menuData['data'] .= "item_119|...|" . $nm_var_lab[9] . "|menu_form_php.php?sc_item_menu=item_119&sc_apl_menu=Reporte_citas_total_tiempos_general&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_despachos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_despachos']) == "on")
{
    $menu_menuData['data'] .= "item_122|...|" . $nm_var_lab[10] . "|menu_form_php.php?sc_item_menu=item_122&sc_apl_menu=grid_despachos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Placas_Yarda_Barrios']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Placas_Yarda_Barrios']) == "on")
{
    $menu_menuData['data'] .= "item_144|...|" . $nm_var_lab[11] . "|menu_form_php.php?sc_item_menu=item_144&sc_apl_menu=Reporte_Placas_Yarda_Barrios&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_131|...|" . $nm_var_lab[12] . "||" . $nm_var_hint[12] . "||_self|\n";
$menu_menuData['data'] .= "item_11|.|" . $nm_var_lab[13] . "||" . $nm_var_hint[13] . "|usr__NM__bg__NM__portapapeles.png|_self|\n";
$menu_menuData['data'] .= "item_1|..|" . $nm_var_lab[14] . "||" . $nm_var_hint[14] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_cabezal']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_cabezal']) == "on")
{
    $menu_menuData['data'] .= "item_3|...|" . $nm_var_lab[15] . "|menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_cabezal&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cabezal']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cabezal']) == "on")
{
    $menu_menuData['data'] .= "item_4|...|" . $nm_var_lab[16] . "|menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_cabezal&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_5|..|" . $nm_var_lab[17] . "||" . $nm_var_hint[17] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_piloto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_piloto']) == "on")
{
    $menu_menuData['data'] .= "item_6|...|" . $nm_var_lab[18] . "|menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_piloto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[18] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_piloto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_piloto']) == "on")
{
    $menu_menuData['data'] .= "item_7|...|" . $nm_var_lab[19] . "|menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_piloto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[19] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_139|..|" . $nm_var_lab[20] . "||" . $nm_var_hint[20] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_master_equipo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_master_equipo']) == "on")
{
    $menu_menuData['data'] .= "item_140|...|" . $nm_var_lab[21] . "|menu_form_php.php?sc_item_menu=item_140&sc_apl_menu=form_master_equipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[21] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_master_equipo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_master_equipo']) == "on")
{
    $menu_menuData['data'] .= "item_141|...|" . $nm_var_lab[22] . "|menu_form_php.php?sc_item_menu=item_141&sc_apl_menu=grid_master_equipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[22] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_21|..|" . $nm_var_lab[23] . "||" . $nm_var_hint[23] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) == "on")
{
    $menu_menuData['data'] .= "item_23|...|" . $nm_var_lab[24] . "|menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=form_estado&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[24] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estado']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_estado']) == "on")
{
    $menu_menuData['data'] .= "item_22|...|" . $nm_var_lab[25] . "|menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_estado&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[25] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_24|..|" . $nm_var_lab[26] . "||" . $nm_var_hint[26] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_naviera']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_naviera']) == "on")
{
    $menu_menuData['data'] .= "item_25|...|" . $nm_var_lab[27] . "|menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=form_naviera&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[27] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_naviera']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_naviera']) == "on")
{
    $menu_menuData['data'] .= "item_26|...|" . $nm_var_lab[28] . "|menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_naviera&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[28] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_30|..|" . $nm_var_lab[29] . "||" . $nm_var_hint[29] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipodecarga']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipodecarga']) == "on")
{
    $menu_menuData['data'] .= "item_31|...|" . $nm_var_lab[30] . "|menu_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_tipodecarga&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[30] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipodecarga']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipodecarga']) == "on")
{
    $menu_menuData['data'] .= "item_32|...|" . $nm_var_lab[31] . "|menu_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_tipodecarga&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[31] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_81|..|" . $nm_var_lab[32] . "||" . $nm_var_hint[32] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_viaje']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_viaje']) == "on")
{
    $menu_menuData['data'] .= "item_82|...|" . $nm_var_lab[33] . "|menu_form_php.php?sc_item_menu=item_82&sc_apl_menu=grid_viaje&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[33] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_buque_1']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_buque_1']) == "on")
{
    $menu_menuData['data'] .= "item_83|...|" . $nm_var_lab[34] . "|menu_form_php.php?sc_item_menu=item_83&sc_apl_menu=form_buque_1&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[34] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_33|..|" . $nm_var_lab[35] . "||" . $nm_var_hint[35] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_equipo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_equipo']) == "on")
{
    $menu_menuData['data'] .= "item_34|...|" . $nm_var_lab[36] . "|menu_form_php.php?sc_item_menu=item_34&sc_apl_menu=form_tipo_equipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[36] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipoequipo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipoequipo']) == "on")
{
    $menu_menuData['data'] .= "item_35|...|" . $nm_var_lab[37] . "|menu_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_tipoequipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[37] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_36|..|" . $nm_var_lab[38] . "||" . $nm_var_hint[38] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_transporte']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_transporte']) == "on")
{
    $menu_menuData['data'] .= "item_37|...|" . $nm_var_lab[39] . "|menu_form_php.php?sc_item_menu=item_37&sc_apl_menu=form_transporte&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[39] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transporte']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_transporte']) == "on")
{
    $menu_menuData['data'] .= "item_38|...|" . $nm_var_lab[40] . "|menu_form_php.php?sc_item_menu=item_38&sc_apl_menu=grid_transporte&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[40] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_yarda']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_yarda']) == "on")
{
    $menu_menuData['data'] .= "item_39|..|" . $nm_var_lab[41] . "|menu_form_php.php?sc_item_menu=item_39&sc_apl_menu=form_yarda&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[41] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_42|.|" . $nm_var_lab[42] . "||" . $nm_var_hint[42] . "|usr__NM__bg__NM__lista.png|_self|\n";
$menu_menuData['data'] .= "item_123|..|" . $nm_var_lab[43] . "||" . $nm_var_hint[43] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_funcionario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_funcionario']) == "on")
{
    $menu_menuData['data'] .= "item_124|...|" . $nm_var_lab[44] . "|menu_form_php.php?sc_item_menu=item_124&sc_apl_menu=form_funcionario&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[44] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_contenido']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_contenido']) == "on")
{
    $menu_menuData['data'] .= "item_127|...|" . $nm_var_lab[45] . "|menu_form_php.php?sc_item_menu=item_127&sc_apl_menu=form_contenido&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[45] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_gestor_aduanal']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_gestor_aduanal']) == "on")
{
    $menu_menuData['data'] .= "item_128|...|" . $nm_var_lab[46] . "|menu_form_php.php?sc_item_menu=item_128&sc_apl_menu=form_gestor_aduanal&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[46] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_consignatario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_consignatario']) == "on")
{
    $menu_menuData['data'] .= "item_129|...|" . $nm_var_lab[47] . "|menu_form_php.php?sc_item_menu=item_129&sc_apl_menu=form_consignatario&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[47] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_viaje_importacion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_viaje_importacion']) == "on")
{
    $menu_menuData['data'] .= "item_130|...|" . $nm_var_lab[48] . "|menu_form_php.php?sc_item_menu=item_130&sc_apl_menu=form_viaje_importacion&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[48] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_revision']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_revision']) == "on")
{
    $menu_menuData['data'] .= "item_43|..|" . $nm_var_lab[49] . "|menu_form_php.php?sc_item_menu=item_43&sc_apl_menu=form_revision&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[49] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Cambio_estatus_Rev']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Cambio_estatus_Rev']) == "on")
{
    $menu_menuData['data'] .= "item_86|..|" . $nm_var_lab[50] . "|menu_form_php.php?sc_item_menu=item_86&sc_apl_menu=Cambio_estatus_Rev&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[50] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_104|..|" . $nm_var_lab[51] . "||" . $nm_var_hint[51] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Revision_Tiempos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Revision_Tiempos']) == "on")
{
    $menu_menuData['data'] .= "item_44|...|" . $nm_var_lab[52] . "|menu_form_php.php?sc_item_menu=item_44&sc_apl_menu=Reporte_Revision_Tiempos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[52] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_132|.|" . $nm_var_lab[53] . "||" . $nm_var_hint[53] . "|grp__NM__ico__NM__weight.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_weighings']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_weighings']) == "on")
{
    $menu_menuData['data'] .= "item_133|..|" . $nm_var_lab[54] . "|menu_form_php.php?sc_item_menu=item_133&sc_apl_menu=grid_weighings&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[54] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_de_pesaje_completo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_de_pesaje_completo']) == "on")
{
    $menu_menuData['data'] .= "item_135|..|" . $nm_var_lab[55] . "|menu_form_php.php?sc_item_menu=item_135&sc_apl_menu=grid_reporte_de_pesaje_completo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[55] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pesaje_por_embarque']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pesaje_por_embarque']) == "on")
{
    $menu_menuData['data'] .= "item_142|..|" . $nm_var_lab[56] . "|menu_form_php.php?sc_item_menu=item_142&sc_apl_menu=grid_pesaje_por_embarque&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[56] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_136|.|" . $nm_var_lab[57] . "||" . $nm_var_hint[57] . "|usr__NM__bg__NM__camion-de-reparto.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_EIR']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_EIR']) == "on")
{
    $menu_menuData['data'] .= "item_137|..|" . $nm_var_lab[58] . "|menu_form_php.php?sc_item_menu=item_137&sc_apl_menu=form_EIR&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[58] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion']) == "on")
{
    $menu_menuData['data'] .= "item_138|..|" . $nm_var_lab[59] . "|menu_form_php.php?sc_item_menu=item_138&sc_apl_menu=grid_condicion&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[59] . "||" . $this->menu_target('_self') . "|" . "\n";
}

$menu_menuData['data'] .= "item_105|.|" . $nm_var_lab[60] . "||" . $this->Nm_lang['lang_menu_security'] . "|usr__NM__bg__NM__habilidades.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Modificar_Cita']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Modificar_Cita']) == "on")
{
    $menu_menuData['data'] .= "item_118|..|" . $nm_var_lab[61] . "|menu_form_php.php?sc_item_menu=item_118&sc_apl_menu=Modificar_Cita&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[60] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) == "on")
{
    $menu_menuData['data'] .= "item_120|..|" . $nm_var_lab[62] . "|menu_form_php.php?sc_item_menu=item_120&sc_apl_menu=registro_turnos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[61] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['Finalizar_Turno']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['Finalizar_Turno']) == "on")
{
    $menu_menuData['data'] .= "item_117|..|" . $nm_var_lab[63] . "|menu_form_php.php?sc_item_menu=item_117&sc_apl_menu=Finalizar_Turno&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[62] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_form_edit_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_form_edit_users']) == "on")
{
    $menu_menuData['data'] .= "item_106|..|" . $this->Nm_lang['lang_list_users'] . "|menu_form_php.php?sc_item_menu=item_106&sc_apl_menu=sec_form_edit_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_apps']) == "on")
{
    $menu_menuData['data'] .= "item_107|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_form_php.php?sc_item_menu=item_107&sc_apl_menu=sec_grid_sec_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_108|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_form_php.php?sc_item_menu=item_108&sc_apl_menu=sec_grid_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_115|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|menu_form_php.php?sc_item_menu=item_115&sc_apl_menu=sec_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
...
{
    $menu_menuData['data'] .= "item_109|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_form_php.php?sc_item_menu=item_109&sc_apl_menu=sec_search_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) == "on")
{
    $menu_menuData['data'] .= "item_110|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_form_php.php?sc_item_menu=item_110&sc_apl_menu=sec_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_logged_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_logged_users']) == "on")
{
    $menu_menuData['data'] .= "item_113|..|" . $this->Nm_lang['lang_logged_users'] . "|menu_form_php.php?sc_item_menu=item_113&sc_apl_menu=sec_logged_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_logged_users'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) == "on")
{
    $menu_menuData['data'] .= "item_111|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_form_php.php?sc_item_menu=item_111&sc_apl_menu=sec_change_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) == "on")
{
    $menu_menuData['data'] .= "item_112|..|" . $this->Nm_lang['lang_exit'] . "|menu_form_php.php?sc_item_menu=item_112&sc_apl_menu=sec_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_target('_parent') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) == "on")
{
    $menu_menuData['data'] .= "item_143|.|" . $nm_var_lab[64] . "|menu_form_php.php?sc_item_menu=item_143&sc_apl_menu=sec_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_target('_parent') . "|" . "\n";
}
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__calendario-mural.png";
$icon_aba = "";
$icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=registro_turnos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=Reimpresion_QR&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reimpresion_QR']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reimpresion_QR']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_41&sc_apl_menu=Despachos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Despachos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Despachos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_40&sc_apl_menu=ingresobar&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['ingresobar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['ingresobar']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_134&sc_apl_menu=Busqueda_Placa&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Busqueda_Placa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Busqueda_Placa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_45&sc_apl_menu=Reporte_citas_total_tiempos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_116&sc_apl_menu=Resumen_estatus_yarda&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Resumen_estatus_yarda']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Resumen_estatus_yarda']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_119&sc_apl_menu=Reporte_citas_total_tiempos_general&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos_general']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_citas_total_tiempos_general']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_122&sc_apl_menu=grid_despachos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_despachos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_despachos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_144&sc_apl_menu=Reporte_Placas_Yarda_Barrios&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Placas_Yarda_Barrios']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Placas_Yarda_Barrios']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "usr__NM__bg__NM__portapapeles.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_cabezal&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_cabezal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_cabezal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_cabezal&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cabezal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cabezal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_piloto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_piloto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_piloto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_piloto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_piloto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_piloto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_140&sc_apl_menu=form_master_equipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_master_equipo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_master_equipo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_141&sc_apl_menu=grid_master_equipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_master_equipo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_master_equipo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=form_estado&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_estado&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estado']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_estado']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=form_naviera&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_naviera']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_naviera']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_naviera&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_naviera']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_naviera']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_tipodecarga&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipodecarga']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipodecarga']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_tipodecarga&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipodecarga']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipodecarga']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_82&sc_apl_menu=grid_viaje&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_viaje']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_viaje']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_83&sc_apl_menu=form_buque_1&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_buque_1']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_buque_1']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_34&sc_apl_menu=form_tipo_equipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_equipo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_equipo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_tipoequipo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipoequipo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipoequipo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_37&sc_apl_menu=form_transporte&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_transporte']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_transporte']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_38&sc_apl_menu=grid_transporte&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transporte']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_transporte']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_39&sc_apl_menu=form_yarda&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_yarda']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_yarda']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "usr__NM__bg__NM__lista.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_124&sc_apl_menu=form_funcionario&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_funcionario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_funcionario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_127&sc_apl_menu=form_contenido&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_contenido']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_contenido']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_128&sc_apl_menu=form_gestor_aduanal&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_gestor_aduanal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_gestor_aduanal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_129&sc_apl_menu=form_consignatario&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_consignatario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_consignatario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_130&sc_apl_menu=form_viaje_importacion&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_viaje_importacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_viaje_importacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_43&sc_apl_menu=form_revision&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_revision']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_revision']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_86&sc_apl_menu=Cambio_estatus_Rev&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Cambio_estatus_Rev']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Cambio_estatus_Rev']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_44&sc_apl_menu=Reporte_Revision_Tiempos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Revision_Tiempos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Reporte_Revision_Tiempos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__weight.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_133&sc_apl_menu=grid_weighings&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_weighings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_weighings']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_135&sc_apl_menu=grid_reporte_de_pesaje_completo&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_de_pesaje_completo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_de_pesaje_completo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_142&sc_apl_menu=grid_pesaje_por_embarque&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pesaje_por_embarque']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pesaje_por_embarque']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "usr__NM__bg__NM__camion-de-reparto.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_137&sc_apl_menu=form_EIR&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_EIR']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_EIR']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_138&sc_apl_menu=grid_condicion&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "usr__NM__bg__NM__habilidades.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_118&sc_apl_menu=Modificar_Cita&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Modificar_Cita']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Modificar_Cita']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_120&sc_apl_menu=registro_turnos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['registro_turnos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_117&sc_apl_menu=Finalizar_Turno&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Finalizar_Turno']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Finalizar_Turno']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_106&sc_apl_menu=sec_form_edit_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_form_edit_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_form_edit_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_107&sc_apl_menu=sec_grid_sec_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_108&sc_apl_menu=sec_grid_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_115&sc_apl_menu=sec_grid_sec_users_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_109&sc_apl_menu=sec_search_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_110&sc_apl_menu=sec_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_113&sc_apl_menu=sec_logged_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_logged_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_logged_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_111&sc_apl_menu=sec_change_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_112&sc_apl_menu=sec_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_143&sc_apl_menu=sec_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<style>
   .scTabText {
   }   #item_143 .icon_fa{ color: #ecf30b  !important}
    <?php
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['fondo_menu']) && $_SESSION['scriptcase']['sc_apl_seg']['fondo_menu'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu');\" item-href=\"menu_form_php.php?sc_item_menu=menu&sc_apl_menu=fondo_menu&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_iframe\"";
} 
else
{ 
...
?>
      <iframe id="iframe_menu" name="menu_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 1200px;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
 foreach ($menu_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 1200px;\" src=\"\"></iframe>
";
     }
 }
}
...
?>
        <td class='sc-layer-1' style='width:7.94%;text-align:left;'>
                        <span class='sc-layer-1-0' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'>   <img src="<?php echo $path_imag_cab ?>/grp__NM__img__NM__TFPB.png" border="0"/></span><br/>
