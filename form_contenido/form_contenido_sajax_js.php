  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contenido" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contenido_form();
	}

  // ---------- Validate idcontenido_
  function do_ajax_form_contenido_validate_idcontenido_(iNumLinha)
  {
    var nomeCampo_idcontenido_ = "idcontenido_" + iNumLinha;
    var var_idcontenido_ = scAjaxGetFieldHidden(nomeCampo_idcontenido_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contenido_validate_idcontenido_(var_idcontenido_, iNumLinha, var_script_case_init, do_ajax_form_contenido_validate_idcontenido__cb);
  } // do_ajax_form_contenido_validate_idcontenido_

  function do_ajax_form_contenido_validate_idcontenido__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idcontenido_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcontenido_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idcontenido_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcontenido_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contenido_validate_idcontenido__cb

  // ---------- Validate descripcion_
  function do_ajax_form_contenido_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contenido_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_contenido_validate_descripcion__cb);
  } // do_ajax_form_contenido_validate_descripcion_

  function do_ajax_form_contenido_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contenido_validate_descripcion__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_contenido_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_contenido_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contenido_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_contenido_add_new_line_cb);
  } // do_ajax_form_contenido_add_new_line

  function do_ajax_form_contenido_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_contenido_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_contenido_backup_line(iNumLinha)
  {
    var var_idcontenido_ = scAjaxGetFieldHidden("idcontenido_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contenido_backup_line(var_idcontenido_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_contenido_backup_line_cb);
  } // do_ajax_form_contenido_backup_line

  function do_ajax_form_contenido_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_contenido_backup_line_cb

  function do_ajax_form_contenido_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_contenido_cancel_insert

  function do_ajax_form_contenido_cancel_update(iSeqVert)
  {
    do_ajax_form_contenido_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_contenido_cancel_update

  function do_ajax_form_contenido_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_contenido_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_contenido_table_refresh()
  {
    var var_idcontenido_ = document.F2.idcontenido_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_contenido_table_refresh(var_idcontenido_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contenido_table_refresh_cb);
  } //  do_ajax_form_contenido_table_refresh

  function do_ajax_form_contenido_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcontenido_.value = scAjaxGetKeyValue("idcontenido_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_contenido_table_refresh_cb_after_alert);
  } // do_ajax_form_contenido_table_refresh_cb
  function do_ajax_form_contenido_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_contenido_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_contenido_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_contenido_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_contenido_submit_form(var_idcontenido_, var_descripcion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contenido_submit_form_cb);
  } // do_ajax_form_contenido_submit_form

  function do_ajax_form_contenido_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcontenido_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contenido_submit_form_cb_after_alert);
  } // do_ajax_form_contenido_submit_form_cb
  function do_ajax_form_contenido_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contenido_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contenido_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_contenido_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idcontenido_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contenido_navigate_form(var_idcontenido_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contenido_navigate_form_cb);
  } // do_ajax_form_contenido_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contenido']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contenido_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcontenido_.value = scAjaxGetKeyValue("idcontenido_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contenido_navigate_form_cb_after_alert);
  } // do_ajax_form_contenido_navigate_form_cb
  function do_ajax_form_contenido_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_contenido_navigate_form_cb_after_alert
  function sc_hide_form_contenido_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idcontenido_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idcontenido_" + iNumLinha] = {"label": "Cod<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idcontenido_"][iNumLinha] = "idcontenido_" + iNumLinha;
    ajax_field_mult["descripcion_"][iNumLinha] = "descripcion_" + iNumLinha;
    ajax_field_id["idcontenido_" + iNumLinha] = new Array("hidden_field_label_idcontenido_", "hidden_field_data_idcontenido_" + iNumLinha);
    ajax_field_id["descripcion_" + iNumLinha] = new Array("hidden_field_label_descripcion_", "hidden_field_data_descripcion_" + iNumLinha);
    ajax_error_count["idcontenido_" + iNumLinha] = "off";
    ajax_error_count["descripcion_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idcontenido_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idcontenido_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idcontenido_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcontenido_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcontenido_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcontenido_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcontenido_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcontenido_'])) ? $this->nmgp_cmp_readonly['idcontenido_'] : 'on';
?>
    scAjaxFieldRead("idcontenido_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idcontenido_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idcontenido_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcontenido_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idcontenido_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idcontenido_" + iRow] = "off";
      ...
      $("#hidden_field_data_idcontenido_" + iRow).removeClass("scFormErrorLine");
