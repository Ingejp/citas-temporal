...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_viaje"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_viaje"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_viaje'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_viaje']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_viaje']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_viaje']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_viaje']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_viaje']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_viaje']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_viaje']['embutida_filho'] as $ind => $sc_init)
          {
