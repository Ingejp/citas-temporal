...
<?php
   ...
   $Ord_Cmp = new grid_viaje_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_viaje_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idviaje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idviaje"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idviaje"] : "Idviaje";
   $tab_ger_campos['idestado'] = "on";
   $tab_def_campos['idestado'] = "idestado";
   $tab_labels["idestado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idestado"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idestado"] : "Estado";
   $tab_ger_campos['viaje'] = "on";
   $tab_def_campos['viaje'] = "viaje";
   $tab_labels["viaje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["viaje"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["viaje"] : "Viaje";
   $tab_ger_campos['fechaatraque'] = "on";
   $tab_def_campos['fechaatraque'] = "fechaAtraque";
   $tab_labels["fechaatraque"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["fechaatraque"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["fechaatraque"] : "Fecha Atraque";
   $tab_ger_campos['fechazarpe'] = "on";
   $tab_def_campos['fechazarpe'] = "fechaZarpe";
   $tab_labels["fechazarpe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["fechazarpe"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["fechazarpe"] : "Fecha Zarpe";
   $tab_ger_campos['idbuque'] = "on";
   $tab_def_campos['idbuque'] = "idBuque";
   $tab_labels["idbuque"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idbuque"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idbuque"] : "Buque";
   $tab_ger_campos['idnaviera'] = "on";
   $tab_def_campos['idnaviera'] = "idNaviera";
   $tab_labels["idnaviera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idnaviera"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['labels']["idnaviera"] : "Naviera";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_viaje']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_viaje']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_viaje_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_viaje']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
