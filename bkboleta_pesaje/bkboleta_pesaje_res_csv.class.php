...
class bkboleta_pesaje_res_csv
{
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".csv";
      $this->Tit_doc       = "bkboleta_pesaje.csv";
      $this->Tit_zip       = "bkboleta_pesaje.zip";
      $this->Label_CSV     = "N";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_name']);
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_return']);
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_res_file'] = $this->Csv_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['csv_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
