<?php
@session_start() ;
$_SESSION['scriptcase']['bkboleta_pesaje']['sc_process_barr'] = true;
require_once('../bkboleta_pesaje/index.php');
unset($_SESSION['scriptcase']['bkboleta_pesaje']['sc_process_barr']);
$ExportCtrl = new bkboleta_pesaje_export_control;
$ExportCtrl->Export_barr();

class bkboleta_pesaje_export_control
{
