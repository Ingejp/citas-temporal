<?php
   include_once('bkboleta_pesaje_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class bkboleta_pesaje_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "bkboleta_pesaje"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/bkboleta_pesaje';
      ...
      if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['bkboleta_pesaje']['actual_lang']) || $_SESSION['scriptcase']['bkboleta_pesaje']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['bkboleta_pesaje']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("bkboleta_pesaje_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["bkboleta_pesaje"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["bkboleta_pesaje"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir']))
      {
      ...
      $this->nm_path_pdf     = $this->path_imag_temp . "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_bkboleta_pesaje" . ".pdf";
      $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "bkboleta_pesaje_erro.class.php"); 
      $this->Erro = new bkboleta_pesaje_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('bkboleta_pesaje'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao']) && $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_perfil']) && $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['bkboleta_pesaje']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['embutida_init']) 
      {
          if (!isset($_SESSION['QR'])) 
          {
              $this->nm_falta_var .= "QR; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['bkboleta_pesaje']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class bkboleta_pesaje_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['bkboleta_pesaje']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['bkboleta_pesaje'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class bkboleta_pesaje_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_ibase'])) 
      { 
          $this->Ini = new bkboleta_pesaje_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['bkboleta_pesaje']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['bkboleta_pesaje'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['bkboleta_pesaje']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['bkboleta_pesaje']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('bkboleta_pesaje') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['bkboleta_pesaje']['label'] = "" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " weighings";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      include_once($this->Ini->path_aplicacao . "bkboleta_pesaje_erro.class.php"); 
      $this->Erro      = new bkboleta_pesaje_erro();
      $this->Erro->Ini = $this->Ini;
      require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_lookup.class.php"); 
      $this->Lookup       = new bkboleta_pesaje_lookup();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['exit'];
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida'])
      { 
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] = "grid" ;  
      }   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig'] = " where QR = " . $_SESSION['QR'] . "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq_ant']   = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['cond_pesq'] = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq_ant'];  
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_bkboleta_pesaje_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_xls.class.php"); 
          } 
          $this->xls  = new bkboleta_pesaje_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_res_xls.class.php"); 
          } 
          $this->xls  = new bkboleta_pesaje_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_xml.class.php"); 
          } 
          $this->xml  = new bkboleta_pesaje_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_res_xml.class.php"); 
          } 
          $this->xml  = new bkboleta_pesaje_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_csv.class.php"); 
          } 
          $this->csv  = new bkboleta_pesaje_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_res_csv.class.php"); 
          } 
          $this->csv  = new bkboleta_pesaje_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_rtf.class.php"); 
          } 
          $this->rtf  = new bkboleta_pesaje_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "bkboleta_pesaje/bkboleta_pesaje_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_res_rtf.class.php"); 
          } 
          $this->rtf  = new bkboleta_pesaje_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new bkboleta_pesaje_pesq();
      ...
      { 
           require_once($this->Ini->path_aplicacao . "bkboleta_pesaje_grid.class.php"); 
           $this->grid  = new bkboleta_pesaje_grid();
...
<?php
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['bkboleta_pesaje']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_bkboleta_pesaje($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_bkboleta_pesaje($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['bkboleta_pesaje']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "bkboleta_pesaje") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['bkboleta_pesaje']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['bkboleta_pesaje']['master_pai']) && $_SESSION['sc_session'][$init_filho]['bkboleta_pesaje']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['bkboleta_pesaje']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           foreach ($todo as $param)
           {
                ...
                if (1 < sizeof($cadapar))
                {
                    ...
                    nm_limpa_str_bkboleta_pesaje($cadapar[1]);
                    nm_protect_num_bkboleta_pesaje($cadapar[0], $cadapar[1]);
                    if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                    $Tmp_par   = $cadapar[0];
                    $$Tmp_par = $cadapar[1];
                }
           }
           if (!isset($QR) && isset($qr)) 
           {
               $_SESSION["QR"] = $qr;
           }
           if (isset($QR)) 
           {
               $_SESSION['QR'] = $QR;
               nm_limpa_str_bkboleta_pesaje($_SESSION["QR"]);
           }
           $NMSC_conf_apl = array();
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']);
               $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida']) && $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['bkboleta_pesaje']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['bkboleta_pesaje']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['bkboleta_pesaje']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['bkboleta_pesaje']['protect_modal']) && !empty($_SESSION['scriptcase']['bkboleta_pesaje']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['bkboleta_pesaje']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "bkboleta_pesaje";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'bkboleta_pesaje' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/bkboleta_pesaje/'))
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'bkboleta_pesaje')
   {
       $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/bkboleta_pesaje_erro.php");
   }
   ...
   if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['bkboleta_pesaje']))
   { 
       return;
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] = $nmgp_opcao ;  
       }   
       if (isset($_POST["QR"])) 
       {
       ...
       if (!isset($_POST["QR"]) && isset($_POST["qr"])) 
       {
           $_SESSION["QR"] = $_POST["qr"];
           nm_limpa_str_bkboleta_pesaje($_SESSION["QR"]);
       }
       ...
       if (!isset($_GET["QR"]) && isset($_GET["qr"])) 
       {
           $_SESSION["QR"] = $_GET["qr"];
           nm_limpa_str_bkboleta_pesaje($_SESSION["QR"]);
       }
       ...
       {
          $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['volta_redirect_tp'] = "";
           $nm_url_saida = "bkboleta_pesaje_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['sc_modal'] = true;
               }
               $nm_url_saida = "bkboleta_pesaje_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['mostra_edit'] = "N";   
           } 
       ...
       $contr_bkboleta_pesaje = new bkboleta_pesaje_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] = "busca";
          $contr_bkboleta_pesaje->NM_ajax_flag = true;
          $contr_bkboleta_pesaje->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] = "busca";
          $contr_bkboleta_pesaje->NM_ajax_flag = true;
          $contr_bkboleta_pesaje->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] = "busca";
          $contr_bkboleta_pesaje->NM_ajax_flag = true;
          $contr_bkboleta_pesaje->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['opcao'] = "busca";
          $contr_bkboleta_pesaje->NM_ajax_flag = true;
          $contr_bkboleta_pesaje->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_bkboleta_pesaje->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['bkboleta_pesaje']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_bkboleta_pesaje(&$str)
   {
   ...
   function nm_protect_num_bkboleta_pesaje($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function bkboleta_pesaje_pack_protect_string($sString)
   {
