...
//
   ...
   $_SESSION['scriptcase']['bkboleta_pesaje']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("bkboleta_pesaje", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   { 
       ...
       $this->in[0] = $Busca_temp['in']; 
       $tmp_pos = strpos($this->in[0], "##@@");
       if ($tmp_pos !== false && !is_array($this->in[0]))
       {
           $this->in[0] = substr($this->in[0], 0, $tmp_pos);
       }
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['order_grid'] = $nmgp_order_by;
...
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/usr__NM__bg__NM__TICKET BASCULA FINAL.png", "1.000000", "2.000000", "20", "14", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['idweighing'] = "Idweighing";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['container'] = "Container";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['vessel'] = "Vessel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['shippingcompany'] = "Shipping Company";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['voyage'] = "Voyage";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['date'] = "Date";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['commodity'] = "Commodity";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['tarechassis'] = "Tare Chassis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['tarecontainer'] = "Tare Container";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['grossweight'] = "Gross Weight";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['netweight'] = "Net Weight";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['packages'] = "Packages";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['country'] = "Country";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['typeoperation'] = "Type Operation";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['vgm'] = "VGM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['qr'] = "QR";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['exitticket'] = "Exit Ticket";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['inticket'] = "In Ticket";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['licenseplate'] = "License Plate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['driverslicense'] = "Drivers License";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['pilotname'] = "Pilot Name";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['transportname'] = "Transport Name";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['chasis'] = "Chasis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['machine'] = "Machine";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['bl'] = "Bl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['out'] = "Out";
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['labels']['in'] = "In";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['bkboleta_pesaje']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['bkboleta_pesaje']['qt_col_grid']) 
      {  
          ...
          $this->exitticket[$this->nm_grid_colunas] = $this->rs_grid->fields[16] ;  
          $this->inticket[$this->nm_grid_colunas] = $this->rs_grid->fields[17] ;  
          $this->licenseplate[$this->nm_grid_colunas] = $this->rs_grid->fields[18] ;  
          $this->driverslicense[$this->nm_grid_colunas] = $this->rs_grid->fields[19] ;  
          $this->driverslicense[$this->nm_grid_colunas] = (string)$this->driverslicense[$this->nm_grid_colunas];
          $this->pilotname[$this->nm_grid_colunas] = $this->rs_grid->fields[20] ;  
          $this->transportname[$this->nm_grid_colunas] = $this->rs_grid->fields[21] ;  
          $this->chasis[$this->nm_grid_colunas] = $this->rs_grid->fields[22] ;  
          $this->machine[$this->nm_grid_colunas] = $this->rs_grid->fields[23] ;  
          $this->machine[$this->nm_grid_colunas] = (string)$this->machine[$this->nm_grid_colunas];
          $this->bl[$this->nm_grid_colunas] = $this->rs_grid->fields[24] ;  
          $this->out[$this->nm_grid_colunas] = $this->rs_grid->fields[25] ;  
          $this->in[$this->nm_grid_colunas] = $this->rs_grid->fields[26] ;  
          ...
          $this->in[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->in[$this->nm_grid_colunas]);
            ...
            $cell_netWeight = array('posx' => '14.305859583331533', 'posy' => '13.5742291664932', 'data' => $this->netweight[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '11', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            ...
            $cell_VGM = array('posx' => '14.301692916664853', 'posy' => '12.88166666666504', 'data' => $this->vgm[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '11', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
