...
class Reporte_citas_total_tiempos_general_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "Reporte_citas_total_tiempos_general_res_xls.class.php");
              $this->Res_xls = new Reporte_citas_total_tiempos_general_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_Reporte_citas_total_tiempos_general.zip";
          $this->Arquivo   .= "_Reporte_citas_total_tiempos_general" . $this->Xls_tp;
          $this->Tit_doc    = "Reporte_citas_total_tiempos_general" . $this->Xls_tp;
          $this->Tit_zip    = "Reporte_citas_total_tiempos_general.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_grid_bitacora_cita_cons_emb, '/');
      $link_xls = substr($this->Ini->link_grid_bitacora_cita_cons_emb, 0, $pos) . "/grid_bitacora_cita_xls.class.php";
      if (!is_file($this->Ini->link_grid_bitacora_cita_cons_emb) || !is_file($link_xls))
      {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['Reporte_citas_total_tiempos_general']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bitacora_cita']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bitacora_cita']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
   ...
   {
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?idcita?#?" . str_replace("'", "@aspass@", $this->Orig_idcita) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bitacora_cita']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bitacora_cita']['nolabel'] = true;
         if (method_exists($this->grid_bitacora_cita, "controle"))
         {
             $this->grid_bitacora_cita->controle();
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   function NM_export_horas_nodo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->horas_nodo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->horas_nodo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- observaciones
   ...
   //----- horas_nodo
   function NM_sub_cons_horas_nodo()
   {
         $this->horas_nodo = html_entity_decode($this->horas_nodo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->horas_nodo = strip_tags($this->horas_nodo);
         if (!NM_is_utf8($this->horas_nodo))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->horas_nodo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>REPORTE DE INGRESOS POR NAVIERA :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Reporte_citas_total_tiempos_general']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
