...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idcontenido";$Nm_numeric[] = "idcontenido";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idcontenido_cond" name="idcontenido_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcontenido'), this, 'idcontenido')">
      ...
      <br><span id="id_hide_idcontenido"  <?php echo $str_hide_idcontenido?>><?php
      if ($idcontenido != "")
      {
      $idcontenido_look = substr($this->Db->qstr($idcontenido), 1, -1); 
      $nmgp_def_dados = array(); 
