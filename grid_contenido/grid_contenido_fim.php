...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_contenido"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_contenido"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contenido']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contenido']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contenido']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contenido']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contenido']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contenido']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contenido']['embutida_filho'] as $ind => $sc_init)
          {
