...
<?php
   ...
   $Ord_Cmp = new Reimpresion_QR_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Reimpresion_QR_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idcita"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idcita"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idcita"] : "No.";
   $tab_ger_campos['fechainicio'] = "on";
   $tab_def_campos['fechainicio'] = "fechaInicio";
   $tab_labels["fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["fechainicio"] : "FECHA";
   $tab_ger_campos['idpiloto'] = "on";
   $tab_def_campos['idpiloto'] = "idpiloto";
   $tab_labels["idpiloto"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idpiloto"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idpiloto"] : "PILOTO";
   $tab_ger_campos['idcabezal'] = "on";
   $tab_def_campos['idcabezal'] = "idcabezal";
   $tab_labels["idcabezal"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idcabezal"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idcabezal"] : "PLACA";
   $tab_ger_campos['idnaviera'] = "on";
   $tab_def_campos['idnaviera'] = "idNaviera";
   $tab_labels["idnaviera"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idnaviera"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idnaviera"] : "NAVIERA";
   $tab_ger_campos['chasis'] = "on";
   $tab_def_campos['chasis'] = "chasis";
   $tab_labels["chasis"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["chasis"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["chasis"] : "CHASIS";
   $tab_ger_campos['contenedorimport'] = "on";
   $tab_def_campos['contenedorimport'] = "contenedorimport";
   $tab_labels["contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["contenedorimport"] : "CONT. IMPORT";
   $tab_ger_campos['contenedorexport'] = "on";
   $tab_def_campos['contenedorexport'] = "contenedorExport";
   $tab_labels["contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["contenedorexport"] : "CONT. EXPORT";
   $tab_ger_campos['idviaje'] = "on";
   $tab_def_campos['idviaje'] = "idviaje";
   $tab_labels["idviaje"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idviaje"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["idviaje"] : "BUQUE Y VIAJE";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['labels']["imprimir"] : "IMPRIMIR";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Reimpresion_QR_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Reimpresion_QR']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
