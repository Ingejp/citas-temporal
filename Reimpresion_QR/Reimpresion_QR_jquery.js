...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_Reimpresion_QR').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_Reimpresion_QR').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_Reimpresion_QR').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_Reimpresion_QR').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_Reimpresion_QR').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_Reimpresion_QR').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_Reimpresion_QR').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_Reimpresion_QR').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_Reimpresion_QR').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_Reimpresion_QR').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_Reimpresion_QR').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_Reimpresion_QR').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
