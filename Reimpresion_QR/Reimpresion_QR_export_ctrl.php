<?php
@session_start() ;
$_SESSION['scriptcase']['Reimpresion_QR']['sc_process_barr'] = true;
require_once('../Reimpresion_QR/index.php');
unset($_SESSION['scriptcase']['Reimpresion_QR']['sc_process_barr']);
$ExportCtrl = new Reimpresion_QR_export_control;
$ExportCtrl->Export_barr();

class Reimpresion_QR_export_control
{
