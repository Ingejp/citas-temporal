...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Reimpresion_QR"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Reimpresion_QR"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Reimpresion_QR']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Reimpresion_QR']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Reimpresion_QR']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Reimpresion_QR']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Reimpresion_QR']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Reimpresion_QR']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Reimpresion_QR']['embutida_filho'] as $ind => $sc_init)
          {
