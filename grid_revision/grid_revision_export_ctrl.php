<?php
@session_start() ;
$_SESSION['scriptcase']['grid_revision']['sc_process_barr'] = true;
require_once('../grid_revision/index.php');
unset($_SESSION['scriptcase']['grid_revision']['sc_process_barr']);
$ExportCtrl = new grid_revision_export_control;
$ExportCtrl->Export_barr();

class grid_revision_export_control
{
