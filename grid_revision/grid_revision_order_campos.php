<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_revision']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_revision_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_revision_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["rev_codigo_revision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_codigo_revision"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_codigo_revision"] : "TURNO";
   ...
   $tab_labels["rev_fecha_solicitud"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_fecha_solicitud"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_fecha_solicitud"] : "FECHA SOLICITUD";
   ...
   $tab_labels["rev_contenedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_contenedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_contenedor"] : "CONTENEDOR";
   ...
   $tab_labels["cab_placa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["cab_placa"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["cab_placa"] : "PLACA";
   ...
   $tab_labels["maga"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["maga"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["maga"] : "MAGA";
   ...
   $tab_labels["sgaia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["sgaia"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["sgaia"] : "SGAIA";
   ...
   $tab_labels["sat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["sat"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["sat"] : "SAT";
   ...
   $tab_labels["dipa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["dipa"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["dipa"] : "DIPA";
   ...
   $tab_labels["ucc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["ucc"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["ucc"] : "UCC";
   $tab_ger_campos['consig_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['consig_nombre'] = "consig_nombre";
   }
   else
   {
       $tab_def_campos['consig_nombre'] = "consig.nombre";
   }
   $tab_labels["consig_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["consig_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["consig_nombre"] : "CONSIGNATARIO";
   $tab_ger_campos['cont_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cont_descripcion'] = "cont_descripcion";
   }
   else
   {
       $tab_def_campos['cont_descripcion'] = "cont.descripcion";
   }
   $tab_labels["cont_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["cont_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["cont_descripcion"] : "MERCADERIA";
   $tab_ger_campos['est_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['est_descripcion'] = "est_descripcion";
   }
   else
   {
       $tab_def_campos['est_descripcion'] = "est.descripcion";
   }
   $tab_labels["est_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["est_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["est_descripcion"] : "ESTATUS";
   ...
   $tab_labels["med_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["med_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["med_descripcion"] : "MEDIDA";
   ...
   $tab_labels["nav_naviera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["nav_naviera"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["nav_naviera"] : "NAVIERA";
   ...
   $tab_labels["buq_buque"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["buq_buque"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["buq_buque"] : "BUQUE";
   ...
   $tab_labels["ramp_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["ramp_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["ramp_descripcion"] : "RAMPA";
   ...
   $tab_labels["sel_selectivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["sel_selectivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["sel_selectivo"] : "Selectivo";
   ...
   $tab_labels["rev_bl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_bl"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_bl"] : "Bl";
   ...
   $tab_labels["tcar_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["tcar_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["tcar_descripcion"] : "Descripcion";
   $tab_ger_campos['gest_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['gest_nombre'] = "gest_nombre";
   }
   else
   {
       $tab_def_campos['gest_nombre'] = "gest.nombre";
   }
   $tab_labels["gest_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["gest_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["gest_nombre"] : "Nombre";
   $tab_ger_campos['termo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['termo'] = "termo";
   }
   else
   {
       $tab_def_campos['termo'] = "IF(rev.termonebulizacion=\"1\",\"SI\",\"NO\")";
   }
   $tab_labels["termo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["termo"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["termo"] : "TERMO";
   ...
   $tab_labels["rev_porcentaje_intrusion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_porcentaje_intrusion"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_porcentaje_intrusion"] : "Porcentaje Intrusion";
   $tab_ger_campos['oper_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['oper_nombre'] = "oper_nombre";
   }
   else
   {
       $tab_def_campos['oper_nombre'] = "oper.nombre";
   }
   $tab_labels["oper_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["oper_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["oper_nombre"] : "Nombre";
   $tab_ger_campos['tmov_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tmov_descripcion'] = "tmov_descripcion";
   }
   else
   {
       $tab_def_campos['tmov_descripcion'] = "tmov.descripcion";
   }
   $tab_labels["tmov_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["tmov_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["tmov_descripcion"] : "Descripcion";
   $tab_ger_campos['rev_cantidad_por_bl'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rev_cantidad_por_bl'] = "rev_cantidad_por_bl";
   }
   else
   {
       $tab_def_campos['rev_cantidad_por_bl'] = "rev.cantidad_por_bl";
   }
   $tab_labels["rev_cantidad_por_bl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_cantidad_por_bl"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_cantidad_por_bl"] : "Cantidad Por Bl";
   ...
   $tab_labels["rev_observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['labels']["rev_observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_revision']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_revision']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_revision_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_revision']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
