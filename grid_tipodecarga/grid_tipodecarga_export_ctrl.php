<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipodecarga']['sc_process_barr'] = true;
require_once('../grid_tipodecarga/index.php');
unset($_SESSION['scriptcase']['grid_tipodecarga']['sc_process_barr']);
$ExportCtrl = new grid_tipodecarga_export_control;
$ExportCtrl->Export_barr();

class grid_tipodecarga_export_control
{
