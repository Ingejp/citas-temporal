...
<?php
   ...
   $Ord_Cmp = new grid_ocupacion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ocupacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idocupacion'] = "idocupacion";
   $tab_labels["idocupacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["idocupacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["idocupacion"] : "Idocupacion";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['ocupaciondry'] = "on";
   $tab_def_campos['ocupaciondry'] = "ocupacionDry";
   $tab_labels["ocupaciondry"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["ocupaciondry"])) ? $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["ocupaciondry"] : "Ocupacion Dry";
   $tab_ger_campos['ocupacionreefer'] = "on";
   $tab_def_campos['ocupacionreefer'] = "ocupacionReefer";
   $tab_labels["ocupacionreefer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["ocupacionreefer"])) ? $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["ocupacionreefer"] : "Ocupacion Reefer";
   $tab_ger_campos['ocupacionteu'] = "on";
   $tab_def_campos['ocupacionteu'] = "ocupacionTeu";
   $tab_labels["ocupacionteu"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["ocupacionteu"])) ? $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["ocupacionteu"] : "Ocupacion Teu";
   $tab_ger_campos['importdry'] = "on";
   $tab_def_campos['importdry'] = "importDry";
   $tab_labels["importdry"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["importdry"])) ? $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['labels']["importdry"] : "Import Dry";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ocupacion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ocupacion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
