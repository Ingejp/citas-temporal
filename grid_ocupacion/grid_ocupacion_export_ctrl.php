<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ocupacion']['sc_process_barr'] = true;
require_once('../grid_ocupacion/index.php');
unset($_SESSION['scriptcase']['grid_ocupacion']['sc_process_barr']);
$ExportCtrl = new grid_ocupacion_export_control;
$ExportCtrl->Export_barr();

class grid_ocupacion_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - ocupacion :: Excel</TITLE>
