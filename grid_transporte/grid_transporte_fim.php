...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_transporte"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_transporte"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_transporte'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transporte']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_transporte']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transporte']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_transporte']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_transporte']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_transporte']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_transporte']['embutida_filho'] as $ind => $sc_init)
          {
