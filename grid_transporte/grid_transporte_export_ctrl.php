<?php
@session_start() ;
$_SESSION['scriptcase']['grid_transporte']['sc_process_barr'] = true;
require_once('../grid_transporte/index.php');
unset($_SESSION['scriptcase']['grid_transporte']['sc_process_barr']);
$ExportCtrl = new grid_transporte_export_control;
$ExportCtrl->Export_barr();

class grid_transporte_export_control
{
