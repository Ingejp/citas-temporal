<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="iddetalle_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['iddetalle_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_detalle_condicion"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_detalle_condicion_submit_form(y, z);
