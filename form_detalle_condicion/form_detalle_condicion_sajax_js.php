  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detalle_condicion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detalle_condicion_form();
	}

  // ---------- Validate iddetalle_
  function do_ajax_form_detalle_condicion_validate_iddetalle_(iNumLinha)
  {
    var nomeCampo_iddetalle_ = "iddetalle_" + iNumLinha;
    var var_iddetalle_ = scAjaxGetFieldHidden(nomeCampo_iddetalle_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_condicion_validate_iddetalle_(var_iddetalle_, iNumLinha, var_script_case_init, do_ajax_form_detalle_condicion_validate_iddetalle__cb);
  } // do_ajax_form_detalle_condicion_validate_iddetalle_

  function do_ajax_form_detalle_condicion_validate_iddetalle__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "iddetalle_" + iLineNumber;
    }
    else
    {
      sFieldValid = "iddetalle_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "iddetalle_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "iddetalle_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_condicion_validate_iddetalle__cb

  // ---------- Validate foto_
  function do_ajax_form_detalle_condicion_validate_foto_(iNumLinha)
  {
    var nomeCampo_foto_ = "foto_" + iNumLinha;
    var var_foto_ = scAjaxGetFieldText(nomeCampo_foto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_condicion_validate_foto_(var_foto_, iNumLinha, var_script_case_init, do_ajax_form_detalle_condicion_validate_foto__cb);
  } // do_ajax_form_detalle_condicion_validate_foto_

  function do_ajax_form_detalle_condicion_validate_foto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "foto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "foto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalle_condicion_validate_foto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detalle_condicion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detalle_condicion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detalle_condicion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detalle_condicion_add_new_line_cb);
  } // do_ajax_form_detalle_condicion_add_new_line

  function do_ajax_form_detalle_condicion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_foto_" + iAjaxNewLine + " = '';");
  } // do_ajax_form_detalle_condicion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detalle_condicion_backup_line(iNumLinha)
  {
    var var_iddetalle_ = scAjaxGetFieldHidden("iddetalle_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalle_condicion_backup_line(var_iddetalle_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detalle_condicion_backup_line_cb);
  } // do_ajax_form_detalle_condicion_backup_line

  function do_ajax_form_detalle_condicion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detalle_condicion_backup_line_cb

  function do_ajax_form_detalle_condicion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detalle_condicion_cancel_insert

  function do_ajax_form_detalle_condicion_cancel_update(iSeqVert)
  {
    do_ajax_form_detalle_condicion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detalle_condicion_cancel_update

  function do_ajax_form_detalle_condicion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detalle_condicion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detalle_condicion_table_refresh()
  {
    var var_iddetalle_ = document.F2.iddetalle_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_detalle_condicion_table_refresh(var_iddetalle_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detalle_condicion_table_refresh_cb);
  } //  do_ajax_form_detalle_condicion_table_refresh

  function do_ajax_form_detalle_condicion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iddetalle_.value = scAjaxGetKeyValue("iddetalle_");
    ...
    scJQGeneralAdd();
    scAjaxAlert(do_ajax_form_detalle_condicion_table_refresh_cb_after_alert);
  } // do_ajax_form_detalle_condicion_table_refresh_cb
  function do_ajax_form_detalle_condicion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_detalle_condicion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detalle_condicion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detalle_condicion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_iddetalle_ = scAjaxGetFieldHidden("iddetalle_" + iNumLinha);
    var var_foto_ = scAjaxGetFieldText("foto_" + iNumLinha);
    var var_foto__ul_name = scAjaxSpecCharProtect(eval('document.F1.foto__ul_name' + iNumLinha + '.value'));
    var var_foto__ul_type = eval('document.F1.foto__ul_type' + iNumLinha + '.value');
    var var_foto__salva = document.F1.elements["foto_" + iNumLinha + "_salva"] ? eval('document.F1.foto_' + iNumLinha + '_salva.value') : "";
    var var_foto__limpa = eval('document.F1.foto__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_detalle_condicion_submit_form(var_iddetalle_, var_foto_, var_foto__ul_name, var_foto__ul_type, var_foto__salva, var_foto__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detalle_condicion_submit_form_cb);
  } // do_ajax_form_detalle_condicion_submit_form

  function do_ajax_form_detalle_condicion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("iddetalle_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("foto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
<?php
        ...
        {
?>
          if (document.F1.elements["foto__limpa" + sc_num_ult_line] && document.F1.elements["foto__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("foto_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["foto__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.foto__ul_name" + sc_num_ult_line + ") document.F1.foto__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.foto__ul_type" + sc_num_ult_line + ") document.F1.foto__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxShowDebug();
    scAjaxSetDisplay(true);
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalle_condicion_submit_form_cb_after_alert);
  } // do_ajax_form_detalle_condicion_submit_form_cb
  function do_ajax_form_detalle_condicion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detalle_condicion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detalle_condicion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_detalle_condicion_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("iddetalle_" + iNavForm);
      scAjaxHideErrorDisplay("foto_" + iNavForm);
    }
    var var_iddetalle_ = document.F2.iddetalle_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detalle_condicion_navigate_form(var_iddetalle_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detalle_condicion_navigate_form_cb);
  } // do_ajax_form_detalle_condicion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_condicion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detalle_condicion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddetalle_.value = scAjaxGetKeyValue("iddetalle_" + var_last_index);
    ...
    {
      eval("if (document.F1.foto__ul_name" + iImg + ") document.F1.foto__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.foto__ul_type" + iImg + ") document.F1.foto__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detalle_condicion_navigate_form_cb_after_alert);
  } // do_ajax_form_detalle_condicion_navigate_form_cb
  function do_ajax_form_detalle_condicion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_detalle_condicion_navigate_form_cb_after_alert
  function sc_hide_form_detalle_condicion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "iddetalle_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "foto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["iddetalle_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["foto_" + iNumLinha] = {"label": "FOTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["iddetalle_"][iNumLinha] = "iddetalle_" + iNumLinha;
    ajax_field_mult["foto_"][iNumLinha] = "foto_" + iNumLinha;
    ajax_field_id["iddetalle_" + iNumLinha] = new Array("hidden_field_label_iddetalle_", "hidden_field_data_iddetalle_" + iNumLinha);
    ajax_field_id["foto_" + iNumLinha] = new Array("hidden_field_label_foto_", "hidden_field_data_foto_" + iNumLinha);
    ajax_error_count["iddetalle_" + iNumLinha] = "off";
    ajax_error_count["foto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["iddetalle_" + iNumLinha] = "on";
    ajax_read_only["foto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["iddetalle_" + iNumLinha] = "on";
    ajax_read_only["foto_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["iddetalle_" + iNumLinha] = null;
    ajax_error_list["foto_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["iddetalle_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["iddetalle_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["iddetalle_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["iddetalle_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["iddetalle_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["foto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["foto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["foto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["foto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["foto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['iddetalle_'])) ? $this->nmgp_cmp_readonly['iddetalle_'] : 'on';
?>
    scAjaxFieldRead("iddetalle_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['foto_'])) ? $this->nmgp_cmp_readonly['foto_'] : 'off';
?>
    scAjaxFieldRead("foto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("iddetalle_" + iSeq, "on");
    scAjaxFieldRead("foto_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["iddetalle_" + iRow] || "on" == ajax_error_count["foto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_iddetalle_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_foto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["iddetalle_" + iRow] && "off" == ajax_error_count["foto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["iddetalle_" + iRow] = "off";
        ajax_error_count["foto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_iddetalle_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_foto_" + iRow).removeClass("scFormErrorLine");
    }
  }
