<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cabezal']['sc_process_barr'] = true;
require_once('../grid_cabezal/index.php');
unset($_SESSION['scriptcase']['grid_cabezal']['sc_process_barr']);
$ExportCtrl = new grid_cabezal_export_control;
$ExportCtrl->Export_barr();

class grid_cabezal_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - cabezal :: Excel</TITLE>
