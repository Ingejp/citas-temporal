...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_cantidadmodulistas' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_cantidadmodulistas_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_cantidadmodulistas_onfocus(this, iSeqRow) });
  $('#id_sc_field_rangoinicial' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_rangoinicial_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_rangoinicial_onfocus(this, iSeqRow) });
  $('#id_sc_field_rangofinal' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_rangofinal_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_rangofinal_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecharegistro' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_fecharegistro_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_fecharegistro_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecharegistro_hora' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_fecharegistro_hora_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_fecharegistro_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechamodificacion' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_fechamodificacion_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_fechamodificacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_horainicio' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_horainicio_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_horainicio_onfocus(this, iSeqRow) });
  $('#id_sc_field_horafin' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_horafin_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_horafin_onfocus(this, iSeqRow) });
  $('#id_sc_field_idtipodemodulista' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_DESPACHO_idtipodemodulista_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_CALEN_MODULISTA_DESPACHO_idtipodemodulista_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_CALEN_MODULISTA_DESPACHO_cantidadmodulistas_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_cantidadmodulistas();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_cantidadmodulistas_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_rangoinicial_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_rangoinicial();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_rangoinicial_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_rangofinal_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_rangofinal();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_rangofinal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_fecharegistro_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_fecharegistro();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_fecharegistro_hora_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_fecharegistro();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_fecharegistro_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_fecharegistro_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_fechamodificacion_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_fechamodificacion();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_fechamodificacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_horainicio_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_horainicio();
  scCssBlur(oThis);
  do_ajax_CALEN_MODULISTA_DESPACHO_event_horainicio_onblur();
}

function sc_CALEN_MODULISTA_DESPACHO_horainicio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_horafin_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_horafin();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_horafin_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_idtipodemodulista_onblur(oThis, iSeqRow) {
  do_ajax_CALEN_MODULISTA_DESPACHO_validate_idtipodemodulista();
  scCssBlur(oThis);
}

function sc_CALEN_MODULISTA_DESPACHO_idtipodemodulista_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_CALEN_MODULISTA_DESPACHO_form" + pageNo).hide();
}
...
function scEventControl_onCalculator_recur_info() {
  if (!_scCalculatorControl["id_sc_field_recur_info"]) {
    ...
    do_ajax_CALEN_MODULISTA_DESPACHO_event_recur_info_onblur();
  }
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecharegistro" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_CALEN_MODULISTA_DESPACHO_validate_fecharegistro(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechamodificacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_CALEN_MODULISTA_DESPACHO_validate_fechamodificacion(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_rangoinicial" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_CALEN_MODULISTA_DESPACHO_validate_rangoinicial(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_rangofinal" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_CALEN_MODULISTA_DESPACHO_validate_rangofinal(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
