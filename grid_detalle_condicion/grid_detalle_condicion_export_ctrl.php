<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalle_condicion']['sc_process_barr'] = true;
require_once('../grid_detalle_condicion/index.php');
unset($_SESSION['scriptcase']['grid_detalle_condicion']['sc_process_barr']);
$ExportCtrl = new grid_detalle_condicion_export_control;
$ExportCtrl->Export_barr();

class grid_detalle_condicion_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> detalle_condicion :: Excel</TITLE>
