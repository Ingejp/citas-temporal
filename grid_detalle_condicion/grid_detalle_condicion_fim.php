...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_detalle_condicion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_detalle_condicion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_condicion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalle_condicion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_condicion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalle_condicion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalle_condicion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalle_condicion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_condicion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalle_condicion']['embutida_filho'] as $ind => $sc_init)
          {
