<?php
@session_start() ;
$_SESSION['scriptcase']['GRID_VERDISPONIBILIDAD']['sc_process_barr'] = true;
require_once('../GRID_VERDISPONIBILIDAD/index.php');
unset($_SESSION['scriptcase']['GRID_VERDISPONIBILIDAD']['sc_process_barr']);
$ExportCtrl = new GRID_VERDISPONIBILIDAD_export_control;
$ExportCtrl->Export_barr();

class GRID_VERDISPONIBILIDAD_export_control
{
