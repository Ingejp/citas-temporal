...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____GRID_VERDISPONIBILIDAD"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____GRID_VERDISPONIBILIDAD"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GRID_VERDISPONIBILIDAD']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['GRID_VERDISPONIBILIDAD']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GRID_VERDISPONIBILIDAD']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['GRID_VERDISPONIBILIDAD']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['GRID_VERDISPONIBILIDAD']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>GRID_VERDISPONIBILIDAD</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['GRID_VERDISPONIBILIDAD']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['GRID_VERDISPONIBILIDAD']['embutida_filho'] as $ind => $sc_init)
          {
