...
<?php
   ...
   $Ord_Cmp = new grid_viaje_importacion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_viaje_importacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idviaje_importacion'] = "idviaje_importacion";
   $tab_labels["idviaje_importacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['labels']["idviaje_importacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['labels']["idviaje_importacion"] : "Idviaje Importacion";
   $tab_ger_campos['codigo'] = "on";
   $tab_def_campos['codigo'] = "codigo";
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['idbuque'] = "on";
   $tab_def_campos['idbuque'] = "idBuque";
   $tab_labels["idbuque"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['labels']["idbuque"])) ? $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['labels']["idbuque"] : "Id Buque";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_viaje_importacion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_viaje_importacion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
