...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_viaje_importacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_viaje_importacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_viaje_importacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_viaje_importacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_viaje_importacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_viaje_importacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_viaje_importacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_viaje_importacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_viaje_importacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_viaje_importacion']['embutida_filho'] as $ind => $sc_init)
          {
