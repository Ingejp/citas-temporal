...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idviaje_importacion";$Nm_numeric[] = "idbuque";$Nm_numeric[] = "idviaje_importacion";$Nm_numeric[] = "idbuque";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idviaje_importacion_cond" name="idviaje_importacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_idviaje_importacion'), this, 'idviaje_importacion')">
      ...
      <br><span id="id_hide_idviaje_importacion"  <?php echo $str_hide_idviaje_importacion?>><?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigo_cond" name="codigo_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo'), this, 'codigo')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idbuque_cond" name="idbuque_cond" onChange="nm_campos_between(document.getElementById('id_vis_idbuque'), this, 'idbuque')">
      ...
      <br><span id="id_hide_idbuque"  <?php echo $str_hide_idbuque?>><?php
      if ($idbuque != "")
      {
      $idbuque_look = substr($this->Db->qstr($idbuque), 1, -1); 
      $nmgp_def_dados = array(); 
