<?php
@session_start() ;
$_SESSION['scriptcase']['grid_viaje_importacion']['sc_process_barr'] = true;
require_once('../grid_viaje_importacion/index.php');
unset($_SESSION['scriptcase']['grid_viaje_importacion']['sc_process_barr']);
$ExportCtrl = new grid_viaje_importacion_export_control;
$ExportCtrl->Export_barr();

class grid_viaje_importacion_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> viaje_importacion :: Excel</TITLE>
