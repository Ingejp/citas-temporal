<?php
@session_start() ;
$_SESSION['scriptcase']['grid_weighings']['sc_process_barr'] = true;
require_once('../grid_weighings/index.php');
unset($_SESSION['scriptcase']['grid_weighings']['sc_process_barr']);
$ExportCtrl = new grid_weighings_export_control;
$ExportCtrl->Export_barr();

class grid_weighings_export_control
{
