<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_weighings']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_weighings_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_weighings_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["imprimir"] : "IMPRIMIR";
   $tab_ger_campos['qr'] = "on";
   $tab_def_campos['qr'] = "QR";
   $tab_labels["qr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["qr"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["qr"] : "QR";
   $tab_ger_campos['container'] = "on";
   $tab_def_campos['container'] = "container";
   $tab_labels["container"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["container"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["container"] : "CONTENEDOR";
   $tab_ger_campos['vessel'] = "on";
   $tab_def_campos['vessel'] = "vessel";
   $tab_labels["vessel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["vessel"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["vessel"] : "BUQUE";
   $tab_ger_campos['shippingcompany'] = "on";
   $tab_def_campos['shippingcompany'] = "shippingCompany";
   $tab_labels["shippingcompany"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["shippingcompany"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["shippingcompany"] : "NAVIERA";
   $tab_ger_campos['voyage'] = "on";
   $tab_def_campos['voyage'] = "voyage";
   $tab_labels["voyage"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["voyage"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["voyage"] : "VIAJE";
   ...
   $tab_labels["date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["date"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["date"] : "FECHA";
   $tab_ger_campos['commodity'] = "on";
   $tab_def_campos['commodity'] = "commodity";
   $tab_labels["commodity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["commodity"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["commodity"] : "PRODUCTO";
   $tab_ger_campos['tarechassis'] = "on";
   $tab_def_campos['tarechassis'] = "tareChassis";
   $tab_labels["tarechassis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["tarechassis"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["tarechassis"] : "TARA CHASIS";
   $tab_ger_campos['tarecontainer'] = "on";
   $tab_def_campos['tarecontainer'] = "tareContainer";
   $tab_labels["tarecontainer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["tarecontainer"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["tarecontainer"] : "TARA CONTENEDOR";
   $tab_ger_campos['grossweight'] = "on";
   $tab_def_campos['grossweight'] = "grossWeight";
   $tab_labels["grossweight"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["grossweight"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["grossweight"] : "PESO BRUTO";
   $tab_ger_campos['netweight'] = "on";
   $tab_def_campos['netweight'] = "netWeight";
   $tab_labels["netweight"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["netweight"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["netweight"] : "PESO NETO";
   $tab_ger_campos['vgm'] = "on";
   $tab_def_campos['vgm'] = "VGM";
   $tab_labels["vgm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["vgm"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["vgm"] : "VGM";
   $tab_ger_campos['typeoperation'] = "on";
   $tab_def_campos['typeoperation'] = "typeOperation";
   $tab_labels["typeoperation"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["typeoperation"])) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['labels']["typeoperation"] : "TIPO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_weighings']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_weighings']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE>REPORTE DE PESAJE DE <?php echo $_SESSION['Naviera_Descripcion'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_weighings_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_weighings']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
