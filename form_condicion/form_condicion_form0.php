...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_condicion_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_condicion_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-numero_contenedor", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_condicion_event_numero_contenedor_onchange) { do_ajax_form_condicion_event_numero_contenedor_onchange(sRow); }
    }
   }
  ...
  $(".sc-ui-autocomp-idcabezal", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_condicion_event_idcabezal_onchange) { do_ajax_form_condicion_event_idcabezal_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-idpiloto", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_condicion_event_idpiloto_onchange) { do_ajax_form_condicion_event_idpiloto_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("form_condicion_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_condicion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_condicion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_condicion_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_condicion_form0' => array(
            'title' => "FORMULARIO",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_condicion_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_condicion_form1' => array(
            'title' => "IMAGENES",
            'class' => $nmgp_num_form == "form_condicion_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('FORMULARIO' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_condicion_form0']['class'] = 'scTabInactive';
                        }
                        if ('IMAGENES' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_condicion_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_condicion_form0"]['class'];
?>
   <li id="id_form_condicion_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_condicion_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/usr__NM__bg__NM__portapapeles.png" align="absmiddle">
     FORMULARIO
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_condicion_form1"]['class'];
?>
   <li id="id_form_condicion_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_condicion_form1')">
...
<div id="form_condicion_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numero_contenedor_line" id="hidden_field_data_numero_contenedor" style="<?php echo $sStyleHidden_numero_contenedor; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_contenedor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_numero_contenedor_label"><span id="id_label_numero_contenedor"><?php echo $this->nm_new_label['numero_contenedor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['numero_contenedor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['numero_contenedor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idcabezal_line" id="hidden_field_data_idcabezal" style="<?php echo $sStyleHidden_idcabezal; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcabezal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcabezal_label"><span id="id_label_idcabezal"><?php echo $this->nm_new_label['idcabezal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['idcabezal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['idcabezal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['Lookup_cable'][] = 'NO'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['Lookup_plug'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['Lookup_plug'][] = 'NO'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idnaviera_line" id="hidden_field_data_idnaviera" style="<?php echo $sStyleHidden_idnaviera; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idnaviera_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idnaviera_label"><span id="id_label_idnaviera"><?php echo $this->nm_new_label['idnaviera']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['idnaviera']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['idnaviera'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_medida_line" id="hidden_field_data_medida" style="<?php echo $sStyleHidden_medida; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_medida_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_medida_label"><span id="id_label_medida"><?php echo $this->nm_new_label['medida']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['medida']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['php_cmp_required']['medida'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><span id="id_read_on_medida" style="<?php echo $sStyleReadLab_medida; ?>"><div id="sc-id-ronly-medida" style="width: 500px; height: 200px; background-color: #FFFFFF"><img style="border-width: 0" /></div>
...
<div class="sc-ui-sign" id="sc-id-sign-medida" style="width: 500px; height: 200px; background-color: #FFFFFF"></div>
<div id="sc-id-disabled-medida" style="display: none; width: 500px; height: 200px; background-color: #FFFFFF"><img style="border-width: 0" /></div>
<br />
FIRMA PILOTO
<br />
