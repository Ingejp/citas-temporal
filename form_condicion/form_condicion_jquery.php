...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'medida':
      case 'idtransporte':
        sc_exib_ocult_pag('form_condicion_form0');
        break;
      case 'picture':
      case 'firma':
        sc_exib_ocult_pag('form_condicion_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecha_hora' + iSeqRow).bind('blur', function() { sc_form_condicion_fecha_hora_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_condicion_fecha_hora_onfocus(this, iSeqRow) });
...
function sc_form_condicion_fecha_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_condicion_validate_fecha();
  scCssBlur(oThis);
}
...
function sc_form_condicion_fecha_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_condicion_form" + pageNo).hide();
}
