<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_condicion" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_condicion']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_condicion"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['where_detal']))
  {
?>  
...
?>
    ...
    { 
       ...
       {
           scAjaxGetFieldSignature("medida");
...
function scForm_packSignature_multi() {
	...
	for (var Nm_x = 1; Nm_x < NM_count_mult; Nm_x++) {
		scAjaxGetFieldSignature("medida" + Nm_x);
	}
...
{
    document.getElementById('form_condicion_form0').style.width='1px';
    document.getElementById('form_condicion_form0').style.height='0px';
    document.getElementById('form_condicion_form0').style.display='none';
    document.getElementById('form_condicion_form0').style.overflow='scroll';
    document.getElementById('form_condicion_form1').style.width='1px';
    document.getElementById('form_condicion_form1').style.height='0px';
    document.getElementById('form_condicion_form1').style.display='none';
    document.getElementById('form_condicion_form1').style.overflow='scroll';
   ...
   if ("form_condicion_form1" == N_pagina) {
