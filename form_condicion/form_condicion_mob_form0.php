...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("LLENAR CONDICION"); } else { echo strip_tags("LLENAR CONDICION"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_condicion/form_condicion_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_condicion_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_condicion_mob_jquery.php');
...
{
?>
  scFocusField('numero_contenedor');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-numero_contenedor", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_condicion_mob_event_numero_contenedor_onchange) { do_ajax_form_condicion_mob_event_numero_contenedor_onchange(sRow); }
    }
   }
  ...
  $(".sc-ui-autocomp-idcabezal", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_condicion_mob_event_idcabezal_onchange) { do_ajax_form_condicion_mob_event_idcabezal_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-idpiloto", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_condicion_mob_event_idpiloto_onchange) { do_ajax_form_condicion_mob_event_idpiloto_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
...
<?php
$str_iframe_body = 'margin-left: 150pxpx; margin-right: 150pxpx;';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_condicion']['error_buffer']) && '' != $_SESSION['scriptcase']['form_condicion']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_condicion']['error_buffer'];
}
...
<?php
 include_once("form_condicion_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_condicion_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_condicion_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_condicion_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "LLENAR CONDICION"; } else { echo "LLENAR CONDICION"; } ?></div>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-7", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-8", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-9", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-10", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcopy", "scBtnFn_sys_format_copy()", "scBtnFn_sys_format_copy()", "sc_b_clone_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-12", "", "group_2");?>
  </div>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-13", "", "");?>
 
<?php
        $NM_btn = true;
    }
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_condicion_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_condicion_mob_form0' => array(
            'title' => "FORMULARIO",
            'class' => $nmgp_num_form == "form_condicion_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_condicion_mob_form1' => array(
            'title' => "IMAGENES",
            'class' => $nmgp_num_form == "form_condicion_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('FORMULARIO' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_condicion_mob_form0']['class'] = 'scTabInactive';
                        }
                        if ('IMAGENES' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_condicion_mob_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_condicion_mob_form0"]['class'];
?>
   <li id="id_form_condicion_mob_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_condicion_mob_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/usr__NM__bg__NM__portapapeles.png" align="absmiddle">
     FORMULARIO
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_condicion_mob_form1"]['class'];
?>
   <li id="id_form_condicion_mob_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_condicion_mob_form1')">
     <img src="<?php echo $this->Ini->path_icones ?>/usr__NM__bg__NM__camera.png" align="absmiddle">
     IMAGENES
    </a>
   </li>
</ul>
...
<div id="form_condicion_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['id_condicion'] = "ID";
    }
?>
<?php
...
<?php
   ...
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["sec_users_login"]) &&  $this->nmgp_cmp_readonly["sec_users_login"] == "on"))
   {
       $bTestReadOnly = false;
...
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["sec_users_login"]) &&  $this->nmgp_cmp_readonly["sec_users_login"] == "on")) { 

 ?>
<input type="hidden" name="sec_users_login" value="<?php echo $this->form_encode_input($sec_users_login) . "\"><span id=\"id_ajax_label_sec_users_login\">" . $sec_users_login . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_sec_users_login" class="sc-ui-readonly-sec_users_login css_sec_users_login_line" style="<?php echo $sStyleReadLab_sec_users_login; ?>"><?php echo $this->sec_users_login; ?></span><span id="id_read_off_sec_users_login" class="css_read_off_sec_users_login" style="white-space: nowrap;<?php echo $sStyleReadInp_sec_users_login; ?>">
 ...
 size=50 maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numero_contenedor_line" id="hidden_field_data_numero_contenedor" style="<?php echo $sStyleHidden_numero_contenedor; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_contenedor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_numero_contenedor_label"><span id="id_label_numero_contenedor"><?php echo $this->nm_new_label['numero_contenedor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['numero_contenedor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['numero_contenedor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['idpiloto'] = "TRANSPORTE";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idpiloto_line" id="hidden_field_data_idpiloto" style="<?php echo $sStyleHidden_idpiloto; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idpiloto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idpiloto_label"><span id="id_label_idpiloto"><?php echo $this->nm_new_label['idpiloto']; ?></span></span><br>
...
?>
<input type="text" id="id_ac_idpiloto" name="idpiloto_autocomp" class="scFormObjectOdd sc-ui-autocomp-idpiloto css_idpiloto_obj" size="30" value="<?php echo $sAutocompValue; ?>" alt="{datatype: 'text', maxLength: 11, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"  /></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idcabezal_line" id="hidden_field_data_idcabezal" style="<?php echo $sStyleHidden_idcabezal; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcabezal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcabezal_label"><span id="id_label_idcabezal"><?php echo $this->nm_new_label['idcabezal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['idcabezal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['idcabezal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
?>
<input type="text" id="id_ac_idcabezal" name="idcabezal_autocomp" class="scFormObjectOdd sc-ui-autocomp-idcabezal css_idcabezal_obj" size="30" value="<?php echo $sAutocompValue; ?>" alt="{datatype: 'text', maxLength: 11, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"  /></span><?php } ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_cable_line" id="hidden_field_data_cable" style="<?php echo $sStyleHidden_cable; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cable_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cable_label"><span id="id_label_cable"><?php echo $this->nm_new_label['cable']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['cable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['cable'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["cable"]) &&  $this->nmgp_cmp_readonly["cable"] == "on") { 

$cable_look = "";
 if ($this->cable == "NO") { $cable_look .= "NO LLEVA" ;} 
...
<span id="id_read_on_cable" class="css_cable_line" style="<?php echo $sStyleReadLab_cable; ?>"><?php echo $this->form_encode_input($cable_look); ?></span><span id="id_read_off_cable" class="css_read_off_cable css_cable_line" style="<?php echo $sStyleReadInp_cable; ?>"><?php echo "<div id=\"idAjaxCheckbox_cable\" style=\"display: inline-block\" class=\"css_cable_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-cable sc-ui-checkbox-cable" name="cable[]" value="NO"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['Lookup_cable'][] = 'NO'; ?>
<?php  if (in_array("NO", $this->cable_1))  { echo " checked" ;} ?> onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">NO LLEVA</label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<input type="hidden" name="plug" value="<?php echo $this->form_encode_input($plug) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_plug_line" id="hidden_field_data_plug" style="<?php echo $sStyleHidden_plug; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_plug_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_plug_label"><span id="id_label_plug"><?php echo $this->nm_new_label['plug']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['plug']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['plug'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["plug"]) &&  $this->nmgp_cmp_readonly["plug"] == "on") { 

 if ("SI" == $this->plug) { $plug_look = "SI";} 
 if ("NO" == $this->plug) { $plug_look = "NO";} 
?>
...
<?php
 ...
 if ("NO" == $this->plug) { $plug_look = "NO";} 
?>
<span id="id_read_on_plug"  class="css_plug_line" style="<?php echo $sStyleReadLab_plug; ?>"><?php echo $this->form_encode_input($plug_look); ?></span><span id="id_read_off_plug" class="css_read_off_plug css_plug_line" style="<?php echo $sStyleReadInp_plug; ?>"><div id="idAjaxRadio_plug" style="display: inline-block"  class="css_plug_line">
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_plug_line"> <div class="sc radio">
<?php $tempOptionId = "id-opt-plug" . $sc_seq_vert . "-1"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-plug sc-ui-radio-plug" type=radio name="plug" value="SI"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['Lookup_plug'][] = 'SI'; ?>
<?php  if ("SI" == $this->plug)  { echo " checked" ;} ?>  onClick="" ><span></span>
<label for="<?php echo $tempOptionId ?>">SI</label> </div>
</TD>
</TR>
<TR>
  <TD class="scFormDataFontOdd css_plug_line"> <div class="sc radio">
<?php $tempOptionId = "id-opt-plug" . $sc_seq_vert . "-2"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-plug sc-ui-radio-plug" type=radio name="plug" value="NO"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['Lookup_plug'][] = 'NO'; ?>
<?php  if ("NO" == $this->plug)  { echo " checked" ;} ?>  onClick="" ><span></span>
...
<?php $sStyleHidden_plug_dumb = ('' == $sStyleHidden_plug) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_plug_dumb" style="<?php echo $sStyleHidden_plug_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idnaviera_line" id="hidden_field_data_idnaviera" style="<?php echo $sStyleHidden_idnaviera; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idnaviera_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idnaviera_label"><span id="id_label_idnaviera"><?php echo $this->nm_new_label['idnaviera']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['idnaviera']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['idnaviera'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['tipomovimiento_idtipomovimiento'] = "TIPO DE MOVIMIENTO";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idyarda_line" id="hidden_field_data_idyarda" style="<?php echo $sStyleHidden_idyarda; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idyarda_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idyarda_label"><span id="id_label_idyarda"><?php echo $this->nm_new_label['idyarda']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['idyarda']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['idyarda'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_idyarda_dumb = ('' == $sStyleHidden_idyarda) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idyarda_dumb" style="<?php echo $sStyleHidden_idyarda_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<span id="id_read_on_observaciones" class="sc-ui-readonly-observaciones css_observaciones_line" style="<?php echo $sStyleReadLab_observaciones; ?>"><?php echo $this->observaciones; ?></span><span id="id_read_off_observaciones" class="css_read_off_observaciones" style="white-space: nowrap;<?php echo $sStyleReadInp_observaciones; ?>">
 ...
 size=200 maxlength=250 alt="{datatype: 'text', maxLength: 250, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789 .,") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['idtransporte'] = "Id Transporte";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idtransporte_line" id="hidden_field_data_idtransporte" style="<?php echo $sStyleHidden_idtransporte; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtransporte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idtransporte_label"><span id="id_label_idtransporte"><?php echo $this->nm_new_label['idtransporte']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_idtransporte" class="sc-ui-readonly-idtransporte css_idtransporte_line" style="<?php echo $sStyleReadLab_idtransporte; ?>"><?php echo $this->idtransporte; ?></span><span id="id_read_off_idtransporte" class="css_read_off_idtransporte" style="white-space: nowrap;<?php echo $sStyleReadInp_idtransporte; ?>">
 <input class="sc-js-input scFormObjectOdd css_idtransporte_obj" style="" id="id_sc_field_idtransporte" type=text name="idtransporte" value="<?php echo $this->form_encode_input($idtransporte) ?>"
 size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['idtransporte']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['idtransporte']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['idtransporte']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['medida'] = "FIRMA";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_medida_line" id="hidden_field_data_medida" style="<?php echo $sStyleHidden_medida; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_medida_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_medida_label"><span id="id_label_medida"><?php echo $this->nm_new_label['medida']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['medida']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['php_cmp_required']['medida'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><span id="id_read_on_medida" style="<?php echo $sStyleReadLab_medida; ?>"><div id="sc-id-ronly-medida" style="width: 100%; background-color: #FFFFFF"><img style="border-width: 0" /></div>
</span><span id="id_read_off_medida" class="css_read_off_medida" style="<?php echo $sStyleReadInp_medida; ?>"><input type="hidden" name="medida" id="id_sc_field_medida" value="<?php echo $this->medida ?>" />
<div class="sc-ui-sign" id="sc-id-sign-medida" style="width: 100%; background-color: #FFFFFF"></div>
<div id="sc-id-disabled-medida" style="display: none; width: 100%; background-color: #FFFFFF"><img style="border-width: 0" /></div>
<br />
FIRMA PILOTO
<br />
<?php echo nmButtonOutput($this->arr_buttons, "bclear", "scJQSignatureClear('medida')", "scJQSignatureClear('medida')", "btn_sign_clear_medida", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>

</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_medida_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_medida_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
