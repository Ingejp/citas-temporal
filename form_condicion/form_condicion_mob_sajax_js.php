  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_condicion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_condicion_mob_form();
	}

  // ---------- Validate id_condicion
  function do_ajax_form_condicion_mob_validate_id_condicion()
  {
    var nomeCampo_id_condicion = "id_condicion";
    var var_id_condicion = scAjaxGetFieldHidden(nomeCampo_id_condicion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_id_condicion(var_id_condicion, var_script_case_init, do_ajax_form_condicion_mob_validate_id_condicion_cb);
  } // do_ajax_form_condicion_mob_validate_id_condicion

  function do_ajax_form_condicion_mob_validate_id_condicion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_id_condicion_cb

  // ---------- Validate sec_users_login
  function do_ajax_form_condicion_mob_validate_sec_users_login()
  {
    var nomeCampo_sec_users_login = "sec_users_login";
    var var_sec_users_login = scAjaxGetFieldText(nomeCampo_sec_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_sec_users_login(var_sec_users_login, var_script_case_init, do_ajax_form_condicion_mob_validate_sec_users_login_cb);
  } // do_ajax_form_condicion_mob_validate_sec_users_login

  function do_ajax_form_condicion_mob_validate_sec_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_sec_users_login_cb

  // ---------- Validate fecha
  function do_ajax_form_condicion_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_condicion_mob_validate_fecha_cb);
  } // do_ajax_form_condicion_mob_validate_fecha

  function do_ajax_form_condicion_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_fecha_cb

  // ---------- Validate numero_contenedor
  function do_ajax_form_condicion_mob_validate_numero_contenedor()
  {
  } // do_ajax_form_condicion_mob_validate_numero_contenedor

  function do_ajax_form_condicion_mob_validate_numero_contenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_numero_contenedor_cb

  // ---------- Validate idpiloto
  function do_ajax_form_condicion_mob_validate_idpiloto()
  {
  } // do_ajax_form_condicion_mob_validate_idpiloto

  function do_ajax_form_condicion_mob_validate_idpiloto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_idpiloto_cb

  // ---------- Validate idcabezal
  function do_ajax_form_condicion_mob_validate_idcabezal()
  {
  } // do_ajax_form_condicion_mob_validate_idcabezal

  function do_ajax_form_condicion_mob_validate_idcabezal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_idcabezal_cb

  // ---------- Validate cable
  function do_ajax_form_condicion_mob_validate_cable()
  {
    var nomeCampo_cable = "cable";
    var var_cable = scAjaxGetFieldCheckbox(nomeCampo_cable, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_cable(var_cable, var_script_case_init, do_ajax_form_condicion_mob_validate_cable_cb);
  } // do_ajax_form_condicion_mob_validate_cable

  function do_ajax_form_condicion_mob_validate_cable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cable";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_cable_cb

  // ---------- Validate plug
  function do_ajax_form_condicion_mob_validate_plug()
  {
    var nomeCampo_plug = "plug";
    var var_plug = scAjaxGetFieldRadio(nomeCampo_plug);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_plug(var_plug, var_script_case_init, do_ajax_form_condicion_mob_validate_plug_cb);
  } // do_ajax_form_condicion_mob_validate_plug

  function do_ajax_form_condicion_mob_validate_plug_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "plug";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_plug_cb

  // ---------- Validate idnaviera
  function do_ajax_form_condicion_mob_validate_idnaviera()
  {
    var nomeCampo_idnaviera = "idnaviera";
    var var_idnaviera = scAjaxGetFieldSelect(nomeCampo_idnaviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_idnaviera(var_idnaviera, var_script_case_init, do_ajax_form_condicion_mob_validate_idnaviera_cb);
  } // do_ajax_form_condicion_mob_validate_idnaviera

  function do_ajax_form_condicion_mob_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_idnaviera_cb

  // ---------- Validate tipomovimiento_idtipomovimiento
  function do_ajax_form_condicion_mob_validate_tipomovimiento_idtipomovimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_tipomovimiento_idtipomovimiento(var_tipomovimiento_idtipomovimiento, var_script_case_init, do_ajax_form_condicion_mob_validate_tipomovimiento_idtipomovimiento_cb);
  } // do_ajax_form_condicion_mob_validate_tipomovimiento_idtipomovimiento

  function do_ajax_form_condicion_mob_validate_tipomovimiento_idtipomovimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_tipomovimiento_idtipomovimiento_cb

  // ---------- Validate idyarda
  function do_ajax_form_condicion_mob_validate_idyarda()
  {
    var nomeCampo_idyarda = "idyarda";
    var var_idyarda = scAjaxGetFieldSelect(nomeCampo_idyarda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_idyarda(var_idyarda, var_script_case_init, do_ajax_form_condicion_mob_validate_idyarda_cb);
  } // do_ajax_form_condicion_mob_validate_idyarda

  function do_ajax_form_condicion_mob_validate_idyarda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idyarda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_idyarda_cb

  // ---------- Validate observaciones
  function do_ajax_form_condicion_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_condicion_mob_validate_observaciones_cb);
  } // do_ajax_form_condicion_mob_validate_observaciones

  function do_ajax_form_condicion_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_observaciones_cb

  // ---------- Validate idtransporte
  function do_ajax_form_condicion_mob_validate_idtransporte()
  {
    var nomeCampo_idtransporte = "idtransporte";
    var var_idtransporte = scAjaxGetFieldText(nomeCampo_idtransporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_idtransporte(var_idtransporte, var_script_case_init, do_ajax_form_condicion_mob_validate_idtransporte_cb);
  } // do_ajax_form_condicion_mob_validate_idtransporte

  function do_ajax_form_condicion_mob_validate_idtransporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_idtransporte_cb

  // ---------- Validate medida
  function do_ajax_form_condicion_mob_validate_medida()
  {
    var nomeCampo_medida = "medida";
    var var_medida = scAjaxGetFieldSignature(nomeCampo_medida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_medida(var_medida, var_script_case_init, do_ajax_form_condicion_mob_validate_medida_cb);
  } // do_ajax_form_condicion_mob_validate_medida

  function do_ajax_form_condicion_mob_validate_medida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medida";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_medida_cb

  // ---------- Validate picture
  function do_ajax_form_condicion_mob_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_picture(var_picture, var_script_case_init, do_ajax_form_condicion_mob_validate_picture_cb);
  } // do_ajax_form_condicion_mob_validate_picture

  function do_ajax_form_condicion_mob_validate_picture_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "picture";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_picture_cb

  // ---------- Validate firma
  function do_ajax_form_condicion_mob_validate_firma()
  {
    var nomeCampo_firma = "firma";
    var var_firma = scAjaxGetFieldText(nomeCampo_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_mob_validate_firma(var_firma, var_script_case_init, do_ajax_form_condicion_mob_validate_firma_cb);
  } // do_ajax_form_condicion_mob_validate_firma

  function do_ajax_form_condicion_mob_validate_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "firma";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_mob_validate_firma_cb

  // ---------- Event onchange idnaviera
  function do_ajax_form_condicion_mob_event_idnaviera_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_condicion_mob_event_idnaviera_onchange(var_numero_contenedor, var_fecha, var_idcabezal, var_script_case_init, do_ajax_form_condicion_mob_event_idnaviera_onchange_cb);
  } // do_ajax_form_condicion_mob_event_idnaviera_onchange

  function do_ajax_form_condicion_mob_event_idnaviera_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idnaviera";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_condicion_mob_event_idnaviera_onchange_cb_after_alert);
  } // do_ajax_form_condicion_mob_event_idnaviera_onchange_cb
  function do_ajax_form_condicion_mob_event_idnaviera_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_condicion_mob_event_idnaviera_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_condicion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_condicion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_condicion_mob_submit_form(var_id_condicion, var_sec_users_login, var_fecha, var_numero_contenedor, var_idpiloto, var_idcabezal, var_cable, var_plug, var_idnaviera, var_tipomovimiento_idtipomovimiento, var_idyarda, var_observaciones, var_idtransporte, var_medida, var_firma, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_condicion_mob_submit_form_cb);
  } // do_ajax_form_condicion_mob_submit_form

  function do_ajax_form_condicion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_condicion_mob_submit_form_cb_after_alert);
  } // do_ajax_form_condicion_mob_submit_form_cb
  function do_ajax_form_condicion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_condicion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detalle_condicion_mob"] = "off";

  function do_ajax_form_condicion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detalle_condicion_mob"] = "on";
    x_ajax_form_condicion_mob_navigate_form(var_id_condicion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_condicion_mob_navigate_form_cb);
  } // do_ajax_form_condicion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_condicion_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detalle_condicion_mob"] && "nmsc_iframe_liga_form_detalle_condicion_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_detalle_condicion_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detalle_condicion_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detalle_condicion_mob').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_detalle_condicion_mob').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_detalle_condicion_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_condicion_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_condicion_mob_navigate_form_cb
  function do_ajax_form_condicion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_condicion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_condicion_mob_navigate_form_cb_after_alert
  function sc_hide_form_condicion_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detalle_condicion_mob"])
    {
      return true;
    }
    return false;
