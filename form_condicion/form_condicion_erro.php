...
$old_error_handler = set_error_handler("form_condicion_scriptcase_error_handler");

function form_condicion_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_condicion']['contr_erro']) && $_SESSION['scriptcase']['form_condicion']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_condicion->contr_form_condicion->Apl_com_erro = true;
            if ($inicial_form_condicion->contr_form_condicion->NM_ajax_flag)
            {
                $inicial_form_condicion->contr_form_condicion->NM_ajax_info['errList']['geral_form_condicion'][] = $msg;
                return;
            }
            form_condicion_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_condicion_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_condicion'])  && '' != $_SESSION['scriptcase']['error_icon']['form_condicion'])  ? $_SESSION['scriptcase']['error_icon']['form_condicion']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_condicion']) && '' != $_SESSION['scriptcase']['error_close']['form_condicion']) ? $_SESSION['scriptcase']['error_close']['form_condicion'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_condicion']) && '' != $_SESSION['scriptcase']['error_span_title']['form_condicion']) ? $_SESSION['scriptcase']['error_span_title']['form_condicion'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_condicion']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_condicion']) ? $_SESSION['scriptcase']['error_icon_title']['form_condicion'] : '';
?>
