  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_condicion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_condicion_form();
	}

  // ---------- Validate id_condicion
  function do_ajax_form_condicion_validate_id_condicion()
  {
    var nomeCampo_id_condicion = "id_condicion";
    var var_id_condicion = scAjaxGetFieldHidden(nomeCampo_id_condicion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_id_condicion(var_id_condicion, var_script_case_init, do_ajax_form_condicion_validate_id_condicion_cb);
  } // do_ajax_form_condicion_validate_id_condicion

  function do_ajax_form_condicion_validate_id_condicion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_condicion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_id_condicion_cb

  // ---------- Validate sec_users_login
  function do_ajax_form_condicion_validate_sec_users_login()
  {
    var nomeCampo_sec_users_login = "sec_users_login";
    var var_sec_users_login = scAjaxGetFieldText(nomeCampo_sec_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_sec_users_login(var_sec_users_login, var_script_case_init, do_ajax_form_condicion_validate_sec_users_login_cb);
  } // do_ajax_form_condicion_validate_sec_users_login

  function do_ajax_form_condicion_validate_sec_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_sec_users_login_cb

  // ---------- Validate fecha
  function do_ajax_form_condicion_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_condicion_validate_fecha_cb);
  } // do_ajax_form_condicion_validate_fecha

  function do_ajax_form_condicion_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_fecha_cb

  // ---------- Validate numero_contenedor
  function do_ajax_form_condicion_validate_numero_contenedor()
  {
  } // do_ajax_form_condicion_validate_numero_contenedor

  function do_ajax_form_condicion_validate_numero_contenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_contenedor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_numero_contenedor_cb

  // ---------- Validate idpiloto
  function do_ajax_form_condicion_validate_idpiloto()
  {
  } // do_ajax_form_condicion_validate_idpiloto

  function do_ajax_form_condicion_validate_idpiloto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_idpiloto_cb

  // ---------- Validate idcabezal
  function do_ajax_form_condicion_validate_idcabezal()
  {
  } // do_ajax_form_condicion_validate_idcabezal

  function do_ajax_form_condicion_validate_idcabezal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_idcabezal_cb

  // ---------- Validate cable
  function do_ajax_form_condicion_validate_cable()
  {
    var nomeCampo_cable = "cable";
    var var_cable = scAjaxGetFieldCheckbox(nomeCampo_cable, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_cable(var_cable, var_script_case_init, do_ajax_form_condicion_validate_cable_cb);
  } // do_ajax_form_condicion_validate_cable

  function do_ajax_form_condicion_validate_cable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cable";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_cable_cb

  // ---------- Validate plug
  function do_ajax_form_condicion_validate_plug()
  {
    var nomeCampo_plug = "plug";
    var var_plug = scAjaxGetFieldRadio(nomeCampo_plug);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_plug(var_plug, var_script_case_init, do_ajax_form_condicion_validate_plug_cb);
  } // do_ajax_form_condicion_validate_plug

  function do_ajax_form_condicion_validate_plug_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "plug";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_plug_cb

  // ---------- Validate idnaviera
  function do_ajax_form_condicion_validate_idnaviera()
  {
    var nomeCampo_idnaviera = "idnaviera";
    var var_idnaviera = scAjaxGetFieldSelect(nomeCampo_idnaviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_idnaviera(var_idnaviera, var_script_case_init, do_ajax_form_condicion_validate_idnaviera_cb);
  } // do_ajax_form_condicion_validate_idnaviera

  function do_ajax_form_condicion_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_idnaviera_cb

  // ---------- Validate tipomovimiento_idtipomovimiento
  function do_ajax_form_condicion_validate_tipomovimiento_idtipomovimiento()
  {
    var nomeCampo_tipomovimiento_idtipomovimiento = "tipomovimiento_idtipomovimiento";
    var var_tipomovimiento_idtipomovimiento = scAjaxGetFieldSelect(nomeCampo_tipomovimiento_idtipomovimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_tipomovimiento_idtipomovimiento(var_tipomovimiento_idtipomovimiento, var_script_case_init, do_ajax_form_condicion_validate_tipomovimiento_idtipomovimiento_cb);
  } // do_ajax_form_condicion_validate_tipomovimiento_idtipomovimiento

  function do_ajax_form_condicion_validate_tipomovimiento_idtipomovimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipomovimiento_idtipomovimiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_tipomovimiento_idtipomovimiento_cb

  // ---------- Validate idyarda
  function do_ajax_form_condicion_validate_idyarda()
  {
    var nomeCampo_idyarda = "idyarda";
    var var_idyarda = scAjaxGetFieldSelect(nomeCampo_idyarda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_idyarda(var_idyarda, var_script_case_init, do_ajax_form_condicion_validate_idyarda_cb);
  } // do_ajax_form_condicion_validate_idyarda

  function do_ajax_form_condicion_validate_idyarda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idyarda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_idyarda_cb

  // ---------- Validate observaciones
  function do_ajax_form_condicion_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_condicion_validate_observaciones_cb);
  } // do_ajax_form_condicion_validate_observaciones

  function do_ajax_form_condicion_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_observaciones_cb

  // ---------- Validate idtransporte
  function do_ajax_form_condicion_validate_idtransporte()
  {
    var nomeCampo_idtransporte = "idtransporte";
    var var_idtransporte = scAjaxGetFieldText(nomeCampo_idtransporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_idtransporte(var_idtransporte, var_script_case_init, do_ajax_form_condicion_validate_idtransporte_cb);
  } // do_ajax_form_condicion_validate_idtransporte

  function do_ajax_form_condicion_validate_idtransporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtransporte";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_idtransporte_cb

  // ---------- Validate medida
  function do_ajax_form_condicion_validate_medida()
  {
    var nomeCampo_medida = "medida";
    var var_medida = scAjaxGetFieldSignature(nomeCampo_medida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_medida(var_medida, var_script_case_init, do_ajax_form_condicion_validate_medida_cb);
  } // do_ajax_form_condicion_validate_medida

  function do_ajax_form_condicion_validate_medida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medida";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_medida_cb

  // ---------- Validate picture
  function do_ajax_form_condicion_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_picture(var_picture, var_script_case_init, do_ajax_form_condicion_validate_picture_cb);
  } // do_ajax_form_condicion_validate_picture

  function do_ajax_form_condicion_validate_picture_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "picture";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_picture_cb

  // ---------- Validate firma
  function do_ajax_form_condicion_validate_firma()
  {
    var nomeCampo_firma = "firma";
    var var_firma = scAjaxGetFieldText(nomeCampo_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_condicion_validate_firma(var_firma, var_script_case_init, do_ajax_form_condicion_validate_firma_cb);
  } // do_ajax_form_condicion_validate_firma

  function do_ajax_form_condicion_validate_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "firma";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_condicion_validate_firma_cb

  // ---------- Event onchange idnaviera
  function do_ajax_form_condicion_event_idnaviera_onchange()
  {
    var var_numero_contenedor = scAjaxGetFieldText("numero_contenedor");
    var var_fecha = scAjaxGetFieldHidden("fecha");
    var var_idcabezal = scAjaxGetFieldText("idcabezal");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_condicion_event_idnaviera_onchange(var_numero_contenedor, var_fecha, var_idcabezal, var_script_case_init, do_ajax_form_condicion_event_idnaviera_onchange_cb);
  } // do_ajax_form_condicion_event_idnaviera_onchange

  function do_ajax_form_condicion_event_idnaviera_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idnaviera";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_condicion_event_idnaviera_onchange_cb_after_alert);
  } // do_ajax_form_condicion_event_idnaviera_onchange_cb
  function do_ajax_form_condicion_event_idnaviera_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_condicion_event_idnaviera_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_condicion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_condicion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_condicion = scAjaxGetFieldHidden("id_condicion");
    var var_sec_users_login = scAjaxGetFieldText("sec_users_login");
    var var_fecha = scAjaxGetFieldHidden("fecha");
    var var_numero_contenedor = scAjaxGetFieldText("numero_contenedor");
    var var_idpiloto = scAjaxGetFieldText("idpiloto");
    var var_idcabezal = scAjaxGetFieldText("idcabezal");
    var var_cable = scAjaxGetFieldCheckbox("cable", ";");
    var var_plug = scAjaxGetFieldRadio("plug");
    var var_idnaviera = scAjaxGetFieldSelect("idnaviera");
    var var_tipomovimiento_idtipomovimiento = scAjaxGetFieldSelect("tipomovimiento_idtipomovimiento");
    var var_idyarda = scAjaxGetFieldSelect("idyarda");
    var var_observaciones = scAjaxGetFieldText("observaciones");
    var var_idtransporte = scAjaxGetFieldText("idtransporte");
    var var_medida = scAjaxGetFieldSignature("medida");
    var var_firma = scAjaxGetFieldText("firma");
    ...
    scAjaxProcOn();
    x_ajax_form_condicion_submit_form(var_id_condicion, var_sec_users_login, var_fecha, var_numero_contenedor, var_idpiloto, var_idcabezal, var_cable, var_plug, var_idnaviera, var_tipomovimiento_idtipomovimiento, var_idyarda, var_observaciones, var_idtransporte, var_medida, var_firma, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_condicion_submit_form_cb);
  } // do_ajax_form_condicion_submit_form

  function do_ajax_form_condicion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_condicion");
      scAjaxHideErrorDisplay("sec_users_login");
      scAjaxHideErrorDisplay("fecha");
      scAjaxHideErrorDisplay("numero_contenedor");
      scAjaxHideErrorDisplay("idpiloto");
      scAjaxHideErrorDisplay("idcabezal");
      scAjaxHideErrorDisplay("cable");
      scAjaxHideErrorDisplay("plug");
      scAjaxHideErrorDisplay("idnaviera");
      scAjaxHideErrorDisplay("tipomovimiento_idtipomovimiento");
      scAjaxHideErrorDisplay("idyarda");
      scAjaxHideErrorDisplay("observaciones");
      scAjaxHideErrorDisplay("idtransporte");
      scAjaxHideErrorDisplay("medida");
      scAjaxHideErrorDisplay("picture");
      scAjaxHideErrorDisplay("firma");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_condicion_submit_form_cb_after_alert);
  } // do_ajax_form_condicion_submit_form_cb
  function do_ajax_form_condicion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_condicion_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detalle_condicion"] = "off";

  function do_ajax_form_condicion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("picture");
    scAjaxHideErrorDisplay("firma");
    var var_id_condicion = document.F2.id_condicion.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detalle_condicion"] = "on";
    x_ajax_form_condicion_navigate_form(var_id_condicion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_condicion_navigate_form_cb);
  } // do_ajax_form_condicion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_condicion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_condicion_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_condicion.value = scAjaxGetKeyValue("id_condicion");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detalle_condicion"] && "nmsc_iframe_liga_form_detalle_condicion" != scMasterDetailIframe["nmsc_iframe_liga_form_detalle_condicion"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detalle_condicion"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detalle_condicion').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_detalle_condicion').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_detalle_condicion').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_condicion_navigate_form_cb_after_alert);
  } // do_ajax_form_condicion_navigate_form_cb
  function do_ajax_form_condicion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_condicion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_condicion_navigate_form_cb_after_alert
  function sc_hide_form_condicion_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detalle_condicion"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_condicion";
  ajax_field_list[1] = "sec_users_login";
  ajax_field_list[2] = "fecha";
  ajax_field_list[3] = "numero_contenedor";
  ajax_field_list[4] = "idpiloto";
  ajax_field_list[5] = "idcabezal";
  ajax_field_list[6] = "cable";
  ajax_field_list[7] = "plug";
  ajax_field_list[8] = "idnaviera";
  ajax_field_list[9] = "tipomovimiento_idtipomovimiento";
  ajax_field_list[10] = "idyarda";
  ajax_field_list[11] = "observaciones";
  ajax_field_list[12] = "idtransporte";
  ajax_field_list[13] = "medida";
  ajax_field_list[14] = "picture";
  ajax_field_list[15] = "firma";
  ...
  var ajax_error_list = {
    "id_condicion": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "numero_contenedor": {"label": "EQUIPO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpiloto": {"label": "TRANSPORTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcabezal": {"label": "PLACA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cable": {"label": "CABLE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "plug": {"label": "PLUG", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tipomovimiento_idtipomovimiento": {"label": "TIPO DE MOVIMIENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idtransporte": {"label": "Id Transporte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medida": {"label": "FIRMA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "picture": {"label": "PICTURE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "firma": {"label": "Firma", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_condicion": new Array(),
    "sec_users_login": new Array(),
    "fecha": new Array(),
    "numero_contenedor": new Array(),
    "idpiloto": new Array(),
    "idcabezal": new Array(),
    "cable": new Array(),
    "plug": new Array(),
    "idnaviera": new Array(),
    "tipomovimiento_idtipomovimiento": new Array(),
    "idyarda": new Array(),
    "observaciones": new Array(),
    "idtransporte": new Array(),
    "medida": new Array(),
    "picture": new Array(),
    "firma": new Array()
  };
  ajax_field_mult["id_condicion"][1] = "id_condicion";
  ajax_field_mult["sec_users_login"][1] = "sec_users_login";
  ajax_field_mult["fecha"][1] = "fecha";
  ajax_field_mult["numero_contenedor"][1] = "numero_contenedor";
  ajax_field_mult["idpiloto"][1] = "idpiloto";
  ajax_field_mult["idcabezal"][1] = "idcabezal";
  ajax_field_mult["cable"][1] = "cable";
  ajax_field_mult["plug"][1] = "plug";
  ajax_field_mult["idnaviera"][1] = "idnaviera";
  ajax_field_mult["tipomovimiento_idtipomovimiento"][1] = "tipomovimiento_idtipomovimiento";
  ajax_field_mult["idyarda"][1] = "idyarda";
  ajax_field_mult["observaciones"][1] = "observaciones";
  ajax_field_mult["idtransporte"][1] = "idtransporte";
  ajax_field_mult["medida"][1] = "medida";
  ajax_field_mult["picture"][1] = "picture";
  ajax_field_mult["firma"][1] = "firma";

  var ajax_field_id = {
    "id_condicion": new Array("hidden_field_label_id_condicion", "hidden_field_data_id_condicion"),
    "fecha": new Array("hidden_field_label_fecha", "hidden_field_data_fecha"),
    "numero_contenedor": new Array("hidden_field_label_numero_contenedor", "hidden_field_data_numero_contenedor"),
    ...
    "cable": new Array("hidden_field_label_cable", "hidden_field_data_cable"),
    "plug": new Array("hidden_field_label_plug", "hidden_field_data_plug"),
    "idnaviera": new Array("hidden_field_label_idnaviera", "hidden_field_data_idnaviera"),
    "tipomovimiento_idtipomovimiento": new Array("hidden_field_label_tipomovimiento_idtipomovimiento", "hidden_field_data_tipomovimiento_idtipomovimiento"),
    ...
    "idtransporte": new Array("hidden_field_label_idtransporte", "hidden_field_data_idtransporte"),
    "medida": new Array("hidden_field_label_medida", "hidden_field_data_medida"),
    "picture": new Array("hidden_field_label_picture", "hidden_field_data_picture"),
    "firma": new Array("hidden_field_label_firma", "hidden_field_data_firma")
  };
  ...
  var ajax_read_only = {
    ...
    "sec_users_login": "on",
    "fecha": "off",
    "numero_contenedor": "off",
    "idpiloto": "off",
    "idcabezal": "off",
    "cable": "off",
    "plug": "off",
    "idnaviera": "off",
    "tipomovimiento_idtipomovimiento": "off",
    "idyarda": "off",
    "observaciones": "off",
    "idtransporte": "off",
    "medida": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tipomovimiento_idtipomovimiento" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
