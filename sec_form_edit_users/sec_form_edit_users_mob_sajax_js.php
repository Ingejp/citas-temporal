...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idyarda
  function do_ajax_sec_form_edit_users_mob_validate_idyarda()
  {
    var nomeCampo_idyarda = "idyarda";
    var var_idyarda = scAjaxGetFieldSelect(nomeCampo_idyarda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_idyarda(var_idyarda, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_idyarda_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_idyarda

  function do_ajax_sec_form_edit_users_mob_validate_idyarda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idyarda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_idyarda_cb

  // ---------- Validate idnaviera
  function do_ajax_sec_form_edit_users_mob_validate_idnaviera()
  {
    var nomeCampo_idnaviera = "idnaviera";
    var var_idnaviera = scAjaxGetFieldSelect(nomeCampo_idnaviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_idnaviera(var_idnaviera, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_idnaviera_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_idnaviera

  function do_ajax_sec_form_edit_users_mob_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_idnaviera_cb

  // ---------- Validate idtipo_usuario
  function do_ajax_sec_form_edit_users_mob_validate_idtipo_usuario()
  {
    var nomeCampo_idtipo_usuario = "idtipo_usuario";
    var var_idtipo_usuario = scAjaxGetFieldSelect(nomeCampo_idtipo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_idtipo_usuario(var_idtipo_usuario, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_idtipo_usuario_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_idtipo_usuario

  function do_ajax_sec_form_edit_users_mob_validate_idtipo_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipo_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_idtipo_usuario_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_form_edit_users_mob_submit_form()
  {
    ...
    var var_idtipo_usuario = scAjaxGetFieldSelect("idtipo_usuario");
    ...
    scAjaxProcOn();
    x_ajax_sec_form_edit_users_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_idyarda, var_idnaviera, var_idtipo_usuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_form_edit_users_mob_submit_form_cb);
  ...
  function do_ajax_sec_form_edit_users_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idtipo_usuario");
      scLigEditLookupCall();
<?php
...
?>
  ...
  ajax_field_list[7] = "idyarda";
  ajax_field_list[8] = "idnaviera";
  ajax_field_list[9] = "idtipo_usuario";
  ...
  var ajax_error_list = {
    ...
    "idtipo_usuario": {"label": "Tipo Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idtipo_usuario"][1] = "idtipo_usuario";
  ...
  var ajax_field_id = {
    ...
    "idtipo_usuario": new Array("hidden_field_label_idtipo_usuario", "hidden_field_data_idtipo_usuario")
  };
