...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idyarda
  function do_ajax_sec_form_edit_users_validate_idyarda()
  {
    var nomeCampo_idyarda = "idyarda";
    var var_idyarda = scAjaxGetFieldSelect(nomeCampo_idyarda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_idyarda(var_idyarda, var_script_case_init, do_ajax_sec_form_edit_users_validate_idyarda_cb);
  } // do_ajax_sec_form_edit_users_validate_idyarda

  function do_ajax_sec_form_edit_users_validate_idyarda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idyarda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_idyarda_cb

  // ---------- Validate idnaviera
  function do_ajax_sec_form_edit_users_validate_idnaviera()
  {
    var nomeCampo_idnaviera = "idnaviera";
    var var_idnaviera = scAjaxGetFieldSelect(nomeCampo_idnaviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_idnaviera(var_idnaviera, var_script_case_init, do_ajax_sec_form_edit_users_validate_idnaviera_cb);
  } // do_ajax_sec_form_edit_users_validate_idnaviera

  function do_ajax_sec_form_edit_users_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_idnaviera_cb

  // ---------- Validate idtipo_usuario
  function do_ajax_sec_form_edit_users_validate_idtipo_usuario()
  {
    var nomeCampo_idtipo_usuario = "idtipo_usuario";
    var var_idtipo_usuario = scAjaxGetFieldSelect(nomeCampo_idtipo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_idtipo_usuario(var_idtipo_usuario, var_script_case_init, do_ajax_sec_form_edit_users_validate_idtipo_usuario_cb);
  } // do_ajax_sec_form_edit_users_validate_idtipo_usuario

  function do_ajax_sec_form_edit_users_validate_idtipo_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_idtipo_usuario_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_idyarda, var_idnaviera, var_idtipo_usuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_form_edit_users_submit_form_cb);
