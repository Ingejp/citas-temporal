   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - sec_users";
      ...
      $_SESSION['scriptcase']['error_icon']['sec_form_edit_users']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//---------------------------------------------------------
    ...
    function ValidateField_idyarda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idyarda) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idyarda']) && !in_array($this->idyarda, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idyarda']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idnaviera(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idnaviera) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idnaviera']) && !in_array($this->idnaviera, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idnaviera']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idtipo_usuario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipo_usuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idtipo_usuario']) && !in_array($this->idtipo_usuario, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idtipo_usuario']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$aLookup[] = array(sec_form_edit_users_pack_protect_string('') => sec_form_edit_users_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idyarda'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idyarda']['valList'][$i] = sec_form_edit_users_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idnaviera'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idnaviera']['valList'][$i] = sec_form_edit_users_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_idtipo_usuario'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipo_usuario']['valList'][$i] = sec_form_edit_users_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['scriptcase']['sec_form_edit_users']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start'] = 0; 
              }
...
//---------- 
      ...
      { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start']) ;  
              } 
          } 
          ...
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['reg_start'] < $qt_geral_reg_sec_form_edit_users;
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['opcao']   = '';
          }
      } 
