...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_pesaje_por_embarque"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_pesaje_por_embarque"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pesaje_por_embarque']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pesaje_por_embarque']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pesaje_por_embarque']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pesaje_por_embarque']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pesaje_por_embarque']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_pesaje_por_embarque</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pesaje_por_embarque']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pesaje_por_embarque']['embutida_filho'] as $ind => $sc_init)
          {
