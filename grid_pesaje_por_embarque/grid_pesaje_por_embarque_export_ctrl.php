<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pesaje_por_embarque']['sc_process_barr'] = true;
require_once('../grid_pesaje_por_embarque/index.php');
unset($_SESSION['scriptcase']['grid_pesaje_por_embarque']['sc_process_barr']);
$ExportCtrl = new grid_pesaje_por_embarque_export_control;
$ExportCtrl->Export_barr();

class grid_pesaje_por_embarque_export_control
{
