...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____busqueda_por_fecha"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____busqueda_por_fecha"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>busqueda_por_fecha</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['embutida_filho'] as $ind => $sc_init)
          {
