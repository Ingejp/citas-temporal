<?php
   include_once('busqueda_por_fecha_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class busqueda_por_fecha_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_grid_reporte_por_fechas_cons_psq;
   var $nm_falta_var;
   var $nm_falta_var_db;
   var $nm_tpbanco;
   var $nm_servidor;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "busqueda_por_fecha"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/busqueda_por_fecha';
      ...
      if (isset($_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['busqueda_por_fecha']['actual_lang']) || $_SESSION['scriptcase']['busqueda_por_fecha']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['busqueda_por_fecha']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("busqueda_por_fecha_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_Link_View'] = true;
          }
      }
    if (!$_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "grid_reporte_por_fechas";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/grid_reporte_por_fechas_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/grid_reporte_por_fechas_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/grid_reporte_por_fechas_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/grid_reporte_por_fechas_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["grid_reporte_por_fechas"] = 'S';
          }
      }
      $this->sc_lig_target["P_@scinf_fechainicio"] = '';
      $this->sc_lig_target["P_@scinf_fechainicio_@scinf_grid_reporte_por_fechas"] = '';
      if ($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["busqueda_por_fecha"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["busqueda_por_fecha"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $this->link_grid_reporte_por_fechas_cons_psq =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('grid_reporte_por_fechas') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "busqueda_por_fecha_erro.class.php"); 
      $this->Erro = new busqueda_por_fecha_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('busqueda_por_fecha'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']) && $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_perfil']) && $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['busqueda_por_fecha']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['busqueda_por_fecha']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new busqueda_por_fecha_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busqueda_por_fecha']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['busqueda_por_fecha']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['busqueda_por_fecha']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['busqueda_por_fecha'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['busqueda_por_fecha']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['busqueda_por_fecha']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('busqueda_por_fecha') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['busqueda_por_fecha']['label'] = "" . $this->Ini->Nm_lang['lang_othr_srch_title'] . " ";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['busqueda_por_fecha']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['busqueda_por_fecha']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['busqueda_por_fecha']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'CITASPB'); 
      } 
      else 
      { 
      ...
      include_once($this->Ini->path_aplicacao . "busqueda_por_fecha_erro.class.php"); 
      $this->Erro      = new busqueda_por_fecha_erro();
      $this->Erro->Ini = $this->Ini;
//
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "busqueda_por_fecha_pesq.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "busqueda_por_fecha_mobile_pesq.class.php"); 
      } 
      $this->pesq  = new busqueda_por_fecha_pesq();
...
//======= =========================
   ...
   $_SESSION['scriptcase']['busqueda_por_fecha']['contr_erro'] = 'off';
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_busqueda_por_fecha($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_busqueda_por_fecha($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['busqueda_por_fecha']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "busqueda_por_fecha") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['busqueda_por_fecha']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   if (!empty($glo_perfil))  
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "busqueda_por_fecha";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'busqueda_por_fecha' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('busqueda_por_fecha' == $sReferer || 'busqueda_por_fecha_' == substr($sReferer, 0, 19))
       {
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'busqueda_por_fecha')
   {
       $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/busqueda_por_fecha_erro.php");
   }
   ...
   { 
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] = $nmgp_opcao ;  
       }   
       if (!empty($nmgp_parms)) 
       { 
           ...
           while (!empty($todo[$ix]))
           {
                ...
                if (1 < sizeof($cadapar))
                {
                    ...
                    nm_limpa_str_busqueda_por_fecha($cadapar[1]);
                    nm_protect_num_busqueda_por_fecha($cadapar[0], $cadapar[1]);
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['num_css'] = rand(0, 1000);
       } 
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['volta_redirect_tp'] = "";
           $nm_url_saida = "busqueda_por_fecha_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_outra_jan'] == 'true')
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_modal'] = true;
               }
               $nm_url_saida = "busqueda_por_fecha_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] != "pdf" ) 
       { 
            $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           $todo = explode(",", $nmgp_parms_ret);
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['dado_psq_ret']  = $todo[2];
           $_SESSION['scriptcase']['sc_tp_saida']  = $salva_tp_saida;
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $salva_url_saida;
           $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opc_psq'] = true ;   
       } 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
       if (isset($_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['sc_outra_jan'])
       {
           $nm_apl_dependente = 0;
       }
       $contr_busqueda_por_fecha = new busqueda_por_fecha_apl();
      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] = "busca";
          $contr_busqueda_por_fecha->NM_ajax_flag = true;
          $contr_busqueda_por_fecha->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_ch_bi_search' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] = "busca";
          $contr_busqueda_por_fecha->NM_ajax_flag = true;
          $contr_busqueda_por_fecha->NM_ajax_opcao = "ajax_ch_bi_search";
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] = "busca";
          $contr_busqueda_por_fecha->NM_ajax_flag = true;
          $contr_busqueda_por_fecha->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] = "busca";
          $contr_busqueda_por_fecha->NM_ajax_flag = true;
          $contr_busqueda_por_fecha->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['busqueda_por_fecha']['opcao'] = "busca";
          $contr_busqueda_por_fecha->NM_ajax_flag = true;
          $contr_busqueda_por_fecha->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_busqueda_por_fecha->controle();
   } 
   if ($nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_busqueda_por_fecha(&$str)
   {
   ...
   function nm_protect_num_busqueda_por_fecha($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function busqueda_por_fecha_pack_protect_string($sString)
   {
