<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reporte_de_pesaje_completo']['sc_process_barr'] = true;
require_once('../grid_reporte_de_pesaje_completo/index.php');
unset($_SESSION['scriptcase']['grid_reporte_de_pesaje_completo']['sc_process_barr']);
$ExportCtrl = new grid_reporte_de_pesaje_completo_export_control;
$ExportCtrl->Export_barr();

class grid_reporte_de_pesaje_completo_export_control
{
