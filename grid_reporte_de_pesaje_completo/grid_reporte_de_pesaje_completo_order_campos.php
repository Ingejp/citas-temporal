<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_reporte_de_pesaje_completo']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_reporte_de_pesaje_completo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reporte_de_pesaje_completo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["imprimir"] : "IMPRIMIR";
   $tab_ger_campos['qr'] = "on";
   $tab_def_campos['qr'] = "QR";
   $tab_labels["qr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["qr"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["qr"] : "QR";
   $tab_ger_campos['container'] = "on";
   $tab_def_campos['container'] = "container";
   $tab_labels["container"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["container"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["container"] : "CONTENEDOR";
   $tab_ger_campos['vessel'] = "on";
   $tab_def_campos['vessel'] = "vessel";
   $tab_labels["vessel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["vessel"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["vessel"] : "BUQUE";
   $tab_ger_campos['shippingcompany'] = "on";
   $tab_def_campos['shippingcompany'] = "shippingCompany";
   $tab_labels["shippingcompany"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["shippingcompany"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["shippingcompany"] : "NAVIERA";
   $tab_ger_campos['voyage'] = "on";
   $tab_def_campos['voyage'] = "voyage";
   $tab_labels["voyage"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["voyage"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["voyage"] : "VIAJE";
   $tab_ger_campos['date'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['date'] = "sc_def_col_1";
   }
   else
   {
       $tab_def_campos['date'] = "`date`";
   }
   $tab_labels["date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["date"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["date"] : "FECHA";
   $tab_ger_campos['commodity'] = "on";
   $tab_def_campos['commodity'] = "commodity";
   $tab_labels["commodity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["commodity"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["commodity"] : "PRODUCTO";
   $tab_ger_campos['grossweight'] = "on";
   $tab_def_campos['grossweight'] = "grossWeight";
   $tab_labels["grossweight"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["grossweight"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["grossweight"] : "PESO BRUTO";
   $tab_ger_campos['tarecontainer'] = "on";
   $tab_def_campos['tarecontainer'] = "tareContainer";
   $tab_labels["tarecontainer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["tarecontainer"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["tarecontainer"] : "TARA CONTENEDOR";
   $tab_ger_campos['tarechassis'] = "on";
   $tab_def_campos['tarechassis'] = "tareChassis";
   $tab_labels["tarechassis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["tarechassis"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["tarechassis"] : "TARA CHASIS";
   $tab_ger_campos['netweight'] = "on";
   $tab_def_campos['netweight'] = "netWeight";
   $tab_labels["netweight"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["netweight"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["netweight"] : "PESO NETO";
   $tab_ger_campos['vgm'] = "on";
   $tab_def_campos['vgm'] = "VGM";
   $tab_labels["vgm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["vgm"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["vgm"] : "VGM";
   $tab_ger_campos['typeoperation'] = "on";
   $tab_def_campos['typeoperation'] = "typeOperation";
   $tab_labels["typeoperation"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["typeoperation"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["typeoperation"] : "TIPO";
   $tab_ger_campos['country'] = "on";
   $tab_def_campos['country'] = "country";
   $tab_labels["country"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["country"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["country"] : "PAIS";
   $tab_ger_campos['exitticket'] = "on";
   $tab_def_campos['exitticket'] = "exitTicket";
   $tab_labels["exitticket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["exitticket"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["exitticket"] : "BOLETA SALIDA";
   $tab_ger_campos['inticket'] = "on";
   $tab_def_campos['inticket'] = "inTicket";
   $tab_labels["inticket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["inticket"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["inticket"] : "BOLETA ENTRADA";
   $tab_ger_campos['licenseplate'] = "on";
   $tab_def_campos['licenseplate'] = "licensePlate";
   $tab_labels["licenseplate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["licenseplate"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["licenseplate"] : "PLACA";
   $tab_ger_campos['driverslicense'] = "on";
   $tab_def_campos['driverslicense'] = "driversLicense";
   $tab_labels["driverslicense"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["driverslicense"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["driverslicense"] : "LICENCIA";
   $tab_ger_campos['pilotname'] = "on";
   $tab_def_campos['pilotname'] = "pilotName";
   $tab_labels["pilotname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["pilotname"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["pilotname"] : "PILOTO";
   $tab_ger_campos['transportname'] = "on";
   $tab_def_campos['transportname'] = "transportName";
   $tab_labels["transportname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["transportname"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["transportname"] : "TRANSPORTE";
   $tab_ger_campos['chasis'] = "on";
   $tab_def_campos['chasis'] = "chasis";
   $tab_labels["chasis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["chasis"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["chasis"] : "CHASIS";
   $tab_ger_campos['bl'] = "on";
   $tab_def_campos['bl'] = "bl";
   $tab_labels["bl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["bl"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["bl"] : "BL";
   $tab_ger_campos['packages'] = "on";
   $tab_def_campos['packages'] = "packages";
   $tab_labels["packages"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["packages"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["packages"] : "BULTOS";
   $tab_ger_campos['machine'] = "on";
   $tab_def_campos['machine'] = "machine";
   $tab_labels["machine"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["machine"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["machine"] : "BASCULA";
   $tab_ger_campos['out'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['out'] = "sc_def_col_2";
   }
   else
   {
       $tab_def_campos['out'] = "`out`";
   }
   $tab_labels["out"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["out"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["out"] : "USUARIO SALIDA";
   $tab_ger_campos['in'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['in'] = "sc_def_col_3";
   }
   else
   {
       $tab_def_campos['in'] = "`In`";
   }
   $tab_labels["in"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["in"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['labels']["in"] : "USUARIO ENTRADA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reporte_de_pesaje_completo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reporte_de_pesaje_completo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
