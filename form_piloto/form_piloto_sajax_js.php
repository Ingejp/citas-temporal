  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_piloto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_piloto_form();
	}

  // ---------- Validate idpiloto
  function do_ajax_form_piloto_validate_idpiloto()
  {
    var nomeCampo_idpiloto = "idpiloto";
    var var_idpiloto = scAjaxGetFieldHidden(nomeCampo_idpiloto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_validate_idpiloto(var_idpiloto, var_script_case_init, do_ajax_form_piloto_validate_idpiloto_cb);
  } // do_ajax_form_piloto_validate_idpiloto

  function do_ajax_form_piloto_validate_idpiloto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_validate_idpiloto_cb

  // ---------- Validate licencia
  function do_ajax_form_piloto_validate_licencia()
  {
    var nomeCampo_licencia = "licencia";
    var var_licencia = scAjaxGetFieldText(nomeCampo_licencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_validate_licencia(var_licencia, var_script_case_init, do_ajax_form_piloto_validate_licencia_cb);
  } // do_ajax_form_piloto_validate_licencia

  function do_ajax_form_piloto_validate_licencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_validate_licencia_cb

  // ---------- Validate nombre
  function do_ajax_form_piloto_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_piloto_validate_nombre_cb);
  } // do_ajax_form_piloto_validate_nombre

  function do_ajax_form_piloto_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_validate_nombre_cb

  // ---------- Validate dpi
  function do_ajax_form_piloto_validate_dpi()
  {
    var nomeCampo_dpi = "dpi";
    var var_dpi = scAjaxGetFieldText(nomeCampo_dpi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_validate_dpi(var_dpi, var_script_case_init, do_ajax_form_piloto_validate_dpi_cb);
  } // do_ajax_form_piloto_validate_dpi

  function do_ajax_form_piloto_validate_dpi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dpi";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_validate_dpi_cb

  // ---------- Validate huella
  function do_ajax_form_piloto_validate_huella()
  {
    var nomeCampo_huella = "huella";
    var var_huella = scAjaxGetFieldText(nomeCampo_huella);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_validate_huella(var_huella, var_script_case_init, do_ajax_form_piloto_validate_huella_cb);
  } // do_ajax_form_piloto_validate_huella

  function do_ajax_form_piloto_validate_huella_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "huella";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_validate_huella_cb

  // ---------- Validate foto
  function do_ajax_form_piloto_validate_foto()
  {
    var nomeCampo_foto = "foto";
    var var_foto = scAjaxGetFieldText(nomeCampo_foto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_validate_foto(var_foto, var_script_case_init, do_ajax_form_piloto_validate_foto_cb);
  } // do_ajax_form_piloto_validate_foto

  function do_ajax_form_piloto_validate_foto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_validate_foto_cb

  // ---------- Validate idtransporte
  function do_ajax_form_piloto_validate_idtransporte()
  {
  } // do_ajax_form_piloto_validate_idtransporte

  function do_ajax_form_piloto_validate_idtransporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_validate_idtransporte_cb

  // ---------- Event onchange licencia
  function do_ajax_form_piloto_event_licencia_onchange()
  {
    var var_licencia = scAjaxGetFieldText("licencia");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_piloto_event_licencia_onchange(var_licencia, var_nombre, var_script_case_init, do_ajax_form_piloto_event_licencia_onchange_cb);
  } // do_ajax_form_piloto_event_licencia_onchange

  function do_ajax_form_piloto_event_licencia_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "licencia";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_piloto_event_licencia_onchange_cb_after_alert);
  } // do_ajax_form_piloto_event_licencia_onchange_cb
  function do_ajax_form_piloto_event_licencia_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_piloto_event_licencia_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_piloto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_piloto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_piloto_submit_form(var_idpiloto, var_licencia, var_nombre, var_dpi, var_huella, var_foto, var_idtransporte, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_piloto_submit_form_cb);
  } // do_ajax_form_piloto_submit_form

  function do_ajax_form_piloto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_piloto_submit_form_cb_after_alert);
  } // do_ajax_form_piloto_submit_form_cb
  function do_ajax_form_piloto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_piloto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_piloto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_piloto_navigate_form(var_idpiloto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_piloto_navigate_form_cb);
  } // do_ajax_form_piloto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_piloto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_piloto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_piloto_navigate_form_cb_after_alert);
  } // do_ajax_form_piloto_navigate_form_cb
  function do_ajax_form_piloto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_piloto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_piloto_navigate_form_cb_after_alert
  function sc_hide_form_piloto_form()
  {
