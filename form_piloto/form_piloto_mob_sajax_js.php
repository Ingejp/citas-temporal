  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_piloto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_piloto_mob_form();
	}

  // ---------- Validate idpiloto
  function do_ajax_form_piloto_mob_validate_idpiloto()
  {
    var nomeCampo_idpiloto = "idpiloto";
    var var_idpiloto = scAjaxGetFieldHidden(nomeCampo_idpiloto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_mob_validate_idpiloto(var_idpiloto, var_script_case_init, do_ajax_form_piloto_mob_validate_idpiloto_cb);
  } // do_ajax_form_piloto_mob_validate_idpiloto

  function do_ajax_form_piloto_mob_validate_idpiloto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_mob_validate_idpiloto_cb

  // ---------- Validate licencia
  function do_ajax_form_piloto_mob_validate_licencia()
  {
    var nomeCampo_licencia = "licencia";
    var var_licencia = scAjaxGetFieldText(nomeCampo_licencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_mob_validate_licencia(var_licencia, var_script_case_init, do_ajax_form_piloto_mob_validate_licencia_cb);
  } // do_ajax_form_piloto_mob_validate_licencia

  function do_ajax_form_piloto_mob_validate_licencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "licencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_mob_validate_licencia_cb

  // ---------- Validate nombre
  function do_ajax_form_piloto_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_piloto_mob_validate_nombre_cb);
  } // do_ajax_form_piloto_mob_validate_nombre

  function do_ajax_form_piloto_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_mob_validate_nombre_cb

  // ---------- Validate dpi
  function do_ajax_form_piloto_mob_validate_dpi()
  {
    var nomeCampo_dpi = "dpi";
    var var_dpi = scAjaxGetFieldText(nomeCampo_dpi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_mob_validate_dpi(var_dpi, var_script_case_init, do_ajax_form_piloto_mob_validate_dpi_cb);
  } // do_ajax_form_piloto_mob_validate_dpi

  function do_ajax_form_piloto_mob_validate_dpi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dpi";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_mob_validate_dpi_cb

  // ---------- Validate huella
  function do_ajax_form_piloto_mob_validate_huella()
  {
    var nomeCampo_huella = "huella";
    var var_huella = scAjaxGetFieldText(nomeCampo_huella);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_mob_validate_huella(var_huella, var_script_case_init, do_ajax_form_piloto_mob_validate_huella_cb);
  } // do_ajax_form_piloto_mob_validate_huella

  function do_ajax_form_piloto_mob_validate_huella_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "huella";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_mob_validate_huella_cb

  // ---------- Validate foto
  function do_ajax_form_piloto_mob_validate_foto()
  {
    var nomeCampo_foto = "foto";
    var var_foto = scAjaxGetFieldText(nomeCampo_foto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_piloto_mob_validate_foto(var_foto, var_script_case_init, do_ajax_form_piloto_mob_validate_foto_cb);
  } // do_ajax_form_piloto_mob_validate_foto

  function do_ajax_form_piloto_mob_validate_foto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_mob_validate_foto_cb

  // ---------- Validate idtransporte
  function do_ajax_form_piloto_mob_validate_idtransporte()
  {
  } // do_ajax_form_piloto_mob_validate_idtransporte

  function do_ajax_form_piloto_mob_validate_idtransporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_piloto_mob_validate_idtransporte_cb

  // ---------- Event onchange licencia
  function do_ajax_form_piloto_mob_event_licencia_onchange()
  {
    var var_licencia = scAjaxGetFieldText("licencia");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_piloto_mob_event_licencia_onchange(var_licencia, var_nombre, var_script_case_init, do_ajax_form_piloto_mob_event_licencia_onchange_cb);
  } // do_ajax_form_piloto_mob_event_licencia_onchange

  function do_ajax_form_piloto_mob_event_licencia_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "licencia";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_piloto_mob_event_licencia_onchange_cb_after_alert);
  } // do_ajax_form_piloto_mob_event_licencia_onchange_cb
  function do_ajax_form_piloto_mob_event_licencia_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_piloto_mob_event_licencia_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_piloto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_piloto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpiloto = scAjaxGetFieldHidden("idpiloto");
    var var_licencia = scAjaxGetFieldText("licencia");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_dpi = scAjaxGetFieldText("dpi");
    var var_huella = scAjaxGetFieldText("huella");
    var var_foto = scAjaxGetFieldText("foto");
    ...
    scAjaxProcOn();
    x_ajax_form_piloto_mob_submit_form(var_idpiloto, var_licencia, var_nombre, var_dpi, var_huella, var_foto, var_idtransporte, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_piloto_mob_submit_form_cb);
  } // do_ajax_form_piloto_mob_submit_form

  function do_ajax_form_piloto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("licencia");
      scAjaxHideErrorDisplay("nombre");
      scAjaxHideErrorDisplay("dpi");
      scAjaxHideErrorDisplay("huella");
      scAjaxHideErrorDisplay("foto");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_piloto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_piloto_mob_submit_form_cb
  function do_ajax_form_piloto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_piloto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_piloto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("foto");
    scAjaxHideErrorDisplay("idtransporte");
    var var_idpiloto = document.F2.idpiloto.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_piloto_mob_navigate_form(var_idpiloto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_piloto_mob_navigate_form_cb);
  } // do_ajax_form_piloto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_piloto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_piloto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpiloto.value = scAjaxGetKeyValue("idpiloto");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_piloto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_piloto_mob_navigate_form_cb
  function do_ajax_form_piloto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_piloto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_piloto_mob_navigate_form_cb_after_alert
  function sc_hide_form_piloto_mob_form()
  {
  ...
  ajax_field_list[1] = "licencia";
  ajax_field_list[2] = "nombre";
  ajax_field_list[3] = "dpi";
  ajax_field_list[4] = "huella";
  ajax_field_list[5] = "foto";
  ajax_field_list[6] = "idtransporte";
  ...
  var ajax_error_list = {
    ...
    "licencia": {"label": "Licencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dpi": {"label": "Dpi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "huella": {"label": "Huella", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "foto": {"label": "Foto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["licencia"][1] = "licencia";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["dpi"][1] = "dpi";
  ajax_field_mult["huella"][1] = "huella";
  ajax_field_mult["foto"][1] = "foto";
  ajax_field_mult["idtransporte"][1] = "idtransporte";

  var ajax_field_id = {
    "idpiloto": new Array("hidden_field_label_idpiloto", "hidden_field_data_idpiloto"),
    "licencia": new Array("hidden_field_label_licencia", "hidden_field_data_licencia"),
    "nombre": new Array("hidden_field_label_nombre", "hidden_field_data_nombre"),
    "dpi": new Array("hidden_field_label_dpi", "hidden_field_data_dpi"),
