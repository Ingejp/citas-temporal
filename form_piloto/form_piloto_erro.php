...
$old_error_handler = set_error_handler("form_piloto_scriptcase_error_handler");

function form_piloto_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_piloto']['contr_erro']) && $_SESSION['scriptcase']['form_piloto']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_piloto->contr_form_piloto->Apl_com_erro = true;
            if ($inicial_form_piloto->contr_form_piloto->NM_ajax_flag)
            {
                $inicial_form_piloto->contr_form_piloto->NM_ajax_info['errList']['geral_form_piloto'][] = $msg;
                return;
            }
            form_piloto_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_piloto_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_piloto'])  && '' != $_SESSION['scriptcase']['error_icon']['form_piloto'])  ? $_SESSION['scriptcase']['error_icon']['form_piloto']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_piloto']) && '' != $_SESSION['scriptcase']['error_span_title']['form_piloto']) ? $_SESSION['scriptcase']['error_span_title']['form_piloto'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_piloto']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_piloto']) ? $_SESSION['scriptcase']['error_icon_title']['form_piloto'] : '';
?>
