  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_CALEN_MODULISTA_INGRESO" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_CALEN_MODULISTA_INGRESO_form();
	}

  // ---------- Validate rangoinicial
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_rangoinicial()
  {
    ...
    setTimeout(function() {
      var var_rangoinicial = scAjaxGetFieldText(nomeCampo_rangoinicial);
      x_ajax_CALEN_MODULISTA_INGRESO_validate_rangoinicial(var_rangoinicial, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_rangoinicial_cb);
    }, 200);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_rangoinicial

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_rangoinicial_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_rangoinicial_cb

  // ---------- Validate rangofinal
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_rangofinal()
  {
    ...
    setTimeout(function() {
      var var_rangofinal = scAjaxGetFieldText(nomeCampo_rangofinal);
      x_ajax_CALEN_MODULISTA_INGRESO_validate_rangofinal(var_rangofinal, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_rangofinal_cb);
    }, 200);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_rangofinal

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_rangofinal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_rangofinal_cb

  // ---------- Validate horainicio
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_horainicio()
  {
    var nomeCampo_horainicio = "horainicio";
    var var_horainicio = scAjaxGetFieldText(nomeCampo_horainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_horainicio(var_horainicio, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_horainicio_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_horainicio

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_horainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_horainicio_cb

  // ---------- Validate horafin
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_horafin()
  {
    var nomeCampo_horafin = "horafin";
    var var_horafin = scAjaxGetFieldText(nomeCampo_horafin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_horafin(var_horafin, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_horafin_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_horafin

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_horafin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horafin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_horafin_cb

  // ---------- Validate fecharegistro
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_fecharegistro()
  {
    var nomeCampo_fecharegistro = "fecharegistro";
    var var_fecharegistro = scAjaxGetFieldText(nomeCampo_fecharegistro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_fecharegistro(var_fecharegistro, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_fecharegistro_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_fecharegistro

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_fecharegistro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_fecharegistro_cb

  // ---------- Validate fechamodificacion
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_fechamodificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_fechamodificacion(var_fechamodificacion, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_fechamodificacion_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_fechamodificacion

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_fechamodificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_fechamodificacion_cb

  // ---------- Validate idtipodemodulista
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_idtipodemodulista()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_idtipodemodulista(var_idtipodemodulista, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_idtipodemodulista_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_idtipodemodulista

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_idtipodemodulista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_idtipodemodulista_cb

  // ---------- Validate cantidadmodulistas
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidadmodulistas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_cantidadmodulistas(var_cantidadmodulistas, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidadmodulistas_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidadmodulistas

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidadmodulistas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidadmodulistas_cb

  // ---------- Validate descripcion
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_descripcion_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_descripcion

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_descripcion_cb

  // ---------- Validate cantidad_dias
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidad_dias()
  {
    var nomeCampo_cantidad_dias = "cantidad_dias";
    var var_cantidad_dias = scAjaxGetFieldSelect(nomeCampo_cantidad_dias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_cantidad_dias(var_cantidad_dias, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidad_dias_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidad_dias

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidad_dias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_cantidad_dias_cb

  // ---------- Validate rango_horas
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_rango_horas()
  {
    var nomeCampo_rango_horas = "rango_horas";
    var var_rango_horas = scAjaxGetFieldText(nomeCampo_rango_horas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_rango_horas(var_rango_horas, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_rango_horas_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_rango_horas

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_rango_horas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_rango_horas_cb

  // ---------- Validate citas_disponibles
  function do_ajax_CALEN_MODULISTA_INGRESO_validate_citas_disponibles()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_CALEN_MODULISTA_INGRESO_validate_citas_disponibles(var_citas_disponibles, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_validate_citas_disponibles_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_citas_disponibles

  function do_ajax_CALEN_MODULISTA_INGRESO_validate_citas_disponibles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_CALEN_MODULISTA_INGRESO_validate_citas_disponibles_cb

  // ---------- Event onblur cantidadmodulistas
  function do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur(var_citas_disponibles, var_cantidadmodulistas, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur

  function do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidadmodulistas";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur_cb_after_alert);
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur_cb
  function do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_cantidadmodulistas_onblur_cb_after_alert

  // ---------- Event onblur horafin
  function do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur(var_rango_horas, var_horainicio, var_horafin, var_descripcion, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur

  function do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "horafin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur_cb_after_alert);
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur_cb
  function do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_horafin_onblur_cb_after_alert

  // ---------- Event onchange idtipodemodulista
  function do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange()
  {
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange(var_descripcion, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange

  function do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idtipodemodulista";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange_cb_after_alert);
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange_cb
  function do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_CALEN_MODULISTA_INGRESO_event_idtipodemodulista_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_CALEN_MODULISTA_INGRESO_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_CALEN_MODULISTA_INGRESO_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_CALEN_MODULISTA_INGRESO_submit_form(var_rangoinicial, var_rangofinal, var_horainicio, var_horafin, var_fecharegistro, var_fechamodificacion, var_idtipodemodulista, var_cantidadmodulistas, var_descripcion, var_cantidad_dias, var_rango_horas, var_citas_disponibles, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_CALEN_MODULISTA_INGRESO_submit_form_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_submit_form

  function do_ajax_CALEN_MODULISTA_INGRESO_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_CALEN_MODULISTA_INGRESO_submit_form_cb_after_alert);
  } // do_ajax_CALEN_MODULISTA_INGRESO_submit_form_cb
  function do_ajax_CALEN_MODULISTA_INGRESO_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_CALEN_MODULISTA_INGRESO_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_CALEN_MODULISTA_INGRESO_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_CALEN_MODULISTA_INGRESO_navigate_form(var_idasignacionmodulista, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_CALEN_MODULISTA_INGRESO_navigate_form_cb);
  } // do_ajax_CALEN_MODULISTA_INGRESO_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_CALEN_MODULISTA_INGRESO_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_CALEN_MODULISTA_INGRESO_navigate_form_cb_after_alert);
  } // do_ajax_CALEN_MODULISTA_INGRESO_navigate_form_cb
  function do_ajax_CALEN_MODULISTA_INGRESO_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_CALEN_MODULISTA_INGRESO_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_CALEN_MODULISTA_INGRESO_navigate_form_cb_after_alert
  function sc_hide_CALEN_MODULISTA_INGRESO_form()
  {
