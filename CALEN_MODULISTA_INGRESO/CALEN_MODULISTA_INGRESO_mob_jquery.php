...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecharegistro_hora' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_INGRESO_fecharegistro_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_CALEN_MODULISTA_INGRESO_fecharegistro_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fechamodificacion_hora' + iSeqRow).bind('blur', function() { sc_CALEN_MODULISTA_INGRESO_fechamodificacion_onblur(this, iSeqRow) })
                                                    .bind('focus', function() { sc_CALEN_MODULISTA_INGRESO_fechamodificacion_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_CALEN_MODULISTA_INGRESO_mob_form" + pageNo).hide();
}
...
function scEventControl_onCalculator_recur_info() {
  if (!_scCalculatorControl["id_sc_field_recur_info"]) {
    ...
    do_ajax_CALEN_MODULISTA_INGRESO_mob_event_recur_info_onblur();
  }
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_rangoinicial" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_CALEN_MODULISTA_INGRESO_mob_validate_rangoinicial(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_rangofinal" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_CALEN_MODULISTA_INGRESO_mob_validate_rangofinal(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecharegistro" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_CALEN_MODULISTA_INGRESO_mob_validate_fecharegistro(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechamodificacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_CALEN_MODULISTA_INGRESO_mob_validate_fechamodificacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
