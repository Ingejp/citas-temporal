...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("CALEN_MODULISTA_INGRESO_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('CALEN_MODULISTA_INGRESO_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("CALEN_MODULISTA_INGRESO_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['CALEN_MODULISTA_INGRESO'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['CALEN_MODULISTA_INGRESO'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rangoinicial_label" id="hidden_field_label_rangoinicial" style="<?php echo $sStyleHidden_rangoinicial; ?>"><span id="id_label_rangoinicial"><?php echo $this->nm_new_label['rangoinicial']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangoinicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangoinicial'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rangofinal_label" id="hidden_field_label_rangofinal" style="<?php echo $sStyleHidden_rangofinal; ?>"><span id="id_label_rangofinal"><?php echo $this->nm_new_label['rangofinal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangofinal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_horainicio_label" id="hidden_field_label_horainicio" style="<?php echo $sStyleHidden_horainicio; ?>"><span id="id_label_horainicio"><?php echo $this->nm_new_label['horainicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horainicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_horafin_label" id="hidden_field_label_horafin" style="<?php echo $sStyleHidden_horafin; ?>"><span id="id_label_horafin"><?php echo $this->nm_new_label['horafin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horafin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechamodificacion_label" id="hidden_field_label_fechamodificacion" style="<?php echo $sStyleHidden_fechamodificacion; ?>"><span id="id_label_fechamodificacion"><?php echo $this->nm_new_label['fechamodificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fechamodificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cantidadmodulistas_label" id="hidden_field_label_cantidadmodulistas" style="<?php echo $sStyleHidden_cantidadmodulistas; ?>"><span id="id_label_cantidadmodulistas"><?php echo $this->nm_new_label['cantidadmodulistas']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['cantidadmodulistas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['cantidadmodulistas'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cantidad_dias_label" id="hidden_field_label_cantidad_dias" style="<?php echo $sStyleHidden_cantidad_dias; ?>"><span id="id_label_cantidad_dias"><?php echo $this->nm_new_label['cantidad_dias']; ?></span></TD>
    <TD class="scFormDataOdd css_cantidad_dias_line" id="hidden_field_data_cantidad_dias" style="<?php echo $sStyleHidden_cantidad_dias; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cantidad_dias_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '1'; ?>
 <option  value="2" <?php  if ($this->cantidad_dias == "2") { echo " selected" ;} ?>>2 Dias</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '2'; ?>
 <option  value="3" <?php  if ($this->cantidad_dias == "3") { echo " selected" ;} ?>>3 Dias</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '3'; ?>
 <option  value="4" <?php  if ($this->cantidad_dias == "4") { echo " selected" ;} ?>>4 Dias</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '4'; ?>
 <option  value="5" <?php  if ($this->cantidad_dias == "5") { echo " selected" ;} ?>>5 Dias</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '5'; ?>
 <option  value="6" <?php  if ($this->cantidad_dias == "6") { echo " selected" ;} ?>>6 Dias</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '6'; ?>
 <option  value="7" <?php  if ($this->cantidad_dias == "7") { echo " selected" ;} ?>>7 Dias</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '7'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rango_horas_label" id="hidden_field_label_rango_horas" style="<?php echo $sStyleHidden_rango_horas; ?>"><span id="id_label_rango_horas"><?php echo $this->nm_new_label['rango_horas']; ?></span></TD>
    <TD class="scFormDataOdd css_rango_horas_line" id="hidden_field_data_rango_horas" style="<?php echo $sStyleHidden_rango_horas; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rango_horas_line" style="vertical-align: top;padding: 0px">
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("CALEN_MODULISTA_INGRESO");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("CALEN_MODULISTA_INGRESO");
 parent.scAjaxDetailHeight("CALEN_MODULISTA_INGRESO", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
