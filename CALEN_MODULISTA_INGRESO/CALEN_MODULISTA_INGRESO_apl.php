<?php
//
class CALEN_MODULISTA_INGRESO_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_CALEN_MODULISTA_INGRESO($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new CALEN_MODULISTA_INGRESO_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['CALEN_MODULISTA_INGRESO']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['CALEN_MODULISTA_INGRESO'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['CALEN_MODULISTA_INGRESO']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['CALEN_MODULISTA_INGRESO']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('CALEN_MODULISTA_INGRESO') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['CALEN_MODULISTA_INGRESO']['label'] = "HORARIO MODULISTAS DE INGRESO";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "CALEN_MODULISTA_INGRESO")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['CALEN_MODULISTA_INGRESO']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['CALEN_MODULISTA_INGRESO'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['CALEN_MODULISTA_INGRESO'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['CALEN_MODULISTA_INGRESO'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("CALEN_MODULISTA_INGRESO", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'CALEN_MODULISTA_INGRESO/CALEN_MODULISTA_INGRESO_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'CALEN_MODULISTA_INGRESO_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'CALEN_MODULISTA_INGRESO_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'CALEN_MODULISTA_INGRESO_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'CALEN_MODULISTA_INGRESO/CALEN_MODULISTA_INGRESO_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "CALEN_MODULISTA_INGRESO_erro.class.php"); 
      }
      $this->Erro      = new CALEN_MODULISTA_INGRESO_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          CALEN_MODULISTA_INGRESO_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "CALEN_MODULISTA_INGRESO.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="CALEN_MODULISTA_INGRESO_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="CALEN_MODULISTA_INGRESO"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO']) || !is_array($this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO']))
              {
                  $this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO'] = array();
              }
              $this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horainicio'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horafin'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horainicio'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horafin'] = false;
...
//---
      ...
      {
      $_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO']['contr_erro'] = 'off'; 
    ...
    function ValidateField_rangoinicial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangoinicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangoinicial'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_rangofinal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['rangofinal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_horainicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horainicio'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horainicio']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horainicio'])
              {
              $hasError = true;
    ...
    function ValidateField_horafin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['horafin'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horafin']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['bypass_required_time']['horafin'])
              {
              $hasError = true;
    ...
    function ValidateField_fecharegistro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fecharegistro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fecharegistro'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fecharegistro_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fecharegistro_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Registro" ; 
              if (!isset($Campos_Erros['fecharegistro_hora']))
    ...
    function ValidateField_fechamodificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fechamodificacion'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fechamodificacion_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['fechamodificacion_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Modificacion" ; 
              if (!isset($Campos_Erros['fechamodificacion_hora']))
    ...
    function ValidateField_idtipodemodulista(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipodemodulista) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_idtipodemodulista']) && !in_array($this->idtipodemodulista, $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_idtipodemodulista']))
               {
                   $hasError = true;
    ...
    function ValidateField_cantidadmodulistas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['cantidadmodulistas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['php_cmp_required']['cantidadmodulistas'] == "on") 
           { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idasignacionmodulista']['keyVal'] = CALEN_MODULISTA_INGRESO_pack_protect_string($this->nmgp_dados_form['idasignacionmodulista']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_idtipodemodulista']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_idtipodemodulista'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_idtipodemodulista']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_idtipodemodulista'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', CALEN_MODULISTA_INGRESO_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_idtipodemodulista'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodemodulista']['valList'][$i] = CALEN_MODULISTA_INGRESO_pack_protect_string($v);
          }
...
$aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string('1') => CALEN_MODULISTA_INGRESO_pack_protect_string("1 Dia"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string('2') => CALEN_MODULISTA_INGRESO_pack_protect_string("2 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string('3') => CALEN_MODULISTA_INGRESO_pack_protect_string("3 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string('4') => CALEN_MODULISTA_INGRESO_pack_protect_string("4 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string('5') => CALEN_MODULISTA_INGRESO_pack_protect_string("5 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string('6') => CALEN_MODULISTA_INGRESO_pack_protect_string("6 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_pack_protect_string('7') => CALEN_MODULISTA_INGRESO_pack_protect_string("7 Dias"));
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['Lookup_cantidad_dias'][] = '7';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['cantidad_dias']['valList'][$i] = CALEN_MODULISTA_INGRESO_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_citas_disponibles($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opcao'] = '';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_CALEN_MODULISTA_INGRESO' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['db_changed'] = true;
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['parms'] = "idasignacionmodulista?#?$this->idasignacionmodulista?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("CALEN_MODULISTA_INGRESO_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_outra_jan'] != 'CALEN_MODULISTA_INGRESO')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
@media (max-width: 853px) {
 ...
 <script type="text/javascript">
  ...
  function calendar_print() {
      $.ajax({
          url: 'CALEN_MODULISTA_INGRESO.php',
          type: 'GET',
          dataType: 'json',
          data: {
...
?>
      events: 'CALEN_MODULISTA_INGRESO.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'CALEN_MODULISTA_INGRESO.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'CALEN_MODULISTA_INGRESO.php?nmgp_opcao=igual_calendar&idasignacionmodulista=' + calEvent.id + '&__orig_idasignacionmodulista=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'CALEN_MODULISTA_INGRESO.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'CALEN_MODULISTA_INGRESO.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<?php
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_CALEN_MODULISTA_INGRESO = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['total'] = $qt_geral_reg_CALEN_MODULISTA_INGRESO;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          CALEN_MODULISTA_INGRESO_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "CALEN_MODULISTA_INGRESO_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['nm_run_menu'] = 2;
       $nmgp_saida_form = "CALEN_MODULISTA_INGRESO_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['masterValue'] as $cmp_master => $val_master)
        {
?>
