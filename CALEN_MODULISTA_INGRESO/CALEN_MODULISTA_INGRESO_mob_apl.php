<?php
//
class CALEN_MODULISTA_INGRESO_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['cantidad_dias']))
          {
              $this->cantidad_dias = $this->NM_ajax_info['param']['cantidad_dias'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['rango_horas']))
          {
              $this->rango_horas = $this->NM_ajax_info['param']['rango_horas'];
          }
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_CALEN_MODULISTA_INGRESO_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new CALEN_MODULISTA_INGRESO_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['CALEN_MODULISTA_INGRESO_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['CALEN_MODULISTA_INGRESO_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['CALEN_MODULISTA_INGRESO_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['CALEN_MODULISTA_INGRESO_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['CALEN_MODULISTA_INGRESO_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('CALEN_MODULISTA_INGRESO_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['CALEN_MODULISTA_INGRESO_mob']['label'] = "HORARIO MODULISTAS DE INGRESO";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "CALEN_MODULISTA_INGRESO_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['CALEN_MODULISTA_INGRESO_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['CALEN_MODULISTA_INGRESO_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['CALEN_MODULISTA_INGRESO_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['CALEN_MODULISTA_INGRESO_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['CALEN_MODULISTA_INGRESO_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("CALEN_MODULISTA_INGRESO_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'CALEN_MODULISTA_INGRESO/CALEN_MODULISTA_INGRESO_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'CALEN_MODULISTA_INGRESO_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'CALEN_MODULISTA_INGRESO_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'CALEN_MODULISTA_INGRESO_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'CALEN_MODULISTA_INGRESO/CALEN_MODULISTA_INGRESO_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "CALEN_MODULISTA_INGRESO_mob_erro.class.php"); 
      }
      $this->Erro      = new CALEN_MODULISTA_INGRESO_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['CALEN_MODULISTA_INGRESO_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_cantidad_dias' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cantidad_dias');
          }
          if ('validate_rango_horas' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'rango_horas');
          }
          ...
          CALEN_MODULISTA_INGRESO_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_cantidadmodulistas_onblur' == $this->NM_ajax_opcao)
          {
              $this->cantidadModulistas_onBlur();
          }
          if ('event_horafin_onblur' == $this->NM_ajax_opcao)
          {
              $this->horaFin_onBlur();
          }
          if ('event_idtipodemodulista_onchange' == $this->NM_ajax_opcao)
          {
              $this->idtipodeModulista_onChange();
          }
          CALEN_MODULISTA_INGRESO_mob_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "CALEN_MODULISTA_INGRESO_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("HORARIO MODULISTAS DE INGRESO") ?></TITLE>
...
<form name="Fdown" method="get" action="CALEN_MODULISTA_INGRESO_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="CALEN_MODULISTA_INGRESO_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="CALEN_MODULISTA_INGRESO_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO_mob']) || !is_array($this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_CALEN_MODULISTA_INGRESO_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horainicio'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horafin'] = true;
      }
      ...
      if ('' == $filtro || 'cantidad_dias' == $filtro)
        $this->ValidateField_cantidad_dias($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "cantidad_dias";

      if ('' == $filtro || 'rango_horas' == $filtro)
        $this->ValidateField_rango_horas($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "rango_horas";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horainicio'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horafin'] = false;
...
//---
      ...
      {
      $_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_rangoinicial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['rangoinicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['rangoinicial'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_rangofinal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['rangofinal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_horainicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['horainicio'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horainicio']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horainicio'])
              {
              $hasError = true;
    ...
    function ValidateField_horafin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['horafin'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horafin']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['bypass_required_time']['horafin'])
              {
              $hasError = true;
    ...
    function ValidateField_fecharegistro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fecharegistro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fecharegistro'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fecharegistro_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fecharegistro_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Registro" ; 
              if (!isset($Campos_Erros['fecharegistro_hora']))
    ...
    function ValidateField_fechamodificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fechamodificacion'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fechamodificacion_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['fechamodificacion_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Modificacion" ; 
              if (!isset($Campos_Erros['fechamodificacion_hora']))
    ...
    function ValidateField_idtipodemodulista(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipodemodulista) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_idtipodemodulista']) && !in_array($this->idtipodemodulista, $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_idtipodemodulista']))
               {
                   $hasError = true;
    ...
    function ValidateField_cantidadmodulistas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['cantidadmodulistas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['php_cmp_required']['cantidadmodulistas'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_cantidad_dias(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->cantidad_dias == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    } // ValidateField_cantidad_dias

    function ValidateField_rango_horas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->rango_horas) > 20) 
          { 
              $hasError = true;
              $Campos_Crit .= "Rango Horas " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['rango_horas']))
              {
                  $Campos_Erros['rango_horas'] = array();
              }
              $Campos_Erros['rango_horas'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['rango_horas']) || !is_array($this->NM_ajax_info['errList']['rango_horas']))
              {
                  $this->NM_ajax_info['errList']['rango_horas'] = array();
              }
              $this->NM_ajax_info['errList']['rango_horas'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'rango_horas';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_rango_horas
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['cantidad_dias'] = $this->cantidad_dias;
    $this->nmgp_dados_form['rango_horas'] = $this->rango_horas;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_cantidad_dias();
          $this->ajax_return_values_rango_horas();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idasignacionmodulista']['keyVal'] = CALEN_MODULISTA_INGRESO_mob_pack_protect_string($this->nmgp_dados_form['idasignacionmodulista']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', CALEN_MODULISTA_INGRESO_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodemodulista']['valList'][$i] = CALEN_MODULISTA_INGRESO_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_descripcion($bForce = false)
   {
          ...
          //----- cantidad_dias
   function ajax_return_values_cantidad_dias($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cantidad_dias", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cantidad_dias);
              $aLookup = array();
              $this->_tmp_lookup_cantidad_dias = $this->cantidad_dias;

$aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string('1') => CALEN_MODULISTA_INGRESO_mob_pack_protect_string("1 Dia"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string('2') => CALEN_MODULISTA_INGRESO_mob_pack_protect_string("2 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string('3') => CALEN_MODULISTA_INGRESO_mob_pack_protect_string("3 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string('4') => CALEN_MODULISTA_INGRESO_mob_pack_protect_string("4 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string('5') => CALEN_MODULISTA_INGRESO_mob_pack_protect_string("5 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string('6') => CALEN_MODULISTA_INGRESO_mob_pack_protect_string("6 Dias"));
$aLookup[] = array(CALEN_MODULISTA_INGRESO_mob_pack_protect_string('7') => CALEN_MODULISTA_INGRESO_mob_pack_protect_string("7 Dias"));
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_cantidad_dias'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_cantidad_dias'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_cantidad_dias'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_cantidad_dias'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_cantidad_dias'][] = '5';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_cantidad_dias'][] = '6';
$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['Lookup_cantidad_dias'][] = '7';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cantidad_dias\"";
          if (isset($this->NM_ajax_info['select_html']['cantidad_dias']) && !empty($this->NM_ajax_info['select_html']['cantidad_dias']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['cantidad_dias'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->cantidad_dias == $sValue)
                  {
                      $this->_tmp_lookup_cantidad_dias = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['cantidad_dias'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['cantidad_dias']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['cantidad_dias']['valList'][$i] = CALEN_MODULISTA_INGRESO_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['cantidad_dias']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['cantidad_dias']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['cantidad_dias']['labList'] = $aLabel;
          }
   }

          //----- rango_horas
   function ajax_return_values_rango_horas($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("rango_horas", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->rango_horas);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['rango_horas'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_idasignacionmodulista($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'off'; 
          ...
          {
              $this->fecharegistro_hora = $this->fecharegistro;
          }
          if (empty($this->fechamodificacion))
          {
              $this->fechamodificacion_hora = $this->fechamodificacion;
          }
      }
      $this->nm_guardar_campos();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opcao'] = '';
   ...
   { 
    ...
    if ("incluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
  $this->horafin =$this->sumarHora($this->horainicio , 1);
$this->rangofinal =$this->rangoinicial ;
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_CALEN_MODULISTA_INGRESO_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['cantidad_dias'] = $this->cantidad_dias;
      $NM_val_form['rango_horas'] = $this->rango_horas;
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "descripcion = '$this->descripcion', cantidadModulistas = $this->cantidadmodulistas, rangoInicial = #$this->rangoinicial#, rangoFinal = #$this->rangofinal#, fechaRegistro = #$this->fecharegistro#, fechaModificacion = #$this->fechamodificacion#, horaInicio = #$this->horainicio#, horaFin = #$this->horafin#, idtipodeModulista = $this->idtipodemodulista, citas_disponibles = $this->citas_disponibles"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "descripcion = '$this->descripcion', cantidadModulistas = $this->cantidadmodulistas, rangoInicial = " . $this->Ini->date_delim . $this->rangoinicial . $this->Ini->date_delim1 . ", rangoFinal = " . $this->Ini->date_delim . $this->rangofinal . $this->Ini->date_delim1 . ", fechaRegistro = " . $this->Ini->date_delim . $this->fecharegistro . $this->Ini->date_delim1 . ", fechaModificacion = " . $this->Ini->date_delim . $this->fechamodificacion . $this->Ini->date_delim1 . ", horaInicio = " . $this->Ini->date_delim . $this->horainicio . $this->Ini->date_delim1 . ", horaFin = " . $this->Ini->date_delim . $this->horafin . $this->Ini->date_delim1 . ", idtipodeModulista = $this->idtipodemodulista, citas_disponibles = $this->citas_disponibles"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('rangoinicial', 'rangofinal', 'horainicio', 'horafin', 'fecharegistro', 'fechamodificacion', 'idtipodemodulista', 'cantidadmodulistas', 'descripcion', 'cantidad_dias', 'rango_horas', 'citas_disponibles'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (descripcion, cantidadModulistas, rangoInicial, rangoFinal, fechaRegistro, fechaModificacion, horaInicio, horaFin, periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles) VALUES ('$this->descripcion', $this->cantidadmodulistas, #$this->rangoinicial#, #$this->rangofinal#, #$this->fecharegistro#, #$this->fechamodificacion#, #$this->horainicio#, #$this->horafin#, '$this->periodo', '$this->reaparicion', '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->idtipodemodulista, $this->category, $this->citas_disponibles)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "descripcion, cantidadModulistas, rangoInicial, rangoFinal, fechaRegistro, fechaModificacion, horaInicio, horaFin, periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles) VALUES (" . $NM_seq_auto . "'$this->descripcion', $this->cantidadmodulistas, " . $this->Ini->date_delim . $this->rangoinicial . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->rangofinal . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fecharegistro . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fechamodificacion . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horainicio . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horafin . $this->Ini->date_delim1 . ", '$this->periodo', '$this->reaparicion', '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->idtipodemodulista, $this->category, $this->citas_disponibles)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "descripcion, cantidadModulistas, rangoInicial, rangoFinal, fechaRegistro, fechaModificacion, horaInicio, horaFin, periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles) VALUES (" . $NM_seq_auto . "'$this->descripcion', $this->cantidadmodulistas, " . $this->Ini->date_delim . $this->rangoinicial . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->rangofinal . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fecharegistro . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fechamodificacion . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horainicio . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horafin . $this->Ini->date_delim1 . ", '$this->periodo', '$this->reaparicion', '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->idtipodemodulista, $this->category, $this->citas_disponibles)"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_rango_horas = $this->rango_horas;
}
  if($this->rango_horas >1){	
	if($this->cantidad_dias >1){
		$total_horas=$this->rango_horas -1;
		for($j=1; $j<=$total_horas; $j++){
			$horaInicio = $this->sumarHora($this->horainicio , $j);
			$horaFin = $this->sumarHora($horaInicio,1);
			$this->insert($horaInicio, $horaFin, $this->rangoinicial , $this->rangofinal );
		}
		
		$limite=$this->cantidad_dias -1;
		for($i=1; $i<=$limite; $i++){		
			$fechaInicial=$this->sumarFecha($this->rangoinicial , $i);
			$fechaFinal=$this->sumarFecha($this->rangofinal , $i);
			$horaInicio = $this->sumarHora($this->horainicio , $i);
			$horaFin = $this->sumarHora($horaInicio,1);
			
			$this->insert($this->horainicio , $this->horafin , $fechaInicial, $fechaFinal);
			
			$total_horas=$this->rango_horas -1;
			for($j=1; $j<=$total_horas; $j++){
				$horaInicio = $this->sumarHora($this->horainicio , $j);
				$horaFin = $this->sumarHora($horaInicio,1);
				$this->insert($horaInicio, $horaFin, $fechaInicial, $fechaFinal);
			}
	...
	if($this->cantidad_dias >1){
		...
		for($i=1; $i<=$total_horas; $i++){
			$horaInicio = $this->sumarHora($this->horainicio , $i);
			$horaFin = $this->sumarHora($horaInicio,1);
			$this->insert($this->horainicio , $this->horafin , $this->rangoinicial , $this->rangofinal );
		}
	}
}
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_rango_horas != $this->rango_horas || (isset($bFlagRead_rango_horas) && $bFlagRead_rango_horas)))
    {
        $this->ajax_return_values_rango_horas(true);
    }
}
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'off'; 
    }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['parms'] = "idasignacionmodulista?#?$this->idasignacionmodulista?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['dados_select'] = $this->nmgp_dados_select;
      ...
      { 
          ...
          else
          {
              ...
              $this->fechamodificacion =  date('Y') . "-" . date('m')  . "-" . date('d') . " " . date('H') . ":" . date('i') . ":" . date('s');
              $this->fechamodificacion_hora =  date('Y') . "-" . date('m')  . "-" . date('d') . " " . date('H') . ":" . date('i') . ":" . date('s');
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function cantidadModulistas_onBlur()
{
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
  
$original_citas_disponibles = $this->citas_disponibles;
$original_cantidadmodulistas = $this->cantidadmodulistas;
$original_cantidadmodulistas = $this->cantidadmodulistas;

$check_sql = "SELECT citas_por_hora"
   . " FROM configuracion_general"
   . " WHERE idconfiguracion_general = 1";
...
{
    $this->citas_disponibles  = $this->rs[0][0] * $this->cantidadmodulistas ;
}
		else     
{
		     $this->citas_disponibles  =0;
...
$modificado_citas_disponibles = $this->citas_disponibles;
$modificado_cantidadmodulistas = $this->cantidadmodulistas;
$modificado_cantidadmodulistas = $this->cantidadmodulistas;
$this->nm_formatar_campos('citas_disponibles', 'cantidadmodulistas');
if ($original_citas_disponibles !== $modificado_citas_disponibles || isset($this->nmgp_cmp_readonly['citas_disponibles']) || (isset($bFlagRead_citas_disponibles) && $bFlagRead_citas_disponibles))
{
    $this->ajax_return_values_citas_disponibles(true);
}
if ($original_cantidadmodulistas !== $modificado_cantidadmodulistas || isset($this->nmgp_cmp_readonly['cantidadmodulistas']) || (isset($bFlagRead_cantidadmodulistas) && $bFlagRead_cantidadmodulistas))
{
    $this->ajax_return_values_cantidadmodulistas(true);
}
if ($original_cantidadmodulistas !== $modificado_cantidadmodulistas || isset($this->nmgp_cmp_readonly['cantidadmodulistas']) || (isset($bFlagRead_cantidadmodulistas) && $bFlagRead_cantidadmodulistas))
{
    $this->ajax_return_values_cantidadmodulistas(true);
}
$this->NM_ajax_info['event_field'] = 'cantidadModulistas';
CALEN_MODULISTA_INGRESO_mob_pack_ajax_response();
exit;
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'off';
}
function calcular_horas_rango($inicio, $fin){
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
...
$this->rango_horas =$this->calcular_horas_rango($this->horainicio ,$this->horafin );



$modificado_rango_horas = $this->rango_horas;
$modificado_horainicio = $this->horainicio;
$modificado_horafin = $this->horafin;
$modificado_descripcion = $this->descripcion;
$modificado_horafin = $this->horafin;
$modificado_horainicio = $this->horainicio;
$this->nm_formatar_campos('rango_horas', 'horainicio', 'horafin', 'descripcion');
if ($original_rango_horas !== $modificado_rango_horas || isset($this->nmgp_cmp_readonly['rango_horas']) || (isset($bFlagRead_rango_horas) && $bFlagRead_rango_horas))
{
    $this->ajax_return_values_rango_horas(true);
}
...
$this->NM_ajax_info['event_field'] = 'horaFin';
CALEN_MODULISTA_INGRESO_mob_pack_ajax_response();
exit;
...
function idtipodeModulista_onChange()
{
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
  
$original_descripcion = $this->descripcion;

if($idtipomodulista =2){
$this->descripcion ="Salida";
}

$modificado_descripcion = $this->descripcion;
$this->nm_formatar_campos('descripcion');
if ($original_descripcion !== $modificado_descripcion || isset($this->nmgp_cmp_readonly['descripcion']) || (isset($bFlagRead_descripcion) && $bFlagRead_descripcion))
{
    $this->ajax_return_values_descripcion(true);
}
$this->NM_ajax_info['event_field'] = 'idtipodeModulista';
CALEN_MODULISTA_INGRESO_mob_pack_ajax_response();
exit;
...
function sumarFecha($fecha, $i){
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
  	
	$add='+';
	$add=$add . $i . ' day';
	$fechaformat= date ('Y-m-d', strtotime($fecha));
	$nuevafecha = strtotime ( $add , strtotime ( $fechaformat ) ) ;
	$nuevafecha = date ( 'Y-m-d' , $nuevafecha );		
	return $nuevafecha;

$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'off';
}
function sumarHora($hora, $j){
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
  
	$add='+';
	$add=$add . $j . ' hour';
	$horaFormat= date ('H:i:s', strtotime($hora));
	$nuevafecha = strtotime ( $add , strtotime ( $horaFormat ) ) ;
...
function insert($horaInicio, $horaFin, $fechaInicio, $fechaFin ){
$_SESSION['scriptcase']['CALEN_MODULISTA_INGRESO_mob']['contr_erro'] = 'on';
  
	$insert_table  = 'asignacionmodulista';      
	$insert_fields = array(   
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("CALEN_MODULISTA_INGRESO_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['sc_outra_jan'] != 'CALEN_MODULISTA_INGRESO_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
@media (max-width: 853px) {
 ...
 <script type="text/javascript">
  ...
  function calendar_print() {
      $.ajax({
          url: 'CALEN_MODULISTA_INGRESO_mob.php',
          type: 'GET',
          dataType: 'json',
          data: {
...
?>
      events: 'CALEN_MODULISTA_INGRESO_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'CALEN_MODULISTA_INGRESO_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'CALEN_MODULISTA_INGRESO_mob.php?nmgp_opcao=igual_calendar&idasignacionmodulista=' + calEvent.id + '&__orig_idasignacionmodulista=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
?>
      ...
      eventResize: function(event, delta, revertFunc) {
        $.post(
          'CALEN_MODULISTA_INGRESO_mob.php',
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'CALEN_MODULISTA_INGRESO_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'CALEN_MODULISTA_INGRESO_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<form name="F1" id="sc-ui-form" method="post"
      action="CALEN_MODULISTA_INGRESO.php"
      target="_self">
...
<?php
   ...
   function calendarFetchSelect($googleInfo = false)
   {
       ...
       $aSelect['description'] = "descripcion";
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_cantidad_dias()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "1 Dia?#?1?#?N?@?";
       $nmgp_def_dados .= "2 Dias?#?2?#?N?@?";
       $nmgp_def_dados .= "3 Dias?#?3?#?N?@?";
       $nmgp_def_dados .= "4 Dias?#?4?#?N?@?";
       $nmgp_def_dados .= "5 Dias?#?5?#?N?@?";
       $nmgp_def_dados .= "6 Dias?#?6?#?N?@?";
       $nmgp_def_dados .= "7 Dias?#?7?#?N?@?";
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_CALEN_MODULISTA_INGRESO_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['total'] = $qt_geral_reg_CALEN_MODULISTA_INGRESO_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          CALEN_MODULISTA_INGRESO_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idasignacionmodulista";$nm_numeric[] = "cantidadmodulistas";$nm_numeric[] = "idtipodemodulista";$nm_numeric[] = "category";$nm_numeric[] = "citas_disponibles";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "CALEN_MODULISTA_INGRESO_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "CALEN_MODULISTA_INGRESO_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['CALEN_MODULISTA_INGRESO_mob']['masterValue']))
{
