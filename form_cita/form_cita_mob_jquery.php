...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fechainicio_hora' + iSeqRow).bind('blur', function() { sc_form_cita_fechainicio_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_cita_fechainicio_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_cita_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechainicio" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cita_mob_validate_fechainicio(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
