  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cita_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cita_mob_form();
	}

  // ---------- Validate idpiloto
  function do_ajax_form_cita_mob_validate_idpiloto()
  {
  } // do_ajax_form_cita_mob_validate_idpiloto

  function do_ajax_form_cita_mob_validate_idpiloto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_idpiloto_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_cita_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_cita_mob_validate_sc_field_1_cb);
  } // do_ajax_form_cita_mob_validate_sc_field_1

  function do_ajax_form_cita_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_sc_field_1_cb

  // ---------- Validate idcontenedor
  function do_ajax_form_cita_mob_validate_idcontenedor()
  {
  } // do_ajax_form_cita_mob_validate_idcontenedor

  function do_ajax_form_cita_mob_validate_idcontenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcontenedor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_idcontenedor_cb

  // ---------- Validate idcabezal
  function do_ajax_form_cita_mob_validate_idcabezal()
  {
  } // do_ajax_form_cita_mob_validate_idcabezal

  function do_ajax_form_cita_mob_validate_idcabezal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_idcabezal_cb

  // ---------- Validate fechainicio
  function do_ajax_form_cita_mob_validate_fechainicio()
  {
    var nomeCampo_fechainicio = "fechainicio";
    var var_fechainicio = scAjaxGetFieldHidden(nomeCampo_fechainicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_fechainicio(var_fechainicio, var_script_case_init, do_ajax_form_cita_mob_validate_fechainicio_cb);
  } // do_ajax_form_cita_mob_validate_fechainicio

  function do_ajax_form_cita_mob_validate_fechainicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_fechainicio_cb

  // ---------- Validate codigo_cita
  function do_ajax_form_cita_mob_validate_codigo_cita()
  {
    var nomeCampo_codigo_cita = "codigo_cita";
    var var_codigo_cita = scAjaxGetFieldHidden(nomeCampo_codigo_cita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_codigo_cita(var_codigo_cita, var_script_case_init, do_ajax_form_cita_mob_validate_codigo_cita_cb);
  } // do_ajax_form_cita_mob_validate_codigo_cita

  function do_ajax_form_cita_mob_validate_codigo_cita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_codigo_cita_cb

  // ---------- Validate idnaviera
  function do_ajax_form_cita_mob_validate_idnaviera()
  {
  } // do_ajax_form_cita_mob_validate_idnaviera

  function do_ajax_form_cita_mob_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_idnaviera_cb

  // ---------- Validate idtipodecarga
  function do_ajax_form_cita_mob_validate_idtipodecarga()
  {
    var nomeCampo_idtipodecarga = "idtipodecarga";
    var var_idtipodecarga = scAjaxGetFieldSelect(nomeCampo_idtipodecarga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_idtipodecarga(var_idtipodecarga, var_script_case_init, do_ajax_form_cita_mob_validate_idtipodecarga_cb);
  } // do_ajax_form_cita_mob_validate_idtipodecarga

  function do_ajax_form_cita_mob_validate_idtipodecarga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_idtipodecarga_cb

  // ---------- Validate descripcion
  function do_ajax_form_cita_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_cita_mob_validate_descripcion_cb);
  } // do_ajax_form_cita_mob_validate_descripcion

  function do_ajax_form_cita_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_descripcion_cb

  // ---------- Validate numcontenedor
  function do_ajax_form_cita_mob_validate_numcontenedor()
  {
    var nomeCampo_numcontenedor = "numcontenedor";
    var var_numcontenedor = scAjaxGetFieldHidden(nomeCampo_numcontenedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_numcontenedor(var_numcontenedor, var_script_case_init, do_ajax_form_cita_mob_validate_numcontenedor_cb);
  } // do_ajax_form_cita_mob_validate_numcontenedor

  function do_ajax_form_cita_mob_validate_numcontenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numcontenedor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_numcontenedor_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_cita_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldHidden(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_cita_mob_validate_sc_field_0_cb);
  } // do_ajax_form_cita_mob_validate_sc_field_0

  function do_ajax_form_cita_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_sc_field_0_cb

  // ---------- Validate nombre
  function do_ajax_form_cita_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldHidden(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cita_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_cita_mob_validate_nombre_cb);
  } // do_ajax_form_cita_mob_validate_nombre

  function do_ajax_form_cita_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cita_mob_validate_nombre_cb

  // ---------- Event onblur horainicio
  function do_ajax_form_cita_mob_event_horainicio_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_cita_mob_event_horainicio_onblur(var_fechainicio, var_contenedor, var_descripcion, var_script_case_init, do_ajax_form_cita_mob_event_horainicio_onblur_cb);
  } // do_ajax_form_cita_mob_event_horainicio_onblur

  function do_ajax_form_cita_mob_event_horainicio_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cita_mob_event_horainicio_onblur_cb_after_alert);
  } // do_ajax_form_cita_mob_event_horainicio_onblur_cb
  function do_ajax_form_cita_mob_event_horainicio_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cita_mob_event_horainicio_onblur_cb_after_alert

  // ---------- Event onchange idcontenedor
  function do_ajax_form_cita_mob_event_idcontenedor_onchange()
  {
    var var_idcontenedor = scAjaxGetFieldText("idcontenedor");
    var var_numcontenedor = scAjaxGetFieldHidden("numcontenedor");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cita_mob_event_idcontenedor_onchange(var_idcontenedor, var_numcontenedor, var_script_case_init, do_ajax_form_cita_mob_event_idcontenedor_onchange_cb);
  } // do_ajax_form_cita_mob_event_idcontenedor_onchange

  function do_ajax_form_cita_mob_event_idcontenedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idcontenedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cita_mob_event_idcontenedor_onchange_cb_after_alert);
  } // do_ajax_form_cita_mob_event_idcontenedor_onchange_cb
  function do_ajax_form_cita_mob_event_idcontenedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cita_mob_event_idcontenedor_onchange_cb_after_alert

  // ---------- Event onchange idcabezal
  function do_ajax_form_cita_mob_event_idcabezal_onchange()
  {
    var var_codigo_cita = scAjaxGetFieldHidden("codigo_cita");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cita_mob_event_idcabezal_onchange(var_codigo_cita, var_sc_field_1, var_numcontenedor, var_fechainicio, var_idcabezal, var_script_case_init, do_ajax_form_cita_mob_event_idcabezal_onchange_cb);
  } // do_ajax_form_cita_mob_event_idcabezal_onchange

  function do_ajax_form_cita_mob_event_idcabezal_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idcabezal";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cita_mob_event_idcabezal_onchange_cb_after_alert);
  } // do_ajax_form_cita_mob_event_idcabezal_onchange_cb
  function do_ajax_form_cita_mob_event_idcabezal_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cita_mob_event_idcabezal_onchange_cb_after_alert

  // ---------- Event onchange idpiloto
  function do_ajax_form_cita_mob_event_idpiloto_onchange()
  {
    var var_idpiloto = scAjaxGetFieldText("idpiloto");
    var var_sc_field_1 = scAjaxGetFieldText("sc_field_1");
    var var_nombre = scAjaxGetFieldHidden("nombre");
    var var_sc_field_0 = scAjaxGetFieldHidden("sc_field_0");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cita_mob_event_idpiloto_onchange(var_idpiloto, var_sc_field_1, var_nombre, var_sc_field_0, var_script_case_init, do_ajax_form_cita_mob_event_idpiloto_onchange_cb);
  } // do_ajax_form_cita_mob_event_idpiloto_onchange

  function do_ajax_form_cita_mob_event_idpiloto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpiloto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cita_mob_event_idpiloto_onchange_cb_after_alert);
  } // do_ajax_form_cita_mob_event_idpiloto_onchange_cb
  function do_ajax_form_cita_mob_event_idpiloto_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cita_mob_event_idpiloto_onchange_cb_after_alert

  // ---------- Event onchange idtipodecarga
  function do_ajax_form_cita_mob_event_idtipodecarga_onchange()
  {
    var var_codigo_cita = scAjaxGetFieldHidden("codigo_cita");
    var var_idcabezal = scAjaxGetFieldText("idcabezal");
    var var_fechainicio = scAjaxGetFieldHidden("fechainicio");
    var var_idnaviera = scAjaxGetFieldText("idnaviera");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_numcontenedor = scAjaxGetFieldHidden("numcontenedor");
    var var_resultado = scAjaxGetFieldText("resultado");
    var var_nombre = scAjaxGetFieldHidden("nombre");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cita_mob_event_idtipodecarga_onchange(var_codigo_cita, var_idcabezal, var_fechainicio, var_idnaviera, var_descripcion, var_numcontenedor, var_resultado, var_nombre, var_script_case_init, do_ajax_form_cita_mob_event_idtipodecarga_onchange_cb);
  } // do_ajax_form_cita_mob_event_idtipodecarga_onchange

  function do_ajax_form_cita_mob_event_idtipodecarga_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idtipodecarga";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cita_mob_event_idtipodecarga_onchange_cb_after_alert);
  } // do_ajax_form_cita_mob_event_idtipodecarga_onchange_cb
  function do_ajax_form_cita_mob_event_idtipodecarga_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cita_mob_event_idtipodecarga_onchange_cb_after_alert

  // ---------- Event onclick placa
  function do_ajax_form_cita_mob_event_placa_onclick()
  {
    var var_fechainicio = scAjaxGetFieldHidden("fechainicio");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cita_mob_event_placa_onclick(var_fechainicio, var_script_case_init, do_ajax_form_cita_mob_event_placa_onclick_cb);
  } // do_ajax_form_cita_mob_event_placa_onclick

  function do_ajax_form_cita_mob_event_placa_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "placa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cita_mob_event_placa_onclick_cb_after_alert);
  } // do_ajax_form_cita_mob_event_placa_onclick_cb
  function do_ajax_form_cita_mob_event_placa_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cita_mob_event_placa_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cita_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cita_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpiloto = scAjaxGetFieldText("idpiloto");
    ...
    scAjaxProcOn();
    x_ajax_form_cita_mob_submit_form(var_idpiloto, var_sc_field_1, var_idcontenedor, var_idcabezal, var_fechainicio, var_codigo_cita, var_idnaviera, var_idtipodecarga, var_descripcion, var_numcontenedor, var_sc_field_0, var_nombre, var_idcita, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cita_mob_submit_form_cb);
  } // do_ajax_form_cita_mob_submit_form

  function do_ajax_form_cita_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idcontenedor");
      ...
      scAjaxHideErrorDisplay("numcontenedor");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cita_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cita_mob_submit_form_cb
  function do_ajax_form_cita_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cita_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cita_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cita_mob_navigate_form(var_idcita, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cita_mob_navigate_form_cb);
  } // do_ajax_form_cita_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cita_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cita_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cita_mob_navigate_form_cb
  function do_ajax_form_cita_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('');
...
{
?>
    do_ajax_form_cita_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cita_mob_navigate_form_cb_after_alert
  function sc_hide_form_cita_mob_form()
  {
  ...
  function do_ajax_form_cita_mob_lkpedt_refresh_idpiloto()
  {
    var var_idpiloto = scAjaxGetFieldText("idpiloto");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "idpiloto";
    x_ajax_form_cita_mob_lkpedt_refresh_idpiloto(var_idpiloto, nmgp_refresh_fields, var_script_case_init, do_ajax_form_cita_mob_lkpedt_refresh_idpiloto_cb);
  } // do_ajax_form_cita_mob_lkpedt_refresh_idpiloto

  function do_ajax_form_cita_mob_lkpedt_refresh_idpiloto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_cita_mob_lkpedt_refresh_idpiloto_cb

  function do_ajax_form_cita_mob_lkpedt_refresh_idcabezal()
  {
    var var_idcabezal = scAjaxGetFieldText("idcabezal");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "idcabezal";
    x_ajax_form_cita_mob_lkpedt_refresh_idcabezal(var_idcabezal, nmgp_refresh_fields, var_script_case_init, do_ajax_form_cita_mob_lkpedt_refresh_idcabezal_cb);
  } // do_ajax_form_cita_mob_lkpedt_refresh_idcabezal

  function do_ajax_form_cita_mob_lkpedt_refresh_idcabezal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_cita_mob_lkpedt_refresh_idcabezal_cb
  ...
  ajax_field_list[0] = "idpiloto";
  ajax_field_list[1] = "sc_field_1";
  ajax_field_list[2] = "idcontenedor";
  ajax_field_list[3] = "idcabezal";
  ajax_field_list[4] = "fechainicio";
  ajax_field_list[5] = "codigo_cita";
  ajax_field_list[6] = "idnaviera";
  ajax_field_list[7] = "idtipodecarga";
  ajax_field_list[8] = "descripcion";
  ajax_field_list[9] = "numcontenedor";
  ajax_field_list[10] = "sc_field_0";
  ajax_field_list[11] = "nombre";
  ...
  var ajax_error_list = {
    ...
    "sc_field_1": {"label": "Nombre Piloto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcontenedor": {"label": "# Contenedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcabezal": {"label": "Placa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechainicio": {"label": "Fecha Llegada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "numcontenedor": {"label": "CONTENEDOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "LICENCIA PILOTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre": {"label": "PILOTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["numcontenedor"][1] = "numcontenedor";
  ...
  var ajax_field_id = {
    ...
    "idcontenedor": new Array("hidden_field_label_idcontenedor", "hidden_field_data_idcontenedor"),
    ...
    "numcontenedor": new Array("hidden_field_label_numcontenedor", "hidden_field_data_numcontenedor"),
