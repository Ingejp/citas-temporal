...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____comprobante_registro"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____comprobante_registro"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['comprobante_registro']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['comprobante_registro']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['comprobante_registro']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['comprobante_registro']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['comprobante_registro']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>comprobante_registro</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['comprobante_registro']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['comprobante_registro']['embutida_filho'] as $ind => $sc_init)
          {
