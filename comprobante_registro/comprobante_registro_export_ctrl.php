<?php
@session_start() ;
$_SESSION['scriptcase']['comprobante_registro']['sc_process_barr'] = true;
require_once('../comprobante_registro/index.php');
unset($_SESSION['scriptcase']['comprobante_registro']['sc_process_barr']);
$ExportCtrl = new comprobante_registro_export_control;
$ExportCtrl->Export_barr();

class comprobante_registro_export_control
{
...
<HEAD>
 <TITLE>REGISTRO DE INGRESO A PRE PUERTO :: Excel</TITLE>
