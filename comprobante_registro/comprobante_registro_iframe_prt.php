...
if (!isset($_SESSION['sc_session']))
{
    ...
    if (is_file($root . $_SESSION['scriptcase']['comprobante_registro']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
    {
?>
<html>
 <body>
...
<?php
 ...
 $SC_module_export = (isset($_GET['SC_module_export'])) ? filter_input(INPUT_GET, 'SC_module_export', FILTER_SANITIZE_STRING) : "n";
 $apl_tipo_print   =  "RC";
 $apl_cor_print    =  "PB";
...
<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
 <head>
  <title>comprobante_registro :: PRINT</title>
