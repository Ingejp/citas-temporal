...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____search_cita"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____search_cita"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['search_cita']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['search_cita']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['search_cita']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['search_cita']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['search_cita']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['search_cita']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['search_cita']['embutida_filho'] as $ind => $sc_init)
          {
