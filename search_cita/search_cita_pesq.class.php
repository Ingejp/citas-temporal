...
<INPUT  type="text" id="SC_turno" name="turno" value="<?php echo NM_encode_input($turno) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idcita_cond" name="idcita_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcita'), this, 'idcita')">
...
<INPUT  type="text" id="SC_idcita" name="idcita" value="<?php echo NM_encode_input($idcita) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codigo_cita_cond" name="codigo_cita_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_cita'), this, 'codigo_cita')">
...
<INPUT  type="text" id="SC_codigo_cita" name="codigo_cita" value="<?php echo NM_encode_input($codigo_cita) ?>"  size=50 alt="{datatype: 'text', maxLength: 180, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_contenedorimport_cond" name="contenedorimport_cond" onChange="nm_campos_between(document.getElementById('id_vis_contenedorimport'), this, 'contenedorimport')">
