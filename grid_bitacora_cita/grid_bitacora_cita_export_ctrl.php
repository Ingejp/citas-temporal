<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bitacora_cita']['sc_process_barr'] = true;
require_once('../grid_bitacora_cita/index.php');
unset($_SESSION['scriptcase']['grid_bitacora_cita']['sc_process_barr']);
$ExportCtrl = new grid_bitacora_cita_export_control;
$ExportCtrl->Export_barr();

class grid_bitacora_cita_export_control
{
