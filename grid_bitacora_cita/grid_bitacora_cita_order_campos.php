...
<?php
   ...
   $Ord_Cmp = new grid_bitacora_cita_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_bitacora_cita_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["fecha"] : "FECHA";
   $tab_ger_campos['descripcion_yarda'] = "on";
   $tab_def_campos['descripcion_yarda'] = "descripcion_yarda";
   $tab_labels["descripcion_yarda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["descripcion_yarda"])) ? $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["descripcion_yarda"] : "UBICACION";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["descripcion"] : "REGISTRO";
   $tab_ger_campos['estadia_horas'] = "on";
   $tab_def_campos['estadia_horas'] = "Estadia_Horas";
   $tab_labels["estadia_horas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["estadia_horas"])) ? $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['labels']["estadia_horas"] : "Estadia Horas";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_bitacora_cita_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_bitacora_cita']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
