...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_bitacora_cita"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_bitacora_cita"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bitacora_cita']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_bitacora_cita']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bitacora_cita']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_bitacora_cita']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_bitacora_cita']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_bitacora_cita</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_bitacora_cita']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_bitacora_cita']['embutida_filho'] as $ind => $sc_init)
          {
