...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_EIR_form();
	}

  // ---------- Validate id_condicion
  function do_ajax_form_EIR_validate_id_condicion()
  {
    var nomeCampo_id_condicion = "id_condicion";
    var var_id_condicion = scAjaxGetFieldHidden(nomeCampo_id_condicion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_id_condicion(var_id_condicion, var_script_case_init, do_ajax_form_EIR_validate_id_condicion_cb);
  } // do_ajax_form_EIR_validate_id_condicion

  function do_ajax_form_EIR_validate_id_condicion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_id_condicion_cb

  // ---------- Validate sec_users_login
  function do_ajax_form_EIR_validate_sec_users_login()
  {
    var nomeCampo_sec_users_login = "sec_users_login";
    var var_sec_users_login = scAjaxGetFieldHidden(nomeCampo_sec_users_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_sec_users_login(var_sec_users_login, var_script_case_init, do_ajax_form_EIR_validate_sec_users_login_cb);
  } // do_ajax_form_EIR_validate_sec_users_login

  function do_ajax_form_EIR_validate_sec_users_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_sec_users_login_cb

  // ---------- Validate fecha
  function do_ajax_form_EIR_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_EIR_validate_fecha_cb);
  } // do_ajax_form_EIR_validate_fecha

  function do_ajax_form_EIR_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_fecha_cb

  // ---------- Validate tipomovimiento_idtipomovimiento
  function do_ajax_form_EIR_validate_tipomovimiento_idtipomovimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_tipomovimiento_idtipomovimiento(var_tipomovimiento_idtipomovimiento, var_script_case_init, do_ajax_form_EIR_validate_tipomovimiento_idtipomovimiento_cb);
  } // do_ajax_form_EIR_validate_tipomovimiento_idtipomovimiento

  function do_ajax_form_EIR_validate_tipomovimiento_idtipomovimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_tipomovimiento_idtipomovimiento_cb

  // ---------- Validate numero_contenedor
  function do_ajax_form_EIR_validate_numero_contenedor()
  {
  } // do_ajax_form_EIR_validate_numero_contenedor

  function do_ajax_form_EIR_validate_numero_contenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_numero_contenedor_cb

  // ---------- Validate idnaviera
  function do_ajax_form_EIR_validate_idnaviera()
  {
    var nomeCampo_idnaviera = "idnaviera";
    var var_idnaviera = scAjaxGetFieldSelect(nomeCampo_idnaviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_idnaviera(var_idnaviera, var_script_case_init, do_ajax_form_EIR_validate_idnaviera_cb);
  } // do_ajax_form_EIR_validate_idnaviera

  function do_ajax_form_EIR_validate_idnaviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_idnaviera_cb

  // ---------- Validate idyarda
  function do_ajax_form_EIR_validate_idyarda()
  {
    var nomeCampo_idyarda = "idyarda";
    var var_idyarda = scAjaxGetFieldSelect(nomeCampo_idyarda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_idyarda(var_idyarda, var_script_case_init, do_ajax_form_EIR_validate_idyarda_cb);
  } // do_ajax_form_EIR_validate_idyarda

  function do_ajax_form_EIR_validate_idyarda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idyarda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_idyarda_cb

  // ---------- Validate idtransporte
  function do_ajax_form_EIR_validate_idtransporte()
  {
  } // do_ajax_form_EIR_validate_idtransporte

  function do_ajax_form_EIR_validate_idtransporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_idtransporte_cb

  // ---------- Validate idcabezal
  function do_ajax_form_EIR_validate_idcabezal()
  {
  } // do_ajax_form_EIR_validate_idcabezal

  function do_ajax_form_EIR_validate_idcabezal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_idcabezal_cb

  // ---------- Validate cable
  function do_ajax_form_EIR_validate_cable()
  {
    var nomeCampo_cable = "cable";
    var var_cable = scAjaxGetFieldCheckbox(nomeCampo_cable, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_cable(var_cable, var_script_case_init, do_ajax_form_EIR_validate_cable_cb);
  } // do_ajax_form_EIR_validate_cable

  function do_ajax_form_EIR_validate_cable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cable";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_cable_cb

  // ---------- Validate plug
  function do_ajax_form_EIR_validate_plug()
  {
    var nomeCampo_plug = "plug";
    var var_plug = scAjaxGetFieldCheckbox(nomeCampo_plug, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_plug(var_plug, var_script_case_init, do_ajax_form_EIR_validate_plug_cb);
  } // do_ajax_form_EIR_validate_plug

  function do_ajax_form_EIR_validate_plug_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "plug";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_plug_cb

  // ---------- Validate medida
  function do_ajax_form_EIR_validate_medida()
  {
    var nomeCampo_medida = "medida";
    var var_medida = scAjaxGetFieldText(nomeCampo_medida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_medida(var_medida, var_script_case_init, do_ajax_form_EIR_validate_medida_cb);
  } // do_ajax_form_EIR_validate_medida

  function do_ajax_form_EIR_validate_medida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medida";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_medida_cb

  // ---------- Validate observaciones
  function do_ajax_form_EIR_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_EIR_validate_observaciones_cb);
  } // do_ajax_form_EIR_validate_observaciones

  function do_ajax_form_EIR_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_observaciones_cb

  // ---------- Validate fima
  function do_ajax_form_EIR_validate_fima()
  {
    var nomeCampo_fima = "fima";
    var var_fima = scAjaxGetFieldSignature(nomeCampo_fima);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_fima(var_fima, var_script_case_init, do_ajax_form_EIR_validate_fima_cb);
  } // do_ajax_form_EIR_validate_fima

  function do_ajax_form_EIR_validate_fima_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fima";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_fima_cb

  // ---------- Validate detalle
  function do_ajax_form_EIR_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_EIR_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_EIR_validate_detalle_cb);
  } // do_ajax_form_EIR_validate_detalle

  function do_ajax_form_EIR_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_EIR_validate_detalle_cb

  // ---------- Event onchange idnaviera
  function do_ajax_form_EIR_event_idnaviera_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_EIR_event_idnaviera_onchange(var_id_condicion, var_idcabezal, var_fecha, var_script_case_init, do_ajax_form_EIR_event_idnaviera_onchange_cb);
  } // do_ajax_form_EIR_event_idnaviera_onchange

  function do_ajax_form_EIR_event_idnaviera_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idnaviera";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_EIR_event_idnaviera_onchange_cb_after_alert);
  } // do_ajax_form_EIR_event_idnaviera_onchange_cb
  function do_ajax_form_EIR_event_idnaviera_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_EIR_event_idnaviera_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_EIR_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_EIR_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_condicion = scAjaxGetFieldHidden("id_condicion");
    ...
    scAjaxProcOn();
    x_ajax_form_EIR_submit_form(var_id_condicion, var_sec_users_login, var_fecha, var_tipomovimiento_idtipomovimiento, var_numero_contenedor, var_idnaviera, var_idyarda, var_idtransporte, var_idcabezal, var_cable, var_plug, var_medida, var_observaciones, var_fima, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_EIR_submit_form_cb);
  } // do_ajax_form_EIR_submit_form

  function do_ajax_form_EIR_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_EIR_submit_form_cb_after_alert);
  } // do_ajax_form_EIR_submit_form_cb
  function do_ajax_form_EIR_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_EIR_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detalle_condicion"] = "off";

  function do_ajax_form_EIR_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_EIR_navigate_form(var_id_condicion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_EIR_navigate_form_cb);
  } // do_ajax_form_EIR_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_EIR_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_EIR_navigate_form_cb_after_alert);
  } // do_ajax_form_EIR_navigate_form_cb
  function do_ajax_form_EIR_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_EIR_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_EIR_navigate_form_cb_after_alert
  function sc_hide_form_EIR_form()
  {
