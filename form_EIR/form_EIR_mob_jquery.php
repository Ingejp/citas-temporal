...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'observaciones':
      case 'fima':
        sc_exib_ocult_pag('form_EIR_mob_form0');
        break;
      case 'detalle':
        sc_exib_ocult_pag('form_EIR_mob_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecha_hora' + iSeqRow).bind('blur', function() { sc_form_EIR_fecha_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_EIR_fecha_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_EIR_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_EIR_mob_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
