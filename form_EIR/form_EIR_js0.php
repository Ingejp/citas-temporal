...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_EIR"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_detal']))
  {
?>  
...
function scForm_packSignature_multi() {
	...
	for (var Nm_x = 1; Nm_x < NM_count_mult; Nm_x++) {
		scAjaxGetFieldSignature("fima" + Nm_x);
	}
...
{
    document.getElementById('form_EIR_form0').style.width='1px';
    document.getElementById('form_EIR_form0').style.height='0px';
    document.getElementById('form_EIR_form0').style.display='none';
    document.getElementById('form_EIR_form0').style.overflow='scroll';
    document.getElementById('form_EIR_form1').style.width='1px';
    document.getElementById('form_EIR_form1').style.height='0px';
    document.getElementById('form_EIR_form1').style.display='none';
    document.getElementById('form_EIR_form1').style.overflow='scroll';
