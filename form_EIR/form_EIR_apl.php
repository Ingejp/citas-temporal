...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_EIR']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_EIR']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_EIR']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_EIR']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_EIR']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_EIR']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_EIR']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->idyarda)) 
          {
              $_SESSION['idyarda'] = $this->idyarda;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_EIR']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_EIR']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_EIR']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_EIR']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_EIR']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_EIR']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_EIR']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_EIR']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_EIR']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_EIR_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['initialize'])
          {
              $_SESSION['scriptcase']['form_EIR']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_EIR']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_EIR']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_EIR']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_EIR'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_EIR']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_EIR']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_EIR') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_EIR']['label'] = "REGISTRAR CONDICION";
      ...
      $_SESSION['scriptcase']['error_icon']['form_EIR']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_EIR'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_EIR']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_EIR'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_EIR'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_EIR/form_EIR_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_EIR_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_EIR_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_EIR_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_EIR/form_EIR_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_EIR_erro.class.php"); 
      }
      $this->Erro      = new form_EIR_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao']))
         { 
             if ($this->id_condicion != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_EIR']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['total']);
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dados_select'];
     }
   }
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_EIR_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_EIR_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_EIR.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_EIR_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_EIR"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_EIR']) || !is_array($this->NM_ajax_info['errList']['geral_form_EIR']))
              {
                  $this->NM_ajax_info['errList']['geral_form_EIR'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_EIR'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_fecha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['fecha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['fecha'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha" ; 
              if (!isset($Campos_Erros['fecha']))
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['fecha_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['fecha_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha" ; 
              if (!isset($Campos_Erros['fecha_hora']))
    ...
    function ValidateField_tipomovimiento_idtipomovimiento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->tipomovimiento_idtipomovimiento == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['tipomovimiento_idtipomovimiento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['tipomovimiento_idtipomovimiento'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->tipomovimiento_idtipomovimiento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_tipomovimiento_idtipomovimiento']) && !in_array($this->tipomovimiento_idtipomovimiento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_tipomovimiento_idtipomovimiento']))
          {
              $hasError = true;
    ...
    function ValidateField_numero_contenedor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['numero_contenedor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['numero_contenedor'] == "on")) 
      { 
...
;
    ...
    function ValidateField_idnaviera(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idnaviera == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['idnaviera']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['idnaviera'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idnaviera) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_idnaviera']) && !in_array($this->idnaviera, $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_idnaviera']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idnaviera']))
    ...
    function ValidateField_idyarda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idyarda == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['idyarda']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['idyarda'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "YARDA" ; 
          ...
          if (!empty($this->idyarda) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_idyarda']) && !in_array($this->idyarda, $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_idyarda']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idyarda']))
...
;
    ...
    function ValidateField_idcabezal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['idcabezal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['php_cmp_required']['idcabezal'] == "on")) 
      { 
          if ($this->idcabezal == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_medida(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->medida, 2, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "MEDIDA; " ; 
                  if (!isset($Campos_Erros['medida']))
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_condicion']['keyVal'] = form_EIR_pack_protect_string($this->nmgp_dados_form['id_condicion']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['foreign_key']['idcondicion'] = $this->nmgp_dados_form['id_condicion'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['where_filter'] = "idcondicion = " . $this->nmgp_dados_form['id_condicion'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['where_detal']  = "idcondicion = " . $this->nmgp_dados_form['id_condicion'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['total']);
          }
...
$aLookup[] = array(form_EIR_pack_protect_string('') => form_EIR_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_tipomovimiento_idtipomovimiento'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tipomovimiento_idtipomovimiento']['valList'][$i] = form_EIR_pack_protect_string($v);
          }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_EIR_pack_protect_string(NM_charset_to_utf8($this->numero_contenedor))]) ? $aLookup[0][form_EIR_pack_protect_string(NM_charset_to_utf8($this->numero_contenedor))] : "";
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_idnaviera'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idnaviera']['valList'][$i] = form_EIR_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_idyarda'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idyarda']['valList'][$i] = form_EIR_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_EIR_pack_protect_string(NM_charset_to_utf8($this->idtransporte))]) ? $aLookup[0][form_EIR_pack_protect_string(NM_charset_to_utf8($this->idtransporte))] : "";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_EIR_pack_protect_string(NM_charset_to_utf8($this->idcabezal))]) ? $aLookup[0][form_EIR_pack_protect_string(NM_charset_to_utf8($this->idcabezal))] : "";
...
$aLookup[] = array(form_EIR_pack_protect_string('SI') => form_EIR_pack_protect_string("SI"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_cable'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['cable']['valList'][$i] = form_EIR_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_EIR_pack_protect_string('SI') => form_EIR_pack_protect_string("SI"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['Lookup_plug'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['plug']['valList'][$i] = form_EIR_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_detalle($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_condicion)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opcao'] = '';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_EIR' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_EIR']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['parms'] = "id_condicion?#?$this->id_condicion?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['form_detalle_condicion_script_case_init'] ]['form_detalle_condicion']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
        include_once("form_EIR_form0.php");
        include_once("form_EIR_form1.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_EIR = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['total'] = $qt_geral_reg_form_EIR;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_EIR_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_EIR_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_EIR_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_EIR']['masterValue'] as $cmp_master => $val_master)
        {
?>
