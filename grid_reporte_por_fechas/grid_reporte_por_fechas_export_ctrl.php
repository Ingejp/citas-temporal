<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reporte_por_fechas']['sc_process_barr'] = true;
require_once('../grid_reporte_por_fechas/index.php');
unset($_SESSION['scriptcase']['grid_reporte_por_fechas']['sc_process_barr']);
$ExportCtrl = new grid_reporte_por_fechas_export_control;
$ExportCtrl->Export_barr();

class grid_reporte_por_fechas_export_control
{
