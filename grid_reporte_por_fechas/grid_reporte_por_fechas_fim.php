...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_reporte_por_fechas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_reporte_por_fechas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_por_fechas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_por_fechas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_por_fechas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_por_fechas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_por_fechas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reporte_por_fechas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_por_fechas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reporte_por_fechas']['embutida_filho'] as $ind => $sc_init)
          {
