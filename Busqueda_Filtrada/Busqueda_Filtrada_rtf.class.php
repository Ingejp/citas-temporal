...
class Busqueda_Filtrada_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "Busqueda_Filtrada.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Busqueda_Filtrada']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Busqueda_Filtrada']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Busqueda_Filtrada']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Busqueda_Filtrada']['rtf_name']);
      }
   ...
   function NM_export_cabezal_placa()
   {
         ...
         $this->cabezal_placa = str_replace('<', '&lt;', $this->cabezal_placa);
         $this->cabezal_placa = str_replace('>', '&gt;', $this->cabezal_placa);
         $this->Texto_tag .= "<td>" . $this->cabezal_placa . "</td>\r\n";
   }
   //----- piloto_nombre
   function NM_export_piloto_nombre()
   {
         ...
         $this->piloto_nombre = str_replace('<', '&lt;', $this->piloto_nombre);
         $this->piloto_nombre = str_replace('>', '&gt;', $this->piloto_nombre);
         $this->Texto_tag .= "<td>" . $this->piloto_nombre . "</td>\r\n";
   }
   ...
   function NM_export_cita_contenedorimport()
   {
         ...
         $this->cita_contenedorimport = str_replace('<', '&lt;', $this->cita_contenedorimport);
         $this->cita_contenedorimport = str_replace('>', '&gt;', $this->cita_contenedorimport);
         $this->Texto_tag .= "<td>" . $this->cita_contenedorimport . "</td>\r\n";
   }
   ...
   function NM_export_cita_contenedorexport()
   {
         ...
         $this->cita_contenedorexport = str_replace('<', '&lt;', $this->cita_contenedorexport);
         $this->cita_contenedorexport = str_replace('>', '&gt;', $this->cita_contenedorexport);
         $this->Texto_tag .= "<td>" . $this->cita_contenedorexport . "</td>\r\n";
   }
   //----- naviera_naviera
   function NM_export_naviera_naviera()
   {
         ...
         $this->naviera_naviera = str_replace('<', '&lt;', $this->naviera_naviera);
         $this->naviera_naviera = str_replace('>', '&gt;', $this->naviera_naviera);
         $this->Texto_tag .= "<td>" . $this->naviera_naviera . "</td>\r\n";
   }
   //----- viaje_viaje
   function NM_export_viaje_viaje()
   {
         ...
         $this->viaje_viaje = str_replace('<', '&lt;', $this->viaje_viaje);
         $this->viaje_viaje = str_replace('>', '&gt;', $this->viaje_viaje);
         $this->Texto_tag .= "<td>" . $this->viaje_viaje . "</td>\r\n";
   }
   //----- cita_observaciones
   function NM_export_cita_observaciones()
   {
         ...
         $this->cita_observaciones = str_replace('<', '&lt;', $this->cita_observaciones);
         $this->cita_observaciones = str_replace('>', '&gt;', $this->cita_observaciones);
         $this->Texto_tag .= "<td>" . $this->cita_observaciones . "</td>\r\n";
   }
   //----- cita_atc_ingreso
   function NM_export_cita_atc_ingreso()
   {
         ...
         $this->cita_atc_ingreso = str_replace('<', '&lt;', $this->cita_atc_ingreso);
         $this->cita_atc_ingreso = str_replace('>', '&gt;', $this->cita_atc_ingreso);
         $this->Texto_tag .= "<td>" . $this->cita_atc_ingreso . "</td>\r\n";
   }
   ...
   function NM_export_cita_marchamo_ingreso()
   {
         ...
         $this->cita_marchamo_ingreso = str_replace('<', '&lt;', $this->cita_marchamo_ingreso);
         $this->cita_marchamo_ingreso = str_replace('>', '&gt;', $this->cita_marchamo_ingreso);
         $this->Texto_tag .= "<td>" . $this->cita_marchamo_ingreso . "</td>\r\n";
   }
   //----- cita_atc_despacho
   function NM_export_cita_atc_despacho()
   {
         ...
         $this->cita_atc_despacho = str_replace('<', '&lt;', $this->cita_atc_despacho);
         $this->cita_atc_despacho = str_replace('>', '&gt;', $this->cita_atc_despacho);
         $this->Texto_tag .= "<td>" . $this->cita_atc_despacho . "</td>\r\n";
   }
   ...
   function NM_export_cita_marchamo_despacho()
   {
         ...
         $this->cita_marchamo_despacho = str_replace('<', '&lt;', $this->cita_marchamo_despacho);
         $this->cita_marchamo_despacho = str_replace('>', '&gt;', $this->cita_marchamo_despacho);
         $this->Texto_tag .= "<td>" . $this->cita_marchamo_despacho . "</td>\r\n";
   }
   ...
   function NM_export_tipodecarga_descripcion()
   {
         ...
         $this->tipodecarga_descripcion = str_replace('<', '&lt;', $this->tipodecarga_descripcion);
         $this->tipodecarga_descripcion = str_replace('>', '&gt;', $this->tipodecarga_descripcion);
         $this->Texto_tag .= "<td>" . $this->tipodecarga_descripcion . "</td>\r\n";
   }
   ...
   function NM_export_yarda_descripcion_yarda()
   {
         ...
         $this->yarda_descripcion_yarda = str_replace('<', '&lt;', $this->yarda_descripcion_yarda);
         $this->yarda_descripcion_yarda = str_replace('>', '&gt;', $this->yarda_descripcion_yarda);
         $this->Texto_tag .= "<td>" . $this->yarda_descripcion_yarda . "</td>\r\n";
   }
   //----- cita_idcita
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Busqueda_Filtrada']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Busqueda_Filtrada']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>REGISTRO INGRESO DE PLACAS :: RTF</TITLE>
