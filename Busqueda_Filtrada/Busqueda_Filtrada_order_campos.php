<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['Busqueda_Filtrada']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new Busqueda_Filtrada_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Busqueda_Filtrada_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['cita_fechainicio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_fechainicio'] = "cita_fechainicio";
   }
   else
   {
       $tab_def_campos['cita_fechainicio'] = "cita.fechaInicio";
   }
   $tab_labels["cita_fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_fechainicio"] : "Fecha";
   $tab_ger_campos['cabezal_placa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cabezal_placa'] = "cabezal_placa";
   }
   else
   {
       $tab_def_campos['cabezal_placa'] = "cabezal.placa";
   }
   $tab_labels["cabezal_placa"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cabezal_placa"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cabezal_placa"] : "Placa";
   $tab_ger_campos['piloto_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['piloto_nombre'] = "piloto_nombre";
   }
   else
   {
       $tab_def_campos['piloto_nombre'] = "piloto.nombre";
   }
   $tab_labels["piloto_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["piloto_nombre"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["piloto_nombre"] : "Nombre";
   $tab_ger_campos['cita_contenedorimport'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_contenedorimport'] = "cita_contenedorimport";
   }
   else
   {
       $tab_def_campos['cita_contenedorimport'] = "cita.contenedorimport";
   }
   $tab_labels["cita_contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_contenedorimport"] : "Importación";
   $tab_ger_campos['cita_contenedorexport'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_contenedorexport'] = "cita_contenedorexport";
   }
   else
   {
       $tab_def_campos['cita_contenedorexport'] = "cita.contenedorExport";
   }
   $tab_labels["cita_contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_contenedorexport"] : "Exportación";
   $tab_ger_campos['naviera_naviera'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['naviera_naviera'] = "naviera_naviera";
   }
   else
   {
       $tab_def_campos['naviera_naviera'] = "naviera.naviera";
   }
   $tab_labels["naviera_naviera"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["naviera_naviera"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["naviera_naviera"] : "Naviera";
   $tab_ger_campos['viaje_viaje'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['viaje_viaje'] = "viaje_viaje";
   }
   else
   {
       $tab_def_campos['viaje_viaje'] = "viaje.viaje";
   }
   $tab_labels["viaje_viaje"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["viaje_viaje"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["viaje_viaje"] : "Viaje";
   $tab_ger_campos['cita_observaciones'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_observaciones'] = "cita_observaciones";
   }
   else
   {
       $tab_def_campos['cita_observaciones'] = "cita.observaciones";
   }
   $tab_labels["cita_observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_observaciones"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_observaciones"] : "Observaciones";
   $tab_ger_campos['cita_atc_ingreso'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_atc_ingreso'] = "cita_atc_ingreso";
   }
   else
   {
       $tab_def_campos['cita_atc_ingreso'] = "cita.atc_ingreso";
   }
   $tab_labels["cita_atc_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_atc_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_atc_ingreso"] : "Atc Ingreso";
   $tab_ger_campos['cita_marchamo_ingreso'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_marchamo_ingreso'] = "cita_marchamo_ingreso";
   }
   else
   {
       $tab_def_campos['cita_marchamo_ingreso'] = "cita.marchamo_ingreso";
   }
   $tab_labels["cita_marchamo_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_marchamo_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_marchamo_ingreso"] : "Marchamo Ingreso";
   $tab_ger_campos['cita_atc_despacho'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_atc_despacho'] = "cita_atc_despacho";
   }
   else
   {
       $tab_def_campos['cita_atc_despacho'] = "cita.atc_despacho";
   }
   $tab_labels["cita_atc_despacho"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_atc_despacho"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_atc_despacho"] : "Atc Despacho";
   $tab_ger_campos['cita_marchamo_despacho'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_marchamo_despacho'] = "cita_marchamo_despacho";
   }
   else
   {
       $tab_def_campos['cita_marchamo_despacho'] = "cita.marchamo_despacho";
   }
   $tab_labels["cita_marchamo_despacho"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_marchamo_despacho"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["cita_marchamo_despacho"] : "Marchamo Despacho";
   $tab_ger_campos['tipodecarga_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipodecarga_descripcion'] = "tipodecarga_descripcion";
   }
   else
   {
       $tab_def_campos['tipodecarga_descripcion'] = "tipodecarga.descripcion";
   }
   $tab_labels["tipodecarga_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["tipodecarga_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["tipodecarga_descripcion"] : "Tipo";
   $tab_ger_campos['yarda_descripcion_yarda'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['yarda_descripcion_yarda'] = "yarda_descripcion_yarda";
   }
   else
   {
       $tab_def_campos['yarda_descripcion_yarda'] = "yarda.descripcion_yarda";
   }
   $tab_labels["yarda_descripcion_yarda"]   = (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["yarda_descripcion_yarda"])) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['labels']["yarda_descripcion_yarda"] : "Predio";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE>REGISTRO INGRESO DE PLACAS</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Busqueda_Filtrada_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Busqueda_Filtrada']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
