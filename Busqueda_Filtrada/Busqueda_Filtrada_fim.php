...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____Busqueda_Filtrada"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____Busqueda_Filtrada"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Busqueda_Filtrada']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Busqueda_Filtrada']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Busqueda_Filtrada']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Busqueda_Filtrada']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Busqueda_Filtrada']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Busqueda_Filtrada']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Busqueda_Filtrada']['embutida_filho'] as $ind => $sc_init)
          {
