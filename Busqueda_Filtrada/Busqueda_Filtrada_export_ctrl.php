<?php
@session_start() ;
$_SESSION['scriptcase']['Busqueda_Filtrada']['sc_process_barr'] = true;
require_once('../Busqueda_Filtrada/index.php');
unset($_SESSION['scriptcase']['Busqueda_Filtrada']['sc_process_barr']);
$ExportCtrl = new Busqueda_Filtrada_export_control;
$ExportCtrl->Export_barr();

class Busqueda_Filtrada_export_control
{
