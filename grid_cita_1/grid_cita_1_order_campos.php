<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_cita_1']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_cita_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cita_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['idcita'] = "idcita";
   }
   else
   {
       $tab_def_campos['idcita'] = "CONCAT(\"CUC_\",cita.idCita)";
   }
   $tab_labels["idcita"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["idcita"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["idcita"] : "Id Cita";
   $tab_ger_campos['cita_codigo_cita'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_codigo_cita'] = "cita_codigo_cita";
   }
   else
   {
       $tab_def_campos['cita_codigo_cita'] = "cita.codigo_cita";
   }
   $tab_labels["cita_codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_codigo_cita"] : "Codigo Cita";
   ...
   $tab_labels["cita_fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_fechainicio"] : "Fecha Inicio";
   $tab_ger_campos['cita_horainicio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_horainicio'] = "cita_horainicio";
   }
   else
   {
       $tab_def_campos['cita_horainicio'] = "cita.horaInicio";
   }
   $tab_labels["cita_horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_horainicio"] : "Hora Inicio";
   $tab_ger_campos['cita_idcontenedor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_idcontenedor'] = "cita_idcontenedor";
   }
   else
   {
       $tab_def_campos['cita_idcontenedor'] = "cita.idContenedor";
   }
   $tab_labels["cita_idcontenedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idcontenedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idcontenedor"] : "Contenedor";
   $tab_ger_campos['cita_idbuque'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_idbuque'] = "cita_idbuque";
   }
   else
   {
       $tab_def_campos['cita_idbuque'] = "cita.idBuque";
   }
   $tab_labels["cita_idbuque"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idbuque"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idbuque"] : "Buque";
   $tab_ger_campos['cita_idestado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_idestado'] = "cita_idestado";
   }
   else
   {
       $tab_def_campos['cita_idestado'] = "cita.idestado";
   }
   $tab_labels["cita_idestado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idestado"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idestado"] : "Estado";
   $tab_ger_campos['cita_idcabezal'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_idcabezal'] = "cita_idcabezal";
   }
   else
   {
       $tab_def_campos['cita_idcabezal'] = "cita.idcabezal";
   }
   $tab_labels["cita_idcabezal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idcabezal"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["cita_idcabezal"] : "Placa";
   $tab_ger_campos['pil_dpi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pil_dpi'] = "pil_dpi";
   }
   else
   {
       $tab_def_campos['pil_dpi'] = "pil.dpi";
   }
   $tab_labels["pil_dpi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["pil_dpi"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['labels']["pil_dpi"] : "Licencia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cita_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cita_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cita_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cita_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
