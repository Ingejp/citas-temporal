<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cita_1']['sc_process_barr'] = true;
require_once('../grid_cita_1/index.php');
unset($_SESSION['scriptcase']['grid_cita_1']['sc_process_barr']);
$ExportCtrl = new grid_cita_1_export_control;
$ExportCtrl->Export_barr();

class grid_cita_1_export_control
{
