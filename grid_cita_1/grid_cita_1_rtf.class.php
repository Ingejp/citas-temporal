...
class grid_cita_1_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cita_1']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cita_1']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cita_1']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cita_1']['rtf_name']);
      }
   ...
   function NM_export_cita_idbuque()
   {
         ...
         $this->look_cita_idbuque = str_replace('<', '&lt;', $this->look_cita_idbuque);
         $this->look_cita_idbuque = str_replace('>', '&gt;', $this->look_cita_idbuque);
         $this->Texto_tag .= "<td>" . $this->look_cita_idbuque . "</td>\r\n";
   }
   //----- cita_idestado
   ...
   function NM_export_pil_dpi()
   {
         ...
         $this->pil_dpi = str_replace('<', '&lt;', $this->pil_dpi);
         $this->pil_dpi = str_replace('>', '&gt;', $this->pil_dpi);
         $this->Texto_tag .= "<td>" . $this->pil_dpi . "</td>\r\n";
   }
   //----- cita_descripcion
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cita_1']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cita_1']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>CITAS SOLICITADAS :: RTF</TITLE>
