<?php
@session_start() ;
$_SESSION['scriptcase']['grid_estado']['sc_process_barr'] = true;
require_once('../grid_estado/index.php');
unset($_SESSION['scriptcase']['grid_estado']['sc_process_barr']);
$ExportCtrl = new grid_estado_export_control;
$ExportCtrl->Export_barr();

class grid_estado_export_control
{
