...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['revision']))
          {
              $this->revision = $this->NM_ajax_info['param']['revision'];
          }
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['TURNOS']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['TURNOS']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['TURNOS']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['TURNOS']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['TURNOS']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['TURNOS']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->idyarda)) 
          {
              $_SESSION['idyarda'] = $this->idyarda;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['TURNOS']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['TURNOS']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['TURNOS']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['TURNOS']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['TURNOS']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['TURNOS']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['TURNOS']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['TURNOS']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['TURNOS']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new TURNOS_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['initialize'])
          {
              $_SESSION['scriptcase']['TURNOS']['contr_erro'] = 'on';
  $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['start'] = 'new';
$_SESSION['scriptcase']['TURNOS']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['TURNOS']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['TURNOS']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['TURNOS'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['TURNOS']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['TURNOS']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('TURNOS') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['TURNOS']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " cita";
      ...
      $_SESSION['scriptcase']['error_icon']['TURNOS']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['TURNOS'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['TURNOS']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['TURNOS'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['TURNOS'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'TURNOS/TURNOS_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'TURNOS_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'TURNOS_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'TURNOS_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'TURNOS/TURNOS_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "TURNOS_erro.class.php"); 
      }
      $this->Erro      = new TURNOS_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao']))
         { 
             if ($this->idcita != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['TURNOS']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['final'];
      }
      else
      {
      }
...
//
      ...
      if (isset($this->idcita)) { $this->nm_limpa_alfa($this->idcita); }
      ...
      if (isset($this->revision)) { $this->nm_limpa_alfa($this->revision); }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['fechainicio']['date_display'] = "ddmmaaaa;hhiiss";
...
//
      ...
      {
          if ('validate_idcita' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idcita');
          }
          ...
          if ('validate_revision' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'revision');
          }
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idpiloto']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idpiloto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idpiloto']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idpiloto'] = array(); 
    }
   ...
   $nm_comando = "SELECT licencia, licencia FROM piloto WHERE licencia LIKE '%" . substr($this->Db->qstr($this->idpiloto), 1, -1) . "%' ORDER BY licencia";
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(TURNOS_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', TURNOS_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idpiloto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idcabezal']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idcabezal'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idcabezal']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idcabezal'] = array(); 
    }
   ...
   $nm_comando = "SELECT placa, placa FROM cabezal WHERE placa LIKE '%" . substr($this->Db->qstr($this->idcabezal), 1, -1) . "%' ORDER BY placa";
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idcabezal'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "TURNOS.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="TURNOS_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="TURNOS"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_TURNOS']) || !is_array($this->NM_ajax_info['errList']['geral_TURNOS']))
              {
                  $this->NM_ajax_info['errList']['geral_TURNOS'] = array();
              }
              $this->NM_ajax_info['errList']['geral_TURNOS'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'idcita' == $filtro)
        $this->ValidateField_idcita($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'revision' == $filtro)
        $this->ValidateField_revision($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_idcita(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $iTestSize = 11;
              if (strlen($this->idcita) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Id Cita: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idcita']))
                  {
                      $Campos_Erros['idcita'] = array();
                  }
                  $Campos_Erros['idcita'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['idcita']) || !is_array($this->NM_ajax_info['errList']['idcita']))
                  {
                      $this->NM_ajax_info['errList']['idcita'] = array();
                  }
                  $this->NM_ajax_info['errList']['idcita'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idcita, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Id Cita; " ; 
                  if (!isset($Campos_Erros['idcita']))
                  ...
                  $Campos_Erros['idcita'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['idcita']) || !is_array($this->NM_ajax_info['errList']['idcita']))
                  {
                      $this->NM_ajax_info['errList']['idcita'] = array();
                  }
                  $this->NM_ajax_info['errList']['idcita'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    function ValidateField_contenedorimport(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Contenedorimport " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 12 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_fechainicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['php_cmp_required']['fechainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['php_cmp_required']['fechainicio'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['php_cmp_required']['fechainicio_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['php_cmp_required']['fechainicio_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Inicio" ; 
              if (!isset($Campos_Erros['fechainicio_hora']))
    ...
    function ValidateField_idnaviera(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idnaviera) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idnaviera']) && !in_array($this->idnaviera, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idnaviera']))
               {
                   $hasError = true;
    ...
    function ValidateField_idtipodecarga(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipodecarga) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipodecarga']) && !in_array($this->idtipodecarga, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipodecarga']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idestado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idestado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idestado']) && !in_array($this->idestado, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idestado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idpiloto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Idpiloto " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 11 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_idcabezal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Idcabezal " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 11 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_idselectivo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idselectivo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idselectivo']) && !in_array($this->idselectivo, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idselectivo']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idyarda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idyarda) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idyarda']) && !in_array($this->idyarda, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idyarda']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idtipomovimiento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipomovimiento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipomovimiento']) && !in_array($this->idtipomovimiento, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipomovimiento']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idviaje(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idviaje) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idviaje']) && !in_array($this->idviaje, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idviaje']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_revision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->revision) > 2) 
          { 
              $hasError = true;
              $Campos_Crit .= "Revision " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['revision']))
              {
                  $Campos_Erros['revision'] = array();
              }
              $Campos_Erros['revision'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['revision']) || !is_array($this->NM_ajax_info['errList']['revision']))
              {
                  $this->NM_ajax_info['errList']['revision'] = array();
              }
              $this->NM_ajax_info['errList']['revision'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_sec_users_login(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sec_users_login) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login']) && !in_array($this->sec_users_login, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $Campos_Erros['sec_users_login'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $this->NM_ajax_info['errList']['sec_users_login'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->idcita || (!empty($format_fields) && isset($format_fields['idcita'])))
      {
          nmgp_Form_Num_Val($this->idcita, $this->field_config['idcita']['symbol_grp'], $this->field_config['idcita']['symbol_dec'], "0", "S", $this->field_config['idcita']['format_neg'], "", "", "-", $this->field_config['idcita']['symbol_fmt']) ; 
      }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_revision();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcita']['keyVal'] = TURNOS_pack_protect_string($this->nmgp_dados_form['idcita']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idnaviera']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idnaviera'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idnaviera']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idnaviera'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idnaviera'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idnaviera']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipodecarga']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipodecarga'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipodecarga']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipodecarga'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipodecarga'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodecarga']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idestado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idestado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idestado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idestado'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idestado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idestado']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][TURNOS_pack_protect_string(NM_charset_to_utf8($this->idpiloto))]) ? $aLookup[0][TURNOS_pack_protect_string(NM_charset_to_utf8($this->idpiloto))] : "";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][TURNOS_pack_protect_string(NM_charset_to_utf8($this->idcabezal))]) ? $aLookup[0][TURNOS_pack_protect_string(NM_charset_to_utf8($this->idcabezal))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idselectivo']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idselectivo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idselectivo']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idselectivo'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idselectivo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idselectivo']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idyarda']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idyarda'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idyarda']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idyarda'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idyarda'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idyarda']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipomovimiento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipomovimiento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipomovimiento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipomovimiento'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idtipomovimiento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipomovimiento']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idviaje']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idviaje'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idviaje']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idviaje'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_idviaje'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"idviaje\"";
          if (isset($this->NM_ajax_info['select_html']['idviaje']) && !empty($this->NM_ajax_info['select_html']['idviaje']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['idviaje'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->idviaje == $sValue)
                  {
                      $this->_tmp_lookup_idviaje = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['idviaje']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['idviaje']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_marchamo_ingreso($bForce = false)
   {
          ...
          //----- revision
   function ajax_return_values_revision($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("revision", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->revision);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['revision'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_sec_users_login($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("sec_users_login", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_sec_users_login = $this->sec_users_login;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"sec_users_login\"";
          if (isset($this->NM_ajax_info['select_html']['sec_users_login']) && !empty($this->NM_ajax_info['select_html']['sec_users_login']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['sec_users_login'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->sec_users_login == $sValue)
                  {
                      $this->_tmp_lookup_sec_users_login = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['sec_users_login']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['sec_users_login']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['sec_users_login']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['sec_users_login']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['sec_users_login']['labList'] = $aLabel;
          }
   }
...
$aLookup[] = array(TURNOS_pack_protect_string('1') => TURNOS_pack_protect_string("QR AUTOMATICO"));
$aLookup[] = array(TURNOS_pack_protect_string('2') => TURNOS_pack_protect_string("QR MANUAL"));
$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_tipo_qr'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_tipo_qr'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_qr']['valList'][$i] = TURNOS_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['TURNOS']['contr_erro'] = 'off'; 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      ...
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM bitacora_cita WHERE cita_idCita = " . $this->idcita ;
      }
      else
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM bitacora_cita WHERE cita_idCita = " . $this->idcita ;
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dataset_bitacora_cita = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                      $this->dataset_bitacora_cita[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      { 
          $this->dataset_bitacora_cita = false;
          $this->dataset_bitacora_cita_erro = $this->Db->ErrorMsg();
      } 
;

      if($this->dataset_bitacora_cita[0][0] > 0)
      {
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_TURNOS' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['TURNOS']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['revision'])) { $this->revision = $NM_val_form['revision']; }
              elseif (isset($this->revision)) { $this->nm_limpa_alfa($this->revision); }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['TURNOS']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['parms'] = "idcita?#?$this->idcita?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_TURNOS = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total'] = $qt_geral_reg_TURNOS;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idcita))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_TURNOS = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] > $qt_geral_reg_TURNOS)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] = $qt_geral_reg_TURNOS; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_TURNOS) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] < $qt_geral_reg_TURNOS;
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_sec_users_login()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_sec_users_login']))
{
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['empty_filter']);
      ...
      if ($field == "SC_all_Cmp") 
      {
          $data_lookup = $this->SC_lookup_idtipomovimiento($arg_search, $data_search);
          if (is_array($data_lookup) && !empty($data_lookup)) 
          {
              $this->SC_monta_condicao($comando, "idtipoMovimiento", $arg_search, $data_lookup);
          }
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "atc_ingreso", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "marchamo_ingreso", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "revision", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "atc_despacho", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "marchamo_despacho", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $data_lookup = $this->SC_lookup_sec_users_login($arg_search, $data_search);
          if (is_array($data_lookup) && !empty($data_lookup)) 
          {
              $this->SC_monta_condicao($comando, "sec_users_login", $arg_search, $data_lookup);
          }
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_TURNOS = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total'] = $qt_geral_reg_TURNOS;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          TURNOS_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_idnaviera($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT naviera, naviera FROM naviera WHERE (naviera LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
   ...
   function SC_lookup_idtipodecarga($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT descripcion, descripcion FROM tipodecarga WHERE (descripcion LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_idestado($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT estado, estado FROM estado WHERE (estado LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_idpiloto($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT licencia, licencia FROM piloto WHERE (licencia LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_idcabezal($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT placa, placa FROM cabezal WHERE (placa LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_idselectivo($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT selectivo, selectivo FROM selectivo WHERE (selectivo LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_idyarda($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT descripcion_yarda, descripcion_yarda FROM yarda WHERE (descripcion_yarda LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_idtipomovimiento($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT descripcion, descripcion FROM tipomovimiento WHERE (descripcion LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_idviaje($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT viaje, viaje FROM viaje WHERE (viaje LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%$campo%'", "LIKE '$campo%'", $nm_comando);
       }
   ...
   function SC_lookup_sec_users_login($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "TURNOS_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['nm_run_menu'] = 2;
       $nmgp_saida_form = "TURNOS_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['retorno_edit'] = "";
   }
