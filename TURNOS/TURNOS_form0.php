...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("TURNOS_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('TURNOS_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idpiloto", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_TURNOS_event_idpiloto_onchange) { do_ajax_TURNOS_event_idpiloto_onchange(sRow); }
    }
   }
  ...
  $(".sc-ui-autocomp-idcabezal", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idcabezal" != sId ? sId.substr(9) : "";
   sc_TURNOS_idcabezal_onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['TURNOS'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['TURNOS'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idcita_label" id="hidden_field_label_idcita" style="<?php echo $sStyleHidden_idcita; ?>"><span id="id_label_idcita"><?php echo $this->nm_new_label['idcita']; ?></span></TD>
    <TD class="scFormDataOdd css_idcita_line" id="hidden_field_data_idcita" style="<?php echo $sStyleHidden_idcita; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcita_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_idcita" class="css_idcita_line" style="<?php echo $sStyleReadLab_idcita; ?>"><?php echo $this->form_encode_input($this->idcita); ?></span><span id="id_read_off_idcita" class="css_read_off_idcita" style="<?php echo $sStyleReadInp_idcita; ?>"><input type="hidden" name="idcita" value="<?php echo $this->form_encode_input($idcita) . "\">"?><span id="id_ajax_label_idcita"><?php echo nl2br($idcita); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigo_cita_line" id="hidden_field_data_codigo_cita" style="<?php echo $sStyleHidden_codigo_cita; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_cita_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_contenedorimport_label" id="hidden_field_label_contenedorimport" style="<?php echo $sStyleHidden_contenedorimport; ?>"><span id="id_label_contenedorimport"><?php echo $this->nm_new_label['contenedorimport']; ?></span></TD>
    <TD class="scFormDataOdd css_contenedorimport_line" id="hidden_field_data_contenedorimport" style="<?php echo $sStyleHidden_contenedorimport; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contenedorimport_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_contenedorexport_label" id="hidden_field_label_contenedorexport" style="<?php echo $sStyleHidden_contenedorexport; ?>"><span id="id_label_contenedorexport"><?php echo $this->nm_new_label['contenedorexport']; ?></span></TD>
    <TD class="scFormDataOdd css_contenedorexport_line" id="hidden_field_data_contenedorexport" style="<?php echo $sStyleHidden_contenedorexport; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contenedorexport_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechainicio_label" id="hidden_field_label_fechainicio" style="<?php echo $sStyleHidden_fechainicio; ?>"><span id="id_label_fechainicio"><?php echo $this->nm_new_label['fechainicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['php_cmp_required']['fechainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['php_cmp_required']['fechainicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fechainicio_line" id="hidden_field_data_fechainicio" style="<?php echo $sStyleHidden_fechainicio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechainicio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_chasis_line" id="hidden_field_data_chasis" style="<?php echo $sStyleHidden_chasis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_chasis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idnaviera_label" id="hidden_field_label_idnaviera" style="<?php echo $sStyleHidden_idnaviera; ?>"><span id="id_label_idnaviera"><?php echo $this->nm_new_label['idnaviera']; ?></span></TD>
    <TD class="scFormDataOdd css_idnaviera_line" id="hidden_field_data_idnaviera" style="<?php echo $sStyleHidden_idnaviera; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idnaviera_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idtipodecarga_label" id="hidden_field_label_idtipodecarga" style="<?php echo $sStyleHidden_idtipodecarga; ?>"><span id="id_label_idtipodecarga"><?php echo $this->nm_new_label['idtipodecarga']; ?></span></TD>
    <TD class="scFormDataOdd css_idtipodecarga_line" id="hidden_field_data_idtipodecarga" style="<?php echo $sStyleHidden_idtipodecarga; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtipodecarga_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idestado_label" id="hidden_field_label_idestado" style="<?php echo $sStyleHidden_idestado; ?>"><span id="id_label_idestado"><?php echo $this->nm_new_label['idestado']; ?></span></TD>
    <TD class="scFormDataOdd css_idestado_line" id="hidden_field_data_idestado" style="<?php echo $sStyleHidden_idestado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idestado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idpiloto_label" id="hidden_field_label_idpiloto" style="<?php echo $sStyleHidden_idpiloto; ?>"><span id="id_label_idpiloto"><?php echo $this->nm_new_label['idpiloto']; ?></span></TD>
    <TD class="scFormDataOdd css_idpiloto_line" id="hidden_field_data_idpiloto" style="<?php echo $sStyleHidden_idpiloto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idpiloto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idcabezal_label" id="hidden_field_label_idcabezal" style="<?php echo $sStyleHidden_idcabezal; ?>"><span id="id_label_idcabezal"><?php echo $this->nm_new_label['idcabezal']; ?></span></TD>
    <TD class="scFormDataOdd css_idcabezal_line" id="hidden_field_data_idcabezal" style="<?php echo $sStyleHidden_idcabezal; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcabezal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idselectivo_label" id="hidden_field_label_idselectivo" style="<?php echo $sStyleHidden_idselectivo; ?>"><span id="id_label_idselectivo"><?php echo $this->nm_new_label['idselectivo']; ?></span></TD>
    <TD class="scFormDataOdd css_idselectivo_line" id="hidden_field_data_idselectivo" style="<?php echo $sStyleHidden_idselectivo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idselectivo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idyarda_label" id="hidden_field_label_idyarda" style="<?php echo $sStyleHidden_idyarda; ?>"><span id="id_label_idyarda"><?php echo $this->nm_new_label['idyarda']; ?></span></TD>
    <TD class="scFormDataOdd css_idyarda_line" id="hidden_field_data_idyarda" style="<?php echo $sStyleHidden_idyarda; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idyarda_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idtipomovimiento_label" id="hidden_field_label_idtipomovimiento" style="<?php echo $sStyleHidden_idtipomovimiento; ?>"><span id="id_label_idtipomovimiento"><?php echo $this->nm_new_label['idtipomovimiento']; ?></span></TD>
    <TD class="scFormDataOdd css_idtipomovimiento_line" id="hidden_field_data_idtipomovimiento" style="<?php echo $sStyleHidden_idtipomovimiento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtipomovimiento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idviaje_label" id="hidden_field_label_idviaje" style="<?php echo $sStyleHidden_idviaje; ?>"><span id="id_label_idviaje"><?php echo $this->nm_new_label['idviaje']; ?></span></TD>
    <TD class="scFormDataOdd css_idviaje_line" id="hidden_field_data_idviaje" style="<?php echo $sStyleHidden_idviaje; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idviaje_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_atc_ingreso_label" id="hidden_field_label_atc_ingreso" style="<?php echo $sStyleHidden_atc_ingreso; ?>"><span id="id_label_atc_ingreso"><?php echo $this->nm_new_label['atc_ingreso']; ?></span></TD>
    <TD class="scFormDataOdd css_atc_ingreso_line" id="hidden_field_data_atc_ingreso" style="<?php echo $sStyleHidden_atc_ingreso; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_atc_ingreso_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_marchamo_ingreso_label" id="hidden_field_label_marchamo_ingreso" style="<?php echo $sStyleHidden_marchamo_ingreso; ?>"><span id="id_label_marchamo_ingreso"><?php echo $this->nm_new_label['marchamo_ingreso']; ?></span></TD>
    <TD class="scFormDataOdd css_marchamo_ingreso_line" id="hidden_field_data_marchamo_ingreso" style="<?php echo $sStyleHidden_marchamo_ingreso; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marchamo_ingreso_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_revision_label" id="hidden_field_label_revision" style="<?php echo $sStyleHidden_revision; ?>"><span id="id_label_revision"><?php echo $this->nm_new_label['revision']; ?></span></TD>
    <TD class="scFormDataOdd css_revision_line" id="hidden_field_data_revision" style="<?php echo $sStyleHidden_revision; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_revision_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_atc_despacho_label" id="hidden_field_label_atc_despacho" style="<?php echo $sStyleHidden_atc_despacho; ?>"><span id="id_label_atc_despacho"><?php echo $this->nm_new_label['atc_despacho']; ?></span></TD>
    <TD class="scFormDataOdd css_atc_despacho_line" id="hidden_field_data_atc_despacho" style="<?php echo $sStyleHidden_atc_despacho; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_atc_despacho_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_marchamo_despacho_label" id="hidden_field_label_marchamo_despacho" style="<?php echo $sStyleHidden_marchamo_despacho; ?>"><span id="id_label_marchamo_despacho"><?php echo $this->nm_new_label['marchamo_despacho']; ?></span></TD>
    <TD class="scFormDataOdd css_marchamo_despacho_line" id="hidden_field_data_marchamo_despacho" style="<?php echo $sStyleHidden_marchamo_despacho; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marchamo_despacho_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sec_users_login_label" id="hidden_field_label_sec_users_login" style="<?php echo $sStyleHidden_sec_users_login; ?>"><span id="id_label_sec_users_login"><?php echo $this->nm_new_label['sec_users_login']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_turno_line" id="hidden_field_data_turno" style="<?php echo $sStyleHidden_turno; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_turno_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_qr_label" id="hidden_field_label_tipo_qr" style="<?php echo $sStyleHidden_tipo_qr; ?>"><span id="id_label_tipo_qr"><?php echo $this->nm_new_label['tipo_qr']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_qr_line" id="hidden_field_data_tipo_qr" style="<?php echo $sStyleHidden_tipo_qr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_qr_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_tipo_qr'][] = '1'; ?>
 <option  value="2" <?php  if ($this->tipo_qr == "2") { echo " selected" ;} ?>>QR MANUAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['Lookup_tipo_qr'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("TURNOS");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("TURNOS");
 parent.scAjaxDetailHeight("TURNOS", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['TURNOS']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
