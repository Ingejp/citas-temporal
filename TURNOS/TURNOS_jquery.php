...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fechainicio_hora' + iSeqRow).bind('blur', function() { sc_TURNOS_fechainicio_hora_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_TURNOS_fechainicio_hora_onfocus(this, iSeqRow) });
...
function sc_TURNOS_fechainicio_hora_onblur(oThis, iSeqRow) {
  do_ajax_TURNOS_validate_fechainicio();
  scCssBlur(oThis);
}
...
function sc_TURNOS_fechainicio_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechainicio" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_TURNOS_validate_fechainicio(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
