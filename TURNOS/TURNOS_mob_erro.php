...
$old_error_handler = set_error_handler("TURNOS_mob_scriptcase_error_handler");

function TURNOS_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['TURNOS_mob']['contr_erro']) && $_SESSION['scriptcase']['TURNOS_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_TURNOS_mob->contr_TURNOS_mob->Apl_com_erro = true;
            if ($inicial_TURNOS_mob->contr_TURNOS_mob->NM_ajax_flag)
            {
                $inicial_TURNOS_mob->contr_TURNOS_mob->NM_ajax_info['errList']['geral_TURNOS_mob'][] = $msg;
                return;
            }
            TURNOS_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function TURNOS_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['TURNOS_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['TURNOS_mob'])  ? $_SESSION['scriptcase']['error_icon']['TURNOS_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['TURNOS_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['TURNOS_mob']) ? $_SESSION['scriptcase']['error_span_title']['TURNOS_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['TURNOS_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['TURNOS_mob']) ? $_SESSION['scriptcase']['error_icon_title']['TURNOS_mob'] : '';
?>
