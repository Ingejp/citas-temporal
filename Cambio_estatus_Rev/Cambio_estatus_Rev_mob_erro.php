...
$old_error_handler = set_error_handler("Cambio_estatus_Rev_mob_scriptcase_error_handler");

function Cambio_estatus_Rev_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Cambio_estatus_Rev_mob']['contr_erro']) && $_SESSION['scriptcase']['Cambio_estatus_Rev_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Cambio_estatus_Rev_mob->contr_Cambio_estatus_Rev_mob->Apl_com_erro = true;
            if ($inicial_Cambio_estatus_Rev_mob->contr_Cambio_estatus_Rev_mob->NM_ajax_flag)
            {
                $inicial_Cambio_estatus_Rev_mob->contr_Cambio_estatus_Rev_mob->NM_ajax_info['errList']['geral_Cambio_estatus_Rev_mob'][] = $msg;
                return;
            }
            Cambio_estatus_Rev_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Cambio_estatus_Rev_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Cambio_estatus_Rev_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['Cambio_estatus_Rev_mob'])  ? $_SESSION['scriptcase']['error_icon']['Cambio_estatus_Rev_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Cambio_estatus_Rev_mob']) && '' != $_SESSION['scriptcase']['error_close']['Cambio_estatus_Rev_mob']) ? $_SESSION['scriptcase']['error_close']['Cambio_estatus_Rev_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Cambio_estatus_Rev_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['Cambio_estatus_Rev_mob']) ? $_SESSION['scriptcase']['error_span_title']['Cambio_estatus_Rev_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Cambio_estatus_Rev_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['Cambio_estatus_Rev_mob']) ? $_SESSION['scriptcase']['error_icon_title']['Cambio_estatus_Rev_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['Cambio_estatus_Rev']['error_buffer'] .= ob_get_flush();
}
