  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Cambio_estatus_Rev_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_Cambio_estatus_Rev_mob_form();
	}

  // ---------- Validate turno
  function do_ajax_Cambio_estatus_Rev_mob_validate_turno()
  {
    var nomeCampo_turno = "turno";
    var var_turno = scAjaxGetFieldText(nomeCampo_turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_turno(var_turno, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_turno_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_turno

  function do_ajax_Cambio_estatus_Rev_mob_validate_turno_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_turno_cb

  // ---------- Validate fac_revision
  function do_ajax_Cambio_estatus_Rev_mob_validate_fac_revision()
  {
    var nomeCampo_fac_revision = "fac_revision";
    var var_fac_revision = scAjaxGetFieldText(nomeCampo_fac_revision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_fac_revision(var_fac_revision, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_fac_revision_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_fac_revision

  function do_ajax_Cambio_estatus_Rev_mob_validate_fac_revision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_fac_revision_cb

  // ---------- Validate fac_acople
  function do_ajax_Cambio_estatus_Rev_mob_validate_fac_acople()
  {
    var nomeCampo_fac_acople = "fac_acople";
    var var_fac_acople = scAjaxGetFieldText(nomeCampo_fac_acople);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_fac_acople(var_fac_acople, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_fac_acople_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_fac_acople

  function do_ajax_Cambio_estatus_Rev_mob_validate_fac_acople_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_fac_acople_cb

  // ---------- Validate placa
  function do_ajax_Cambio_estatus_Rev_mob_validate_placa()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_placa

  function do_ajax_Cambio_estatus_Rev_mob_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_placa_cb

  // ---------- Validate nuevo_estatus
  function do_ajax_Cambio_estatus_Rev_mob_validate_nuevo_estatus()
  {
    var nomeCampo_nuevo_estatus = "nuevo_estatus";
    var var_nuevo_estatus = scAjaxGetFieldSelect(nomeCampo_nuevo_estatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_nuevo_estatus(var_nuevo_estatus, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_nuevo_estatus_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_nuevo_estatus

  function do_ajax_Cambio_estatus_Rev_mob_validate_nuevo_estatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_nuevo_estatus_cb

  // ---------- Validate sc_field_0
  function do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_0_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_0

  function do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_0_cb

  // ---------- Validate sc_field_1
  function do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_1_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_1

  function do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_sc_field_1_cb

  // ---------- Validate operador
  function do_ajax_Cambio_estatus_Rev_mob_validate_operador()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_operador

  function do_ajax_Cambio_estatus_Rev_mob_validate_operador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_operador_cb

  // ---------- Validate rampa
  function do_ajax_Cambio_estatus_Rev_mob_validate_rampa()
  {
    var nomeCampo_rampa = "rampa";
    var var_rampa = scAjaxGetFieldSelect(nomeCampo_rampa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_rampa(var_rampa, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_rampa_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_rampa

  function do_ajax_Cambio_estatus_Rev_mob_validate_rampa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rampa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_rampa_cb

  // ---------- Validate tipo_revision
  function do_ajax_Cambio_estatus_Rev_mob_validate_tipo_revision()
  {
    var nomeCampo_tipo_revision = "tipo_revision";
    var var_tipo_revision = scAjaxGetFieldSelect(nomeCampo_tipo_revision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_tipo_revision(var_tipo_revision, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_tipo_revision_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_tipo_revision

  function do_ajax_Cambio_estatus_Rev_mob_validate_tipo_revision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_tipo_revision_cb

  // ---------- Validate intrusion
  function do_ajax_Cambio_estatus_Rev_mob_validate_intrusion()
  {
    var nomeCampo_intrusion = "intrusion";
    var var_intrusion = scAjaxGetFieldText(nomeCampo_intrusion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_intrusion(var_intrusion, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_intrusion_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_intrusion

  function do_ajax_Cambio_estatus_Rev_mob_validate_intrusion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_intrusion_cb

  // ---------- Validate observaciones
  function do_ajax_Cambio_estatus_Rev_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_observaciones_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_observaciones

  function do_ajax_Cambio_estatus_Rev_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_observaciones_cb

  // ---------- Validate cliente
  function do_ajax_Cambio_estatus_Rev_mob_validate_cliente()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_cliente

  function do_ajax_Cambio_estatus_Rev_mob_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_cliente_cb

  // ---------- Validate contenedor
  function do_ajax_Cambio_estatus_Rev_mob_validate_contenedor()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_contenedor

  function do_ajax_Cambio_estatus_Rev_mob_validate_contenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_contenedor_cb

  // ---------- Validate estatus
  function do_ajax_Cambio_estatus_Rev_mob_validate_estatus()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_estatus

  function do_ajax_Cambio_estatus_Rev_mob_validate_estatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estatus";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_estatus_cb

  // ---------- Validate ubicacion
  function do_ajax_Cambio_estatus_Rev_mob_validate_ubicacion()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_ubicacion

  function do_ajax_Cambio_estatus_Rev_mob_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_ubicacion_cb

  // ---------- Validate nombre
  function do_ajax_Cambio_estatus_Rev_mob_validate_nombre()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_nombre

  function do_ajax_Cambio_estatus_Rev_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_nombre_cb

  // ---------- Validate telefonos
  function do_ajax_Cambio_estatus_Rev_mob_validate_telefonos()
  {
  } // do_ajax_Cambio_estatus_Rev_mob_validate_telefonos

  function do_ajax_Cambio_estatus_Rev_mob_validate_telefonos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_telefonos_cb

  // ---------- Validate codigo
  function do_ajax_Cambio_estatus_Rev_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_validate_codigo_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_validate_codigo

  function do_ajax_Cambio_estatus_Rev_mob_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_mob_validate_codigo_cb

  // ---------- Event onchange turno
  function do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_Cambio_estatus_Rev_mob_event_turno_onchange(var_turno, var_contenedor, var_cliente, var_estatus, var_rampa, var_fac_revision, var_fac_acople, var_ubicacion, var_telefonos, var_nombre, var_placa, var_codigo, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange

  function do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "turno";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange_cb
  function do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Cambio_estatus_Rev_mob_event_turno_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_sc_btn_0
  function do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick(var_operador, var_intrusion, var_nuevo_estatus, var_ubicacion, var_fac_revision, var_fac_acople, var_rampa, var_codigo, var_tipo_revision, var_turno, var_placa, var_sc_field_0, var_sc_field_1, var_observaciones, var_cliente, var_contenedor, var_estatus, var_nombre, var_telefonos, var_script_case_init, do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick

  function do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick_cb
  function do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Cambio_estatus_Rev_mob_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Cambio_estatus_Rev_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Cambio_estatus_Rev_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_turno = scAjaxGetFieldText("turno");
    ...
    scAjaxProcOn();
    x_ajax_Cambio_estatus_Rev_mob_submit_form(var_turno, var_fac_revision, var_fac_acople, var_placa, var_nuevo_estatus, var_sc_field_0, var_sc_field_1, var_operador, var_rampa, var_tipo_revision, var_intrusion, var_observaciones, var_cliente, var_contenedor, var_estatus, var_ubicacion, var_nombre, var_telefonos, var_codigo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Cambio_estatus_Rev_mob_submit_form_cb);
  } // do_ajax_Cambio_estatus_Rev_mob_submit_form

  function do_ajax_Cambio_estatus_Rev_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_mob_submit_form_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_mob_submit_form_cb
  function do_ajax_Cambio_estatus_Rev_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Cambio_estatus_Rev_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Cambio_estatus_Rev_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Cambio_estatus_Rev_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Cambio_estatus_Rev_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_mob_navigate_form_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_mob_navigate_form_cb
  function do_ajax_Cambio_estatus_Rev_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('turno');
...
{
?>
    do_ajax_Cambio_estatus_Rev_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Cambio_estatus_Rev_mob_navigate_form_cb_after_alert
  function sc_hide_Cambio_estatus_Rev_mob_form()
  {
