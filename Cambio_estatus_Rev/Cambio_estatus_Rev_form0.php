...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("Cambio_estatus_Rev_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Cambio_estatus_Rev_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-placa", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_Cambio_estatus_Rev_event_placa_onchange) { do_ajax_Cambio_estatus_Rev_event_placa_onchange(sRow); }
    }
   }
  ...
  $(".sc-ui-autocomp-operador", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_Cambio_estatus_Rev_event_operador_onchange) { do_ajax_Cambio_estatus_Rev_event_operador_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("Cambio_estatus_Rev_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['Cambio_estatus_Rev'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Cambio_estatus_Rev'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fac_revision_line" id="hidden_field_data_fac_revision" style="<?php echo $sStyleHidden_fac_revision; ?>"> <span class="scFormLabelOddFormat css_fac_revision_label"><span id="id_label_fac_revision"><?php echo $this->nm_new_label['fac_revision']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_revision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_revision'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fac_acople_line" id="hidden_field_data_fac_acople" style="<?php echo $sStyleHidden_fac_acople; ?>"> <span class="scFormLabelOddFormat css_fac_acople_label"><span id="id_label_fac_acople"><?php echo $this->nm_new_label['fac_acople']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_acople']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_acople'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_placa_line" id="hidden_field_data_placa" style="<?php echo $sStyleHidden_placa; ?>"> <span class="scFormLabelOddFormat css_placa_label"><span id="id_label_placa"><?php echo $this->nm_new_label['placa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['placa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['placa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_fac_revision_dumb = ('' == $sStyleHidden_fac_revision) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fac_revision_dumb" style="<?php echo $sStyleHidden_fac_revision_dumb; ?>"></TD>
<?php $sStyleHidden_fac_acople_dumb = ('' == $sStyleHidden_fac_acople) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fac_acople_dumb" style="<?php echo $sStyleHidden_fac_acople_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nuevo_estatus_line" id="hidden_field_data_nuevo_estatus" style="<?php echo $sStyleHidden_nuevo_estatus; ?>"> <span class="scFormLabelOddFormat css_nuevo_estatus_label"><span id="id_label_nuevo_estatus"><?php echo $this->nm_new_label['nuevo_estatus']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['nuevo_estatus']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['nuevo_estatus'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_nuevo_estatus_dumb = ('' == $sStyleHidden_nuevo_estatus) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_nuevo_estatus_dumb" style="<?php echo $sStyleHidden_nuevo_estatus_dumb; ?>"></TD>
...
<?php $sStyleHidden_rampa_dumb = ('' == $sStyleHidden_rampa) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_rampa_dumb" style="<?php echo $sStyleHidden_rampa_dumb; ?>"></TD>
<?php $sStyleHidden_tipo_revision_dumb = ('' == $sStyleHidden_tipo_revision) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tipo_revision_dumb" style="<?php echo $sStyleHidden_tipo_revision_dumb; ?>"></TD>
<?php $sStyleHidden_intrusion_dumb = ('' == $sStyleHidden_intrusion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_intrusion_dumb" style="<?php echo $sStyleHidden_intrusion_dumb; ?>"></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("Cambio_estatus_Rev");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("Cambio_estatus_Rev");
 parent.scAjaxDetailHeight("Cambio_estatus_Rev", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
