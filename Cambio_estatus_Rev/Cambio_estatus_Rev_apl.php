...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_login)) 
          {
              $_SESSION['usr_login'] = $this->usr_login;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new Cambio_estatus_Rev_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['Cambio_estatus_Rev']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Cambio_estatus_Rev']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Cambio_estatus_Rev'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Cambio_estatus_Rev']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Cambio_estatus_Rev']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Cambio_estatus_Rev') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Cambio_estatus_Rev']['label'] = "ACTUALIZACION AL PROCESO DE INSPECCION";
      ...
      $_SESSION['scriptcase']['error_icon']['Cambio_estatus_Rev']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['Cambio_estatus_Rev'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['Cambio_estatus_Rev']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Cambio_estatus_Rev'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Cambio_estatus_Rev'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'Cambio_estatus_Rev/Cambio_estatus_Rev_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'Cambio_estatus_Rev_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'Cambio_estatus_Rev_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'Cambio_estatus_Rev_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'Cambio_estatus_Rev/Cambio_estatus_Rev_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "Cambio_estatus_Rev_erro.class.php"); 
      }
      $this->Erro      = new Cambio_estatus_Rev_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['Cambio_estatus_Rev']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_placa']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_placa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_placa']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_placa'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(Cambio_estatus_Rev_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', Cambio_estatus_Rev_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_placa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_operador']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_operador'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_operador']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_operador'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_operador'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->nombre = "";
          $this->telefonos = "";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos']))
              { 
                  $turno = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][0]; 
                  $fac_revision = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][1]; 
                  $fac_acople = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][2]; 
                  $placa = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][3]; 
                  $nuevo_estatus = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][4]; 
                  $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][5]; 
                  $sc_field_1 = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][6]; 
                  $operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][7]; 
                  $rampa = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][8]; 
                  $tipo_revision = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][9]; 
                  $intrusion = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][10]; 
                  $observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][11]; 
                  $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][12]; 
                  $contenedor = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][13]; 
                  $estatus = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][14]; 
                  $ubicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][15]; 
                  $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][16]; 
                  $telefonos = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][17]; 
                  $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][18]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][0] = $this->turno; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][1] = $this->fac_revision; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][2] = $this->fac_acople; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][3] = $this->placa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][4] = $this->nuevo_estatus; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][5] = $this->sc_field_0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][6] = $this->sc_field_1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][7] = $this->operador; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][8] = $this->rampa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][9] = $this->tipo_revision; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][10] = $this->intrusion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][11] = $this->observaciones; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][12] = $this->cliente; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][13] = $this->contenedor; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][14] = $this->estatus; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][15] = $this->ubicacion; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][16] = $this->nombre; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][17] = $this->telefonos; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['campos'][18] = $this->codigo; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("Cambio_estatus_Rev", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("Cambio_estatus_Rev_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "Cambio_estatus_Rev.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="Cambio_estatus_Rev_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="Cambio_estatus_Rev"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_Cambio_estatus_Rev']) || !is_array($this->NM_ajax_info['errList']['geral_Cambio_estatus_Rev']))
              {
                  $this->NM_ajax_info['errList']['geral_Cambio_estatus_Rev'] = array();
              }
              $this->NM_ajax_info['errList']['geral_Cambio_estatus_Rev'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
    ...
    function ValidateField_fac_revision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_revision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_revision'] == "on")) 
      { 
...
;
    ...
    function ValidateField_fac_acople(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_acople']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['fac_acople'] == "on")) 
      { 
          if ($this->fac_acople == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_placa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['placa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['placa'] == "on")) 
      { 
          if ($this->placa == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_nuevo_estatus(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nuevo_estatus == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['nuevo_estatus']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['php_cmp_required']['nuevo_estatus'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->nuevo_estatus) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus']) && !in_array($this->nuevo_estatus, $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus']))
          {
              $hasError = true;
...
;
    ...
    function ValidateField_rampa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->rampa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa']) && !in_array($this->rampa, $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_tipo_revision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tipo_revision) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision']) && !in_array($this->tipo_revision, $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_intrusion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->intrusion, 3, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][Cambio_estatus_Rev_pack_protect_string(NM_charset_to_utf8($this->placa))]) ? $aLookup[0][Cambio_estatus_Rev_pack_protect_string(NM_charset_to_utf8($this->placa))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus'] = array(); 
}
$aLookup[] = array(Cambio_estatus_Rev_pack_protect_string('') => Cambio_estatus_Rev_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_nuevo_estatus'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['nuevo_estatus']['valList'][$i] = Cambio_estatus_Rev_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][Cambio_estatus_Rev_pack_protect_string(NM_charset_to_utf8($this->operador))]) ? $aLookup[0][Cambio_estatus_Rev_pack_protect_string(NM_charset_to_utf8($this->operador))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa'] = array(); 
}
$aLookup[] = array(Cambio_estatus_Rev_pack_protect_string('') => Cambio_estatus_Rev_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_rampa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['rampa']['valList'][$i] = Cambio_estatus_Rev_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision'] = array(); 
}
$aLookup[] = array(Cambio_estatus_Rev_pack_protect_string('') => Cambio_estatus_Rev_pack_protect_string('-- SELECCIONE --'));
$_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['Lookup_tipo_revision'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_revision']['valList'][$i] = Cambio_estatus_Rev_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_codigo($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
{
$_SESSION['scriptcase']['Cambio_estatus_Rev']['contr_erro'] = 'on';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("Cambio_estatus_Rev_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "Cambio_estatus_Rev_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['nm_run_menu'] = 2;
       $nmgp_saida_form = "Cambio_estatus_Rev_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['retorno_edit'] = "";
   }
