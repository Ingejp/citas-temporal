  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Cambio_estatus_Rev" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_Cambio_estatus_Rev_form();
	}

  // ---------- Validate turno
  function do_ajax_Cambio_estatus_Rev_validate_turno()
  {
    var nomeCampo_turno = "turno";
    var var_turno = scAjaxGetFieldText(nomeCampo_turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_turno(var_turno, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_turno_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_turno

  function do_ajax_Cambio_estatus_Rev_validate_turno_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_turno_cb

  // ---------- Validate fac_revision
  function do_ajax_Cambio_estatus_Rev_validate_fac_revision()
  {
    var nomeCampo_fac_revision = "fac_revision";
    var var_fac_revision = scAjaxGetFieldText(nomeCampo_fac_revision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_fac_revision(var_fac_revision, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_fac_revision_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_fac_revision

  function do_ajax_Cambio_estatus_Rev_validate_fac_revision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_revision";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_fac_revision_cb

  // ---------- Validate fac_acople
  function do_ajax_Cambio_estatus_Rev_validate_fac_acople()
  {
    var nomeCampo_fac_acople = "fac_acople";
    var var_fac_acople = scAjaxGetFieldText(nomeCampo_fac_acople);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_fac_acople(var_fac_acople, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_fac_acople_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_fac_acople

  function do_ajax_Cambio_estatus_Rev_validate_fac_acople_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_acople";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_fac_acople_cb

  // ---------- Validate placa
  function do_ajax_Cambio_estatus_Rev_validate_placa()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_placa

  function do_ajax_Cambio_estatus_Rev_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_placa_cb

  // ---------- Validate nuevo_estatus
  function do_ajax_Cambio_estatus_Rev_validate_nuevo_estatus()
  {
    var nomeCampo_nuevo_estatus = "nuevo_estatus";
    var var_nuevo_estatus = scAjaxGetFieldSelect(nomeCampo_nuevo_estatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_nuevo_estatus(var_nuevo_estatus, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_nuevo_estatus_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_nuevo_estatus

  function do_ajax_Cambio_estatus_Rev_validate_nuevo_estatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nuevo_estatus";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_nuevo_estatus_cb

  // ---------- Validate sc_field_0
  function do_ajax_Cambio_estatus_Rev_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_sc_field_0_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_sc_field_0

  function do_ajax_Cambio_estatus_Rev_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_sc_field_0_cb

  // ---------- Validate sc_field_1
  function do_ajax_Cambio_estatus_Rev_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_sc_field_1_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_sc_field_1

  function do_ajax_Cambio_estatus_Rev_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_sc_field_1_cb

  // ---------- Validate operador
  function do_ajax_Cambio_estatus_Rev_validate_operador()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_operador

  function do_ajax_Cambio_estatus_Rev_validate_operador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "operador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_operador_cb

  // ---------- Validate rampa
  function do_ajax_Cambio_estatus_Rev_validate_rampa()
  {
    var nomeCampo_rampa = "rampa";
    var var_rampa = scAjaxGetFieldSelect(nomeCampo_rampa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_rampa(var_rampa, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_rampa_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_rampa

  function do_ajax_Cambio_estatus_Rev_validate_rampa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rampa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_rampa_cb

  // ---------- Validate tipo_revision
  function do_ajax_Cambio_estatus_Rev_validate_tipo_revision()
  {
    var nomeCampo_tipo_revision = "tipo_revision";
    var var_tipo_revision = scAjaxGetFieldSelect(nomeCampo_tipo_revision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_tipo_revision(var_tipo_revision, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_tipo_revision_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_tipo_revision

  function do_ajax_Cambio_estatus_Rev_validate_tipo_revision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_revision";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_tipo_revision_cb

  // ---------- Validate intrusion
  function do_ajax_Cambio_estatus_Rev_validate_intrusion()
  {
    var nomeCampo_intrusion = "intrusion";
    var var_intrusion = scAjaxGetFieldText(nomeCampo_intrusion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_intrusion(var_intrusion, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_intrusion_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_intrusion

  function do_ajax_Cambio_estatus_Rev_validate_intrusion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intrusion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_intrusion_cb

  // ---------- Validate observaciones
  function do_ajax_Cambio_estatus_Rev_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_observaciones_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_observaciones

  function do_ajax_Cambio_estatus_Rev_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_observaciones_cb

  // ---------- Validate cliente
  function do_ajax_Cambio_estatus_Rev_validate_cliente()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_cliente

  function do_ajax_Cambio_estatus_Rev_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_cliente_cb

  // ---------- Validate contenedor
  function do_ajax_Cambio_estatus_Rev_validate_contenedor()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_contenedor

  function do_ajax_Cambio_estatus_Rev_validate_contenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_contenedor_cb

  // ---------- Validate estatus
  function do_ajax_Cambio_estatus_Rev_validate_estatus()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_estatus

  function do_ajax_Cambio_estatus_Rev_validate_estatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estatus";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_estatus_cb

  // ---------- Validate ubicacion
  function do_ajax_Cambio_estatus_Rev_validate_ubicacion()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_ubicacion

  function do_ajax_Cambio_estatus_Rev_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_ubicacion_cb

  // ---------- Validate nombre
  function do_ajax_Cambio_estatus_Rev_validate_nombre()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_nombre

  function do_ajax_Cambio_estatus_Rev_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_nombre_cb

  // ---------- Validate telefonos
  function do_ajax_Cambio_estatus_Rev_validate_telefonos()
  {
  } // do_ajax_Cambio_estatus_Rev_validate_telefonos

  function do_ajax_Cambio_estatus_Rev_validate_telefonos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_telefonos_cb

  // ---------- Validate codigo
  function do_ajax_Cambio_estatus_Rev_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Cambio_estatus_Rev_validate_codigo(var_codigo, var_script_case_init, do_ajax_Cambio_estatus_Rev_validate_codigo_cb);
  } // do_ajax_Cambio_estatus_Rev_validate_codigo

  function do_ajax_Cambio_estatus_Rev_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Cambio_estatus_Rev_validate_codigo_cb

  // ---------- Event onchange turno
  function do_ajax_Cambio_estatus_Rev_event_turno_onchange()
  {
    var var_turno = scAjaxGetFieldText("turno");
    var var_contenedor = scAjaxGetFieldHidden("contenedor");
    var var_cliente = scAjaxGetFieldHidden("cliente");
    var var_estatus = scAjaxGetFieldHidden("estatus");
    var var_rampa = scAjaxGetFieldSelect("rampa");
    var var_fac_revision = scAjaxGetFieldText("fac_revision");
    var var_fac_acople = scAjaxGetFieldText("fac_acople");
    var var_ubicacion = scAjaxGetFieldHidden("ubicacion");
    var var_telefonos = scAjaxGetFieldHidden("telefonos");
    ...
    scAjaxProcOn(true);
    x_ajax_Cambio_estatus_Rev_event_turno_onchange(var_turno, var_contenedor, var_cliente, var_estatus, var_rampa, var_fac_revision, var_fac_acople, var_ubicacion, var_telefonos, var_nombre, var_placa, var_codigo, var_script_case_init, do_ajax_Cambio_estatus_Rev_event_turno_onchange_cb);
  } // do_ajax_Cambio_estatus_Rev_event_turno_onchange

  function do_ajax_Cambio_estatus_Rev_event_turno_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "turno";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_event_turno_onchange_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_event_turno_onchange_cb
  function do_ajax_Cambio_estatus_Rev_event_turno_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Cambio_estatus_Rev_event_turno_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_sc_btn_0
  function do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick()
  {
    var var_operador = scAjaxGetFieldText("operador");
    var var_intrusion = scAjaxGetFieldText("intrusion");
    var var_nuevo_estatus = scAjaxGetFieldSelect("nuevo_estatus");
    var var_ubicacion = scAjaxGetFieldHidden("ubicacion");
    var var_fac_revision = scAjaxGetFieldText("fac_revision");
    var var_fac_acople = scAjaxGetFieldText("fac_acople");
    var var_rampa = scAjaxGetFieldSelect("rampa");
    var var_codigo = scAjaxGetFieldText("codigo");
    var var_tipo_revision = scAjaxGetFieldSelect("tipo_revision");
    var var_turno = scAjaxGetFieldText("turno");
    var var_placa = scAjaxGetFieldText("placa");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick(var_operador, var_intrusion, var_nuevo_estatus, var_ubicacion, var_fac_revision, var_fac_acople, var_rampa, var_codigo, var_tipo_revision, var_turno, var_placa, var_sc_field_0, var_sc_field_1, var_observaciones, var_cliente, var_contenedor, var_estatus, var_nombre, var_telefonos, var_script_case_init, do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick_cb);
  } // do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick

  function do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick_cb
  function do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Cambio_estatus_Rev_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Cambio_estatus_Rev_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Cambio_estatus_Rev_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_turno = scAjaxGetFieldText("turno");
    ...
    scAjaxProcOn();
    x_ajax_Cambio_estatus_Rev_submit_form(var_turno, var_fac_revision, var_fac_acople, var_placa, var_nuevo_estatus, var_sc_field_0, var_sc_field_1, var_operador, var_rampa, var_tipo_revision, var_intrusion, var_observaciones, var_cliente, var_contenedor, var_estatus, var_ubicacion, var_nombre, var_telefonos, var_codigo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Cambio_estatus_Rev_submit_form_cb);
  } // do_ajax_Cambio_estatus_Rev_submit_form

  function do_ajax_Cambio_estatus_Rev_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_submit_form_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_submit_form_cb
  function do_ajax_Cambio_estatus_Rev_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Cambio_estatus_Rev_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Cambio_estatus_Rev_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Cambio_estatus_Rev_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Cambio_estatus_Rev']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Cambio_estatus_Rev_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Cambio_estatus_Rev_navigate_form_cb_after_alert);
  } // do_ajax_Cambio_estatus_Rev_navigate_form_cb
  function do_ajax_Cambio_estatus_Rev_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('turno');
...
{
?>
    do_ajax_Cambio_estatus_Rev_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Cambio_estatus_Rev_navigate_form_cb_after_alert
  function sc_hide_Cambio_estatus_Rev_form()
  {
  ...
  ajax_field_list[0] = "turno";
  ajax_field_list[1] = "fac_revision";
  ajax_field_list[2] = "fac_acople";
  ajax_field_list[3] = "placa";
  ajax_field_list[4] = "nuevo_estatus";
  ajax_field_list[5] = "sc_field_0";
  ajax_field_list[6] = "sc_field_1";
  ajax_field_list[7] = "operador";
  ajax_field_list[8] = "rampa";
  ajax_field_list[9] = "tipo_revision";
  ajax_field_list[10] = "intrusion";
  ajax_field_list[11] = "observaciones";
  ajax_field_list[12] = "cliente";
  ajax_field_list[13] = "contenedor";
  ajax_field_list[14] = "estatus";
  ajax_field_list[15] = "ubicacion";
  ajax_field_list[16] = "nombre";
  ajax_field_list[17] = "telefonos";
  ajax_field_list[18] = "codigo";
  ...
  var ajax_error_list = {
    "turno": {"label": "CONTENEDOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_revision": {"label": "FACTURA REVISION", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_acople": {"label": "FACTURA ACOPLE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "placa": {"label": "PLACA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nuevo_estatus": {"label": "NUEVO ESTATUS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "HORA INICIO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_1": {"label": "HORA FIN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "operador": {"label": "OPERADOR DE TORITO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rampa": {"label": "RAMPA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_revision": {"label": "TIPO_REVISION", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "intrusion": {"label": "% INTRUSION", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "contenedor": {"label": "MERCADERIA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "telefonos": {"label": "TELEFONOS GESTOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codigo": {"label": "CODIGO DE TURNO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "turno": new Array(),
    "fac_revision": new Array(),
    "fac_acople": new Array(),
    "placa": new Array(),
    "nuevo_estatus": new Array(),
    "sc_field_0": new Array(),
    "sc_field_1": new Array(),
    "operador": new Array(),
    "rampa": new Array(),
    "tipo_revision": new Array(),
    "intrusion": new Array(),
  ...
  ajax_field_mult["fac_revision"][1] = "fac_revision";
  ajax_field_mult["fac_acople"][1] = "fac_acople";
  ajax_field_mult["placa"][1] = "placa";
  ajax_field_mult["nuevo_estatus"][1] = "nuevo_estatus";
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";
  ajax_field_mult["sc_field_1"][1] = "sc_field_1";
  ajax_field_mult["operador"][1] = "operador";
  ajax_field_mult["rampa"][1] = "rampa";
  ajax_field_mult["tipo_revision"][1] = "tipo_revision";
  ajax_field_mult["intrusion"][1] = "intrusion";
  ...
  var ajax_field_id = {
    ...
    "fac_revision": new Array("hidden_field_label_fac_revision", "hidden_field_data_fac_revision"),
    "fac_acople": new Array("hidden_field_label_fac_acople", "hidden_field_data_fac_acople"),
    "placa": new Array("hidden_field_label_placa", "hidden_field_data_placa"),
    "nuevo_estatus": new Array("hidden_field_label_nuevo_estatus", "hidden_field_data_nuevo_estatus"),
    ...
    "operador": new Array("hidden_field_label_operador", "hidden_field_data_operador"),
    "rampa": new Array("hidden_field_label_rampa", "hidden_field_data_rampa"),
    "tipo_revision": new Array("hidden_field_label_tipo_revision", "hidden_field_data_tipo_revision"),
    "intrusion": new Array("hidden_field_label_intrusion", "hidden_field_data_intrusion"),
