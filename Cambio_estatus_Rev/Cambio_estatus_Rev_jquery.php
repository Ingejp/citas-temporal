...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_sc_field_0_hora' + iSeqRow).bind('blur', function() { sc_Cambio_estatus_Rev_sc_field_0_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_Cambio_estatus_Rev_sc_field_0_hora_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_sc_field_1_hora' + iSeqRow).bind('blur', function() { sc_Cambio_estatus_Rev_sc_field_1_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_Cambio_estatus_Rev_sc_field_1_hora_onfocus(this, iSeqRow) });
...
function sc_Cambio_estatus_Rev_sc_field_0_hora_onblur(oThis, iSeqRow) {
  do_ajax_Cambio_estatus_Rev_validate_sc_field_0();
  scCssBlur(oThis);
}
...
function sc_Cambio_estatus_Rev_sc_field_0_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_Cambio_estatus_Rev_sc_field_1_hora_onblur(oThis, iSeqRow) {
  do_ajax_Cambio_estatus_Rev_validate_sc_field_1();
  scCssBlur(oThis);
}
...
function sc_Cambio_estatus_Rev_sc_field_1_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_Cambio_estatus_Rev_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_sc_field_0" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_Cambio_estatus_Rev_validate_sc_field_0(iSeqRow);
    },
    numberOfMonths: 1,
...
?>
  ...
  $("#id_sc_field_sc_field_1" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_Cambio_estatus_Rev_validate_sc_field_1(iSeqRow);
    },
    numberOfMonths: 1,
    dayNames: ["<?php        echo html_entity_decode($this->Ini->Nm_lang['lang_days_sund'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_mond'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_tued'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_wend'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_thud'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_frid'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_satd'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>"],
    dayNamesMin: ["<?php     echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_sund'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_mond'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_tued'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_wend'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_thud'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_frid'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_substr_days_satd'], ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>"],
