<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cita_2']['sc_process_barr'] = true;
require_once('../grid_cita_2/index.php');
unset($_SESSION['scriptcase']['grid_cita_2']['sc_process_barr']);
$ExportCtrl = new grid_cita_2_export_control;
$ExportCtrl->Export_barr();

class grid_cita_2_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> cita :: Excel</TITLE>
