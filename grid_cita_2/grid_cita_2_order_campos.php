...
<?php
   ...
   $Ord_Cmp = new grid_cita_2_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cita_2_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idcita"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["idcita"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["idcita"] : "Id Cita";
   $tab_ger_campos['codigo_cita'] = "on";
   $tab_def_campos['codigo_cita'] = "codigo_cita";
   $tab_labels["codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["codigo_cita"] : "Codigo Cita";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['fechainicio'] = "on";
   $tab_def_campos['fechainicio'] = "fechaInicio";
   $tab_labels["fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["fechainicio"] : "Fecha Inicio";
   $tab_ger_campos['fechafin'] = "on";
   $tab_def_campos['fechafin'] = "fechaFin";
   $tab_labels["fechafin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["fechafin"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["fechafin"] : "Fecha Fin";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "horaInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_cita_2']['labels']["horainicio"] : "Hora Inicio";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cita_2']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cita_2']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cita_2_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cita_2']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
