<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_cita_3_restore']['sc_process_barr'] = true;
require_once('../pdfreport_cita_3_restore/index.php');
unset($_SESSION['scriptcase']['pdfreport_cita_3_restore']['sc_process_barr']);
$ExportCtrl = new pdfreport_cita_3_restore_export_control;
$ExportCtrl->Export_barr();

class pdfreport_cita_3_restore_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> cita :: Excel</TITLE>
