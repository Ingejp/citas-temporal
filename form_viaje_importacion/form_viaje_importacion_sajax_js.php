  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_viaje_importacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_viaje_importacion_form();
	}

  // ---------- Validate idviaje_importacion_
  function do_ajax_form_viaje_importacion_validate_idviaje_importacion_(iNumLinha)
  {
    var nomeCampo_idviaje_importacion_ = "idviaje_importacion_" + iNumLinha;
    var var_idviaje_importacion_ = scAjaxGetFieldHidden(nomeCampo_idviaje_importacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_importacion_validate_idviaje_importacion_(var_idviaje_importacion_, iNumLinha, var_script_case_init, do_ajax_form_viaje_importacion_validate_idviaje_importacion__cb);
  } // do_ajax_form_viaje_importacion_validate_idviaje_importacion_

  function do_ajax_form_viaje_importacion_validate_idviaje_importacion__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idviaje_importacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idviaje_importacion_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idviaje_importacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idviaje_importacion_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_importacion_validate_idviaje_importacion__cb

  // ---------- Validate codigo_
  function do_ajax_form_viaje_importacion_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_importacion_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_viaje_importacion_validate_codigo__cb);
  } // do_ajax_form_viaje_importacion_validate_codigo_

  function do_ajax_form_viaje_importacion_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_importacion_validate_codigo__cb

  // ---------- Validate idbuque_
  function do_ajax_form_viaje_importacion_validate_idbuque_(iNumLinha)
  {
    var nomeCampo_idbuque_ = "idbuque_" + iNumLinha;
    var var_idbuque_ = scAjaxGetFieldSelect(nomeCampo_idbuque_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_importacion_validate_idbuque_(var_idbuque_, iNumLinha, var_script_case_init, do_ajax_form_viaje_importacion_validate_idbuque__cb);
  } // do_ajax_form_viaje_importacion_validate_idbuque_

  function do_ajax_form_viaje_importacion_validate_idbuque__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idbuque_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idbuque_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idbuque_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idbuque_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_viaje_importacion_validate_idbuque__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_viaje_importacion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_viaje_importacion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_viaje_importacion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_viaje_importacion_add_new_line_cb);
  } // do_ajax_form_viaje_importacion_add_new_line

  function do_ajax_form_viaje_importacion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_viaje_importacion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_viaje_importacion_backup_line(iNumLinha)
  {
    var var_idviaje_importacion_ = scAjaxGetFieldHidden("idviaje_importacion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_viaje_importacion_backup_line(var_idviaje_importacion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_viaje_importacion_backup_line_cb);
  } // do_ajax_form_viaje_importacion_backup_line

  function do_ajax_form_viaje_importacion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_viaje_importacion_backup_line_cb

  function do_ajax_form_viaje_importacion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_viaje_importacion_cancel_insert

  function do_ajax_form_viaje_importacion_cancel_update(iSeqVert)
  {
    do_ajax_form_viaje_importacion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_viaje_importacion_cancel_update

  function do_ajax_form_viaje_importacion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_viaje_importacion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_viaje_importacion_table_refresh()
  {
    var var_idviaje_importacion_ = document.F2.idviaje_importacion_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_viaje_importacion_table_refresh(var_idviaje_importacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_viaje_importacion_table_refresh_cb);
  } //  do_ajax_form_viaje_importacion_table_refresh

  function do_ajax_form_viaje_importacion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idviaje_importacion_.value = scAjaxGetKeyValue("idviaje_importacion_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_viaje_importacion_table_refresh_cb_after_alert);
  } // do_ajax_form_viaje_importacion_table_refresh_cb
  function do_ajax_form_viaje_importacion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_viaje_importacion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_viaje_importacion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_viaje_importacion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_idbuque_ = scAjaxGetFieldSelect("idbuque_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_viaje_importacion_submit_form(var_idviaje_importacion_, var_codigo_, var_idbuque_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_viaje_importacion_submit_form_cb);
  } // do_ajax_form_viaje_importacion_submit_form

  function do_ajax_form_viaje_importacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idviaje_importacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idbuque_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_viaje_importacion_submit_form_cb_after_alert);
  } // do_ajax_form_viaje_importacion_submit_form_cb
  function do_ajax_form_viaje_importacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_viaje_importacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_viaje_importacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_viaje_importacion_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idviaje_importacion_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_" + iNavForm);
      scAjaxHideErrorDisplay("idbuque_" + iNavForm);
    }
    var var_idviaje_importacion_ = document.F2.idviaje_importacion_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_viaje_importacion_navigate_form(var_idviaje_importacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_viaje_importacion_navigate_form_cb);
  } // do_ajax_form_viaje_importacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_viaje_importacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_viaje_importacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idviaje_importacion_.value = scAjaxGetKeyValue("idviaje_importacion_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_viaje_importacion_navigate_form_cb_after_alert);
  } // do_ajax_form_viaje_importacion_navigate_form_cb
  function do_ajax_form_viaje_importacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_viaje_importacion_navigate_form_cb_after_alert
  function sc_hide_form_viaje_importacion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idviaje_importacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idbuque_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idviaje_importacion_" + iNumLinha] = {"label": "COD<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["idbuque_" + iNumLinha] = {"label": "BUQUE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idviaje_importacion_"][iNumLinha] = "idviaje_importacion_" + iNumLinha;
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["idbuque_"][iNumLinha] = "idbuque_" + iNumLinha;
    ajax_field_id["idviaje_importacion_" + iNumLinha] = new Array("hidden_field_label_idviaje_importacion_", "hidden_field_data_idviaje_importacion_" + iNumLinha);
    ajax_field_id["codigo_" + iNumLinha] = new Array("hidden_field_label_codigo_", "hidden_field_data_codigo_" + iNumLinha);
    ajax_field_id["idbuque_" + iNumLinha] = new Array("hidden_field_label_idbuque_", "hidden_field_data_idbuque_" + iNumLinha);
    ajax_error_count["idviaje_importacion_" + iNumLinha] = "off";
    ajax_error_count["codigo_" + iNumLinha] = "off";
    ajax_error_count["idbuque_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idviaje_importacion_" + iNumLinha] = "on";
    ajax_read_only["codigo_" + iNumLinha] = "off";
    ajax_read_only["idbuque_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["idbuque_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idviaje_importacion_" + iNumLinha] = null;
    ajax_error_list["codigo_" + iNumLinha] = null;
    ajax_error_list["idbuque_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idviaje_importacion_": new Array(),
    "codigo_": new Array(),
    "idbuque_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idviaje_importacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idviaje_importacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idviaje_importacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idviaje_importacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idviaje_importacion_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idbuque_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idbuque_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idbuque_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idbuque_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idbuque_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idviaje_importacion_'])) ? $this->nmgp_cmp_readonly['idviaje_importacion_'] : 'on';
?>
    scAjaxFieldRead("idviaje_importacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idbuque_'])) ? $this->nmgp_cmp_readonly['idbuque_'] : 'off';
?>
    scAjaxFieldRead("idbuque_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idviaje_importacion_" + iSeq, "on");
    scAjaxFieldRead("codigo_" + iSeq, "on");
    scAjaxFieldRead("idbuque_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idviaje_importacion_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["idbuque_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idviaje_importacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idbuque_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idviaje_importacion_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["idbuque_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idviaje_importacion_" + iRow] = "off";
        ajax_error_count["codigo_" + iRow] = "off";
        ajax_error_count["idbuque_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idviaje_importacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idbuque_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idviaje_importacion_" == sIndex)
    {
