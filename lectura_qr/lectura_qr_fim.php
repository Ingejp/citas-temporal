...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____lectura_qr"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____lectura_qr"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lectura_qr']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['lectura_qr']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lectura_qr']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['lectura_qr']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['lectura_qr']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['lectura_qr']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['lectura_qr']['embutida_filho'] as $ind => $sc_init)
          {
