<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['lectura_qr']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new lectura_qr_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class lectura_qr_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idcita"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["idcita"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["idcita"] : "Id Cita";
   ...
   $tab_labels["cita_codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_codigo_cita"] : "Codigo Cita";
   $tab_ger_campos['cita_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cita_descripcion'] = "cita_descripcion";
   }
   else
   {
       $tab_def_campos['cita_descripcion'] = "cita.descripcion";
   }
   $tab_labels["cita_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_descripcion"] : "Descripcion";
   ...
   $tab_labels["cita_fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_fechainicio"] : "Fecha Inicio";
   ...
   $tab_labels["cita_horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_horainicio"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_horainicio"] : "Hora Inicio";
   ...
   $tab_labels["cita_idcontenedor"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_idcontenedor"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_idcontenedor"] : "Contenedor";
   ...
   $tab_labels["cita_idcabezal"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_idcabezal"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_idcabezal"] : "Cabezal";
   ...
   $tab_labels["cita_idestado"]   = (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_idestado"])) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['labels']["cita_idestado"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['lectura_qr']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['lectura_qr']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "lectura_qr_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['lectura_qr']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
