<?php
@session_start() ;
$_SESSION['scriptcase']['lectura_qr']['sc_process_barr'] = true;
require_once('../lectura_qr/index.php');
unset($_SESSION['scriptcase']['lectura_qr']['sc_process_barr']);
$ExportCtrl = new lectura_qr_export_control;
$ExportCtrl->Export_barr();

class lectura_qr_export_control
{
