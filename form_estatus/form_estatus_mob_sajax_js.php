  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estatus_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_estatus_mob_form();
	}

  // ---------- Validate idestatus
  function do_ajax_form_estatus_mob_validate_idestatus()
  {
    var nomeCampo_idestatus = "idestatus";
    var var_idestatus = scAjaxGetFieldHidden(nomeCampo_idestatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estatus_mob_validate_idestatus(var_idestatus, var_script_case_init, do_ajax_form_estatus_mob_validate_idestatus_cb);
  } // do_ajax_form_estatus_mob_validate_idestatus

  function do_ajax_form_estatus_mob_validate_idestatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idestatus";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estatus_mob_validate_idestatus_cb

  // ---------- Validate estatus
  function do_ajax_form_estatus_mob_validate_estatus()
  {
    var nomeCampo_estatus = "estatus";
    var var_estatus = scAjaxGetFieldText(nomeCampo_estatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estatus_mob_validate_estatus(var_estatus, var_script_case_init, do_ajax_form_estatus_mob_validate_estatus_cb);
  } // do_ajax_form_estatus_mob_validate_estatus

  function do_ajax_form_estatus_mob_validate_estatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estatus";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estatus_mob_validate_estatus_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_estatus_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estatus_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idestatus = scAjaxGetFieldHidden("idestatus");
    var var_estatus = scAjaxGetFieldText("estatus");
    ...
    scAjaxProcOn();
    x_ajax_form_estatus_mob_submit_form(var_idestatus, var_estatus, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_estatus_mob_submit_form_cb);
  } // do_ajax_form_estatus_mob_submit_form

  function do_ajax_form_estatus_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idestatus");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_estatus_mob_submit_form_cb_after_alert);
  } // do_ajax_form_estatus_mob_submit_form_cb
  function do_ajax_form_estatus_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_estatus_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_estatus_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idestatus");
    scAjaxHideErrorDisplay("estatus");
    var var_idestatus = document.F2.idestatus.value;
    ...
    scAjaxProcOn();
    x_ajax_form_estatus_mob_navigate_form(var_idestatus, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estatus_mob_navigate_form_cb);
  } // do_ajax_form_estatus_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estatus_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estatus_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idestatus.value = scAjaxGetKeyValue("idestatus");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_estatus_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_estatus_mob_navigate_form_cb
  function do_ajax_form_estatus_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_estatus_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_estatus_mob_navigate_form_cb_after_alert
  function sc_hide_form_estatus_mob_form()
  {
  ...
  ajax_field_list[0] = "idestatus";
  ajax_field_list[1] = "estatus";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idestatus": {"label": "Idestatus", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["idestatus"][1] = "idestatus";
  ajax_field_mult["estatus"][1] = "estatus";

  var ajax_field_id = {
    "idestatus": new Array("hidden_field_label_idestatus", "hidden_field_data_idestatus"),
