...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_naviera"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_naviera"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_naviera'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_naviera']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_naviera']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_naviera']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_naviera']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_naviera']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_naviera']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_naviera']['embutida_filho'] as $ind => $sc_init)
          {
