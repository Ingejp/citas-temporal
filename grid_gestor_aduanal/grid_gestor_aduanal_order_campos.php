...
<?php
   ...
   $Ord_Cmp = new grid_gestor_aduanal_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_gestor_aduanal_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idgestor_aduanal'] = "idgestor_aduanal";
   $tab_labels["idgestor_aduanal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["idgestor_aduanal"])) ? $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["idgestor_aduanal"] : "Idgestor Aduanal";
   $tab_ger_campos['dpi'] = "on";
   $tab_def_campos['dpi'] = "dpi";
   $tab_labels["dpi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["dpi"])) ? $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["dpi"] : "Dpi";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['telefono1'] = "on";
   $tab_def_campos['telefono1'] = "telefono1";
   $tab_labels["telefono1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["telefono1"])) ? $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["telefono1"] : "Telefono 1";
   $tab_ger_campos['telefono2'] = "on";
   $tab_def_campos['telefono2'] = "telefono2";
   $tab_labels["telefono2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["telefono2"])) ? $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['labels']["telefono2"] : "Telefono 2";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_gestor_aduanal_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_gestor_aduanal']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
