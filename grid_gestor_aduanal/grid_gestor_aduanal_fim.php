...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_gestor_aduanal"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_gestor_aduanal"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_aduanal']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_gestor_aduanal']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_aduanal']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_gestor_aduanal']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_gestor_aduanal']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_gestor_aduanal</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_gestor_aduanal']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_gestor_aduanal']['embutida_filho'] as $ind => $sc_init)
          {
