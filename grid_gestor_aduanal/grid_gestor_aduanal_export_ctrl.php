<?php
@session_start() ;
$_SESSION['scriptcase']['grid_gestor_aduanal']['sc_process_barr'] = true;
require_once('../grid_gestor_aduanal/index.php');
unset($_SESSION['scriptcase']['grid_gestor_aduanal']['sc_process_barr']);
$ExportCtrl = new grid_gestor_aduanal_export_control;
$ExportCtrl->Export_barr();

class grid_gestor_aduanal_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> gestor_aduanal :: Excel</TITLE>
