...
class grid_condicion_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_condicion.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion']['rtf_name']);
      }
   ...
   function NM_export_numero_contenedor()
   {
         ...
         $this->look_numero_contenedor = str_replace('<', '&lt;', $this->look_numero_contenedor);
         $this->look_numero_contenedor = str_replace('>', '&gt;', $this->look_numero_contenedor);
         $this->Texto_tag .= "<td>" . $this->look_numero_contenedor . "</td>\r\n";
   }
   //----- idcabezal
   ...
   function NM_export_cable()
   {
         ...
         $this->cable = str_replace('<', '&lt;', $this->cable);
         $this->cable = str_replace('>', '&gt;', $this->cable);
         $this->Texto_tag .= "<td>" . $this->cable . "</td>\r\n";
   }
   //----- plug
   function NM_export_plug()
   {
         ...
         $this->plug = str_replace('<', '&lt;', $this->plug);
         $this->plug = str_replace('>', '&gt;', $this->plug);
         $this->Texto_tag .= "<td>" . $this->plug . "</td>\r\n";
   }
   //----- idnaviera
   ...
   function NM_export_fima()
   {
         ...
         $this->fima = str_replace('<', '&lt;', $this->fima);
         $this->fima = str_replace('>', '&gt;', $this->fima);
         $this->Texto_tag .= "<td>" . $this->fima . "</td>\r\n";
   }
   //----- id_condicion
   function NM_export_id_condicion()
   {
         ...
         $this->id_condicion = str_replace('<', '&lt;', $this->id_condicion);
         $this->id_condicion = str_replace('>', '&gt;', $this->id_condicion);
         $this->Texto_tag .= "<td>" . $this->id_condicion . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>REPORTE DE CONDICION DE EQUIPO :: RTF</TITLE>
