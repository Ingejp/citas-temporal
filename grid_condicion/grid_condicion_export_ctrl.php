<?php
@session_start() ;
$_SESSION['scriptcase']['grid_condicion']['sc_process_barr'] = true;
require_once('../grid_condicion/index.php');
unset($_SESSION['scriptcase']['grid_condicion']['sc_process_barr']);
$ExportCtrl = new grid_condicion_export_control;
$ExportCtrl->Export_barr();

class grid_condicion_export_control
{
