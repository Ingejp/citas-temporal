...
<?php
   ...
   $Ord_Cmp = new grid_condicion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_condicion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["imprimir"] : "IMPRIMIR";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["fecha"] : "FECHA";
   $tab_ger_campos['numero_contenedor'] = "on";
   $tab_def_campos['numero_contenedor'] = "numero_contenedor";
   $tab_labels["numero_contenedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["numero_contenedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["numero_contenedor"] : "CONTENEDOR";
   $tab_ger_campos['idcabezal'] = "on";
   $tab_def_campos['idcabezal'] = "idcabezal";
   $tab_labels["idcabezal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["idcabezal"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["idcabezal"] : "PLACA";
   $tab_ger_campos['idtransporte'] = "on";
   $tab_def_campos['idtransporte'] = "idTransporte";
   $tab_labels["idtransporte"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["idtransporte"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["idtransporte"] : "TRANSPORTE";
   $tab_ger_campos['cable'] = "on";
   $tab_def_campos['cable'] = "cable";
   $tab_labels["cable"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["cable"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["cable"] : "CABLE";
   $tab_ger_campos['plug'] = "on";
   $tab_def_campos['plug'] = "plug";
   $tab_labels["plug"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["plug"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["plug"] : "PLUG";
   $tab_ger_campos['idnaviera'] = "on";
   $tab_def_campos['idnaviera'] = "idnaviera";
   $tab_labels["idnaviera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["idnaviera"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["idnaviera"] : "NAVIERA";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["observaciones"] : "OBSERVACIONES";
   $tab_ger_campos['fima'] = "on";
   $tab_def_campos['fima'] = "fima";
   $tab_labels["fima"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["fima"])) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['labels']["fima"] : "FIRMA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_condicion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_condicion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_condicion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_condicion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
