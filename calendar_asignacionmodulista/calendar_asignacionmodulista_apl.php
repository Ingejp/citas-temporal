<?php
//
class calendar_asignacionmodulista_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_calendar_asignacionmodulista($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_asignacionmodulista_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_asignacionmodulista']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_asignacionmodulista'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_asignacionmodulista']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_asignacionmodulista']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_asignacionmodulista') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_asignacionmodulista']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - asignacionmodulista";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "calendar_asignacionmodulista")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_asignacionmodulista']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_asignacionmodulista'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_asignacionmodulista'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_asignacionmodulista'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_asignacionmodulista", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_asignacionmodulista/calendar_asignacionmodulista_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_asignacionmodulista_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_asignacionmodulista_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_asignacionmodulista_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_asignacionmodulista/calendar_asignacionmodulista_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_asignacionmodulista_erro.class.php"); 
      }
      $this->Erro      = new calendar_asignacionmodulista_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          calendar_asignacionmodulista_pack_ajax_response();
          exit;
      }
      if (isset($this->sc_inline_call) && 'Y' == $this->sc_inline_call)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['calendar_asignacionmodulista']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_asignacionmodulista.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="calendar_asignacionmodulista_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_asignacionmodulista"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horainicio'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horafin'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horainicio'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horafin'] = false;
...
//---
    ...
    function ValidateField_rangoinicial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangoinicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangoinicial'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangoinicial_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangoinicial_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Rango Inicial" ; 
              if (!isset($Campos_Erros['rangoinicial_hora']))
    ...
    function ValidateField_rangofinal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangofinal'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangofinal_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangofinal_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Rango Final" ; 
              if (!isset($Campos_Erros['rangofinal_hora']))
    ...
    function ValidateField_fecharegistro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fecharegistro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fecharegistro'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fecharegistro_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fecharegistro_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Registro" ; 
              if (!isset($Campos_Erros['fecharegistro_hora']))
    ...
    function ValidateField_fechamodificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fechamodificacion'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fechamodificacion_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fechamodificacion_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Modificacion" ; 
              if (!isset($Campos_Erros['fechamodificacion_hora']))
    ...
    function ValidateField_horainicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horainicio'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horainicio']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horainicio'])
              {
              $hasError = true;
    ...
    function ValidateField_horafin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horafin'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horafin']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['bypass_required_time']['horafin'])
              {
              $hasError = true;
    ...
    function ValidateField_idtipodemodulista(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipodemodulista) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup_idtipodemodulista']) && !in_array($this->idtipodemodulista, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup_idtipodemodulista']))
               {
                   $hasError = true;
    ...
    function ValidateField_category(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->category, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_citas_disponibles(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->citas_disponibles, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_citas_reservadas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->citas_reservadas, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idasignacionmodulista']['keyVal'] = calendar_asignacionmodulista_pack_protect_string($this->nmgp_dados_form['idasignacionmodulista']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup_idtipodemodulista']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup_idtipodemodulista'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup_idtipodemodulista']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup_idtipodemodulista'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_asignacionmodulista_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_asignacionmodulista_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup_idtipodemodulista'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodemodulista']['valList'][$i] = calendar_asignacionmodulista_pack_protect_string($v);
          }
...
$aLookup[] = array(calendar_asignacionmodulista_pack_protect_string('Y') => calendar_asignacionmodulista_pack_protect_string("" . $this->Ini->Nm_lang['lang_per_allday'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup___calend_all_day__'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['__calend_all_day__']['valList'][$i] = calendar_asignacionmodulista_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idasignacionmodulista)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opcao'] = '';
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['calendar_asignacionmodulista']['contr_erro'] = 'on';
             /* detalle_asaignacion */
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_calendar_asignacionmodulista' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['calendar_asignacionmodulista']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['db_changed'] = true;
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['parms'] = "idasignacionmodulista?#?$this->idasignacionmodulista?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_asignacionmodulista_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_outra_jan'] != 'calendar_asignacionmodulista')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
@media (max-width: 853px) {
 ...
 <script type="text/javascript">
  ...
  function calendar_print() {
      $.ajax({
          url: 'calendar_asignacionmodulista.php',
          type: 'GET',
          dataType: 'json',
          data: {
...
?>
      events: 'calendar_asignacionmodulista.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'calendar_asignacionmodulista.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'calendar_asignacionmodulista.php?nmgp_opcao=igual_calendar&idasignacionmodulista=' + calEvent.id + '&__orig_idasignacionmodulista=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
?>
      ...
      eventResize: function(event, delta, revertFunc) {
        $.post(
          'calendar_asignacionmodulista.php',
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'calendar_asignacionmodulista.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'calendar_asignacionmodulista.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<?php
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_asignacionmodulista = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['total'] = $qt_geral_reg_calendar_asignacionmodulista;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_asignacionmodulista_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_asignacionmodulista_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_asignacionmodulista_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['masterValue'] as $cmp_master => $val_master)
        {
?>
