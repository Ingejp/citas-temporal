<?php
//
class calendar_asignacionmodulista_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['citas_disponibles']))
          {
              $this->citas_disponibles = $this->NM_ajax_info['param']['citas_disponibles'];
          }
          if (isset($this->NM_ajax_info['param']['citas_reservadas']))
          {
              $this->citas_reservadas = $this->NM_ajax_info['param']['citas_reservadas'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['reaparicion']))
          {
              $this->reaparicion = $this->NM_ajax_info['param']['reaparicion'];
          }
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_calendar_asignacionmodulista_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $aDtParts = explode(' ', $this->fechamodificacion);
          $this->fechamodificacion      = $aDtParts[0];
          $this->fechamodificacion_hora = $aDtParts[1];
      }
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_asignacionmodulista_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['calendar_asignacionmodulista_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_asignacionmodulista_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_asignacionmodulista_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_asignacionmodulista_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_asignacionmodulista_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_asignacionmodulista_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_asignacionmodulista_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - asignacionmodulista";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "calendar_asignacionmodulista_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_asignacionmodulista_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_asignacionmodulista_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_asignacionmodulista_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_asignacionmodulista_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_asignacionmodulista_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_asignacionmodulista_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_asignacionmodulista/calendar_asignacionmodulista_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_asignacionmodulista_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_asignacionmodulista_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_asignacionmodulista_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_asignacionmodulista/calendar_asignacionmodulista_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_asignacionmodulista_mob_erro.class.php"); 
      }
      $this->Erro      = new calendar_asignacionmodulista_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_asignacionmodulista_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      if (isset($this->reaparicion)) { $this->nm_limpa_alfa($this->reaparicion); }
      ...
      if (isset($this->citas_disponibles)) { $this->nm_limpa_alfa($this->citas_disponibles); }
      if (isset($this->citas_reservadas)) { $this->nm_limpa_alfa($this->citas_reservadas); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['rangoinicial']['date_display'] = "ddmmaaaa;hhiiss";
      ...
      $this->field_config['rangofinal']['date_display'] = "ddmmaaaa;hhiiss";
      ...
      $this->field_config['fechamodificacion']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'] . ';' . $_SESSION['scriptcase']['reg_conf']['time_format'];
      $this->field_config['fechamodificacion']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['fechamodificacion']['time_sep']     = $_SESSION['scriptcase']['reg_conf']['time_sep'];
      $this->field_config['fechamodificacion']['date_display'] = "ddmmaaaa;hhiiss";
      $this->new_date_format('DH', 'fechamodificacion');
      //-- horainicio
      ...
      //-- category
      $this->field_config['category']               = array();
      $this->field_config['category']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['category']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['category']['symbol_dec'] = '';
      $this->field_config['category']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['category']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- citas_disponibles
      $this->field_config['citas_disponibles']               = array();
      $this->field_config['citas_disponibles']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['citas_disponibles']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['citas_disponibles']['symbol_dec'] = '';
      $this->field_config['citas_disponibles']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['citas_disponibles']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- citas_reservadas
      $this->field_config['citas_reservadas']               = array();
      $this->field_config['citas_reservadas']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['citas_reservadas']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['citas_reservadas']['symbol_dec'] = '';
      $this->field_config['citas_reservadas']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['citas_reservadas']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- reminder
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_reaparicion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'reaparicion');
          }
          ...
          if ('validate_citas_disponibles' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'citas_disponibles');
          }
          if ('validate_citas_reservadas' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'citas_reservadas');
          }
          ...
          calendar_asignacionmodulista_mob_pack_ajax_response();
          exit;
      }
      if (isset($this->sc_inline_call) && 'Y' == $this->sc_inline_call)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['calendar_asignacionmodulista_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_asignacionmodulista_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="calendar_asignacionmodulista_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_asignacionmodulista_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="calendar_asignacionmodulista_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'idtipodemodulista':
               return "Idtipode Modulista";
               break;
           case 'category':
               return "Category";
               break;
           case 'citas_disponibles':
               return "Citas Disponibles";
               break;
           case 'citas_reservadas':
               return "Citas Reservadas";
               break;
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista_mob']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_asignacionmodulista_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horainicio'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horafin'] = true;
      }
      ...
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "periodo";

      if ('' == $filtro || 'reaparicion' == $filtro)
        $this->ValidateField_reaparicion($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "reaparicion";
      ...
      if ('' == $filtro || 'citas_disponibles' == $filtro)
        $this->ValidateField_citas_disponibles($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "citas_disponibles";

      if ('' == $filtro || 'citas_reservadas' == $filtro)
        $this->ValidateField_citas_reservadas($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "citas_reservadas";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horainicio'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horafin'] = false;
...
//---
    ...
    function ValidateField_descripcion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (NM_utf8_strlen($this->descripcion) > 145) 
          { 
              $hasError = true;
              $Campos_Crit .= "Descripcion " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 145 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['descripcion']))
              {
                  $Campos_Erros['descripcion'] = array();
              }
              $Campos_Erros['descripcion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 145 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['descripcion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 145 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_rangoinicial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangoinicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangoinicial'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangoinicial_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangoinicial_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Rango Inicial" ; 
              if (!isset($Campos_Erros['rangoinicial_hora']))
    ...
    function ValidateField_rangofinal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangofinal'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangofinal_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangofinal_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Rango Final" ; 
              if (!isset($Campos_Erros['rangofinal_hora']))
    ...
    function ValidateField_fecharegistro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fecharegistro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fecharegistro'] == "on") 
           { 
              $hasError = true;
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fecharegistro_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fecharegistro_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Registro" ; 
              if (!isset($Campos_Erros['fecharegistro_hora']))
    ...
    function ValidateField_fechamodificacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fechamodificacion'] == "on") 
           { 
              $hasError = true;
      ...
      nm_limpa_hora($this->fechamodificacion_hora, $this->field_config['fechamodificacion_hora']['time_sep']) ; 
      if ($this->nmgp_opcao != "excluir") 
      {
          $Format_Hora = $this->field_config['fechamodificacion_hora']['date_format']; 
          nm_limpa_hora($Format_Hora, $this->field_config['fechamodificacion_hora']['time_sep']) ; 
          if (trim($this->fechamodificacion_hora) != "")  
          { 
              if ($teste_validade->Hora($this->fechamodificacion_hora, $Format_Hora) == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Fecha Modificacion; " ; 
                  if (!isset($Campos_Erros['fechamodificacion_hora']))
                  {
                      $Campos_Erros['fechamodificacion_hora'] = array();
                  }
                  $Campos_Erros['fechamodificacion_hora'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fechamodificacion']) || !is_array($this->NM_ajax_info['errList']['fechamodificacion']))
                  {
                      $this->NM_ajax_info['errList']['fechamodificacion'] = array();
                  }
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fechamodificacion_hora']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fechamodificacion_hora'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fecha Modificacion" ; 
              if (!isset($Campos_Erros['fechamodificacion_hora']))
              ...
              $Campos_Erros['fechamodificacion_hora'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['fechamodificacion']) || !is_array($this->NM_ajax_info['errList']['fechamodificacion']))
                  {
                      $this->NM_ajax_info['errList']['fechamodificacion'] = array();
                  }
      ...
      if (isset($Campos_Erros['fechamodificacion']) && isset($Campos_Erros['fechamodificacion_hora']))
      {
          $this->removeDuplicateDttmError($Campos_Erros['fechamodificacion'], $Campos_Erros['fechamodificacion_hora']);
          if (empty($Campos_Erros['fechamodificacion_hora']))
          {
              unset($Campos_Erros['fechamodificacion_hora']);
          }
          if (isset($this->NM_ajax_info['errList']['fechamodificacion']))
          {
              $this->NM_ajax_info['errList']['fechamodificacion'] = array_unique($this->NM_ajax_info['errList']['fechamodificacion']);
          }
      }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fechamodificacion_hora';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_fechamodificacion_hora
    ...
    function ValidateField_horainicio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['horainicio'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horainicio']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horainicio'])
              {
              $hasError = true;
    ...
    function ValidateField_horafin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['horafin'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horafin']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['bypass_required_time']['horafin'])
              {
              $hasError = true;
    ...
    function ValidateField_periodo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->periodo) > 45) 
          { 
              $hasError = true;
              $Campos_Crit .= "Periodo " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['periodo']))
              {
                  $Campos_Erros['periodo'] = array();
              }
              $Campos_Erros['periodo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['periodo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_reaparicion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->reaparicion) > 45) 
          { 
              $hasError = true;
              $Campos_Crit .= "Reaparicion " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['reaparicion']))
              {
                  $Campos_Erros['reaparicion'] = array();
              }
              $Campos_Erros['reaparicion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['reaparicion']) || !is_array($this->NM_ajax_info['errList']['reaparicion']))
              {
                  $this->NM_ajax_info['errList']['reaparicion'] = array();
              }
              $this->NM_ajax_info['errList']['reaparicion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'reaparicion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_reaparicion
    ...
    function ValidateField_id_api(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Id Api " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_idtipodemodulista(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipodemodulista) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup_idtipodemodulista']) && !in_array($this->idtipodemodulista, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup_idtipodemodulista']))
               {
                   $hasError = true;
    ...
    function ValidateField_category(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->category, $this->field_config['category']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->category != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->category) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Category: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['category']))
                  {
                      $Campos_Erros['category'] = array();
                  }
                  $Campos_Erros['category'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['category'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->category, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Category; " ; 
                  if (!isset($Campos_Erros['category']))
                  {
                      $Campos_Erros['category'] = array();
                  }
    ...
    function ValidateField_citas_disponibles(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->citas_disponibles === "" || is_null($this->citas_disponibles))  
      { 
          $this->citas_disponibles = 0;
          $this->sc_force_zero[] = 'citas_disponibles';
      } 
      nm_limpa_numero($this->citas_disponibles, $this->field_config['citas_disponibles']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->citas_disponibles != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->citas_disponibles) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Citas Disponibles: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['citas_disponibles']))
                  {
                      $Campos_Erros['citas_disponibles'] = array();
                  }
                  $Campos_Erros['citas_disponibles'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['citas_disponibles']) || !is_array($this->NM_ajax_info['errList']['citas_disponibles']))
                  {
                      $this->NM_ajax_info['errList']['citas_disponibles'] = array();
                  }
                  $this->NM_ajax_info['errList']['citas_disponibles'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->citas_disponibles, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Citas Disponibles; " ; 
                  if (!isset($Campos_Erros['citas_disponibles']))
                  {
                      $Campos_Erros['citas_disponibles'] = array();
                  }
                  $Campos_Erros['citas_disponibles'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['citas_disponibles']) || !is_array($this->NM_ajax_info['errList']['citas_disponibles']))
                  {
                      $this->NM_ajax_info['errList']['citas_disponibles'] = array();
                  }
                  $this->NM_ajax_info['errList']['citas_disponibles'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'citas_disponibles';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_citas_disponibles

    function ValidateField_citas_reservadas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->citas_reservadas === "" || is_null($this->citas_reservadas))  
      { 
          $this->citas_reservadas = 0;
          $this->sc_force_zero[] = 'citas_reservadas';
      } 
      nm_limpa_numero($this->citas_reservadas, $this->field_config['citas_reservadas']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->citas_reservadas != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->citas_reservadas) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Citas Reservadas: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['citas_reservadas']))
                  {
                      $Campos_Erros['citas_reservadas'] = array();
                  }
                  $Campos_Erros['citas_reservadas'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['citas_reservadas']) || !is_array($this->NM_ajax_info['errList']['citas_reservadas']))
                  {
                      $this->NM_ajax_info['errList']['citas_reservadas'] = array();
                  }
                  $this->NM_ajax_info['errList']['citas_reservadas'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->citas_reservadas, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Citas Reservadas; " ; 
                  if (!isset($Campos_Erros['citas_reservadas']))
                  {
                      $Campos_Erros['citas_reservadas'] = array();
                  }
                  $Campos_Erros['citas_reservadas'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['citas_reservadas']) || !is_array($this->NM_ajax_info['errList']['citas_reservadas']))
                  {
                      $this->NM_ajax_info['errList']['citas_reservadas'] = array();
                  }
                  $this->NM_ajax_info['errList']['citas_reservadas'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'citas_reservadas';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_citas_reservadas
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['citas_disponibles'] = $this->citas_disponibles;
    $this->nmgp_dados_form['citas_reservadas'] = $this->citas_reservadas;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_data($this->fechamodificacion, $this->field_config['fechamodificacion']['date_sep']) ; 
      nm_limpa_hora($this->fechamodificacion_hora, $this->field_config['fechamodificacion']['time_sep']) ; 
      $this->Before_unformat['horainicio'] = $this->horainicio;
      nm_limpa_hora($this->horainicio, $this->field_config['horainicio']['time_sep']) ; 
      $this->Before_unformat['horafin'] = $this->horafin;
      nm_limpa_hora($this->horafin, $this->field_config['horafin']['time_sep']) ; 
      $this->Before_unformat['category'] = $this->category;
      nm_limpa_numero($this->category, $this->field_config['category']['symbol_grp']) ; 
      $this->Before_unformat['citas_disponibles'] = $this->citas_disponibles;
      nm_limpa_numero($this->citas_disponibles, $this->field_config['citas_disponibles']['symbol_grp']) ; 
      $this->Before_unformat['citas_reservadas'] = $this->citas_reservadas;
      nm_limpa_numero($this->citas_reservadas, $this->field_config['citas_reservadas']['symbol_grp']) ; 
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "category")
      {
          nm_limpa_numero($this->category, $this->field_config['category']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "citas_disponibles")
      {
          nm_limpa_numero($this->citas_disponibles, $this->field_config['citas_disponibles']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "citas_reservadas")
      {
          nm_limpa_numero($this->citas_reservadas, $this->field_config['citas_reservadas']['symbol_grp']) ; 
      }
   }
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      {
          $nm_separa_data = strpos($this->field_config['fechamodificacion']['date_format'], ";") ;
          $guarda_format_hora = $this->field_config['fechamodificacion']['date_format'];
          $this->field_config['fechamodificacion']['date_format'] = substr($this->field_config['fechamodificacion']['date_format'], 0, $nm_separa_data) ;
          $separador = strpos($this->fechamodificacion, " ") ; 
          $this->fechamodificacion_hora = substr($this->fechamodificacion, $separador + 1) ; 
          $this->fechamodificacion = substr($this->fechamodificacion, 0, $separador) ; 
          ...
          $this->field_config['fechamodificacion']['date_format'] = substr($guarda_format_hora, $nm_separa_data + 1) ;
          nm_volta_hora($this->fechamodificacion_hora, $this->field_config['fechamodificacion']['date_format']) ; 
          nmgp_Form_Hora($this->fechamodificacion_hora, $this->field_config['fechamodificacion']['date_format'], $this->field_config['fechamodificacion']['time_sep']) ;  
      ...
      if ('' !== $this->category || (!empty($format_fields) && isset($format_fields['category'])))
      {
          nmgp_Form_Num_Val($this->category, $this->field_config['category']['symbol_grp'], $this->field_config['category']['symbol_dec'], "0", "S", $this->field_config['category']['format_neg'], "", "", "-", $this->field_config['category']['symbol_fmt']) ; 
      }
      if ('' !== $this->citas_disponibles || (!empty($format_fields) && isset($format_fields['citas_disponibles'])))
      {
          nmgp_Form_Num_Val($this->citas_disponibles, $this->field_config['citas_disponibles']['symbol_grp'], $this->field_config['citas_disponibles']['symbol_dec'], "0", "S", $this->field_config['citas_disponibles']['format_neg'], "", "", "-", $this->field_config['citas_disponibles']['symbol_fmt']) ; 
      }
      if ('' !== $this->citas_reservadas || (!empty($format_fields) && isset($format_fields['citas_reservadas'])))
      {
          nmgp_Form_Num_Val($this->citas_reservadas, $this->field_config['citas_reservadas']['symbol_grp'], $this->field_config['citas_reservadas']['symbol_dec'], "0", "S", $this->field_config['citas_reservadas']['format_neg'], "", "", "-", $this->field_config['citas_reservadas']['symbol_fmt']) ; 
      }
      if ($this->recur_info != '')
      {
          $tmpRecurInfo = json_decode($this->recur_info, true);
...
//-- 
   function nm_converte_datas($use_null = true, $bForce = false)
   {
      ...
      { 
          ...
          $this->field_config['fechamodificacion']['date_format'] = substr($guarda_format_hora, $nm_separa_data + 1) ;
          nm_conv_hora($this->fechamodificacion_hora, $this->field_config['fechamodificacion']['date_format']) ; 
          if ($this->fechamodificacion_hora == "" )  
          { 
              $this->fechamodificacion_hora = "00:00:00:000" ; 
          }
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
          {
              $this->fechamodificacion_hora = substr($this->fechamodificacion_hora, 0, -4) . "." . substr($this->fechamodificacion_hora, -3);
          }
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          {
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_reaparicion();
          ...
          $this->ajax_return_values_citas_disponibles();
          $this->ajax_return_values_citas_reservadas();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idasignacionmodulista']['keyVal'] = calendar_asignacionmodulista_mob_pack_protect_string($this->nmgp_dados_form['idasignacionmodulista']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_fechamodificacion($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['fechamodificacion'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->fechamodificacion . ' ' . $this->fechamodificacion_hora),
              );
          }
   }
   ...
   function ajax_return_values_periodo($bForce = false)
   {
          ...
          //----- reaparicion
   function ajax_return_values_reaparicion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("reaparicion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->reaparicion);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['reaparicion'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup_idtipodemodulista']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup_idtipodemodulista'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup_idtipodemodulista']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup_idtipodemodulista'] = array(); 
}
   ...
   $old_value_category = $this->category;
   ...
   $unformatted_value_category = $this->category;
   ...
   $this->category = $old_value_category;
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_asignacionmodulista_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_asignacionmodulista_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup_idtipodemodulista'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipodemodulista']['valList'][$i] = calendar_asignacionmodulista_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_category($bForce = false)
   {
          ...
          //----- citas_disponibles
   function ajax_return_values_citas_disponibles($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("citas_disponibles", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->citas_disponibles);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['citas_disponibles'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- citas_reservadas
   function ajax_return_values_citas_reservadas($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("citas_reservadas", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->citas_reservadas);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['citas_reservadas'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
$aLookup[] = array(calendar_asignacionmodulista_mob_pack_protect_string('Y') => calendar_asignacionmodulista_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_per_allday'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup___calend_all_day__'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['__calend_all_day__']['valList'][$i] = calendar_asignacionmodulista_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idasignacionmodulista)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opcao'] = '';
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['calendar_asignacionmodulista_mob']['contr_erro'] = 'on';
             /* detalle_asaignacion */
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM detalle_asaignacion WHERE idasignacionModulista = " . $this->idasignacionmodulista ;
      }
      else
      {
          $sc_cmd_dependency = "SELECT COUNT(*) AS countTest FROM detalle_asaignacion WHERE idasignacionModulista = " . $this->idasignacionmodulista ;
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dataset_detalle_asaignacion = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                      $this->dataset_detalle_asaignacion[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      { 
          $this->dataset_detalle_asaignacion = false;
          $this->dataset_detalle_asaignacion_erro = $this->Db->ErrorMsg();
      } 
;

      if($this->dataset_detalle_asaignacion[0][0] > 0)
      {
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_calendar_asignacionmodulista_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['calendar_asignacionmodulista_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['citas_disponibles'] = $this->citas_disponibles;
      $NM_val_form['citas_reservadas'] = $this->citas_reservadas;
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "descripcion = '$this->descripcion', cantidadModulistas = $this->cantidadmodulistas, rangoInicial = #$this->rangoinicial#, rangoFinal = #$this->rangofinal#, fechaRegistro = #$this->fecharegistro#, fechaModificacion = #$this->fechamodificacion#, horaInicio = #$this->horainicio#, horaFin = #$this->horafin#, periodo = '$this->periodo', reaparicion = '$this->reaparicion', id_api = '$this->id_api', recur_info = '$this->recur_info', event_color = '$this->event_color', idtipodeModulista = $this->idtipodemodulista, category = $this->category, citas_disponibles = $this->citas_disponibles, citas_reservadas = $this->citas_reservadas"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "descripcion = '$this->descripcion', cantidadModulistas = $this->cantidadmodulistas, rangoInicial = " . $this->Ini->date_delim . $this->rangoinicial . $this->Ini->date_delim1 . ", rangoFinal = " . $this->Ini->date_delim . $this->rangofinal . $this->Ini->date_delim1 . ", fechaRegistro = " . $this->Ini->date_delim . $this->fecharegistro . $this->Ini->date_delim1 . ", fechaModificacion = " . $this->Ini->date_delim . $this->fechamodificacion . $this->Ini->date_delim1 . ", horaInicio = " . $this->Ini->date_delim . $this->horainicio . $this->Ini->date_delim1 . ", horaFin = " . $this->Ini->date_delim . $this->horafin . $this->Ini->date_delim1 . ", periodo = '$this->periodo', reaparicion = '$this->reaparicion', id_api = '$this->id_api', recur_info = '$this->recur_info', event_color = '$this->event_color', idtipodeModulista = $this->idtipodemodulista, category = $this->category, citas_disponibles = $this->citas_disponibles, citas_reservadas = $this->citas_reservadas"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['reaparicion'])) { $this->reaparicion = $NM_val_form['reaparicion']; }
              elseif (isset($this->reaparicion)) { $this->nm_limpa_alfa($this->reaparicion); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['citas_disponibles'])) { $this->citas_disponibles = $NM_val_form['citas_disponibles']; }
              elseif (isset($this->citas_disponibles)) { $this->nm_limpa_alfa($this->citas_disponibles); }
              if     (isset($NM_val_form) && isset($NM_val_form['citas_reservadas'])) { $this->citas_reservadas = $NM_val_form['citas_reservadas']; }
              elseif (isset($this->citas_reservadas)) { $this->nm_limpa_alfa($this->citas_reservadas); }

              $this->nm_formatar_campos();

              $aOldRefresh               = $this->nmgp_refresh_fields;
              $this->nmgp_refresh_fields = array_diff(array('idasignacionmodulista', 'descripcion', 'cantidadmodulistas', 'rangoinicial', 'rangofinal', 'fecharegistro', 'fechamodificacion', 'horainicio', 'horafin', 'periodo', 'reaparicion', 'id_api', 'recur_info', 'event_color', 'idtipodemodulista', 'category', 'citas_disponibles', 'citas_reservadas', '__calend_all_day__'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (descripcion, cantidadModulistas, rangoInicial, rangoFinal, fechaRegistro, fechaModificacion, horaInicio, horaFin, periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles, citas_reservadas) VALUES ('$this->descripcion', $this->cantidadmodulistas, #$this->rangoinicial#, #$this->rangofinal#, #$this->fecharegistro#, #$this->fechamodificacion#, #$this->horainicio#, #$this->horafin#, '$this->periodo', '$this->reaparicion', '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->idtipodemodulista, $this->category, $this->citas_disponibles, $this->citas_reservadas)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "descripcion, cantidadModulistas, rangoInicial, rangoFinal, fechaRegistro, fechaModificacion, horaInicio, horaFin, periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles, citas_reservadas) VALUES (" . $NM_seq_auto . "'$this->descripcion', $this->cantidadmodulistas, " . $this->Ini->date_delim . $this->rangoinicial . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->rangofinal . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fecharegistro . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fechamodificacion . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horainicio . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horafin . $this->Ini->date_delim1 . ", '$this->periodo', '$this->reaparicion', '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->idtipodemodulista, $this->category, $this->citas_disponibles, $this->citas_reservadas)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "descripcion, cantidadModulistas, rangoInicial, rangoFinal, fechaRegistro, fechaModificacion, horaInicio, horaFin, periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles, citas_reservadas) VALUES (" . $NM_seq_auto . "'$this->descripcion', $this->cantidadmodulistas, " . $this->Ini->date_delim . $this->rangoinicial . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->rangofinal . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fecharegistro . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fechamodificacion . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horainicio . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->horafin . $this->Ini->date_delim1 . ", '$this->periodo', '$this->reaparicion', '$this->id_api', '$this->id_event_google', '$this->recur_info', '$this->event_color', '$this->creator', '$this->reminder', $this->idtipodemodulista, $this->category, $this->citas_disponibles, $this->citas_reservadas)"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['parms'] = "idasignacionmodulista?#?$this->idasignacionmodulista?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              $nmgp_select = "SELECT idasignacionModulista, descripcion, cantidadModulistas, str_replace (convert(char(10),rangoInicial,102), '.', '-') + ' ' + convert(char(8),rangoInicial,20), str_replace (convert(char(10),rangoFinal,102), '.', '-') + ' ' + convert(char(8),rangoFinal,20), str_replace (convert(char(10),fechaRegistro,102), '.', '-') + ' ' + convert(char(8),fechaRegistro,20), str_replace (convert(char(10),fechaModificacion,102), '.', '-') + ' ' + convert(char(8),fechaModificacion,20), str_replace (convert(char(10),horaInicio,102), '.', '-') + ' ' + convert(char(8),horaInicio,20), str_replace (convert(char(10),horaFin,102), '.', '-') + ' ' + convert(char(8),horaFin,20), periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles, citas_reservadas from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT idasignacionModulista, descripcion, cantidadModulistas, rangoInicial, rangoFinal, fechaRegistro, fechaModificacion, horaInicio, horaFin, periodo, reaparicion, id_api, id_event_google, recur_info, event_color, creator, reminder, idtipodeModulista, category, citas_disponibles, citas_reservadas from " . $this->Ini->nm_tabela ; 
          } 
          $aWhere = array();
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->fecharegistro = $rs->fields[5] ; 
              ...
              $this->fechamodificacion = $rs->fields[6] ; 
              ...
              $this->reaparicion = $rs->fields[10] ; 
              $this->nmgp_dados_select['reaparicion'] = $this->reaparicion;
              $this->id_api = $rs->fields[11] ; 
              $this->nmgp_dados_select['id_api'] = $this->id_api;
              $this->id_event_google = $rs->fields[12] ; 
              $this->nmgp_dados_select['id_event_google'] = $this->id_event_google;
              $this->recur_info = $rs->fields[13] ; 
              $this->nmgp_dados_select['recur_info'] = $this->recur_info;
              $this->event_color = $rs->fields[14] ; 
              $this->nmgp_dados_select['event_color'] = $this->event_color;
              $this->creator = $rs->fields[15] ; 
              $this->nmgp_dados_select['creator'] = $this->creator;
              $this->reminder = $rs->fields[16] ; 
              $this->nmgp_dados_select['reminder'] = $this->reminder;
              $this->idtipodemodulista = $rs->fields[17] ; 
              $this->nmgp_dados_select['idtipodemodulista'] = $this->idtipodemodulista;
              $this->category = $rs->fields[18] ; 
              $this->nmgp_dados_select['category'] = $this->category;
              $this->citas_disponibles = $rs->fields[19] ; 
              $this->nmgp_dados_select['citas_disponibles'] = $this->citas_disponibles;
              $this->citas_reservadas = $rs->fields[20] ; 
              $this->nmgp_dados_select['citas_reservadas'] = $this->citas_reservadas;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_asignacionmodulista_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_outra_jan'] != 'calendar_asignacionmodulista_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
@media (max-width: 853px) {
 ...
 <script type="text/javascript">
  ...
  function calendar_print() {
      $.ajax({
          url: 'calendar_asignacionmodulista_mob.php',
          type: 'GET',
          dataType: 'json',
          data: {
...
?>
      events: 'calendar_asignacionmodulista_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'calendar_asignacionmodulista_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'calendar_asignacionmodulista_mob.php?nmgp_opcao=igual_calendar&idasignacionmodulista=' + calEvent.id + '&__orig_idasignacionmodulista=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
?>
      ...
      eventResize: function(event, delta, revertFunc) {
        $.post(
          'calendar_asignacionmodulista_mob.php',
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'calendar_asignacionmodulista_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'calendar_asignacionmodulista_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<form name="F1" id="sc-ui-form" method="post"
      action="calendar_asignacionmodulista.php"
      target="_self">
...
<?php
   ...
   function calendarFetchSelect($googleInfo = false)
   {
       ...
       $aSelect['description'] = "rangoInicial";
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_asignacionmodulista_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['total'] = $qt_geral_reg_calendar_asignacionmodulista_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_asignacionmodulista_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idasignacionmodulista";$nm_numeric[] = "cantidadmodulistas";$nm_numeric[] = "idtipodemodulista";$nm_numeric[] = "category";$nm_numeric[] = "citas_disponibles";$nm_numeric[] = "citas_reservadas";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_asignacionmodulista_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_asignacionmodulista_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
