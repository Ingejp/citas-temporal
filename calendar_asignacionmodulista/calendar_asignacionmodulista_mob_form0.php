...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>calendar_asignacionmodulista/calendar_asignacionmodulista_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("calendar_asignacionmodulista_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('calendar_asignacionmodulista_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['calendar_asignacionmodulista']['error_buffer']) && '' != $_SESSION['scriptcase']['calendar_asignacionmodulista']['error_buffer'])
{
    echo $_SESSION['scriptcase']['calendar_asignacionmodulista']['error_buffer'];
}
...
<?php
 include_once("calendar_asignacionmodulista_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="calendar_asignacionmodulista_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_asignacionmodulista_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_asignacionmodulista_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rangofinal_line" id="hidden_field_data_rangofinal" style="<?php echo $sStyleHidden_rangofinal; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rangofinal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rangofinal_label"><span id="id_label_rangofinal"><?php echo $this->nm_new_label['rangofinal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['rangofinal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fechamodificacion_line" id="hidden_field_data_fechamodificacion" style="<?php echo $sStyleHidden_fechamodificacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechamodificacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fechamodificacion_label"><span id="id_label_fechamodificacion"><?php echo $this->nm_new_label['fechamodificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['fechamodificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_horafin_line" id="hidden_field_data_horafin" style="<?php echo $sStyleHidden_horafin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_horafin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_horafin_label"><span id="id_label_horafin"><?php echo $this->nm_new_label['horafin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['php_cmp_required']['horafin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { ?>
<span id="id_read_on_periodo" class="sc-ui-readonly-periodo css_periodo_line" style="<?php echo $sStyleReadLab_periodo; ?>"><?php echo $this->periodo; ?></span><span id="id_read_off_periodo" class="css_read_off_periodo" style="white-space: nowrap;<?php echo $sStyleReadInp_periodo; ?>">
...
<input type="hidden" name="reaparicion" value="<?php echo $this->form_encode_input($reaparicion) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_reaparicion_line" id="hidden_field_data_reaparicion" style="<?php echo $sStyleHidden_reaparicion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_reaparicion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_reaparicion_label"><span id="id_label_reaparicion"><?php echo $this->nm_new_label['reaparicion']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["reaparicion"]) &&  $this->nmgp_cmp_readonly["reaparicion"] == "on") { 

 ?>
<input type="hidden" name="reaparicion" value="<?php echo $this->form_encode_input($reaparicion) . "\">" . $reaparicion . ""; ?>
<?php } else { ?>
<span id="id_read_on_reaparicion" class="sc-ui-readonly-reaparicion css_reaparicion_line" style="<?php echo $sStyleReadLab_reaparicion; ?>"><?php echo $this->reaparicion; ?></span><span id="id_read_off_reaparicion" class="css_read_off_reaparicion" style="white-space: nowrap;<?php echo $sStyleReadInp_reaparicion; ?>">
 <input class="sc-js-input scFormObjectOdd css_reaparicion_obj" style="" id="id_sc_field_reaparicion" type=text name="reaparicion" value="<?php echo $this->form_encode_input($reaparicion) ?>"
 size=45 maxlength=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_recur_info_line" id="hidden_field_data_recur_info" style="<?php echo $sStyleHidden_recur_info; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_recur_info_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_recur_info_label"><span id="id_label_recur_info"><?php echo $this->nm_new_label['recur_info']; ?></span></span><br><span id="id_read_on_recur_info" style="<?php echo $sStyleReadLab_recur_info; ?>"></span><span id="id_read_off_recur_info" class="css_read_off_recur_info" style="<?php echo $sStyleReadInp_recur_info; ?>"><?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_event_color_line" id="hidden_field_data_event_color" style="<?php echo $sStyleHidden_event_color; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_event_color_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_event_color_label"><span id="id_label_event_color"><?php echo $this->nm_new_label['event_color']; ?></span></span><br>
...
<span id="id_read_on_event_color" class="sc-ui-readonly-event_color css_event_color_line" style="<?php echo $sStyleReadLab_event_color; ?>"><?php echo $this->event_color; ?></span><span id="id_read_off_event_color" class="css_read_off_event_color" style="white-space: nowrap;<?php echo $sStyleReadInp_event_color; ?>">
 <input class="sc-js-input scFormObjectOdd css_event_color_obj" style="" id="id_sc_field_event_color" type=text name="event_color" value="<?php echo $this->form_encode_input($event_color) ?>"
 size=50 maxlength=255 alt="{enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bsrgb", "", "", "event_color_cor", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<input type="hidden" name="category" value="<?php echo $this->form_encode_input($category) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_category_line" id="hidden_field_data_category" style="<?php echo $sStyleHidden_category; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_category_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_category_label"><span id="id_label_category"><?php echo $this->nm_new_label['category']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["category"]) &&  $this->nmgp_cmp_readonly["category"] == "on") { 

 ?>
<input type="hidden" name="category" value="<?php echo $this->form_encode_input($category) . "\">" . $category . ""; ?>
<?php } else { ?>
<span id="id_read_on_category" class="sc-ui-readonly-category css_category_line" style="<?php echo $sStyleReadLab_category; ?>"><?php echo $this->category; ?></span><span id="id_read_off_category" class="css_read_off_category" style="white-space: nowrap;<?php echo $sStyleReadInp_category; ?>">
 <input class="sc-js-input scFormObjectOdd css_category_obj" style="" id="id_sc_field_category" type=text name="category" value="<?php echo $this->form_encode_input($category) ?>"
 size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['category']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['category']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['category']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_citas_reservadas_line" id="hidden_field_data_citas_reservadas" style="<?php echo $sStyleHidden_citas_reservadas; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_citas_reservadas_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_citas_reservadas_label"><span id="id_label_citas_reservadas"><?php echo $this->nm_new_label['citas_reservadas']; ?></span></span><br>
...
<?php $sStyleHidden_citas_reservadas_dumb = ('' == $sStyleHidden_citas_reservadas) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_citas_reservadas_dumb" style="<?php echo $sStyleHidden_citas_reservadas_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['Lookup___calend_all_day__'][] = 'Y'; ?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendar_asignacionmodulista_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_asignacionmodulista_mob");
 parent.scAjaxDetailHeight("calendar_asignacionmodulista_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
