...
$old_error_handler = set_error_handler("calendar_asignacionmodulista_mob_scriptcase_error_handler");

function calendar_asignacionmodulista_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['calendar_asignacionmodulista_mob']['contr_erro']) && $_SESSION['scriptcase']['calendar_asignacionmodulista_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_calendar_asignacionmodulista_mob->contr_calendar_asignacionmodulista_mob->Apl_com_erro = true;
            if ($inicial_calendar_asignacionmodulista_mob->contr_calendar_asignacionmodulista_mob->NM_ajax_flag)
            {
                $inicial_calendar_asignacionmodulista_mob->contr_calendar_asignacionmodulista_mob->NM_ajax_info['errList']['geral_calendar_asignacionmodulista_mob'][] = $msg;
                return;
            }
            calendar_asignacionmodulista_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function calendar_asignacionmodulista_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['calendar_asignacionmodulista_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['calendar_asignacionmodulista_mob'])  ? $_SESSION['scriptcase']['error_icon']['calendar_asignacionmodulista_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['calendar_asignacionmodulista_mob']) && '' != $_SESSION['scriptcase']['error_close']['calendar_asignacionmodulista_mob']) ? $_SESSION['scriptcase']['error_close']['calendar_asignacionmodulista_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['calendar_asignacionmodulista_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['calendar_asignacionmodulista_mob']) ? $_SESSION['scriptcase']['error_span_title']['calendar_asignacionmodulista_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['calendar_asignacionmodulista_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['calendar_asignacionmodulista_mob']) ? $_SESSION['scriptcase']['error_icon_title']['calendar_asignacionmodulista_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['calendar_asignacionmodulista']['error_buffer'] .= ob_get_flush();
}
