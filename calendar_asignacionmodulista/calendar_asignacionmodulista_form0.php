...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("calendar_asignacionmodulista_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('calendar_asignacionmodulista_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("calendar_asignacionmodulista_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_asignacionmodulista'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_asignacionmodulista'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rangoinicial_label" id="hidden_field_label_rangoinicial" style="<?php echo $sStyleHidden_rangoinicial; ?>"><span id="id_label_rangoinicial"><?php echo $this->nm_new_label['rangoinicial']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangoinicial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangoinicial'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rangofinal_label" id="hidden_field_label_rangofinal" style="<?php echo $sStyleHidden_rangofinal; ?>"><span id="id_label_rangofinal"><?php echo $this->nm_new_label['rangofinal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangofinal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['rangofinal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechamodificacion_label" id="hidden_field_label_fechamodificacion" style="<?php echo $sStyleHidden_fechamodificacion; ?>"><span id="id_label_fechamodificacion"><?php echo $this->nm_new_label['fechamodificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fechamodificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['fechamodificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_horainicio_label" id="hidden_field_label_horainicio" style="<?php echo $sStyleHidden_horainicio; ?>"><span id="id_label_horainicio"><?php echo $this->nm_new_label['horainicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horainicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horainicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_horafin_label" id="hidden_field_label_horafin" style="<?php echo $sStyleHidden_horafin; ?>"><span id="id_label_horafin"><?php echo $this->nm_new_label['horafin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horafin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['php_cmp_required']['horafin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_citas_disponibles_label" id="hidden_field_label_citas_disponibles" style="<?php echo $sStyleHidden_citas_disponibles; ?>"><span id="id_label_citas_disponibles"><?php echo $this->nm_new_label['citas_disponibles']; ?></span></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['Lookup___calend_all_day__'][] = 'Y'; ?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendar_asignacionmodulista");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_asignacionmodulista");
 parent.scAjaxDetailHeight("calendar_asignacionmodulista", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_asignacionmodulista']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
