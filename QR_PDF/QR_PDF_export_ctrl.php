<?php
@session_start() ;
$_SESSION['scriptcase']['QR_PDF']['sc_process_barr'] = true;
require_once('../QR_PDF/index.php');
unset($_SESSION['scriptcase']['QR_PDF']['sc_process_barr']);
$ExportCtrl = new QR_PDF_export_control;
$ExportCtrl->Export_barr();

class QR_PDF_export_control
{
