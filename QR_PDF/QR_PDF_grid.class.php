...
//
   ...
   $_SESSION['scriptcase']['QR_PDF']['default_font'] = $this->default_font;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
...
$_SESSION['scriptcase']['QR_PDF']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['QR_PDF']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idcita'] = "Id Cita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['codigo_cita'] = "Codigo Cita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['contenedorimport'] = "Contenedorimport";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['contenedorexport'] = "Contenedor Export";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['observaciones'] = "Observaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['fechainicio'] = "Fecha Inicio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['chasis'] = "Chasis";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idnaviera'] = "Id Naviera";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idtipodecarga'] = "Idtipodecarga";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idestado'] = "Idestado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idpiloto'] = "Idpiloto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idcabezal'] = "Idcabezal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idselectivo'] = "Idselectivo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idyarda'] = "Idyarda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idtipomovimiento'] = "Idtipo Movimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['labels']['idviaje'] = "Idviaje";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['QR_PDF']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['QR_PDF']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['QR_PDF']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['qt_col_grid']) 
      {  
          ...
          $this->idviaje[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->idviaje[$this->nm_grid_colunas]);
            ...
            $cell_observaciones = array('posx' => '6.745234583332483', 'posy' => '6.74687499999915', 'data' => $this->observaciones[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
