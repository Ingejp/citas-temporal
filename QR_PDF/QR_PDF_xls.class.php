...
class QR_PDF_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new QR_PDF_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_QR_PDF.zip";
          $this->Arquivo   .= "_QR_PDF" . $this->Xls_tp;
          $this->Tit_doc    = "QR_PDF" . $this->Xls_tp;
          $this->Tit_zip    = "QR_PDF.zip";
      ...
      require_once($this->Ini->path_aplicacao . "QR_PDF_total.class.php"); 
      $this->Tot = new QR_PDF_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['field_order'] as $Cada_cmp)
      {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['campos_busca'];
      ...
      $_SESSION['scriptcase']['QR_PDF']['contr_erro'] = 'on';
...
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_dinamico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_dinamico'] != $this->nm_where_dinamico) {
    $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_dinamico'] = $this->nm_where_dinamico;
    unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['inicio']);
}
...
$_SESSION['scriptcase']['QR_PDF']['contr_erro'] = 'off'; 
      ...
      {   
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq'] .= $this->nm_where_dinamico;
      }   
      $this->arr_export = array('label' => array(), 'lines' => array());
      $this->arr_span   = array();

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count = "SELECT count(*) AS countTest from (SELECT  concat('TURNO: ', ( idCita - (SELECT turno FROM cita WHERE idcita=62) )) as idCita,     codigo_cita,     contenedorimport,     contenedorExport,     observaciones,     fechaInicio,     chasis,     idNaviera,     idtipodecarga,     idestado,     idpiloto,     idcabezal,     idselectivo,     idyarda,     idtipoMovimiento,     idviaje FROM     cita) nm_sel_esp"; 
      ...
      { 
          $nmgp_select = "SELECT idCita, codigo_cita, contenedorimport, contenedorExport, observaciones, fechaInicio, chasis, idNaviera, idtipodecarga, idestado, idpiloto, idcabezal, idselectivo, idyarda, idtipoMovimiento, idviaje from (SELECT  concat('TURNO: ', ( idCita - (SELECT turno FROM cita WHERE idcita=62) )) as idCita,     codigo_cita,     contenedorimport,     contenedorExport,     observaciones,     fechaInicio,     chasis,     idNaviera,     idtipodecarga,     idestado,     idpiloto,     idcabezal,     idselectivo,     idyarda,     idtipoMovimiento,     idviaje FROM     cita) nm_sel_esp"; 
      } 
      else 
      { 
          $nmgp_select = "SELECT idCita, codigo_cita, contenedorimport, contenedorExport, observaciones, fechaInicio, chasis, idNaviera, idtipodecarga, idestado, idpiloto, idcabezal, idselectivo, idyarda, idtipoMovimiento, idviaje from (SELECT  concat('TURNO: ', ( idCita - (SELECT turno FROM cita WHERE idcita=62) )) as idCita,     codigo_cita,     contenedorimport,     contenedorExport,     observaciones,     fechaInicio,     chasis,     idNaviera,     idtipodecarga,     idestado,     idpiloto,     idcabezal,     idselectivo,     idyarda,     idtipoMovimiento,     idviaje FROM     cita) nm_sel_esp"; 
      } 
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['QR_PDF']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
