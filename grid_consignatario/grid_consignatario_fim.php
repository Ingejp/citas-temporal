...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_consignatario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_consignatario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consignatario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_consignatario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_consignatario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_consignatario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_consignatario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_consignatario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_consignatario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_consignatario']['embutida_filho'] as $ind => $sc_init)
          {
