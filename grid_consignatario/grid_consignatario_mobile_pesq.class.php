...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idconsignatario";$Nm_numeric[] = "idconsignatario";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idconsignatario_cond" name="idconsignatario_cond" onChange="nm_campos_between(document.getElementById('id_vis_idconsignatario'), this, 'idconsignatario')">
      ...
      <br><span id="id_hide_idconsignatario"  <?php echo $str_hide_idconsignatario?>><?php
      if ($idconsignatario != "")
      {
      $idconsignatario_look = substr($this->Db->qstr($idconsignatario), 1, -1); 
      $nmgp_def_dados = array(); 
