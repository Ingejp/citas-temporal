...
if (!isset($_SESSION['sc_session']))
{
    ...
    if (is_file($root . $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
    {
?>
<html>
 <body>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("sec_logged_users_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['sec_logged_users']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['sec_logged_users']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_sec_logged_users.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['sec_logged_users'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdf_output;
