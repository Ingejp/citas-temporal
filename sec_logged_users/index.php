<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['sec_logged_users']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_doc']        = "";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_logged_users']['glo_nm_conexao'], $this->root . $this->path_prod, 'CITASPB'); 
      } 
      else 
      { 
          ob_start();
...
//
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_sec_logged_users.pdf";
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['ajax_nav'])
         {
             ...
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['fast_search'][0] = $field;
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sec_logged_users']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_CITASPB'])) {
               $_SESSION['scriptcase']['sec_logged_users']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CITASPB'];
           }
       }
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['sec_logged_users']['orig_pesq'] = $nmgp_orig_pesq;
   }
