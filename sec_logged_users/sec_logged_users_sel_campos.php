...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$this->sc_init]['sec_logged_users']['usr_cmp_sel']) && $_SESSION['sc_session'][$this->sc_init]['sec_logged_users']['usr_cmp_sel'] != $_SESSION['sc_session'][$this->sc_init]['sec_logged_users']['usr_cmp_sel_orig']) {
      $disp_rest = "";
  }
  else {
      $order_orig = array();
