<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipodecita']['sc_process_barr'] = true;
require_once('../grid_tipodecita/index.php');
unset($_SESSION['scriptcase']['grid_tipodecita']['sc_process_barr']);
$ExportCtrl = new grid_tipodecita_export_control;
$ExportCtrl->Export_barr();

class grid_tipodecita_export_control
{
