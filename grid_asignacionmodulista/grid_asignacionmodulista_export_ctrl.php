<?php
@session_start() ;
$_SESSION['scriptcase']['grid_asignacionmodulista']['sc_process_barr'] = true;
require_once('../grid_asignacionmodulista/index.php');
unset($_SESSION['scriptcase']['grid_asignacionmodulista']['sc_process_barr']);
$ExportCtrl = new grid_asignacionmodulista_export_control;
$ExportCtrl->Export_barr();

class grid_asignacionmodulista_export_control
{
