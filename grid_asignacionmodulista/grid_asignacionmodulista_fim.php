...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_asignacionmodulista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CITASPB_____grid_asignacionmodulista"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_asignacionmodulista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_asignacionmodulista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_asignacionmodulista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_asignacionmodulista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_asignacionmodulista']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_asignacionmodulista</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_asignacionmodulista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_asignacionmodulista']['embutida_filho'] as $ind => $sc_init)
          {
