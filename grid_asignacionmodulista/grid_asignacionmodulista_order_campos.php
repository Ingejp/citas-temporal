...
<?php
   ...
   $Ord_Cmp = new grid_asignacionmodulista_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_asignacionmodulista_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cantidadmodulistas'] = "cantidadModulistas";
   $tab_labels["cantidadmodulistas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["cantidadmodulistas"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["cantidadmodulistas"] : "Cantidad Modulistas";
   $tab_ger_campos['rangoinicial'] = "on";
   $tab_def_campos['rangoinicial'] = "rangoInicial";
   $tab_labels["rangoinicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["rangoinicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["rangoinicial"] : "Rango Inicial";
   $tab_ger_campos['rangofinal'] = "on";
   $tab_def_campos['rangofinal'] = "rangoFinal";
   $tab_labels["rangofinal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["rangofinal"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["rangofinal"] : "Rango Final";
   $tab_ger_campos['horainicio'] = "on";
   $tab_def_campos['horainicio'] = "horaInicio";
   $tab_labels["horainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["horainicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["horainicio"] : "Hora Inicio";
   $tab_ger_campos['citas_disponibles'] = "on";
   $tab_def_campos['citas_disponibles'] = "citas_disponibles";
   $tab_labels["citas_disponibles"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["citas_disponibles"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["citas_disponibles"] : "Citas Disponibles";
   $tab_ger_campos['citas_reservadas'] = "on";
   $tab_def_campos['citas_reservadas'] = "citas_reservadas";
   $tab_labels["citas_reservadas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["citas_reservadas"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['labels']["citas_reservadas"] : "Citas Reservadas";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_asignacionmodulista_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_asignacionmodulista']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
