...
class grid_asignacionmodulista_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_asignacionmodulista.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['pivot_group_by'];
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['arr_export']['data'];
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignacionmodulista']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
