...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("ingresobar_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('ingresobar_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
?>
...
<?php
 include_once("ingresobar_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['ingresobar'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ingresobar'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_atc_line" id="hidden_field_data_atc" style="<?php echo $sStyleHidden_atc; ?>"> <span class="scFormLabelOddFormat css_atc_label"><span id="id_label_atc"><?php echo $this->nm_new_label['atc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['php_cmp_required']['atc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['php_cmp_required']['atc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sc_field_0_line" id="hidden_field_data_sc_field_0" style="<?php echo $sStyleHidden_sc_field_0; ?>"> <span class="scFormLabelOddFormat css_sc_field_0_label"><span id="id_label_sc_field_0"><?php echo $this->nm_new_label['sc_field_0']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['php_cmp_required']['sc_field_0']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['php_cmp_required']['sc_field_0'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("ingresobar");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("ingresobar");
 parent.scAjaxDetailHeight("ingresobar", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
