  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_ingresobar" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_ingresobar_form();
	}

  // ---------- Validate codigo_cita
  function do_ajax_ingresobar_validate_codigo_cita()
  {
    var nomeCampo_codigo_cita = "codigo_cita";
    var var_codigo_cita = scAjaxGetFieldText(nomeCampo_codigo_cita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_codigo_cita(var_codigo_cita, var_script_case_init, do_ajax_ingresobar_validate_codigo_cita_cb);
  } // do_ajax_ingresobar_validate_codigo_cita

  function do_ajax_ingresobar_validate_codigo_cita_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_codigo_cita_cb

  // ---------- Validate atc
  function do_ajax_ingresobar_validate_atc()
  {
    var nomeCampo_atc = "atc";
    var var_atc = scAjaxGetFieldText(nomeCampo_atc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_atc(var_atc, var_script_case_init, do_ajax_ingresobar_validate_atc_cb);
  } // do_ajax_ingresobar_validate_atc

  function do_ajax_ingresobar_validate_atc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "atc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_atc_cb

  // ---------- Validate sc_field_0
  function do_ajax_ingresobar_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_ingresobar_validate_sc_field_0_cb);
  } // do_ajax_ingresobar_validate_sc_field_0

  function do_ajax_ingresobar_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_sc_field_0_cb

  // ---------- Validate placa
  function do_ajax_ingresobar_validate_placa()
  {
    var nomeCampo_placa = "placa";
    var var_placa = scAjaxGetFieldText(nomeCampo_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_placa(var_placa, var_script_case_init, do_ajax_ingresobar_validate_placa_cb);
  } // do_ajax_ingresobar_validate_placa

  function do_ajax_ingresobar_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_placa_cb

  // ---------- Validate chasis
  function do_ajax_ingresobar_validate_chasis()
  {
    var nomeCampo_chasis = "chasis";
    var var_chasis = scAjaxGetFieldText(nomeCampo_chasis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_chasis(var_chasis, var_script_case_init, do_ajax_ingresobar_validate_chasis_cb);
  } // do_ajax_ingresobar_validate_chasis

  function do_ajax_ingresobar_validate_chasis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "chasis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_chasis_cb

  // ---------- Validate naviera
  function do_ajax_ingresobar_validate_naviera()
  {
    var nomeCampo_naviera = "naviera";
    var var_naviera = scAjaxGetFieldText(nomeCampo_naviera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_naviera(var_naviera, var_script_case_init, do_ajax_ingresobar_validate_naviera_cb);
  } // do_ajax_ingresobar_validate_naviera

  function do_ajax_ingresobar_validate_naviera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "naviera";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_naviera_cb

  // ---------- Validate contenedor_exp
  function do_ajax_ingresobar_validate_contenedor_exp()
  {
    var nomeCampo_contenedor_exp = "contenedor_exp";
    var var_contenedor_exp = scAjaxGetFieldText(nomeCampo_contenedor_exp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_contenedor_exp(var_contenedor_exp, var_script_case_init, do_ajax_ingresobar_validate_contenedor_exp_cb);
  } // do_ajax_ingresobar_validate_contenedor_exp

  function do_ajax_ingresobar_validate_contenedor_exp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_contenedor_exp_cb

  // ---------- Validate contenedor_imp
  function do_ajax_ingresobar_validate_contenedor_imp()
  {
    var nomeCampo_contenedor_imp = "contenedor_imp";
    var var_contenedor_imp = scAjaxGetFieldText(nomeCampo_contenedor_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_contenedor_imp(var_contenedor_imp, var_script_case_init, do_ajax_ingresobar_validate_contenedor_imp_cb);
  } // do_ajax_ingresobar_validate_contenedor_imp

  function do_ajax_ingresobar_validate_contenedor_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_contenedor_imp_cb

  // ---------- Validate idcita
  function do_ajax_ingresobar_validate_idcita()
  {
    var nomeCampo_idcita = "idcita";
    var var_idcita = scAjaxGetFieldText(nomeCampo_idcita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ingresobar_validate_idcita(var_idcita, var_script_case_init, do_ajax_ingresobar_validate_idcita_cb);
  } // do_ajax_ingresobar_validate_idcita

  function do_ajax_ingresobar_validate_idcita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcita";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ingresobar_validate_idcita_cb

  // ---------- Event onchange codigo_cita
  function do_ajax_ingresobar_event_codigo_cita_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_ingresobar_event_codigo_cita_onchange(var_codigo_cita, var_placa, var_chasis, var_naviera, var_contenedor_exp, var_contenedor_imp, var_idcita, var_script_case_init, do_ajax_ingresobar_event_codigo_cita_onchange_cb);
  } // do_ajax_ingresobar_event_codigo_cita_onchange

  function do_ajax_ingresobar_event_codigo_cita_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_cita";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_ingresobar_event_codigo_cita_onchange_cb_after_alert);
  } // do_ajax_ingresobar_event_codigo_cita_onchange_cb
  function do_ajax_ingresobar_event_codigo_cita_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_ingresobar_event_codigo_cita_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_sc_btn_0
  function do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick()
  {
    var var_codigo_cita = scAjaxGetFieldText("codigo_cita");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick(var_codigo_cita, var_atc, var_sc_field_0, var_placa, var_chasis, var_naviera, var_contenedor_exp, var_contenedor_imp, var_idcita, var_script_case_init, do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick_cb);
  } // do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick

  function do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert);
  } // do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick_cb
  function do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_ingresobar_event_scajaxbutton_sc_btn_0_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_ingresobar_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_ingresobar_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigo_cita = scAjaxGetFieldText("codigo_cita");
    ...
    scAjaxProcOn();
    x_ajax_ingresobar_submit_form(var_codigo_cita, var_atc, var_sc_field_0, var_placa, var_chasis, var_naviera, var_contenedor_exp, var_contenedor_imp, var_idcita, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_ingresobar_submit_form_cb);
  } // do_ajax_ingresobar_submit_form

  function do_ajax_ingresobar_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_ingresobar_submit_form_cb_after_alert);
  } // do_ajax_ingresobar_submit_form_cb
  function do_ajax_ingresobar_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_ingresobar_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_ingresobar_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_ingresobar_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['ingresobar']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_ingresobar_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_ingresobar_navigate_form_cb_after_alert);
  } // do_ajax_ingresobar_navigate_form_cb
  function do_ajax_ingresobar_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_ingresobar_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_ingresobar_navigate_form_cb_after_alert
  function sc_hide_ingresobar_form()
  {
