...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_cita' + iSeqRow).bind('blur', function() { sc_ingresobar_codigo_cita_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_ingresobar_codigo_cita_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_ingresobar_codigo_cita_onfocus(this, iSeqRow) });
  $('#id_sc_field_placa' + iSeqRow).bind('blur', function() { sc_ingresobar_placa_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_ingresobar_placa_onfocus(this, iSeqRow) });
  $('#id_sc_field_chasis' + iSeqRow).bind('blur', function() { sc_ingresobar_chasis_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_ingresobar_chasis_onfocus(this, iSeqRow) });
  $('#id_sc_field_naviera' + iSeqRow).bind('blur', function() { sc_ingresobar_naviera_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_ingresobar_naviera_onfocus(this, iSeqRow) });
  $('#id_sc_field_contenedor_exp' + iSeqRow).bind('blur', function() { sc_ingresobar_contenedor_exp_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_ingresobar_contenedor_exp_onfocus(this, iSeqRow) });
  $('#id_sc_field_contenedor_imp' + iSeqRow).bind('blur', function() { sc_ingresobar_contenedor_imp_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_ingresobar_contenedor_imp_onfocus(this, iSeqRow) });
  $('#id_sc_field_atc' + iSeqRow).bind('blur', function() { sc_ingresobar_atc_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_ingresobar_atc_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_ingresobar_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_ingresobar_sc_field_0_onfocus(this, iSeqRow) });
  $('#id_sc_field_idcita' + iSeqRow).bind('blur', function() { sc_ingresobar_idcita_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_ingresobar_idcita_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_ingresobar_codigo_cita_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_codigo_cita();
  scCssBlur(oThis);
}

function sc_ingresobar_codigo_cita_onchange(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_event_codigo_cita_onchange();
}

function sc_ingresobar_codigo_cita_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_placa_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_placa();
  scCssBlur(oThis);
}

function sc_ingresobar_placa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_chasis_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_chasis();
  scCssBlur(oThis);
}

function sc_ingresobar_chasis_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_naviera_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_naviera();
  scCssBlur(oThis);
}

function sc_ingresobar_naviera_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_contenedor_exp_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_contenedor_exp();
  scCssBlur(oThis);
}

function sc_ingresobar_contenedor_exp_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_contenedor_imp_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_contenedor_imp();
  scCssBlur(oThis);
}

function sc_ingresobar_contenedor_imp_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_atc_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_atc();
  scCssBlur(oThis);
}

function sc_ingresobar_atc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_sc_field_0_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_sc_field_0();
  scCssBlur(oThis);
}

function sc_ingresobar_sc_field_0_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_ingresobar_idcita_onblur(oThis, iSeqRow) {
  do_ajax_ingresobar_mob_validate_idcita();
  scCssBlur(oThis);
}

function sc_ingresobar_idcita_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_ingresobar_mob_form" + pageNo).hide();
}
