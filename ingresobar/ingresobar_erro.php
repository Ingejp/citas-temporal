...
$old_error_handler = set_error_handler("ingresobar_scriptcase_error_handler");

function ingresobar_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['ingresobar']['contr_erro']) && $_SESSION['scriptcase']['ingresobar']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ingresobar->contr_ingresobar->Apl_com_erro = true;
            if ($inicial_ingresobar->contr_ingresobar->NM_ajax_flag)
            {
                $inicial_ingresobar->contr_ingresobar->NM_ajax_info['errList']['geral_ingresobar'][] = $msg;
                return;
            }
            ingresobar_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ingresobar_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ingresobar'])  && '' != $_SESSION['scriptcase']['error_icon']['ingresobar'])  ? $_SESSION['scriptcase']['error_icon']['ingresobar']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['ingresobar']) && '' != $_SESSION['scriptcase']['error_close']['ingresobar']) ? $_SESSION['scriptcase']['error_close']['ingresobar'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ingresobar']) && '' != $_SESSION['scriptcase']['error_span_title']['ingresobar']) ? $_SESSION['scriptcase']['error_span_title']['ingresobar'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ingresobar']) && '' != $_SESSION['scriptcase']['error_icon_title']['ingresobar']) ? $_SESSION['scriptcase']['error_icon_title']['ingresobar'] : '';
?>
