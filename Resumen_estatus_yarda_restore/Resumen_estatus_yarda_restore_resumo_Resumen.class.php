...
class Resumen_estatus_yarda_restore_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['contr_total_geral'] == "OK")
      {
          $this->array_total_tipo_carga = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_total']['tipo_carga'];
          $this->array_total_nav_naviera = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_total']['nav_naviera'];
      }
      else
      {
          $this->array_total_tipo_carga = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_total']['tipo_carga'] = $this->array_total_tipo_carga;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_total']['nav_naviera'] = $this->array_total_nav_naviera;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['turno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['turno'] = "Turno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_codigo_cita']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_codigo_cita'] = "Codigo Cita"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cab_placa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cab_placa'] = "Placa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['piloto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['piloto'] = "PILOTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_contenedorimport']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_contenedorimport'] = "Contenedorimport"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_contenedorexport']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_contenedorexport'] = "Contenedor Export"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_fechainicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_fechainicio'] = "Fecha Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['nav_naviera']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['nav_naviera'] = "Naviera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['tipo_carga']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['tipo_carga'] = "TIPO CARGA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['yarda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['yarda'] = "YARDA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['est_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['est_estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_chasis']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cit_chasis'] = "Chasis"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_licencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_licencia'] = "Licencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_dpi']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_dpi'] = "Dpi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_huella']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_huella'] = "Huella"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_foto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['pil_foto'] = "Foto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['viaje']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['viaje'] = "VIAJE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['via_fechaatraque']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['via_fechaatraque'] = "Fecha Atraque"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['via_fechazarpe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['via_fechazarpe'] = "Fecha Zarpe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['via_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['via_descripcion'] = "Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cab_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['cab_descripcion'] = "Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['buq_buque']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['buq_buque'] = "Buque"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['tipo_movimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['labels']['tipo_movimiento'] = "TIPO MOVIMIENTO"; 
       }
       //-----
       $this->comp_field_nm = array(
           'tipo_carga' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_order']['Resumen']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_order']['Resumen'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_order']['Resumen'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_display']['Resumen'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_display']['Resumen'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_display']['Resumen'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_display']['Resumen'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_display']['Resumen'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_display']['Resumen'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['summarizing_fields_display']['Resumen'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@Resumen_estatus_yarda_restore@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "Resumen_estatus_yarda_restore_total.class.php"); 
      }
      ...
      $this->Total   = new Resumen_estatus_yarda_restore_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['doc_word'])
{
   ...
   { 
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Resumen_estatus_yarda_restore_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Resumen_estatus_yarda_restore_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Resumen_estatus_yarda_restore_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Resumen_estatus_yarda_restore/Resumen_estatus_yarda_restore_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['dashboard_info']['remove_margin'] ? ' style="margin: 0"' : '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\"" . $remove_margin . ">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Resumen_estatus_yarda_restore/Resumen_estatus_yarda_restore_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume&nm_all_modules=grid,resume&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=en_us&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=Resumen_estatus_yarda_restore&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Resumen_estatus_yarda_restore/Resumen_estatus_yarda_restore_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Resumen_estatus_yarda_restore/Resumen_estatus_yarda_restore_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("Resumen_estatus_yarda_restore_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'Resumen_estatus_yarda_restore_config_pivot.php?nome_apl=Resumen_estatus_yarda_restore&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Resumen_estatus_yarda_restore_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "Resumen_estatus_yarda_restore/Resumen_estatus_yarda_restore_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
