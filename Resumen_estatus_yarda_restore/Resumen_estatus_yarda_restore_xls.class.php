...
class Resumen_estatus_yarda_restore_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          { 
              ...
              $this->Res_xls = new Resumen_estatus_yarda_restore_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_Resumen_estatus_yarda_restore.zip";
          $this->Arquivo   .= "_Resumen_estatus_yarda_restore" . $this->Xls_tp;
          $this->Tit_doc    = "Resumen_estatus_yarda_restore" . $this->Xls_tp;
          $this->Tit_zip    = "Resumen_estatus_yarda_restore.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_return']);
          if ($this->Tem_xls_res) {
      ...
      {
          $this->cnt_cab_placa = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['tot_geral'][2];
      }
   }
   //---- 
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_tipo_carga = " = " . $this->Db->qstr($this->tipo_carga);
          ...
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'])
         { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_cit_fechainicio()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->cit_fechainicio = substr($this->cit_fechainicio, 0, 10);
         if (empty($this->cit_fechainicio) || $this->cit_fechainicio == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
         ...
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cit_fechainicio);
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['nolabel'])
       {
 ...
 function quebra_nav_naviera_Resumen($tipo_carga, $nav_naviera) 
 {
   ...
   function quebra_tipo_carga_Resumen_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_nav_naviera_Resumen_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>RESUMEN DE UNIDADES EN YARDA :: Excel</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
