<?php
@session_start() ;
$_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['sc_process_barr'] = true;
require_once('../Resumen_estatus_yarda_restore/index.php');
unset($_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['sc_process_barr']);
$ExportCtrl = new Resumen_estatus_yarda_restore_export_control;
$ExportCtrl->Export_barr();

class Resumen_estatus_yarda_restore_export_control
{
