<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['glo_nm_path_imag_temp'] . "/sc_apl_default_CITASPB.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new Resumen_estatus_yarda_restore_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Resumen_estatus_yarda_restore_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['turno'] = "cit.idCita";
   }
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["turno"] : "Turno";
   $tab_ger_campos['cit_codigo_cita'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cit_codigo_cita'] = "cit_codigo_cita";
   }
   else
   {
       $tab_def_campos['cit_codigo_cita'] = "cit.codigo_cita";
   }
   $tab_labels["cit_codigo_cita"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_codigo_cita"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_codigo_cita"] : "Codigo Cita";
   ...
   $tab_labels["cab_placa"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cab_placa"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cab_placa"] : "Placa";
   $tab_ger_campos['piloto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['piloto'] = "piloto";
   }
   else
   {
       $tab_def_campos['piloto'] = "pil.nombre";
   }
   $tab_labels["piloto"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["piloto"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["piloto"] : "PILOTO";
   $tab_ger_campos['cit_contenedorimport'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cit_contenedorimport'] = "cit_contenedorimport";
   }
   else
   {
       $tab_def_campos['cit_contenedorimport'] = "cit.contenedorimport";
   }
   $tab_labels["cit_contenedorimport"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_contenedorimport"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_contenedorimport"] : "Contenedorimport";
   $tab_ger_campos['cit_contenedorexport'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cit_contenedorexport'] = "cit_contenedorexport";
   }
   else
   {
       $tab_def_campos['cit_contenedorexport'] = "cit.contenedorExport";
   }
   $tab_labels["cit_contenedorexport"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_contenedorexport"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_contenedorexport"] : "Contenedor Export";
   $tab_ger_campos['cit_fechainicio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cit_fechainicio'] = "cit_fechainicio";
   }
   else
   {
       $tab_def_campos['cit_fechainicio'] = "cit.fechaInicio";
   }
   $tab_labels["cit_fechainicio"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_fechainicio"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["cit_fechainicio"] : "Fecha Inicio";
   ...
   $tab_labels["nav_naviera"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["nav_naviera"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["nav_naviera"] : "Naviera";
   $tab_ger_campos['tipo_carga'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipo_carga'] = "tipo_carga";
   }
   else
   {
       $tab_def_campos['tipo_carga'] = "tipcar.descripcion";
   }
   $tab_labels["tipo_carga"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["tipo_carga"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["tipo_carga"] : "TIPO CARGA";
   $tab_ger_campos['yarda'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['yarda'] = "yarda";
   }
   else
   {
       $tab_def_campos['yarda'] = "yard.descripcion_yarda";
   }
   $tab_labels["yarda"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["yarda"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["yarda"] : "YARDA";
   $tab_ger_campos['est_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['est_estado'] = "est_estado";
   }
   else
   {
       $tab_def_campos['est_estado'] = "est.estado";
   }
   $tab_labels["est_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["est_estado"])) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['labels']["est_estado"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE>RESUMEN DE UNIDADES EN YARDA</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Resumen_estatus_yarda_restore_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Resumen_estatus_yarda_restore']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
