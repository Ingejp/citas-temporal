...
class Resumen_estatus_yarda_restore_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "Resumen_estatus_yarda_restore.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['rtf_name']);
      }
...
$_SESSION['scriptcase']['Resumen_estatus_yarda_restore']['contr_erro'] = 'off'; 
   ...
   function NM_export_cit_codigo_cita()
   {
         ...
         $this->cit_codigo_cita = str_replace('<', '&lt;', $this->cit_codigo_cita);
         $this->cit_codigo_cita = str_replace('>', '&gt;', $this->cit_codigo_cita);
         $this->Texto_tag .= "<td>" . $this->cit_codigo_cita . "</td>\r\n";
   }
   //----- cab_placa
   ...
   function NM_export_piloto()
   {
         ...
         $this->piloto = str_replace('<', '&lt;', $this->piloto);
         $this->piloto = str_replace('>', '&gt;', $this->piloto);
         $this->Texto_tag .= "<td>" . $this->piloto . "</td>\r\n";
   }
   ...
   function NM_export_cit_contenedorimport()
   {
         ...
         $this->cit_contenedorimport = str_replace('<', '&lt;', $this->cit_contenedorimport);
         $this->cit_contenedorimport = str_replace('>', '&gt;', $this->cit_contenedorimport);
         $this->Texto_tag .= "<td>" . $this->cit_contenedorimport . "</td>\r\n";
   }
   ...
   function NM_export_cit_contenedorexport()
   {
         ...
         $this->cit_contenedorexport = str_replace('<', '&lt;', $this->cit_contenedorexport);
         $this->cit_contenedorexport = str_replace('>', '&gt;', $this->cit_contenedorexport);
         $this->Texto_tag .= "<td>" . $this->cit_contenedorexport . "</td>\r\n";
   }
   //----- cit_fechainicio
   function NM_export_cit_fechainicio()
   {
         ...
         $this->cit_fechainicio = str_replace('<', '&lt;', $this->cit_fechainicio);
         $this->cit_fechainicio = str_replace('>', '&gt;', $this->cit_fechainicio);
         $this->Texto_tag .= "<td>" . $this->cit_fechainicio . "</td>\r\n";
   }
   //----- nav_naviera
   ...
   function NM_export_tipo_carga()
   {
         ...
         $this->tipo_carga = str_replace('<', '&lt;', $this->tipo_carga);
         $this->tipo_carga = str_replace('>', '&gt;', $this->tipo_carga);
         $this->Texto_tag .= "<td>" . $this->tipo_carga . "</td>\r\n";
   }
   //----- yarda
   ...
   function NM_export_est_estado()
   {
         ...
         $this->est_estado = str_replace('<', '&lt;', $this->est_estado);
         $this->est_estado = str_replace('>', '&gt;', $this->est_estado);
         $this->Texto_tag .= "<td>" . $this->est_estado . "</td>\r\n";
   }
   //----- cit_observaciones
   function NM_export_cit_observaciones()
   {
         ...
         $this->cit_observaciones = str_replace('<', '&lt;', $this->cit_observaciones);
         $this->cit_observaciones = str_replace('>', '&gt;', $this->cit_observaciones);
         $this->Texto_tag .= "<td>" . $this->cit_observaciones . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Resumen_estatus_yarda_restore']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>RESUMEN DE UNIDADES EN YARDA :: RTF</TITLE>
